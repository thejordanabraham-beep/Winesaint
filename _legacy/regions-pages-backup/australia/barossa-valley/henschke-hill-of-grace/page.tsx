...
export default async function HenschkeHillofGraceVineyardPage() {
  const climatData = await getClimatData('henschke-hill-of-grace');

  return (
    <RegionLayout
      title="Henschke Hill of Grace"
      level="vineyard"
      parentRegion="australia/barossa-valley"
      contentFile="henschke-hill-of-grace-guide.md"
