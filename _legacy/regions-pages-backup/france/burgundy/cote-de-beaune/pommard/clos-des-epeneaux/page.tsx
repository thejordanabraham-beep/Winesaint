...
export default async function ClosdespeneauxVineyardPage() {
  const climatData = await getClimatData('clos-des-epeneaux');

  return (
    <RegionLayout
      title="Clos des Épeneaux"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-beaune/pommard"
      contentFile="clos-des-epeneaux-vineyard-guide.md"
