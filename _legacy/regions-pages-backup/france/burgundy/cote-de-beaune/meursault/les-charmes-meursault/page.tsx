...
export default async function LesCharmesVineyardPage() {
  const climatData = await getClimatData('les-charmes-meursault');
  ...
  return (
    <RegionLayout
      ...
      contentFile="les-charmes-meursault-vineyard-guide.md"
