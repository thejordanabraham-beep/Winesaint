...
export default async function ChevalierMontrachetVineyardPage() {
  const climatData = await getClimatData('chevalier-montrachet');

  return (
    <RegionLayout
      title="Chevalier-Montrachet"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-beaune/puligny-montrachet"
      contentFile="chevalier-montrachet-vineyard-guide.md"
