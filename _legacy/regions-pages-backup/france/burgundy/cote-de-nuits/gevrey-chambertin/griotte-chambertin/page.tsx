...
export default async function GriotteChambertinVineyardPage() {
  const climatData = await getClimatData('griotte-chambertin');

  return (
    <RegionLayout
      title="Griotte-Chambertin"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-nuits/gevrey-chambertin"
      contentFile="griotte-chambertin-vineyard-guide.md"
