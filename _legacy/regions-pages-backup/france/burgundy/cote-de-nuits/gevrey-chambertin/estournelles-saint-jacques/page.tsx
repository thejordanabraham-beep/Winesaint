...
export default async function EstournellesSaintJacquesVineyardPage() {
  const climatData = await getClimatData('estournelles-saint-jacques');

  return (
    <RegionLayout
      title="Estournelles Saint-Jacques"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-nuits/gevrey-chambertin"
      contentFile="estournelles-saint-jacques-vineyard-guide.md"
