...
export default async function ChapelleChambertinVineyardPage() {
  const climatData = await getClimatData('chapelle-chambertin');

  return (
    <RegionLayout
      title="Chapelle-Chambertin"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-nuits/gevrey-chambertin"
      contentFile="chapelle-chambertin-vineyard-guide.md"
