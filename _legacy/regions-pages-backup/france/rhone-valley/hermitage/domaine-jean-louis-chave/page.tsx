...
export default async function DomaineJeanLouisChaveVineyardPage() {
  const climatData = await getClimatData('domaine-jean-louis-chave');
  ...
  return (
    <RegionLayout
      ...
      contentFile="domaine-jean-louis-chave-guide.md"
