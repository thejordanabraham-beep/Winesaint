...
export default async function RdesheimerBergSchlossbergVineyardPage() {
  const climatData = await getClimatData('rudesheimer-berg-schlossberg');

  return (
    <RegionLayout
      title="Rüdesheimer Berg Schlossberg"
      level="vineyard"
      parentRegion="germany/rheingau"
      contentFile="rudesheimer-berg-schlossberg-vineyard-guide.md"
