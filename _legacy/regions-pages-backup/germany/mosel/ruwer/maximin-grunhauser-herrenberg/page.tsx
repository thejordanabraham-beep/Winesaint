...
export default async function MaximinGrunhauserHerrenbergVineyardPage() {
  const climatData = await getClimatData('maximin-grunhauser-herrenberg');

  return (
    <RegionLayout
      title="Maximin Grünhäuser Herrenberg"
      level="vineyard"
      parentRegion="germany/mosel/ruwer"
      contentFile="maximin-grunhauser-herrenberg-guide.md"
