...
export default async function EitelsbacherMarienholzVineyardPage() {
  const climatData = await getClimatData('eitelsbacher-marienholz');

  return (
    <RegionLayout
      title="Eitelsbacher Marienholz"
      level="vineyard"
      parentRegion="germany/mosel/ruwer"
      contentFile="eitelsbacher-marienholz-guide.md"
