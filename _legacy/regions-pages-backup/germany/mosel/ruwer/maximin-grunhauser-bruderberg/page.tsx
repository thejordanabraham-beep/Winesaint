...
export default async function MaximinGrunhauserBruderbergVineyardPage() {
  const climatData = await getClimatData('maximin-grunhauser-bruderberg');

  return (
    <RegionLayout
      title="Maximin Grünhäuser Bruderberg"
      level="vineyard"
      parentRegion="germany/mosel/ruwer"
      contentFile="maximin-grunhauser-bruderberg-guide.md"
