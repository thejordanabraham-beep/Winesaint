...
export default async function PiesporterGoldtropfchenVineyardPage() {
  const climatData = await getClimatData('piesporter-goldtropfchen');

  return (
    <RegionLayout
      title="Piesporter Goldtröpfchen"
      level="vineyard"
      parentRegion="germany/mosel/mittelmosel"
      contentFile="piesporter-goldtropfchen-guide.md"
