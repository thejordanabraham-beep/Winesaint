...
export default async function BraunebergerJufferSonnenuhrVineyardPage() {
  const climatData = await getClimatData('brauneberger-juffer-sonnenuhr');

  return (
    <RegionLayout
      title="Brauneberger Juffer-Sonnenuhr"
      level="vineyard"
      parentRegion="germany/mosel/mittelmosel"
      contentFile="brauneberger-juffer-sonnenuhr-guide.md"
