...
export default async function ZeltingerSonnenuhrVineyardPage() {
  const climatData = await getClimatData('zeltinger-sonnenuhr');

  return (
    <RegionLayout
      title="Zeltinger Sonnenuhr"
      level="vineyard"
      parentRegion="germany/mosel/mittelmosel"
      contentFile="zeltinger-sonnenuhr-guide.md"
