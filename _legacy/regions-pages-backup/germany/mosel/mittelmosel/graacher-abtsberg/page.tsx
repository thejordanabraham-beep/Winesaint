...
export default async function GraacherAbtsbergVineyardPage() {
  const climatData = await getClimatData('graacher-abtsberg');

  return (
    <RegionLayout
      title="Graacher Abtsberg"
      level="vineyard"
      parentRegion="germany/mosel/mittelmosel"
      contentFile="graacher-abtsberg-guide.md"
