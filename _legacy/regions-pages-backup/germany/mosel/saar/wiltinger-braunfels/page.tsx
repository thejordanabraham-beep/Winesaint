...
export default async function WiltingerBraunfelsVineyardPage() {
  const climatData = await getClimatData('wiltinger-braunfels');

  return (
    <RegionLayout
      title="Wiltinger Braunfels"
      level="vineyard"
      parentRegion="germany/mosel/saar"
      contentFile="wiltinger-braunfels-guide.md"
