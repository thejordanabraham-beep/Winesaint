...
export default async function WinningerUhlenRothLayVineyardPage() {
  const climatData = await getClimatData('winninger-uhlen-roth-lay');

  return (
    <RegionLayout
      title="Winninger Uhlen Roth Lay"
      level="vineyard"
      parentRegion="germany/mosel/terrassenmosel"
      contentFile="winninger-uhlen-roth-lay-guide.md"
