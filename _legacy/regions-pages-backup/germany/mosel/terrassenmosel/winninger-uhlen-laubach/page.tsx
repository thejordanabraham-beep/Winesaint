...
export default async function WinningerUhlenLaubachVineyardPage() {
  const climatData = await getClimatData('winninger-uhlen-laubach');

  return (
    <RegionLayout
      title="Winninger Uhlen Laubach"
      level="vineyard"
      parentRegion="germany/mosel/terrassenmosel"
      contentFile="winninger-uhlen-laubach-guide.md"
