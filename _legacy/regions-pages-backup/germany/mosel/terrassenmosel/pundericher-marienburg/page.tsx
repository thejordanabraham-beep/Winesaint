...
export default async function PundericherMarienburgVineyardPage() {
  const climatData = await getClimatData('pundericher-marienburg');

  return (
    <RegionLayout
      title="Pündericher Marienburg"
      level="vineyard"
      parentRegion="germany/mosel/terrassenmosel"
      contentFile="pundericher-marienburg-guide.md"
