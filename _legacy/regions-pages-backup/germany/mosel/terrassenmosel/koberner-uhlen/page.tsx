...
export default async function KobernerUhlenVineyardPage() {
  const climatData = await getClimatData('koberner-uhlen');

  return (
    <RegionLayout
      title="Koberner Uhlen"
      level="vineyard"
      parentRegion="germany/mosel/terrassenmosel"
      contentFile="koberner-uhlen-guide.md"
