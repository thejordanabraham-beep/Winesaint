...
export default async function AlmavivaVineyardPage() {
  const climatData = await getClimatData('almaviva');

  return (
    <RegionLayout
      title="Almaviva"
      level="vineyard"
      parentRegion="chile/maipo-valley"
      contentFile="almaviva-guide.md"
