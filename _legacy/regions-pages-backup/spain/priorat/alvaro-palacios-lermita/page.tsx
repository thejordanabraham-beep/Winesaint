...
export default async function AlvaroPalaciosLErmitaVineyardPage() {
  const climatData = await getClimatData('alvaro-palacios-lermita');

  return (
    <RegionLayout
      title="Alvaro Palacios L'Ermita"
      level="vineyard"
      parentRegion="spain/priorat"
      contentFile="alvaro-palacios-lermita-guide.md"
