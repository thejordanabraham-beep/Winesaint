...
export default async function MarqusdeMurrietaVineyardPage() {
  const climatData = await getClimatData('marques-de-murrieta');
  ...
  return (
    <RegionLayout
      ...
      contentFile="marques-de-murrieta-guide.md"
