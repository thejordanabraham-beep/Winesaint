...
export default function SlovakiaPage() {
  const breadcrumbItems = [
    ...
    { name: 'Slovakia', href: '/regions/slovakia' },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="flex gap-8">
          <RegionSidebar
            ...
            regions={SLOVAKIA_MAJOR_REGIONS}
            basePath="/regions/slovakia"
          />

          <main className="flex-1">
            <div className="bg-white rounded-lg border border-gray-200 p-8 shadow-sm">
              <div className="mb-8">
                <h1 className="text-4xl font-bold text-gray-900 mb-2">Slovakia</h1>
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Wine region information for Slovakia.
                </p>
