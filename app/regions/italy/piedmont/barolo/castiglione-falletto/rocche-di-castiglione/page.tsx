...
export default async function RocchediCastiglioneVineyardPage() {
  const climatData = await getClimatData('rocche-di-castiglione');

  return (
    <RegionLayout
      title="Rocche di Castiglione"
      level="vineyard"
      parentRegion="italy/piedmont/barolo/castiglione-falletto"
      contentFile="rocche-di-castiglione-vineyard-guide.md"
