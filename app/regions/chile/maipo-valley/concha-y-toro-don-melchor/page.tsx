...
export default async function ConchayToroDonMelchorVineyardPage() {
  const climatData = await getClimatData('concha-y-toro-don-melchor');

  return (
    <RegionLayout
      title="Concha y Toro Don Melchor"
      level="vineyard"
      parentRegion="chile/maipo-valley"
      contentFile="concha-y-toro-don-melchor-guide.md"
