...
export default async function WinningerRottgenVineyardPage() {
  const climatData = await getClimatData('winninger-rottgen');

  return (
    <RegionLayout
      title="Winninger Röttgen"
      level="vineyard"
      parentRegion="germany/mosel/terrassenmosel"
      contentFile="winninger-rottgen-guide.md"
