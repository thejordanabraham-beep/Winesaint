...
export default async function PundericherNonnenbergVineyardPage() {
  const climatData = await getClimatData('pundericher-nonnenberg');

  return (
    <RegionLayout
      title="Pündericher Nonnenberg"
      level="vineyard"
      parentRegion="germany/mosel/terrassenmosel"
      contentFile="pundericher-nonnenberg-guide.md"
