...
export default async function PiesporterDomherrVineyardPage() {
  const climatData = await getClimatData('piesporter-domherr');

  return (
    <RegionLayout
      title="Piesporter Domherr"
      level="vineyard"
      parentRegion="germany/mosel/mittelmosel"
      contentFile="piesporter-domherr-guide.md"
