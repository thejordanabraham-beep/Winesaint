...
export default async function GraacherHimmelreichVineyardPage() {
  const climatData = await getClimatData('graacher-himmelreich');

  return (
    <RegionLayout
      title="Graacher Himmelreich"
      level="vineyard"
      parentRegion="germany/mosel/mittelmosel"
      contentFile="graacher-himmelreich-guide.md"
