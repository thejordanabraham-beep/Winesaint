...
export default async function ErdenerBusslayVineyardPage() {
  const climatData = await getClimatData('erdener-busslay');

  return (
    <RegionLayout
      title="Erdener Busslay"
      level="vineyard"
      parentRegion="germany/mosel/mittelmosel"
      contentFile="erdener-busslay-guide.md"
