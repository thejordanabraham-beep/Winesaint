...
export default async function GraacherDomprobstVineyardPage() {
  const climatData = await getClimatData('graacher-domprobst');

  return (
    <RegionLayout
      title="Graacher Domprobst"
      level="vineyard"
      parentRegion="germany/mosel/mittelmosel"
      contentFile="graacher-domprobst-guide.md"
