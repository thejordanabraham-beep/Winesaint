...
export default async function UrzigerGoldwingertVineyardPage() {
  const climatData = await getClimatData('urziger-goldwingert');

  return (
    <RegionLayout
      title="Ürziger Goldwingert"
      level="vineyard"
      parentRegion="germany/mosel/mittelmosel"
      contentFile="urziger-goldwingert-guide.md"
