...
export default async function WintricherOhligsbergVineyardPage() {
  const climatData = await getClimatData('wintricher-ohligsberg');

  return (
    <RegionLayout
      title="Wintricher Ohligsberg"
      level="vineyard"
      parentRegion="germany/mosel/mittelmosel"
      contentFile="wintricher-ohligsberg-guide.md"
