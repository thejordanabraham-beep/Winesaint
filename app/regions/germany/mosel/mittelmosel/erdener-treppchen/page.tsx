...
export default async function ErdenerTreppchenVineyardPage() {
  const climatData = await getClimatData('erdener-treppchen');

  return (
    <RegionLayout
      title="Erdener Treppchen"
      level="vineyard"
      parentRegion="germany/mosel/mittelmosel"
      contentFile="erdener-treppchen-guide.md"
