...
export default async function BraunebergerJufferVineyardPage() {
  const climatData = await getClimatData('brauneberger-juffer');

  return (
    <RegionLayout
      title="Brauneberger Juffer"
      level="vineyard"
      parentRegion="germany/mosel/mittelmosel"
      contentFile="brauneberger-juffer-guide.md"
