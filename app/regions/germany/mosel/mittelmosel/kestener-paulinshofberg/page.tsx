...
export default async function KestenerPaulinshofbergVineyardPage() {
  const climatData = await getClimatData('kestener-paulinshofberg');

  return (
    <RegionLayout
      title="Kestener Paulinshofberg"
      level="vineyard"
      parentRegion="germany/mosel/mittelmosel"
      contentFile="kestener-paulinshofberg-guide.md"
