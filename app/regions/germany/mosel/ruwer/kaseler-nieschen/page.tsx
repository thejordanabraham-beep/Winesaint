...
export default async function KaselerNieschenVineyardPage() {
  const climatData = await getClimatData('kaseler-nieschen');

  return (
    <RegionLayout
      title="Kaseler Nies'chen"
      level="vineyard"
      parentRegion="germany/mosel/ruwer"
      contentFile="kaseler-nieschen-guide.md"
