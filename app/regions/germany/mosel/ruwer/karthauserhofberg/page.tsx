...
export default async function KarthauserhofbergVineyardPage() {
  const climatData = await getClimatData('karthauserhofberg');

  return (
    <RegionLayout
      title="Karthäuserhofberg"
      level="vineyard"
      parentRegion="germany/mosel/ruwer"
      contentFile="karthauserhofberg-guide.md"
