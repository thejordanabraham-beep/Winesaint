...
export default async function BernkastelerDoctorVineyardPage() {
  const climatData = await getClimatData('bernkasteler-doctor');
  ...
  return (
    <RegionLayout
      ...
      contentFile="bernkasteler-doctor-vineyard-guide.md"
