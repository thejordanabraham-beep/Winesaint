...
export default async function ErdenerPrlatVineyardPage() {
  const climatData = await getClimatData('erdener-pralat');

  return (
    <RegionLayout
      title="Erdener Prälat"
      level="vineyard"
      parentRegion="germany/mosel"
      contentFile="erdener-pralat-vineyard-guide.md"
