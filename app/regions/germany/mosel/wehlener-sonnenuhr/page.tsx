...
export default async function WehlenerSonnenuhrVineyardPage() {
  const climatData = await getClimatData('wehlener-sonnenuhr');

  return (
    <RegionLayout
      title="Wehlener Sonnenuhr"
      level="vineyard"
      parentRegion="germany/mosel"
      contentFile="wehlener-sonnenuhr-vineyard-guide.md"
