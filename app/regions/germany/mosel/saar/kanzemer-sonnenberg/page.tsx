...
export default async function KanzemerSonnenbergVineyardPage() {
  const climatData = await getClimatData('kanzemer-sonnenberg');

  return (
    <RegionLayout
      title="Kanzemer Sonnenberg"
      level="vineyard"
      parentRegion="germany/mosel/saar"
      contentFile="kanzemer-sonnenberg-guide.md"
