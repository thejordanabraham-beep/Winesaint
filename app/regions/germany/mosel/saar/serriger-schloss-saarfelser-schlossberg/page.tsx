...
export default async function SerrigerSchlossSaarfelserSchlossbergVineyardPage() {
  const climatData = await getClimatData('serriger-schloss-saarfelser-schlossberg');

  return (
    <RegionLayout
      title="Serriger Schloss Saarfelser Schlossberg"
      level="vineyard"
      parentRegion="germany/mosel/saar"
      contentFile="serriger-schloss-saarfelser-schlossberg-guide.md"
