...
export default async function OckfenerGeisbergVineyardPage() {
  const climatData = await getClimatData('ockfener-geisberg');

  return (
    <RegionLayout
      title="Ockfener Geisberg"
      level="vineyard"
      parentRegion="germany/mosel/saar"
      contentFile="ockfener-geisberg-guide.md"
