...
export default async function KanzemerAltenbergVineyardPage() {
  const climatData = await getClimatData('kanzemer-altenberg');

  return (
    <RegionLayout
      title="Kanzemer Altenberg"
      level="vineyard"
      parentRegion="germany/mosel/saar"
      contentFile="kanzemer-altenberg-guide.md"
