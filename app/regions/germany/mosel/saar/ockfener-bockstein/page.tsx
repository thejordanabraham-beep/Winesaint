...
export default async function OckfenerBocksteinVineyardPage() {
  const climatData = await getClimatData('ockfener-bockstein');

  return (
    <RegionLayout
      title="Ockfener Bockstein"
      level="vineyard"
      parentRegion="germany/mosel/saar"
      contentFile="ockfener-bockstein-guide.md"
