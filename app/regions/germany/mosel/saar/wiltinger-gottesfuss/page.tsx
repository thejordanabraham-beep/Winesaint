...
export default async function WiltingerGottesfussVineyardPage() {
  const climatData = await getClimatData('wiltinger-gottesfuss');

  return (
    <RegionLayout
      title="Wiltinger Gottesfuß"
      level="vineyard"
      parentRegion="germany/mosel/saar"
      contentFile="wiltinger-gottesfuss-guide.md"
