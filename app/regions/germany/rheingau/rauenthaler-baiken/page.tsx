...
export default async function RauenthalerBaikenVineyardPage() {
  const climatData = await getClimatData('rauenthaler-baiken');

  return (
    <RegionLayout
      title="Rauenthaler Baiken"
      level="vineyard"
      parentRegion="germany/rheingau"
      contentFile="rauenthaler-baiken-vineyard-guide.md"
