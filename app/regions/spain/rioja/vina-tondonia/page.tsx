...
export default async function ViaTondoniaVineyardPage() {
  const climatData = await getClimatData('vina-tondonia');

  return (
    <RegionLayout
      title="Viña Tondonia"
      level="vineyard"
      parentRegion="spain/rioja"
      contentFile="vina-tondonia-guide.md"
