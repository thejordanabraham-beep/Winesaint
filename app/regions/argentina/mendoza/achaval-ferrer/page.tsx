...
export default async function AchavalFerrerVineyardPage() {
  const climatData = await getClimatData('achaval-ferrer');

  return (
    <RegionLayout
      title="Achaval Ferrer"
      level="vineyard"
      parentRegion="argentina/mendoza"
      contentFile="achaval-ferrer-guide.md"
