...
export default async function TorbreckRunRigVineyardPage() {
  const climatData = await getClimatData('torbreck-runrig');

  return (
    <RegionLayout
      title="Torbreck RunRig"
      level="vineyard"
      parentRegion="australia/barossa-valley"
      contentFile="torbreck-runrig-guide.md"
