...
export default async function ChteaudeBeaucastelVineyardPage() {
  const climatData = await getClimatData('chateau-de-beaucastel');
  ...
  return (
    <RegionLayout
      ...
      contentFile="chateau-de-beaucastel-guide.md"
