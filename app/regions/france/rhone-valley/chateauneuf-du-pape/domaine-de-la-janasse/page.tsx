...
export default async function DomainedelaJanasseVineyardPage() {
  const climatData = await getClimatData('domaine-de-la-janasse');
  ...
  return (
    <RegionLayout
      ...
      contentFile="domaine-de-la-janasse-guide.md"
