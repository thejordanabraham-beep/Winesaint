...
export default async function PaulJabouletAnVineyardPage() {
  const climatData = await getClimatData('paul-jaboulet-aine');
  ...
  return (
    <RegionLayout
      ...
      contentFile="paul-jaboulet-aine-guide.md"
