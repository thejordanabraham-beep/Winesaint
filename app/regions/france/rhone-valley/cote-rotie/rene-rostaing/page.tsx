...
export default async function RenRostaingVineyardPage() {
  const climatData = await getClimatData('rene-rostaing');

  return (
    <RegionLayout
      title="René Rostaing"
      level="vineyard"
      parentRegion="france/rhone-valley/cote-rotie"
      contentFile="rene-rostaing-guide.md"
