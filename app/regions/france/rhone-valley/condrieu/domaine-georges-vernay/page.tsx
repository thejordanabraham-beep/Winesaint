...
export default async function DomaineGeorgesVernayVineyardPage() {
  const climatData = await getClimatData('domaine-georges-vernay');

  return (
    <RegionLayout
      title="Domaine Georges Vernay"
      level="vineyard"
      parentRegion="france/rhone-valley/condrieu"
      contentFile="domaine-georges-vernay-guide.md"
