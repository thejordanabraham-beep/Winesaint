...
export default async function DomaineYvesCuilleronVineyardPage() {
  const climatData = await getClimatData('domaine-yves-cuilleron');
  ...
  return (
    <RegionLayout
      ...
      contentFile="domaine-yves-cuilleron-guide.md"
