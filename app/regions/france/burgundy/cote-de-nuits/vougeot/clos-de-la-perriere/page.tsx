...
export default async function ClosdelaPerrireVineyardPage() {
  const climatData = await getClimatData('clos-de-la-perriere');

  return (
    <RegionLayout
      title="Clos de la Perrière"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-nuits/vougeot"
      contentFile="clos-de-la-perriere-vineyard-guide.md"
