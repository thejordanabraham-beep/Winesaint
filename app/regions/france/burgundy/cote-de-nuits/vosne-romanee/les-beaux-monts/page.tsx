...
export default async function LesBeauxMontsVineyardPage() {
  const climatData = await getClimatData('les-beaux-monts');

  return (
    <RegionLayout
      title="Les Beaux Monts"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-nuits/vosne-romanee"
      contentFile="les-beaux-monts-vineyard-guide.md"
