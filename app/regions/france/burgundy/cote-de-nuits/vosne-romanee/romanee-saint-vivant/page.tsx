...
export default async function RomaneSaintVivantVineyardPage() {
  const climatData = await getClimatData('romanee-saint-vivant');

  return (
    <RegionLayout
      title="Romanée-Saint-Vivant"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-nuits/vosne-romanee"
      contentFile="romanee-saint-vivant-vineyard-guide.md"
