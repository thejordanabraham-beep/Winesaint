...
export default async function LesAmoureusesVineyardPage() {
  const climatData = await getClimatData('les-amoureuses');
  ...
  return (
    <RegionLayout
      ...
      contentFile="les-amoureuses-vineyard-guide.md"
