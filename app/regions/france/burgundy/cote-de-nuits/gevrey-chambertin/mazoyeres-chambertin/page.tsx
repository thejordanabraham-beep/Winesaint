...
export default async function MazoyresChambertinVineyardPage() {
  const climatData = await getClimatData('mazoyeres-chambertin');

  return (
    <RegionLayout
      title="Mazoyères-Chambertin"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-nuits/gevrey-chambertin"
      contentFile="mazoyeres-chambertin-vineyard-guide.md"
