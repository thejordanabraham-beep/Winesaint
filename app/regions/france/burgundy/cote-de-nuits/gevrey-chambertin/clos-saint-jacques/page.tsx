...
export default async function ClosSaintJacquesVineyardPage() {
  const climatData = await getClimatData('clos-saint-jacques');

  return (
    <RegionLayout
      title="Clos Saint-Jacques"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-nuits/gevrey-chambertin"
      contentFile="clos-saint-jacques-vineyard-guide.md"
