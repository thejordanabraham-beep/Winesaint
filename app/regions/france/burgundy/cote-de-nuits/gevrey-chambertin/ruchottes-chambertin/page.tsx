...
export default async function RuchottesChambertinVineyardPage() {
  const climatData = await getClimatData('ruchottes-chambertin');

  return (
    <RegionLayout
      title="Ruchottes-Chambertin"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-nuits/gevrey-chambertin"
      contentFile="ruchottes-chambertin-vineyard-guide.md"
