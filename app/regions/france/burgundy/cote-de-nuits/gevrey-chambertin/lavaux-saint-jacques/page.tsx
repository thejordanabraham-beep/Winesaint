...
export default async function LavauxSaintJacquesVineyardPage() {
  const climatData = await getClimatData('lavaux-saint-jacques');

  return (
    <RegionLayout
      title="Lavaux Saint-Jacques"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-nuits/gevrey-chambertin"
      contentFile="lavaux-saint-jacques-vineyard-guide.md"
