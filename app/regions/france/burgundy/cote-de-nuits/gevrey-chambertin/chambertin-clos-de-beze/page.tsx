...
export default async function ChambertinClosdeBzeVineyardPage() {
  const climatData = await getClimatData('chambertin-clos-de-beze');
  ...
  return (
    <RegionLayout
      ...
      contentFile="chambertin-clos-de-beze-vineyard-guide.md"
