...
export default async function ClosdelaRocheVineyardPage() {
  const climatData = await getClimatData('clos-de-la-roche');

  return (
    <RegionLayout
      title="Clos de la Roche"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-nuits/morey-saint-denis"
      contentFile="clos-de-la-roche-vineyard-guide.md"
