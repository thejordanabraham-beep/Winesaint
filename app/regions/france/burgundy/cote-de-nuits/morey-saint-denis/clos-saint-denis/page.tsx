...
export default async function ClosSaintDenisVineyardPage() {
  const climatData = await getClimatData('clos-saint-denis');

  return (
    <RegionLayout
      title="Clos Saint-Denis"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-nuits/morey-saint-denis"
      contentFile="clos-saint-denis-vineyard-guide.md"
