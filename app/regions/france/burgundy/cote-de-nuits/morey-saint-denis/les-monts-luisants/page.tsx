...
export default async function LesMontsLuisantsVineyardPage() {
  const climatData = await getClimatData('les-monts-luisants');

  return (
    <RegionLayout
      title="Les Monts Luisants"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-nuits/morey-saint-denis"
      contentFile="les-monts-luisants-vineyard-guide.md"
