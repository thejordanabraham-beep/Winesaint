...
export default async function ClosdesLambraysVineyardPage() {
  const climatData = await getClimatData('clos-des-lambrays');

  return (
    <RegionLayout
      title="Clos des Lambrays"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-nuits/morey-saint-denis"
      contentFile="clos-des-lambrays-vineyard-guide.md"
