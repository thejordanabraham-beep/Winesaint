...
export default async function ClosdesOrmesVineyardPage() {
  const climatData = await getClimatData('clos-des-ormes');

  return (
    <RegionLayout
      title="Clos des Ormes"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-nuits/morey-saint-denis"
      contentFile="clos-des-ormes-vineyard-guide.md"
