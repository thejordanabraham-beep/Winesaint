...
export default async function LesRuchottesVineyardPage() {
  const climatData = await getClimatData('les-ruchottes-chassagne');
  ...
  return (
    <RegionLayout
      ...
      contentFile="les-ruchottes-chassagne-vineyard-guide.md"
