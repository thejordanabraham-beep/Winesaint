...
export default async function ClosdesChnesVineyardPage() {
  const climatData = await getClimatData('clos-des-chenes');

  return (
    <RegionLayout
      title="Clos des Chênes"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-beaune/volnay"
      contentFile="clos-des-chenes-vineyard-guide.md"
