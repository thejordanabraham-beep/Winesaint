...
export default async function CortonCharlemagneVineyardPage() {
  const climatData = await getClimatData('corton-charlemagne');
  ...
  return (
    <RegionLayout
      ...
      contentFile="corton-charlemagne-vineyard-guide.md"
