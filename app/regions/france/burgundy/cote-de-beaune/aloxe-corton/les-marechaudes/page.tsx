...
export default async function LesMarchaudesVineyardPage() {
  const climatData = await getClimatData('les-marechaudes');

  return (
    <RegionLayout
      title="Les Maréchaudes"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-beaune/aloxe-corton"
      contentFile="les-marechaudes-vineyard-guide.md"
