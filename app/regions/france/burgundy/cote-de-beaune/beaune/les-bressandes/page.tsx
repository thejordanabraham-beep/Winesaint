...
export default async function LesBressandesVineyardPage() {
  const climatData = await getClimatData('les-bressandes');

  return (
    <RegionLayout
      title="Les Bressandes"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-beaune/beaune"
      contentFile="les-bressandes-vineyard-guide.md"
