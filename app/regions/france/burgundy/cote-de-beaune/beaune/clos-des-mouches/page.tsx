...
export default async function ClosdesMouchesVineyardPage() {
  const climatData = await getClimatData('clos-des-mouches');

  return (
    <RegionLayout
      title="Clos des Mouches"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-beaune/beaune"
      contentFile="clos-des-mouches-vineyard-guide.md"
