...
export default async function LesGenevriresVineyardPage() {
  const climatData = await getClimatData('les-genevrieres');

  return (
    <RegionLayout
      title="Les Genevrières"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-beaune/meursault"
      contentFile="les-genevrieres-vineyard-guide.md"
