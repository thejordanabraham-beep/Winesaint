...
export default async function BienvenuesBtardMontrachetVineyardPage() {
  const climatData = await getClimatData('bienvenues-batard-montrachet');

  return (
    <RegionLayout
      title="Bienvenues-Bâtard-Montrachet"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-beaune/puligny-montrachet"
      contentFile="bienvenues-batard-montrachet-vineyard-guide.md"
