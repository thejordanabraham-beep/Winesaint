...
export default async function ChteauLovilleBartonVineyardPage() {
  const climatData = await getClimatData('chateau-leoville-barton');
  ...
  return (
    <RegionLayout
      ...
      contentFile="chateau-leoville-barton-guide.md"
