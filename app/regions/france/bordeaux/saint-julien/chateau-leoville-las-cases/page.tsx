...
export default async function ChteauLovilleLasCasesVineyardPage() {
  const climatData = await getClimatData('chateau-leoville-las-cases');

  return (
    <RegionLayout
      title="Château Léoville-Las Cases"
      level="vineyard"
      parentRegion="france/bordeaux/saint-julien"
      contentFile="chateau-leoville-las-cases-guide.md"
