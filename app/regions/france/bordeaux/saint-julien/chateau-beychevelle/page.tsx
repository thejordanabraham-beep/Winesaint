...
export default async function ChteauBeychevelleVineyardPage() {
  const climatData = await getClimatData('chateau-beychevelle');
  ...
  return (
    <RegionLayout
      ...
      contentFile="chateau-beychevelle-guide.md"
