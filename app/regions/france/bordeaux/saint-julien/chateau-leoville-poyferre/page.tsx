...
export default async function ChteauLovillePoyferrVineyardPage() {
  const climatData = await getClimatData('chateau-leoville-poyferre');
  ...
  return (
    <RegionLayout
      ...
      contentFile="chateau-leoville-poyferre-guide.md"
