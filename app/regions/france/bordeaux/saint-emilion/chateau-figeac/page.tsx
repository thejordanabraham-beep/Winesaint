...
export default async function ChteauFigeacVineyardPage() {
  const climatData = await getClimatData('chateau-figeac');

  return (
    <RegionLayout
      title="Château Figeac"
      level="vineyard"
      parentRegion="france/bordeaux/saint-emilion"
      contentFile="chateau-figeac-guide.md"
