...
export default async function ChteauChevalBlancVineyardPage() {
  const climatData = await getClimatData('chateau-cheval-blanc');
  ...
  return (
    <RegionLayout
      ...
      contentFile="chateau-cheval-blanc-guide.md"
