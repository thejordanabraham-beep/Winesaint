...
export default async function VieuxChteauCertanVineyardPage() {
  const climatData = await getClimatData('vieux-chateau-certan');
  ...
  return (
    <RegionLayout
      ...
      contentFile="vieux-chateau-certan-guide.md"
