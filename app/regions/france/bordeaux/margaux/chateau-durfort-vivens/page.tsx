...
export default async function ChteauDurfortVivensVineyardPage() {
  const climatData = await getClimatData('chateau-durfort-vivens');

  return (
    <RegionLayout
      title="Château Durfort-Vivens"
      level="vineyard"
      parentRegion="france/bordeaux/margaux"
      contentFile="chateau-durfort-vivens-guide.md"
