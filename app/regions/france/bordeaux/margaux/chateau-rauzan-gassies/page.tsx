...
export default async function ChteauRauzanGassiesVineyardPage() {
  const climatData = await getClimatData('chateau-rauzan-gassies');

  return (
    <RegionLayout
      title="Château Rauzan-Gassies"
      level="vineyard"
      parentRegion="france/bordeaux/margaux"
      contentFile="chateau-rauzan-gassies-guide.md"
