...
export default async function ChteauRauzanSglaVineyardPage() {
  const climatData = await getClimatData('chateau-rauzan-segla');
  ...
  return (
    <RegionLayout
      ...
      contentFile="chateau-rauzan-segla-guide.md"
