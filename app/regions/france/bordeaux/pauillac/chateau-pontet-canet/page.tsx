...
export default async function ChteauPontetCanetVineyardPage() {
  const climatData = await getClimatData('chateau-pontet-canet');
  ...
  return (
    <RegionLayout
      ...
      contentFile="chateau-pontet-canet-guide.md"
