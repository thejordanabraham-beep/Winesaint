...
export default async function ChteauDuhartMilonVineyardPage() {
  const climatData = await getClimatData('chateau-duhart-milon');
  ...
  return (
    <RegionLayout
      ...
      contentFile="chateau-duhart-milon-guide.md"
