...
export default async function ChteauGrandPuyLacosteVineyardPage() {
  const climatData = await getClimatData('chateau-grand-puy-lacoste');
  ...
  return (
    <RegionLayout
      ...
      contentFile="chateau-grand-puy-lacoste-guide.md"
