...
export default async function ChteauLynchBagesVineyardPage() {
  const climatData = await getClimatData('chateau-lynch-bages');
  ...
  return (
    <RegionLayout
      ...
      contentFile="chateau-lynch-bages-guide.md"
