...
export default async function ChteauPichonLonguevilleComtessedeLalandeVineyardPage() {
  const climatData = await getClimatData('chateau-pichon-longueville-comtesse-de-lalande');
  ...
  return (
    <RegionLayout
      ...
      contentFile="chateau-pichon-longueville-comtesse-de-lalande-guide.md"
