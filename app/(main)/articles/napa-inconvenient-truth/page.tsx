...
export default function NapaInconvenientTruthArticle() {
  return (
    <div className="bg-[#FAF7F2] min-h-screen">
      ...
      <div className="border-b-3 border-[#1C1C1C] bg-white">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">/</span>
            <span className="text-[#1C1C1C]">Napa: An Inconvenient Truth</span>
          </nav>
        </div>
      </div>
      ...
      <article className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            <strong>This is why Napa has become a Cabernet monoculture.</strong> It's not that other varieties won't grow (they demonstrably do). It's not that winemakers don't want diversity (many do). It's that at Napa's cost structure, only Cabernet Sauvignon generates sufficient revenue to justify farming.
          </p>
          ...
          <p>
            Chad Clark, director of North Coast operations for Allied Grape Growers, summed it up: <strong>"I never thought Cabernet Sauvignon would be a difficult sell in Napa Valley."</strong>
          </p>
          ...
          <p>
            <strong>The suggestion that Napa should diversify into Grenache, Tempranillo, or other heat-tolerant varieties isn't climate adaptation—it's economic abandonment.</strong> It's telling farmers to give up the one thing that makes their operations financially viable in exchange for varieties that might handle heat better but definitely won't pay the bills.
          </p>
