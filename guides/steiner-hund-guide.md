...
1. Fragmented ownership preventing any single producer from accumulating sufficient holdings to justify dedicated bottlings
2. Challenging site characteristics (difficult terrain, less optimal exposure) that discourage premium positioning
3. Historical accident, where the site simply hasn't attracted ambitious producers willing to invest in its promotion
