...
export default async function ErbacherMarcobrunnVineyardPage() {
  const climatData = await getClimatData('erbacher-marcobrunn');

  return (
    <RegionLayout
      title="Erbacher Marcobrunn"
      level="vineyard"
      parentRegion="germany/rheingau"
      contentFile="erbacher-marcobrunn-vineyard-guide.md"
