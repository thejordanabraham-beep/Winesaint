...
export default async function WiltingerBrauneKuppVineyardPage() {
  const climatData = await getClimatData('wiltinger-braune-kupp');

  return (
    <RegionLayout
      title="Wiltinger Braune Kupp"
      level="vineyard"
      parentRegion="germany/mosel/saar"
      contentFile="wiltinger-braune-kupp-guide.md"
