...
export default async function LieserNiederbergHeldenVineyardPage() {
  const climatData = await getClimatData('lieser-niederberg-helden');

  return (
    <RegionLayout
      title="Lieser Niederberg Helden"
      level="vineyard"
      parentRegion="germany/mosel/mittelmosel"
      contentFile="lieser-niederberg-helden-guide.md"
