...
export default async function UrzigerWurzgartenVineyardPage() {
  const climatData = await getClimatData('urziger-wurzgarten');

  return (
    <RegionLayout
      title="Ürziger Würzgarten"
      level="vineyard"
      parentRegion="germany/mosel/mittelmosel"
      contentFile="urziger-wurzgarten-guide.md"
