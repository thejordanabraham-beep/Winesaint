...
export default async function MaximinGrunhauserAbtsbergVineyardPage() {
  const climatData = await getClimatData('maximin-grunhauser-abtsberg');

  return (
    <RegionLayout
      title="Maximin Grünhäuser Abtsberg"
      level="vineyard"
      parentRegion="germany/mosel/ruwer"
      contentFile="maximin-grunhauser-abtsberg-guide.md"
