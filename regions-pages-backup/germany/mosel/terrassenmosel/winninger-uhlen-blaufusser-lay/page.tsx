...
export default async function WinningerUhlenBlaufusserLayVineyardPage() {
  const climatData = await getClimatData('winninger-uhlen-blaufusser-lay');

  return (
    <RegionLayout
      title="Winninger Uhlen Blaufüsser Lay"
      level="vineyard"
      parentRegion="germany/mosel/terrassenmosel"
      contentFile="winninger-uhlen-blaufusser-lay-guide.md"
