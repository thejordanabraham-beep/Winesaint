...
export default async function WinningerHammVineyardPage() {
  const climatData = await getClimatData('winninger-hamm');

  return (
    <RegionLayout
      title="Winninger Hamm"
      level="vineyard"
      parentRegion="germany/mosel/terrassenmosel"
      contentFile="winninger-hamm-guide.md"
