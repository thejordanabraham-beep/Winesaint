...
export default async function LeeuwinEstateVineyardPage() {
  const climatData = await getClimatData('leeuwin-estate');

  return (
    <RegionLayout
      title="Leeuwin Estate"
      level="vineyard"
      parentRegion="australia/margaret-river"
      contentFile="leeuwin-estate-guide.md"
