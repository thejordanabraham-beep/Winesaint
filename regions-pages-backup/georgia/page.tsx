...
export default function GeorgiaPage() {
  const breadcrumbItems = [
    ...
    { name: 'Georgia', href: '/regions/georgia' },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="flex gap-8">
          <RegionSidebar
            ...
            regions={GEORGIA_MAJOR_REGIONS}
            basePath="/regions/georgia"
          />

          <main className="flex-1">
            <div className="bg-white rounded-lg border border-gray-200 p-8 shadow-sm">
              <div className="mb-8">
                <h1 className="text-4xl font-bold text-gray-900 mb-2">Georgia</h1>
                <p className="text-lg text-gray-600">
                  Qvevri wines and 8,000-year tradition
                </p>
              </div>
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Wine region information for Georgia.
                </p>
