...
export default async function StagsLeapWineCellarsVineyardPage() {
  const climatData = await getClimatData('stags-leap-wine-cellars');
  ...
  return (
    <RegionLayout
      ...
      contentFile="stags-leap-wine-cellars-guide.md"
