...
export default async function MountDifficultyVineyardPage() {
  const climatData = await getClimatData('mount-difficulty');

  return (
    <RegionLayout
      title="Mount Difficulty"
      level="vineyard"
      parentRegion="new-zealand/central-otago"
      contentFile="mount-difficulty-guide.md"
