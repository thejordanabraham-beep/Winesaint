...
export default async function CloudyBayVineyardPage() {
  const climatData = await getClimatData('cloudy-bay');

  return (
    <RegionLayout
      title="Cloudy Bay"
      level="vineyard"
      parentRegion="new-zealand/marlborough"
      contentFile="cloudy-bay-guide.md"
