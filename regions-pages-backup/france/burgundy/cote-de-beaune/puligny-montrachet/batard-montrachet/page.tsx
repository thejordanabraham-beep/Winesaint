...
export default async function BtardMontrachetVineyardPage() {
  const climatData = await getClimatData('batard-montrachet');
  ...
  return (
    <RegionLayout
      ...
      contentFile="batard-montrachet-vineyard-guide.md"
