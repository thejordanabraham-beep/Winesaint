...
export default async function LesPerriresVineyardPage() {
  const climatData = await getClimatData('les-perrieres-meursault');
  ...
  return (
    <RegionLayout
      ...
      contentFile="les-perrieres-meursault-vineyard-guide.md"
