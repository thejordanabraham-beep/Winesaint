...
export default async function ClosdelaBarreVineyardPage() {
  const climatData = await getClimatData('clos-de-la-barre');

  return (
    <RegionLayout
      title="Clos de la Barre"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-beaune/meursault"
      contentFile="clos-de-la-barre-vineyard-guide.md"
