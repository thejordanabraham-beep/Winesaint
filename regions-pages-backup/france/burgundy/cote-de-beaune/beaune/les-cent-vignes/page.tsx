...
export default async function LesCentVignesVineyardPage() {
  const climatData = await getClimatData('les-cent-vignes');

  return (
    <RegionLayout
      title="Les Cent Vignes"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-beaune/beaune"
      contentFile="les-cent-vignes-vineyard-guide.md"
