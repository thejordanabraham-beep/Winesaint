...
export default async function LesPetitsVougeotsVineyardPage() {
  const climatData = await getClimatData('les-petits-vougeots');

  return (
    <RegionLayout
      title="Les Petits Vougeots"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-nuits/vougeot"
      contentFile="les-petits-vougeots-vineyard-guide.md"
