...
export default async function ClosdeVougeotVineyardPage() {
  const climatData = await getClimatData('clos-de-vougeot');
  ...
  return (
    <RegionLayout
      ...
      contentFile="clos-de-vougeot-vineyard-guide.md"
