...
export default async function BonnesMaresVineyardPage() {
  const climatData = await getClimatData('bonnes-mares-morey');
  ...
  return (
    <RegionLayout
      ...
      contentFile="bonnes-mares-morey-vineyard-guide.md"
