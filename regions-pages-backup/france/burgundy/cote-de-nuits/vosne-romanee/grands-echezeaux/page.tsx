...
export default async function GrandschezeauxVineyardPage() {
  const climatData = await getClimatData('grands-echezeaux');

  return (
    <RegionLayout
      title="Grands Échezeaux"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-nuits/vosne-romanee"
      contentFile="grands-echezeaux-vineyard-guide.md"
