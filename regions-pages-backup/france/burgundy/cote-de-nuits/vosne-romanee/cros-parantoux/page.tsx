...
export default async function CrosParantouxVineyardPage() {
  const climatData = await getClimatData('cros-parantoux');

  return (
    <RegionLayout
      title="Cros Parantoux"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-nuits/vosne-romanee"
      contentFile="cros-parantoux-vineyard-guide.md"
