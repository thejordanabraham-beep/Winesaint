...
export default async function AuxMalconsortsVineyardPage() {
  const climatData = await getClimatData('aux-malconsorts');

  return (
    <RegionLayout
      title="Aux Malconsorts"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-nuits/vosne-romanee"
      contentFile="aux-malconsorts-vineyard-guide.md"
