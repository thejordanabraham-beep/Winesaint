...
export default async function CharmesChambertinVineyardPage() {
  const climatData = await getClimatData('charmes-chambertin');
  ...
  return (
    <RegionLayout
      ...
      contentFile="charmes-chambertin-vineyard-guide.md"
