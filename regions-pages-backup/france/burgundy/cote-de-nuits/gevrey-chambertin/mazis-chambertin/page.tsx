...
export default async function MazisChambertinVineyardPage() {
  const climatData = await getClimatData('mazis-chambertin');

  return (
    <RegionLayout
      title="Mazis-Chambertin"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-nuits/gevrey-chambertin"
      contentFile="mazis-chambertin-vineyard-guide.md"
