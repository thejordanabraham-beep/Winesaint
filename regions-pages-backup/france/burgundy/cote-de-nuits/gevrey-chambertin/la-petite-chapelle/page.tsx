...
export default async function LaPetiteChapelleVineyardPage() {
  const climatData = await getClimatData('la-petite-chapelle');
  ...
  return (
    <RegionLayout
      ...
      contentFile="la-petite-chapelle-vineyard-guide.md"
