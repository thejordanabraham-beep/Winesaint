...
export default async function LatriciresChambertinVineyardPage() {
  const climatData = await getClimatData('latricieres-chambertin');

  return (
    <RegionLayout
      title="Latricières-Chambertin"
      level="vineyard"
      parentRegion="france/burgundy/cote-de-nuits/gevrey-chambertin"
      contentFile="latricieres-chambertin-vineyard-guide.md"
