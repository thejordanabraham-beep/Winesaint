# Meerspinne: A Pfalz Vineyard Guide
...
**Gutswein** (estate wine): Entry-level wines from estate-owned vineyards
**Ortswein** (village wine): Wines from classified village sites
**Erste Lage** (first growth): Premier cru equivalent from superior sites
**Grosse Lage** (great growth): Grand cru equivalent from exceptional sites
