...
**Full-Bodied Red + Delicate White Fish**
The wine overpowers the food. The subtle flavors of sole, flounder, or halibut are lost against a Napa Cabernet. Match the weight.

**Artichokes + Most Wine**
Artichokes contain a compound called cynarin that makes anything consumed immediately after taste sweeter. This plays havoc with dry wine. If artichokes must be paired, choose high-acid whites (Grüner Veltliner, Vermentino) and warn guests that the artichoke may alter their perception of the wine.

**Eggs + Wine**
A notoriously difficult pairing. The sulfurous compounds in eggs coat the palate and dull wine flavors. Champagne and sparkling wine handle it best, which is why brunch pairings default to bubbles.

**Vinegar / Heavily Pickled Food + Wine**
Acetic acid in vinegar clashes with wine acids. Keep dressings light if wine is being poured, or avoid pairing wine with heavily pickled or vinegar-dominated dishes.

---

## Section 4: Building a Recommendation on the Floor
...
**Step 4: Make a confident recommendation with a reason**
Never just say "this pairs well." Tell the guest why. "The acidity in this Sancerre will cut right through the richness of the goat cheese and the creaminess of the sauce" is infinitely more convincing than "white wine goes with cheese." Guests buy confidence. Give it to them.
...
**Q1. What is the single most important principle in food and wine pairing?**
- A) Always pair red wine with red meat and white wine with fish
- B) Match the weight and intensity of the food with the weight and intensity of the wine
- C) The most expensive wine on the list will always be the best pairing
- D) Regional pairings should always be avoided in favor of international combinations

**Correct: B**

---

**Q2. Why does a highly tannic red wine pair poorly with fish?**
- A) Red wine is too heavy and overpowers the delicate flavors of fish
- B) Tannin reacts with fish oils to produce a metallic, fishy aftertaste
- C) Fish acidity clashes with the low acidity in red wine
- D) The color of the wine stains the white flesh of the fish

**Correct: B**

---

**Q3. A guest orders a rich, buttery lobster dish. Which pairing best applies the principle of complementary matching?**
- A) Light, crisp Muscadet
- B) Tannic Cabernet Sauvignon
- C) Full-bodied, barrel-fermented Chardonnay
- D) Bone-dry Riesling
...
**Q4. A guest is ordering spicy Thai food. Which wine is the safest recommendation?**
- A) 15% ABV Barossa Shiraz
- B) Off-dry Riesling with moderate alcohol
- C) Barolo
- D) Oaked Napa Chardonnay

**Correct: B**

---

**Q5. "What grows together, goes together" refers to:**
- A) Pairing wines with food that share the same color
- B) Blending grape varieties grown in adjacent vineyards
- C) The tendency for regional food and wine pairings to work naturally due to shared culinary evolution
- D) The practice of serving wine produced at the same restaurant where the food is made

**Correct: C**

---

**Q6. Why should a dessert wine always be at least as sweet as the dessert it is served with?**
- A) Sweet wines contain more alcohol, which is needed to digest rich desserts
- B) If the food is sweeter than the wine, the wine will taste dry, harsh, and unbalanced by comparison
- C) A sweeter wine will always taste better with any food, regardless of the dish
- D) Regulations in most countries require it
...
**Q8. Cynarin in artichokes causes a pairing problem because:**
- A) It reacts with tannins to produce bitterness
- B) It makes foods consumed afterward taste sweeter, which distorts wine perception
- C) It strips acidity from the wine on the palate
- D) It amplifies the perception of alcohol in wine
...
**Q10. How should you frame a pairing recommendation to be most effective with a guest?**
- A) List all possible options and let the guest decide
- B) Simply state the wine name without explanation
- C) Make a confident recommendation and explain specifically why it works with their dish
- D) Always defer to the sommelier and avoid making recommendations yourself

**Correct: C**

---

*Module 5 complete. Proceed to Module 6: Wine Service.*
