...
## Section 1: Preparing for Service — Mise en Place
...
|------------|-------------------|
| Sparkling (Champagne, Cava, Prosecco) | 6–10°C / 43–50°F |
| Light white and rosé | 8–12°C / 46–54°F |
| Full-bodied white (oaked Chardonnay, Viognier) | 10–14°C / 50–57°F |
| Light red (Beaujolais, Pinot Noir) | 12–16°C / 54–61°F |
| Medium-full bodied red | 16–18°C / 61–64°F |
| Fortified wine — sweet (Port, Sauternes) | 12–16°C / 54–61°F |
| Fortified wine — dry (Fino Sherry) | 6–10°C / 43–50°F |
...
## Section 2: Bottle Service — Presentation, Opening, and Pouring
...
## Section 4: Wine Faults — Identifying and Handling
...
## Section 5: Handling Guest Situations
...
| Term | Definition |
|------|-----------|
| **Mise en Place** | French for "put into place" — the preparation of tools, equipment, and product before service begins |
| **86'd** | Industry term for an item that is sold out or unavailable |
| **Host** | The guest who ordered the bottle; the person to whom the bottle is presented and the first taste is poured |
| **Decanting** | Pouring wine from its bottle into a decanter to separate sediment and/or aerate the wine |
| **TCA (Corked)** | Trichloroanisole — the most common wine fault, producing a musty, wet cardboard aroma |
| **Oxidation** | A wine fault caused by excessive oxygen exposure, producing flat, bruised fruit aromas |
| **Reduction** | A wine fault caused by insufficient oxygen, producing struck match or sulfurous aromas — often temporary |
| **Worm** | The spiral part of a corkscrew |
| **Ah-So** | A two-pronged wine opener designed for old or fragile corks that might break if pierced |
| **Serviette** | A folded service cloth used during wine service for presentation and drip prevention |
| **Standard Pour** | 5 oz (150ml) for by-the-glass service; approximately 3 oz (90ml) when serving a bottle at the table |
...
**Q1. When cutting the foil on a wine bottle, where should the cut be made and why?**
- A) At the top of the bottle neck — for a cleaner presentation
- B) At the second (lower) lip — to prevent wine from running behind the foil on future pours
- C) Halfway down the bottle neck — to expose more of the cork
- D) The foil should be removed entirely before presenting the bottle

**Correct: B**

---

**Q2. What is the purpose of presenting the cork to the host after opening?**
- A) It is a legal requirement in most wine-serving jurisdictions
- B) It allows the host to examine the cork for signs of seepage or drying and confirms the service is attentive
- C) The host must sign the cork to confirm the bottle is authentic
- D) The cork must be smelled by the host to confirm the wine is not faulty

**Correct: B**

---

**Q3. A guest's white wine has been in the refrigerator and arrives at the table too cold. What is the correct approach?**
- A) Reheat the wine briefly in a microwave at the bar
- B) Add warm water to the ice bucket to bring the temperature up faster
- C) Allow it to warm naturally in the glass or decanter; white wine that is too cold will come up to temperature with time
- D) Replace the bottle with a new one from room temperature storage

**Correct: C**

---

**Q4. What does it mean when a wine is described as "corked"?**
- A) There are cork fragments floating in the wine
- B) The wine smells and tastes of musty wet cardboard due to TCA contamination
- C) The cork has been pushed into the bottle
- D) The wine is sealed with a natural cork rather than a screwcap

**Correct: B**

---

**Q5. When pouring a bottle of wine for a table of four, in what order should guests be served?**
- A) Host first, then clockwise around the table
- B) Closest guest first, then working away from the server
- C) Guest of honor first if present, then other guests clockwise, host last
- D) Alphabetically by the guest's name

**Correct: C**

---

**Q6. Why should a fresh glass be brought to the host when a second bottle of the same wine is ordered?**
- A) It is a formal service requirement for all bottle changes
- B) To allow the host to confirm the second bottle is not faulty before it is poured for the table
- C) The original glass may have residue that affects the new wine's flavor
- D) It signals to other guests that a new bottle has been ordered

**Correct: B**

---

**Q7. A wine smells of struck match and burnt rubber when first poured. What fault is this, and what should you do first?**
- A) TCA — replace the bottle immediately
- B) Oxidation — replace the bottle immediately
- C) Reduction — decant or swirl aggressively; the smell may dissipate with air exposure
- D) Heat damage — replace the bottle and alert the sommelier

**Correct: C**

---

**Q8. What is the standard by-the-glass pour size, and how many glasses does a 750ml bottle yield at that size?**
- A) 4 oz per glass, yielding 6 glasses
- B) 5 oz per glass, yielding 5 glasses
- C) 6 oz per glass, yielding 4 glasses
- D) 3 oz per glass, yielding 8 glasses

**Correct: B**

---

**Q9. A young Barolo has been ordered. The guest asks if it should be decanted. What is the best response?**
- A) No — decanting destroys the wine's aromatics and should never be done
- B) Only if the wine has visible sediment
- C) Yes — young, tannic Barolo benefits from 30–60 minutes of decanting to soften tannins and open aromas
- D) Decanting is only appropriate for white wines

**Correct: C**

---

**Q10. A guest says they think their wine is bad, but when you taste it, it seems technically sound — just not to their style preference. What should guide your response?**
- A) Insist the wine is fine and educate the guest on what they are tasting
- B) Replace the wine immediately regardless of the cause
- C) Know your establishment's policy — a genuinely faulty wine is always replaced; a wine not to taste preference depends on house policy
- D) Offer the guest a different glass of the same wine to see if they change their mind

**Correct: C**

---

*Module 6 complete. You have finished Level 1: Foundations.*
*Proceed to the Level 1 Certification Exam — 50 questions, 70% pass rate required.*
