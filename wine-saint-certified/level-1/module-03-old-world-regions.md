...
## Section 1: What Is the Old World?
...
- **Amarone della Valpolicella DOCG:** The region's prestige wine. Made from grapes dried for 3–4 months (*appassimento*), concentrating sugars and flavors before fermentation. The result is a massive, full-bodied, complex wine — dried cherry, dark chocolate, leather, spice — with 15–17% ABV and extraordinary age potential. Fermented completely dry despite the concentrated sugar.
...
- **Rueda:** High-altitude Castilian plateau. Dominated by **Verdejo** — crisp, aromatic, herbal. Often blended with Sauvignon Blanc.
...
| Term | Definition |
|------|-----------|
| **Old World** | Wine-producing countries of Europe with centuries of winemaking tradition |
| **Appellation** | A legally defined wine-producing area with specific rules on grapes, yields, and production methods |
| **AOC / AOP** | Appellation d'Origine Contrôlée / Protégée — France's top wine classification system |
| **DOCG** | Denominazione di Origine Controllata e Garantita — Italy's highest wine classification |
| **DOCa** | Denominación de Origen Calificada — Spain's highest wine classification (held only by Rioja and Priorat) |
| **Premier Cru / Grand Cru** | Burgundy's vineyard classification system; Premier Cru is elevated, Grand Cru is the top tier |
| **1855 Classification** | Bordeaux's historic ranking of Left Bank estates into five growths (Premiers through Cinquièmes Crus) |
| **Appassimento** | The Italian technique of drying harvested grapes to concentrate sugars and flavors, used in Amarone production |
| **Ripasso** | Valpolicella wine re-fermented on Amarone grape skins to add body and complexity |
| **Super Tuscan** | Term for innovative Tuscan wines using non-traditional grapes or blends, typically classified as IGT Toscana |
| **Llicorella** | The black slate and quartz soil of Priorat, key to the region's distinctive mineral character |
| **Sur Lie** | Aging wine on its lees (dead yeast cells) to add texture, complexity, and a distinctive savory quality |
...
**Q1. Which grape dominates the Left Bank of Bordeaux?**
- A) Merlot
- B) Cabernet Franc
...
**Q2. Pétrus, one of the world's most expensive wines, comes from which Bordeaux appellation?**
- A) Pauillac
- B) Saint-Julien
- C) Margaux
- D) Pomerol
...
**Q3. In Burgundy's quality hierarchy, which level sits directly above Premier Cru?**
- A) Village
- B) Regional (Bourgogne AOC)
- C) Grand Cru
- D) Cru Classé
...
**Q4. Chablis is known for producing Chardonnay with which distinctive characteristic?**
- A) Rich, buttery, and heavily oaked
- B) Lean, mineral, and unoaked or lightly oaked
- C) Sweet and botrytis-affected
- D) Sparkling and low in alcohol

**Correct: B**

---

**Q5. What is the key stylistic difference between Northern and Southern Rhône red wines?**
- A) Northern Rhône uses Grenache; Southern Rhône uses Syrah
- B) Northern Rhône is 100% Syrah and structured; Southern Rhône is Grenache-dominant blends and fuller
- C) Northern Rhône produces only white wines; Southern Rhône produces only red wines
- D) There is no meaningful stylistic difference between the two zones

**Correct: B**

---

**Q6. A guest orders Sancerre. What grape and region are they getting?**
- A) Chardonnay from Burgundy
- B) Pinot Gris from Alsace
- C) Sauvignon Blanc from the Loire Valley
- D) Viognier from the Northern Rhône

**Correct: C**

---

**Q7. What is Amarone della Valpolicella and what makes its production unique?**
- A) A light Venetian red made from Garganega grapes fermented in steel tanks
- B) A powerful, dry red made from grapes dried for months to concentrate sugars before fermentation
- C) A sweet sparkling wine made from Glera grapes using the tank method
- D) A Tuscan red blended from Sangiovese and Cabernet Sauvignon

**Correct: B**

---

**Q8. What does "IGT Toscana" on a label often signal at a high price point?**
- A) A simple table wine not worth the price
- B) A wine that failed to meet DOCG standards
- C) Likely a Super Tuscan — a wine using non-traditional grapes or blends outside DOC/DOCG rules
- D) A wine from a specific single vineyard in Tuscany

**Correct: C**

---

**Q9. Which Spanish region is known for its llicorella (black slate) soils and extremely concentrated, high-alcohol Garnacha-based reds?**
- A) Rioja
- B) Ribera del Duero
- C) Rías Baixas
- D) Priorat
...
**Q10. A guest is familiar with Rioja and wants to try something similar but with more intensity and structure. What would you recommend from this module?**
- A) Soave Classico
- B) Ribera del Duero
- C) Beaujolais Cru
- D) Alsace Riesling
...
*Module 3 complete. Proceed to Module 4: New World Regions.*
