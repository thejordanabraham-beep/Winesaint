...
## Section 1: How Grape Variety Shapes a Wine
...
## Section 2: The Six Essential Red Grapes
...
## Section 3: The Six Essential White Grapes
...
| Term | Definition |
|------|-----------|
| **Impact Compounds** | Chemical compounds in a grape variety that express as specific aromas and flavors (e.g., pyrazines = green bell pepper in Cabernet Sauvignon) |
| **Pyrazines** | Compounds found in Cabernet Sauvignon, Sauvignon Blanc, and Merlot responsible for herbaceous, grassy, and green bell pepper aromas |
| **TDN (Petrol note)** | A chemical compound (1,1,6-trimethyl-1,2-dihydronaphthalene) that develops in aged Riesling, producing a petroleum or kerosene-like aroma considered a hallmark of quality |
| **Malolactic Fermentation (MLF)** | A secondary process converting sharp malic acid into softer lactic acid, creating creamier texture: common in Chardonnay |
| **Phenolic Bitterness** | Astringency in white wines from grape skin compounds, distinct from tannin: present in Albariño, Pinot Grigio, Gewürztraminer, and Viognier |
| **Terroir** | The complete natural environment of a vineyard: soil, climate, topography: and its influence on the character of the wine |
| **Clone** | A genetically identical cutting propagated from a parent vine; different clones of the same grape variety can produce wines with distinct characteristics |
...
**Q1. Which red grape is naturally low in tannin due to its thin skin?**
...
**Q2. A guest orders "something with a peppery, meaty character." Which grape variety is the best match?**
- A) Merlot
- B) Pinot Noir
- C) Sangiovese
- D) Syrah (Northern Rhône style)

**Correct: D**

---

**Q3. Zinfandel and Primitivo are:**
- A) Two different grapes from California and Italy respectively
- B) The same grape grown in different countries
- C) A common blending combination in California
- D) Different grapes that share similar flavor profiles by coincidence

**Correct: B**

---

**Q4. A guest says they "hate oaky Chardonnay." Which style would you recommend?**
- A) Napa Valley barrel-fermented Chardonnay
- B) Unoaked Chablis from Burgundy
- C) White Burgundy from the Côte de Beaune
- D) Australian Margaret River Chardonnay

**Correct: B**

---

**Q5. What chemical compound gives aged Riesling its characteristic petrol or kerosene aroma?**
- A) Pyrazines
- B) Rotundone
- C) TDN (trimethyl-dihydronaphthalene)
- D) Diacetyl
...
**Q6. Which of the following best describes the difference between Italian Pinot Grigio and Alsatian Pinot Gris?**
- A) They are made from different grape varieties with similar names
- B) Italian Pinot Grigio is light and crisp; Alsatian Pinot Gris is rich, spiced, and full-bodied
- C) Pinot Gris is always sweet; Pinot Grigio is always dry
- D) The difference is only in the name; the wines are identical in style

**Correct: B**

---

**Q7. Sangiovese is described as "designed for food." What structural characteristics make it so food-friendly?**
- A) Low tannin and low acidity
- B) High alcohol and full body
- C) High acidity and high tannin
- D) Low acidity and medium body

**Correct: C**

---

**Q8. A guest who loves California Zinfandel wants to try something new at a higher price point. Based on the flavor profile, which would be the most logical recommendation?**
- A) Mosel Riesling
- B) Albariño
- C) Châteauneuf-du-Pape (Grenache-based blend)
- D) Pinot Grigio
...
**Q9. Which grape variety is most associated with the aroma descriptors "lychee, rose petal, and ginger"?**
- A) Viognier
- B) Gewürztraminer
- C) Riesling
- D) Albariño
...
**Q10. A cool climate versus a warm climate will generally produce which difference in a wine made from the same grape variety?**
- A) Cool climate produces riper fruit and higher alcohol; warm climate produces more acidity
- B) Cool climate produces higher acidity and more restrained fruit; warm climate produces riper fruit and higher alcohol
- C) There is no meaningful difference; the grape variety determines the flavor regardless of climate
- D) Cool climate produces more tannin; warm climate produces less tannin

**Correct: B**

---

**Q11. Nebbiolo is often described as deceptive in the glass. Why?**
- A) It smells sweet but tastes dry
- B) Its color is deceptively pale for a wine with very high tannin and acidity
- C) It appears full-bodied but is actually light in alcohol
- D) Its aroma suggests age but it is always released young

**Correct: B**

---

**Q12. Cabernet Franc is the parent grape of which variety?**
- A) Merlot
- B) Pinot Noir
...
**Q13. A guest orders a Rioja Gran Reserva. What does that classification tell you about the wine?**
- A) It was made from a single named vineyard in Rioja
- B) It is a blend of Tempranillo and Garnacha aged in stainless steel
- C) It was aged for a minimum of 5 years including at least 2 years in oak, and only produced in exceptional vintages
- D) It is the entry-level classification in the Rioja system

**Correct: C**

---

**Q14. Which white grape is co-fermented with Syrah in some Côte-Rôtie wines to add aromatic lift?**
- A) Chardonnay
- B) Marsanne
- C) Viognier
- D) Roussanne
...
**Q15. A guest says they love the range of Chenin Blanc, dry Vouvray, off-dry Anjou, and sweet Quarts de Chaume. What single characteristic makes Chenin Blanc work across all these styles?**
- A) Its naturally low acidity allows sweetness to dominate
- B) Its neutral flavor profile takes on the character of wherever it's grown
- C) Its very high natural acidity provides structure and freshness at every level of sweetness
- D) Its thick skins provide the tannin needed to balance residual sugar

**Correct: C**

---

**Q16. Trebbiano is known by a different name in France, where it is used primarily for distillation into Cognac and Armagnac. What is it called?**
- A) Roussanne
- B) Ugni Blanc
- C) Clairette
- D) Picpoul
...
*Module 2 complete. Proceed to Module 3: Old World Regions.*