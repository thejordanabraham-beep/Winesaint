...
**Level:** 1 — Foundations
**Audience:** Servers, Bartenders, Front-of-House Staff
**Duration:** ~30 minutes
**Certification Requirement:** Required for Level 1 Certification
...
Every decision a winemaker makes — when to pick the grapes, how long to leave the juice in contact with the skins, whether to age in oak barrels — happens either before, during, or after that fundamental fermentation process.
...
## Section 3: Reading a Wine Label
...
**Producer / Winery**
Who made the wine. This is typically the most prominent name on the front label. In France, this might be a château (Château Margaux); in Italy, an estate (Antinori); in California, a winery name (Ridge Vineyards).
...
**Grape Variety**
The type of grape used — Chardonnay, Cabernet Sauvignon, Pinot Noir. Not all labels list this. Many Old World wines omit the grape variety because the appellation implies it: the region has its own laws dictating which grapes may be grown and how the wine must be made.

**Vintage**
The year the grapes were harvested. Weather changes year to year — a hot, dry year typically produces riper, richer wines; a cool, wet year can produce leaner, more structured ones. A wine labeled **NV** (non-vintage) is a blend of multiple years, a deliberate choice for consistency — common in Champagne, Sherry, and many Port styles.

**Alcohol by Volume (ABV)**
Required by law on every bottle. Ranges from roughly 7.5% (German Mosel Riesling) to 16%+ (Napa Zinfandel, Barossa Shiraz). Higher ABV generally means more body and warmth on the palate. Fortified wines typically list 15–22% ABV.
...
When a wine is made entirely or primarily from grapes grown in one specific named vineyard, the producer may list the vineyard on the label — "To Kalon Vineyard," "Hyde Vineyard," "Bacigalupi." This signals a step up in specificity and often quality, as the producer is making a statement about the particular character of that site.
...
## Section 4: What You're Tasting — The Five Components
...
### Body
The overall weight and richness of the wine in your mouth — light, medium, or full. An easy reference point: light-bodied wine feels like skim milk; medium-bodied like whole milk; full-bodied like cream. Body is influenced primarily by alcohol level, but also by residual sugar, extraction, and winemaking. A full-bodied white (oaked Chardonnay) can feel richer than a light-bodied red (Pinot Noir).
...
| Term | Definition |
|------|-----------|
| **Fermentation** | The process by which yeast converts grape sugar into alcohol and CO₂ |
| **Skin Contact** | The period during winemaking when juice sits with grape skins, extracting color, tannin, and flavor |
| **Dry** | A wine with little to no residual sugar; fermentation has run to or near completion |
| **Residual Sugar (RS)** | Sugar remaining in the wine after fermentation is complete |
| **Appellation** | A legally defined wine-producing region (e.g., Napa Valley, Bordeaux, Marlborough) |
| **Vintage** | The year the grapes were harvested |
| **Fortified Wine** | Wine to which a distilled spirit has been added, raising alcohol to 15–22% ABV |
| **Botrytis cinerea** | A beneficial mold ("noble rot") that concentrates sugars in grapes, used to make many great sweet wines |
| **Cuvée / Fantasy Name** | A proprietary name given to a wine by the producer, not referencing grape or region |
| **Vineyard Designation** | A named single vineyard listed on the label, indicating the specific site where grapes were grown |
| **ABV** | Alcohol by Volume — the percentage of alcohol in the finished wine |
| **Tannin** | Naturally occurring compounds from grape skins, seeds, stems, and oak that create a drying sensation in red wine |
...
- A) The process of aging wine in oak barrels
- B) The process by which yeast converts sugar into alcohol and carbon dioxide
- C) The blending of two different grape varieties
- D) The filtering of wine before bottling

**Correct: B**

---

**Q2. How does red wine get its color?**
- A) Red food pigment is added during bottling
- B) Red grapes have naturally red juice inside
- C) Extended contact between the juice and dark grape skins during fermentation
- D) The wine is aged in red oak barrels

**Correct: C**

---

**Q3. A wine described as "dry" means:**
- A) The wine was made in a hot, arid climate
- B) The wine has little to no residual sugar
- C) The wine has high tannins
- D) The wine was aged without water contact

**Correct: B**

---

**Q4. Which of the following sweet wines contains NO added spirit?**
- A) Port
- B) Sweet Sherry
- C) Sauternes
- D) Madeira
...
**Q5. Fino Sherry and Port are both fortified wines, yet they taste very different. Why?**
- A) They are made from completely different grape species
- B) Fino Sherry is fortified after fermentation (dry); Port is fortified mid-fermentation (sweet)
- C) Fino Sherry uses white grapes; Port uses red grapes only
- D) Port is aged in oak; Fino Sherry is not

**Correct: B**

---

**Q6. A wine label reads "NV." What does this mean?**
- A) The wine is made from a new, experimental grape variety
- B) The wine has not been vintage-certified by the appellation authority
- C) The wine is a blend of multiple harvest years
- D) The wine contains no added sulfites

**Correct: C**

---

**Q7. A producer labels their wine "Insignia" without listing a grape variety or region prominently. This is an example of:**
- A) A vineyard designation
- B) A cuvée or fantasy name
- C) An appellation
- D) A vintage designation

**Correct: B**

---

**Q8. Which structural component in red wine creates a drying, astringent sensation on the gums and teeth?**
- A) Acidity
- B) Residual sugar
- C) Tannin
- D) Alcohol
...
**Q9. A guest says a Pinot Noir "tastes sweet" because of its cherry and strawberry aromas. How do you best respond?**
- A) Agree — fruity wines are always sweet
- B) Explain that fruit aromas come from the grape variety and can be present in completely dry wines
- C) Recommend a dessert wine instead
- D) Tell them only white wines can taste fruity

**Correct: B**

---

**Q10. When scanning a wine label quickly before making a recommendation, which sequence gives you the most useful information first?**
- A) ABV → Vintage → Producer → Grape variety
- B) Grape variety → Fantasy name → Vineyard → ABV
- C) Region → Grape variety → Vintage → ABV
- D) Producer → Region → Fantasy name → Vintage

**Correct: C**

---

*Module 1 complete. Proceed to Module 2: Major Grape Varieties.*
