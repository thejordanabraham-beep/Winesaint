...
**Level:** Austria Mastery — DAC System & Austrian Wine Classification
**Module:** 13
...
## Section 1: 1985 — The Scandal That Built Modern Austrian Wine
...
## Section 2: The Austrian Quality Pyramid — From Table Wine to Trockenbeerenauslese
...
Kabinett is a subcategory of Qualitätswein with additional constraints: the wine must be estate-bottled (Eigenbauqualität), it must be dry in style, and alcohol is capped at a maximum of 12.7% ABV. Must weight requirements are modest — typically 73°+ KMW. The result is a deliberately light, fresh, unoaked style. Austrian Kabinett is not comparable to German Kabinett, which can be sweet — Austrian Kabinett is consistently dry and intended for early drinking.
...
Ausbruch is one of the most historically significant designations in Austrian wine law and one of the most poorly understood outside specialist circles. It occupies a legal position between Beerenauslese and Trockenbeerenauslese (must weight: 138°+ KMW), but its true distinction is geographic: Ausbruch is legally restricted to the town of Rust on the western shore of the Neusiedlersee in Burgenland. Production involves a specific traditional method — partially desiccated, botrytized grapes are fermented with the addition of freshly pressed juice from healthy grapes, which reactivates fermentation. The result is a wine of unusual complexity: the concentrated, honeyed character of TBA combined with a freshness and structural brightness not always found at that concentration level.
...
## Section 3: The DAC System — What It Is, What Problem It Solves, and Why It Matters
...
## Section 4: The DAC Appellations — A Region-by-Region Map

Austria currently recognizes sixteen DAC appellations, each with specific geographic boundaries, permitted varieties, and founding dates. The list has expanded significantly since the first DAC was established in 2002, and the trajectory of expansion reflects a systematic effort to bring every major Austrian wine region under the appellation framework.
...
**8. Carnuntum DAC** — Located east of Vienna along the Danube, Carnuntum permits Blaufränkisch and Zweigelt. The region's warm Pannonian influence produces reds of ripeness and body, with the best producers — Gerhard Markowitsch and Gernot Heinrich — demonstrating what Carnuntum can achieve at a serious level.
...
**11. Wiener Gemischter Satz DAC** — One of the most historically significant and conceptually unique DACs in Austria: the field blend wines of Vienna. Gemischter Satz (mixed set) refers to a traditional Viennese practice of planting multiple grape varieties in a single vineyard — the harvest goes in together and the varieties are fermented together. The resulting wines are complex, site-specific, and irreducibly Viennese. The DAC requires a minimum of three varieties, no single variety exceeding 50%, all varieties harvested and fermented together from registered Rieden within Vienna's city limits.
...
## Section 5: The Three-Tier DAC Hierarchy — Gebietswein, Ortswein, and Riedenwein
...
## Section 6: The Vinea Wachau, Label Reading, and Floor Strategy

### The Wachau: A Classification Outside the DAC System

The Wachau deserves separate treatment in any discussion of Austrian wine classification because it operates — deliberately and stubbornly — outside the DAC system. The Wachau is Austria's most internationally recognized wine appellation and the source of some of the country's most celebrated and expensive white wines. Yet it has no DAC designation. The reason is historical, philosophical, and practical.
...
**Quality Tier** — The Prädikat (Kabinett, Spätlese, Auslese, BA, TBA, etc.) appears on wines that carry a sweeter or more concentrated quality designation. Dry wines typically do not carry a Prädikat — the absence of a Prädikat is not a quality marker in the negative sense; most of Austria's finest dry wines carry none.

**Ried (Single Vineyard) Name** — In regions where the Riedenwein tier is developed, the Ried name is a premium signal. Learn the key Rieden within each appellation covered in this program: Heiligenstein and Gaisberg in Kamptal for Riesling; Kellerberg and Steinfeder in Wachau for Grüner Veltliner; Hochrain and Käferberg in Kremstal.
...
| Term | Definition |
|------|------------|
| DAC (Districtus Austriae Controllatus) | Austria's legally defined appellation of origin system, introduced in 2002; each DAC specifies permitted varieties, geographic boundaries, and minimum quality standards; wines not meeting DAC criteria must be labeled with a broader regional designation |
| Qualitätswein | The legal category encompassing all Austrian quality wines from the entry level through TBA; requires state laboratory analysis and official tasting panel certification via a Prüfnummer |
| Prüfnummer | The state testing number printed on every Austrian Qualitätswein, confirming it has passed mandatory chemical analysis and official sensory evaluation; the tangible product of Austria's post-1985 wine law reform |
| Kabinett | A subcategory of Austrian Qualitätswein: estate-bottled, dry, maximum 12.7% ABV; lighter and fresher than standard Qualitätswein; not to be confused with the often-sweet German Kabinett category |
| Ausbruch | A uniquely Austrian sweet wine designation, legally restricted to the town of Rust in Burgenland; must weight between BA and TBA; traditionally made by adding fresh must to botrytized grapes to reactivate fermentation; produces wines of exceptional complexity |
| Trockenbeerenauslese (TBA) | The pinnacle of the Austrian quality pyramid; produced from fully desiccated, botrytized grapes harvested individually; must weight 150°+ KMW; among the most concentrated and expensive sweet wines produced anywhere in the world |
| Eiswein | A sweet wine category produced from naturally frozen grapes, concentrating sugar and acid by pressing ice crystals out of the must; distinguished from botrytized sweet wines by its extreme acidity and purity of fruit |
| Gebietswein | The entry tier of the three-level DAC quality hierarchy; wines from anywhere within the DAC zone, expressing regional variety character without requiring village or single-vineyard specificity |
| Ortswein | The middle tier of the three-level DAC hierarchy; wines from a specific named village (Gemeinde) within the DAC zone; carries greater geographic specificity, higher must weight requirements, and greater expected complexity than Gebietswein |
| Riedenwein | The premium tier of the three-level DAC hierarchy; wines from a single registered named vineyard (Ried); Austria's legal equivalent of Burgundy's premier cru and grand cru framework |
| Ried | A legally registered, geographically delineated single vineyard site in Austria; the term appears on labels of Riedenwein-tier DAC wines and indicates a specific parcel with defined soil, aspect, and microclimate characteristics |
| Vinea Wachau | The private producers' association of the Wachau region, founded 1983; operates its own independent quality classification (Steinfeder, Federspiel, Smaragd) separate from and predating the DAC system |
| Smaragd | The premium category of the Vinea Wachau classification; named after the emerald-green lizard of the Wachau; minimum 12.5% ABV; produced from the ripest, latest-harvested grapes; the category associated with the Wachau's most structured and age-worthy dry whites |
| Federspiel | The middle tier of the Vinea Wachau classification; 11.5–12.5% ABV; named after the falconers' lure; greater complexity and aging potential than Steinfeder; the most commercially versatile Wachau category |
| Traditionsweingüter | Austria's association of traditional wine estates; the Austrian equivalent of Germany's VDP; maintains voluntary quality standards above the legal minimum, including the Erste Lage (first growth) single-vineyard classification system |

---

## Quiz — The Austrian DAC System: Classification, Quality, and What Every Label Is Telling You

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. What substance was illegally added to Austrian wines in the 1985 scandal, and what was the stated purpose?**
- A) Methanol, to increase alcohol levels for export thresholds
- B) Diethylene glycol, an antifreeze component, to simulate the body and sweetness of late-harvest wines
- C) Tartaric acid, to artificially elevate acidity in underripe vintages
- D) Potassium sorbate, to stabilize wines against microbial spoilage

**Correct: B**

---

**Q2. Despite the 1985 scandal's catastrophic reputational impact, health authorities ultimately determined that:**
- A) The amounts of diethylene glycol used were sufficient to cause serious long-term illness in regular consumers
- B) The affected wines caused dozens of hospitalizations across Germany and Austria
- C) The amounts detected were insufficient to cause harm, and no illnesses were reported
- D) Only wines exported to Germany were affected; domestic Austrian wines were untainted

**Correct: C**

---

**Q3. Which post-1985 Austrian wine law requirement appears as a six-digit number on every Qualitätswein label and confirms the wine passed both laboratory analysis and official sensory evaluation?**
- A) Kontrollnummer
- B) Vinzenz-Siegel
- C) Prüfnummer
- D) Qualitätszertifikat

**Correct: C**

---

**Q4. Austrian Kabinett differs from German Kabinett most significantly in that:**
- A) Austrian Kabinett must be made from Grüner Veltliner, while German Kabinett permits any variety
- B) Austrian Kabinett is consistently dry and estate-bottled with a maximum 12.7% ABV, while German Kabinett may be sweet
- C) Austrian Kabinett requires botrytis-affected grapes, while German Kabinett does not
- D) Austrian Kabinett is a sparkling wine category; German Kabinett is still

**Correct: B**

---

**Q5. Ausbruch is a uniquely Austrian sweet wine designation. Which of the following accurately describes its legal requirements?**
- A) It may be produced anywhere in Austria from any permitted white variety, provided must weight exceeds 127° KMW
- B) It is restricted to the town of Rust in Burgenland, with must weight between BA and TBA levels, and traditionally involves adding fresh must to botrytized grapes
- C) It is a sub-category of Eiswein, produced from frozen grapes in the Burgenland lakeside vineyards
- D) It is produced exclusively in the Wachau and classified under the Vinea Wachau system as a sweet Smaragd

**Correct: B**

---

**Q6. What core problem did the DAC system, introduced in 2002, solve that the existing quality pyramid did not address?**
- A) The pyramid allowed too many varieties in each region, creating stylistic inconsistency within appellations
- B) Producers could label wines with overly broad geographic designations (e.g., "Niederösterreich") that conveyed no meaningful information about specific origin or style
- C) The pyramid did not require state certification, allowing producers to label any wine as Qualitätswein without laboratory testing
- D) International buyers were unfamiliar with German must weight measurements and needed an alternative system

**Correct: B**

---

**Q7. A Kamptal producer makes an outstanding Chardonnay from a single vineyard in the region. Under Austrian wine law, how must this wine be labeled?**
- A) Kamptal DAC Chardonnay, as the wine comes from within the Kamptal geographic zone
- B) Kamptal DAC Riedenwein, because it is from a single vineyard regardless of variety
- C) Niederösterreich Qualitätswein, because Chardonnay is not a permitted Kamptal DAC variety
- D) Wagram DAC, because Chardonnay must be produced under a DAC that permits it

**Correct: C**

---

**Q8. Which was the first Austrian DAC appellation established, in what year, and for which variety?**
- A) Kremstal DAC, 2007, Grüner Veltliner and Riesling
- B) Kamptal DAC, 2008, Grüner Veltliner and Riesling
- C) Weinviertel DAC, 2002, Grüner Veltliner
- D) Wachau DAC, 2000, Grüner Veltliner and Riesling

**Correct: C**

---

**Q9. The Leithaberg DAC is unusual among Austrian DACs because it:**
- A) Permits only a single red variety — Zweigelt — across both white and red wine production
- B) Permits a broader range of white varieties — including Grüner Veltliner, Weißburgunder, Neuburger, and Chardonnay — alongside Blaufränkisch for reds
- C) Is the only Austrian DAC to permit Sauvignon Blanc as a designated variety
- D) Straddles the Austrian-Hungarian border and requires both countries' certification

**Correct: B**

---

**Q10. The Wiener Gemischter Satz DAC is unique in the Austrian appellation system because it:**
- A) Is the only DAC to permit sweet wine production alongside dry wines
- B) Covers vineyards within a world capital city and requires a field blend of at least three co-planted varieties harvested and fermented together
- C) Is the only DAC to prohibit new oak aging entirely
- D) Was established before the DAC system, functioning as a prototype for the eventual national framework

**Correct: B**

---

**Q11. In the three-tier DAC quality hierarchy, the correct ascending order from broadest to most specific is:**
- A) Riedenwein → Ortswein → Gebietswein
- B) Gebietswein → Riedenwein → Ortswein
- C) Ortswein → Gebietswein → Riedenwein
...
**Q12. The three-tier DAC hierarchy (Gebietswein, Ortswein, Riedenwein) is most directly modeled on which established European wine classification system?**
- A) The German Prädikat system of must weight categories
- B) The Bordeaux cru classé system of estate ranking
- C) The Burgundy appellation hierarchy of regional, village, and single-vineyard designations
- D) The Italian DOC/DOCG framework of regional and controlled designations

**Correct: C**

---

**Q13. The Vinea Wachau operates independently of the DAC system. A guest asks why the Wachau's finest wines are not labeled as "Wachau DAC." The accurate explanation is:**
- A) The Wachau lacks the minimum vineyard size required to establish a DAC appellation
- B) The Vinea Wachau's own internal classification (Steinfeder, Federspiel, Smaragd) predates DAC and provides a quality framework the producers consider sufficient and superior for their region
- C) The Austrian government has denied the Wachau's DAC application three times since 2002
- D) The Wachau's variety range is too narrow to qualify under DAC rules, which require a minimum of two permitted varieties

**Correct: B**

---

**Q14. Smaragd, the premium category of the Vinea Wachau system, is named after:**
- A) The green-tinged schist of the Wachau's primary rock vineyards
- B) The emerald-green lizard (Lacerta viridis) that sunbathes on the Wachau's stone walls
- C) The green tinge visible in young, high-acid Grüner Veltliner when poured in natural light
- D) The medieval Smaragd castle overlooking the central Wachau valley

**Correct: B**

---

**Q15. A server notices a bottle on the list from a known Kremstal producer, but the label reads "Niederösterreich Qualitätswein" rather than "Kremstal DAC." The most likely explanation is:**
- A) The wine failed the Kremstal DAC tasting panel and had to be downgraded
- B) The producer is in transition between DAC registrations and is awaiting certification renewal
- C) The wine is made from a variety not permitted under the Kremstal DAC rules, so it must carry the broader regional designation
- D) Niederösterreich Qualitätswein is a superior designation to Kremstal DAC under the revised 2019 Austrian wine law

**Correct: C**

---

**Q16. A guest who is unfamiliar with Austrian wine points to a bottle labeled "Eiswein" and asks how it differs from a Trockenbeerenauslese. The accurate distinction is:**
- A) Eiswein is fermented completely dry from frozen grapes, while TBA is always sweet due to botrytis
- B) Eiswein comes from frozen grapes with concentrated sugar and extreme acidity, producing a pure fruit character; TBA comes from fully desiccated botrytized grapes, producing honeyed, oxidative complexity with lower acidity
- C) Eiswein and TBA are legally the same designation; the term used depends only on the producer's marketing preference
- D) Eiswein is produced only in Niederösterreich, while TBA is a Burgenland-only designation

**Correct: B**

---

**Q17. A guest orders a bottle of Wachau white wine. The label shows "Federspiel." What should the sommelier communicate about this wine's style and positioning?**
- A) Federspiel is the lightest Wachau category, maximum 11.5% ABV, built for immediate drinking with minimal aging potential
- B) Federspiel is the Wachau's premium tier, from the ripest grapes, with minimum 12.5% ABV and strong aging potential
- C) Federspiel is the middle tier — 11.5–12.5% ABV — with greater complexity than Steinfeder, capable of several years of development, and the most commercially versatile Wachau category
- D) Federspiel is equivalent to Auslese in the German system and may have some residual sweetness

**Correct: C**

---

**Q18. In the context of Austrian wine classification, the Traditionsweingüter is:**
- A) The Austrian government ministry responsible for issuing DAC designations and enforcing wine law
- B) Austria's association of traditional wine estates, equivalent to Germany's VDP, maintaining voluntary quality standards including the Erste Lage single-vineyard classification
- C) The statutory body that administers the Prüfnummer certification process for all Austrian Qualitätswein
- D) A regional producers' association specific to the Wachau, equivalent to the Vinea Wachau for other regions

**Correct: B**

---

**Q19. A guest asks: "If a wine just says Kamptal DAC on the label without a village name or vineyard name, what does that tell me?" The accurate answer is:**
- A) The wine is from the entry-tier Gebietswein level — grapes from anywhere within the Kamptal zone, expressing regional Grüner Veltliner or Riesling character at the most accessible quality and price level
- B) The wine failed to qualify for the Ortswein or Riedenwein tier and was declassified to the basic DAC level as a quality concession
- C) The absence of a village or vineyard name indicates the wine is a blend of multiple DAC appellations, not a single-source product
- D) Kamptal DAC without additional qualification is automatically the Smaragd equivalent — the most concentrated and age-worthy expression of the appellation

**Correct: A**

---

**Q20. Which two Austrian DAC appellations are most closely associated with benchmark Blaufränkisch production, respectively representing a structured, tannic expression from iron-rich clay soils in central Burgenland and a finer, more mineral expression from basalt soils in southern Burgenland?**
- A) Leithaberg DAC and Neusiedlersee DAC
- B) Carnuntum DAC and Rosalia DAC
- C) Mittelburgenland DAC and Eisenberg DAC
- D) Weinviertel DAC and Wagram DAC
