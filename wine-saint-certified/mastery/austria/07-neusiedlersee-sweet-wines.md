...
**Level:** Austria Mastery — Neusiedlersee & The Great Sweet Wines
**Module:** 07
...
## Section 1: The Lake at the Center, Geography and the Pannonian Mechanism

The Neusiedlersee sits at the heart of one of Europe's most unusual wine-producing landscapes. Stretching roughly 36 kilometers from north to south and up to 14 kilometers across at its widest, this shallow steppe lake straddles the border between Austria and Hungary at the eastern edge of the Burgenland province. It is, by almost any hydrological measure, an anomaly: the deepest point in the lake barely reaches two meters. The lake is, effectively, a vast, sun-warmed puddle sitting in the middle of a flat Pannonian plain.
...
## Section 2: The Prädikat System, Austria's Sweet Wine Classification
...
## Section 3: The Varieties, What Goes Into Austria's Greatest Sweet Wines
...
## Section 4: Rust and the Ausbruch Tradition, Royal Wine, Near-Extinction, and Revival
...
Kracher committed with a scientist's precision and an artist's ambition. He studied botrytis systematically, experimented with vinification and aging approaches, and developed a rigorous system for classifying his TBAs by both variety and stylistic intent. By the early 1990s, Wine Spectator critic Robert Parker and others were encountering Kracher TBAs at international tastings and reaching for language that placed them in the company of Château d'Yquem and Germany's greatest Rheingau TBAs. The 100-point scores followed. The international reputation was secured.

Alois Kracher Sr. died in 2007. His son Gerhard Kracher continues the estate with the same philosophical commitment and has extended the producer's reach into new varieties and new export markets. The quality has not wavered.
...
## Section 6: Austrian Sweet Wines on the Floor, Comparison, Positioning, and Service Strategy
...
| Term | Definition |
|------|------------|
| Neusiedlersee DAC | The Austrian Districtus Austriae Controllatus wine region centered on the eastern and southern shores of the Neusiedlersee lake in Burgenland; the primary source of Austria's great botrytis sweet wines |
| Botrytis cinerea | The noble rot fungus that penetrates grape skins, dehydrates berries, and concentrates sugar, acid, and glycerol while introducing complex secondary aromatics including honey, saffron, and dried fruit; in Neusiedlersee, conditions for botrytis form reliably almost every vintage |
| Prädikat | The Austrian (and German) system of sweet wine classification based on natural sugar levels in the must at harvest, measured in degrees KMW in Austria; the rungs ascend from Spätlese through Auslese, Beerenauslese, Ausbruch, and Trockenbeerenauslese |
| KMW | Klosterneuburger Mostwaage; Austria's unit for measuring grape must sugar (roughly equivalent to Oechsle in Germany); Spätlese begins at 19° KMW; TBA requires a minimum of 30° KMW |
| Trockenbeerenauslese (TBA) | The highest level of Austrian (and German) Prädikat classification; produced from individually selected, fully desiccated botrytized berries; minimum 30° KMW; wines are among the most concentrated and age-worthy in the world |
| Ausbruch | A uniquely Austrian Prädikat designation historically associated with the town of Rust; sits between Beerenauslese and TBA in concentration; produced using the Überrieseln technique of re-moistening desiccated botrytized berries with fresh grape must before or during fermentation |
| Überrieseln | The traditional Ruster Ausbruch production technique: adding fresh grape must or wine to desiccated, botrytized berries to rehydrate them and facilitate fermentation while preserving extraordinary concentration |
| Eiswein | A Prädikat wine made from grapes frozen on the vine, pressed while still frozen so that the water fraction (ice) is separated from the concentrated liquid sugar and acid; no botrytis involved; produces wines of pure varietal fruit character with piercing acidity |
| Welschriesling | Austria's most important sweet wine variety; unrelated to Rhine Riesling; known as Riesling Italico in Italy and Graševina in Croatia; its high natural acidity makes it the structural backbone of Neusiedlersee TBA production |
| Zwischen den Seen | "Between the lakes": Kracher's stainless steel-aged TBA stylistic line; fermented and aged with no oak contact to preserve the pure, lifted expression of botrytis character and varietal identity |
| Nouvelle Vague | "New wave": Kracher's French oak-aged TBA stylistic line; fermented and aged in small barriques, producing richer, more complex, oak-influenced wines with stylistic parallels to Sauternes |
| Pannonian Climate | The continental climatic regime that dominates eastern Austria and extends across Hungary; characterized by hot dry summers, warm autumns, cold winters, and low rainfall; essential to building the sugar levels required for Prädikat sweet wine production |
| Ruster Ausbruch DAC | The specific geographical designation protecting the historic Ausbruch style produced within the town of Rust on the western shore of the Neusiedlersee; legally requires the traditional production method and minimum quality standards distinct from generic Ausbruch |
| Beerenauslese (BA) | The Prädikat level immediately below Ausbruch; minimum 25° KMW; produced from individually selected botrytized berries; intensely sweet, with high natural acidity; capable of aging twenty years or more |
| Morillon | The Austrian regional name for Chardonnay, particularly used in Styria and in certain Burgenland botrytis productions; appears in several of Kracher's blended TBA cuvées |

---

## Quiz: Neusiedlersee & The Great Austrian Sweet Wines

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. What is the primary geological feature that makes the Neusiedlersee uniquely suited to reliable botrytis formation every year?**
- A) Its deep, cold waters that create persistent lake fog year-round
- B) Its shallow depth, which allows summer heat to accumulate and release slowly into autumn, creating a daily mist-and-desiccation cycle ideal for botrytis
- C) Its location in a mountain valley that traps cold air and generates morning frost
- D) Its proximity to the Alps, which force moisture-laden westerly air masses over the vineyards

**Correct: B**

---

**Q2. How does Neusiedlersee's botrytis reliability compare to that of Sauternes?**
- A) Sauternes produces botrytis reliably every year; Neusiedlersee produces it erratically
- B) Both regions produce botrytis with equal consistency, driven by the same river-and-warm-air mechanism
- C) Neusiedlersee produces botrytis in almost every vintage; Sauternes conditions can be erratic, sometimes leading producers to declassify or release no wine
- D) Neither region produces reliable botrytis, both depend entirely on vintage variation

**Correct: C**

---

**Q3. In Austria's Prädikat system, which classification sits uniquely between Beerenauslese and Trockenbeerenauslese and is historically associated with the town of Rust?**
- A) Spätlese
- B) Eiswein
- C) Auslese
- D) Ausbruch
...
**Q4. What is the traditional Überrieseln technique used in Ruster Ausbruch production?**
- A) Harvesting grapes in sub-zero temperatures and pressing them while frozen
- B) Adding fresh grape must or wine to desiccated botrytized berries to rehydrate them before or during fermentation
- C) Aging the finished wine in new French oak barriques for a minimum of eighteen months
- D) Removing botrytized berries from clusters and drying them on straw mats before pressing

**Correct: B**

---

**Q5. Welschriesling, the dominant variety in Neusiedlersee TBA production, is best described as:**
- A) A synonym for Rhine Riesling from the Mosel and Rheingau in Germany
- B) A clone of Riesling developed in Austria in the twentieth century for high-sugar botrytis production
- C) A distinct, unrelated variety known as Riesling Italico in Italy and Graševina in Croatia, prized for its high natural acidity
- D) A crossing of Riesling and Welschriesling developed at the Klosterneuburg viticultural research station

**Correct: C**

---

**Q6. What does the term "Zwischen den Seen" refer to in the context of Weinlaubenhof Kracher's wine lineup?**
- A) A geographical designation for vineyards located between the Neusiedlersee and the Danube
- B) Kracher's stainless steel-aged TBA line, vinified with no oak contact to preserve pure botrytis and varietal character
- C) Kracher's oak-aged TBA line, produced in the style of Sauternes with French barrique aging
- D) A proprietary blending method combining Welschriesling and Chardonnay before botrytis harvest

**Correct: B**

---

**Q7. Alois Kracher Senior's background before becoming Austria's most celebrated sweet wine producer was:**
- A) He trained as a chef at the Hotel Imperial in Vienna and came to wine through food pairing
- B) He was a Viennese wine merchant who purchased the Illmitz estate in the 1970s
- C) He studied oenology at the University of Natural Resources and Life Sciences in Vienna (BOKU)
- D) He trained as a pharmacist before inheriting his family estate in Illmitz and applying scientific rigor to TBA production

**Correct: D**

---

**Q8. In Kracher's numbered TBA cuvée series, what does the ascending number generally indicate?**
- A) The vintage year in which the wine was produced
- B) The percentage of Welschriesling in the blend
- C) An ascending scale of richness and concentration, with higher numbers representing the most desiccated, concentrated selections
- D) The number of months the wine spent in French oak barriques

**Correct: C**

---

**Q9. Eiswein production differs fundamentally from botrytis Prädikat wines because:**
- A) Eiswein grapes are harvested earlier than botrytis wines and vinified at warmer temperatures
- B) Eiswein involves no botrytis; concentration is achieved by freezing grapes on the vine and pressing them while frozen, separating the ice (water) from the concentrated liquid
- C) Eiswein uses the Überrieseln technique, dried grapes are rehydrated with ice water before pressing
- D) Eiswein is produced exclusively from Rhine Riesling; botrytis wines use Welschriesling

**Correct: B**

---

**Q10. During what historical period was Ruster Ausbruch considered a royal wine served at European courts as a substitute for Tokay?**
- A) The Roman occupation of Pannonia in the first century BCE
- B) The seventeenth and eighteenth centuries, when Habsburg court and other European aristocracies consumed it when Hungarian Tokay was unavailable
- C) The late nineteenth century, following phylloxera's devastation of French wine regions
- D) The post-World War II reconstruction period, when Tokay was unavailable due to the Iron Curtain

**Correct: B**

---

**Q11. A guest at your table tells you they love Château d'Yquem but finds the price prohibitive for regular ordering. Which Austrian producer and style would you recommend, and what is the most compelling case for it?**
- A) Feiler-Artinger Ruster Ausbruch, comparable in price to Sauternes and made in the same style
- B) Weinlaubenhof Kracher TBA Nouvelle Vague, international critics have placed it in Sauternes' quality tier at approximately half the price, with reliable production nearly every vintage
- C) Heidi Schröck Muskat Ottonel Auslese; a lighter, more accessible sweet wine with less concentration
- D) Umathum Trockenbeerenauslese. Austria's only producer to have received 100-point scores from Wine Spectator

**Correct: B**

---

**Q12. Which producer is most specifically associated with the historic revival of authentic Ruster Ausbruch, including advocacy for the traditional Überrieseln technique?**
- A) Weinlaubenhof Kracher (Gerhard Kracher)
- B) Josef Umathum
- C) Feiler-Artinger and Heidi Schröck
- D) Wenzel and Alois Kracher Senior

**Correct: C**

---

**Q13. What is the minimum must weight (KMW) required for a wine to be classified as Trockenbeerenauslese in Austria?**
- A) 19° KMW
- B) 25° KMW
- C) 27° KMW
- D) 30° KMW
...
**Q14. How does the flavor profile of a Kracher TBA Zwischen den Seen typically differ from a Kracher TBA Nouvelle Vague?**
- A) Zwischen den Seen is sweeter and more concentrated; Nouvelle Vague is lighter and less alcoholic
- B) Zwischen den Seen is fermented with whole clusters; Nouvelle Vague uses only free-run juice from botrytized berries
- C) Zwischen den Seen is stainless steel-aged and more transparent in botrytis and varietal character; Nouvelle Vague is oak-aged and richer with vanilla and spice complexity from barrique
- D) Zwischen den Seen uses only Welschriesling; Nouvelle Vague blends Chardonnay and Gewürztraminer exclusively

**Correct: C**

---

**Q15. A floor manager is building a by-the-glass dessert wine program and wants to include Austrian sweet wine at three price points. Which structure best reflects a logical progression through Austria's Prädikat hierarchy?**
- A) Eiswein at entry, Ruster Ausbruch at mid, and a German TBA Riesling at prestige level
- B) Auslese at entry, Ruster Ausbruch (BA or Feiler-Artinger) at mid-level discovery, and Kracher TBA at prestige
- C) Spätlese dry at entry, Gewürztraminer Auslese at mid, and Sauternes at prestige
- D) Muskat Ottonel Beerenauslese at all three levels, differentiated only by vintage

**Correct: B**

---

**Q16. Which of the following best explains why Welschriesling outperforms Rhine Riesling in Neusiedlersee TBA production, according to this module?**
- A) Welschriesling has thicker skins that resist botrytis penetration, producing slower and more selective fungal development
- B) Welschriesling produces naturally lower acidity than Rhine Riesling, making the sweetness more comfortable at extreme sugar levels
- C) Welschriesling's high natural acidity acts as a structural backbone against extreme sweetness, while its relatively neutral fruit character serves as a canvas for complex botrytis aromatics
- D) Welschriesling is more resistant to frost damage during Eiswein harvests, making it safer for late-season picking

**Correct: C**

---

**Q17. In a guest conversation, how would you most accurately describe the sensory difference between a Beerenauslese and an Eiswein from Austria?**
- A) A Beerenauslese is always drier and less sweet than an Eiswein, because its fermentation is encouraged by the botrytis organisms themselves
- B) A Beerenauslese is produced from botrytized berries and shows complex honey, saffron, and dried fruit notes from noble rot; an Eiswein is produced by freezing, no botrytis involved; and shows pure, crystalline varietal fruit with piercing acidity and no botrytis character
- C) There is no sensory difference; both wines achieve the same sugar concentration through different means and taste nearly identical
- D) An Eiswein is always more expensive than a Beerenauslese because the harvest requires night labor in sub-zero temperatures

**Correct: B**

---

**Q18. The 1985 Austrian wine scandal had which indirect effect on the career of Alois Kracher Senior?**
- A) It forced him to leave Austria and produce wine in Germany for five years
- B) It created a market vacuum and a demand for credible quality producers; Kracher's commitment to transparency and scientific rigor helped rebuild Austria's sweet wine reputation from the ruins of the scandal
- C) It caused the Austrian government to ban TBA production for a period of seven years
- D) It allowed Kracher to purchase multiple competitor estates at reduced prices and consolidate his holdings around Illmitz

**Correct: B**

---

**Q19. Which statement most accurately compares Austrian TBA wines to German TBA wines?**
- A) Austrian TBAs are made exclusively from Riesling; German TBAs use a wider range of varieties including Welschriesling, Gewürztraminer, and Muskat Ottonel
- B) German TBAs are typically less expensive than Austrian TBAs at the top producer level
- C) Austrian TBAs draw on a wider variety palette and are often more immediately accessible and diverse in aromatics; German top-producer TBAs (particularly Mosel Riesling) are typically more expensive and can show more extreme acid tension
- D) There is no meaningful stylistic difference between Austrian and German TBAs; both are produced by identical legal standards and taste equivalently

**Correct: C**

---

**Q20. A guest unfamiliar with Austrian wine asks why they should try a Kracher TBA when they already know and love Château d'Yquem. What is the most effective and accurate floor response?**
- A) "Kracher is basically the same wine as Yquem, identical production method, same grape varieties, same region. You'll feel right at home."
- B) "Kracher TBA is actually less sweet than Yquem, so it's a better choice if you prefer drier wines with your dessert."
- C) "Kracher TBA has been compared directly to Château d'Yquem by international critics and received perfect scores from Wine Spectator. It's produced from different varieties, particularly Welschriesling, which gives it a sharper acidity and more lifted character. It's also roughly half the price. Most guests who love Yquem find Kracher a revelation."
- D) "Austrian wines are generally considered superior to French wines in academic blind tastings, so Kracher is the obvious upgrade from Sauternes."
