...
**Level:** France Mastery — Southwest France
**Module:** 22
...
## Section 1: The Map and the Myth, Southwest France as a Region
...
## Section 2: Cahors, Malbec's True Homeland
...
## Section 3: Madiran and Pacherenc du Vic-Bilh, The Tannin Frontier
...
## Section 4: Bergerac and Duras, Bordeaux's Shadow
...
## Section 5: Jurançon and Gascony, Mountain Whites and the Spirit of Armagnac
...
## Section 6: Irouléguy and Floor Application, Bringing the Southwest to the Table
...
| Term | Definition |
|------|------------|
| Cahors | AOP in the Lot River valley of Southwest France; minimum 70% Malbec (locally called Côt or Auxerrois); known as the "Black Wine" for its historic density and pigmentation; three terrace levels, with the high causse limestone producing the most structured, age-worthy wines; Malbec's historical origin before Argentina |
| Côt / Auxerrois (Cahors) | Local synonyms for Malbec in Cahors; no relation to Burgundy's white Auxerrois grape; the Cahors Auxerrois is purely a naming convention for the Malbec variety in this region |
| Tannat | Indigenous red grape variety of Southwest France; the primary grape of Madiran; produces the highest tannin levels of any major French variety; requires careful vinification or extended aging to manage its structural intensity; also grown in Uruguay (introduced by Basque immigrants) and carries significant resveratrol and procyanidin content |
| Micro-oxygenation | Winemaking technique invented by Patrick Ducournau at Château Montus in 1991; involves controlled introduction of tiny amounts of oxygen into wine during or after fermentation to polymerize tannins, accelerating the softening process otherwise achieved only by years of barrel aging; now used in wine production worldwide |
| Madiran | AOP in the Adour River foothills of Southwest France; minimum 40% Tannat blended with Cabernet Franc, Cabernet Sauvignon, and/or Fer Servadou; southeast-facing clay-limestone hillsides; rescued from obscurity by Alain Brumont; birthplace of micro-oxygenation |
| Pacherenc du Vic-Bilh | White wine AOP covering the same geographic boundaries as Madiran; produces both dry and sweet styles from Arrufiac, Petit Courbu, Gros Manseng, and Petit Manseng; name derives from ancient Gascon for "staked in rows"; benchmark producers include Alain Brumont (Château Montus) |
| Pécharmant | Bergerac's finest red sub-appellation; northeast of Bergerac city on clay-iron hillsides; "pech" (hilltop) soils with iron-rich ferruginous clay subsoil (tran/hardpan); Bordeaux varieties; produces more structured, age-worthy wine than flat-terrain Bergerac |
| Monbazillac | Sweet wine AOP within Bergerac; south-facing hillsides south of the Dordogne; Sémillon-dominant with Sauvignon Blanc and Muscadelle; botrytis-concentrated via multiple-pass harvesting; widely described as a high-quality, underpriced alternative to Sauternes |
| Jurançon | AOP in the Pyrenean foothills south of Pau; two designations: Jurançon Sec (dry, from Gros Manseng) and Jurançon (sweet, from late-harvest Petit Manseng); associated with Henri IV's birth legend; benchmark producers: Domaine Cauhapé, Clos Uroulat, Clos Lapeyre |
| Petit Manseng | Indigenous Southwest French grape variety; thick skin resists botrytis; concentrates through passerillage (desiccation on vine in mountain winds) rather than noble rot; produces Jurançon sweet wines of extraordinary intensity: tropical fruit, dried apricot, candied citrus peel, honey, with fresh acidity |
| Passerillage | The concentration of sugar and flavor in grapes through desiccation on the vine (rather than botrytis), driven by wind, reduced humidity, and cool temperatures; the mechanism used by Petit Manseng in Jurançon; distinct from noble rot's flavor profile, produces cleaner, more citric, tropical fruit character without mushroom/honey overlay |
| Irouléguy | France's only Basque AOP; approximately 220 hectares in the French Basque Pyrenees near Saint-Jean-Pied-de-Port; extreme terraced viticulture on schist and sandstone; Tannat-dominant reds, Petit Courbu/Gros Manseng/Petit Manseng whites; two cooperatives plus small independent estates (Domaine Ilarria, Domaine Arretxea); tiny production, strong rarity value |
| Armagnac | France's oldest brandy, produced in Gascony (Gers) from Ugni Blanc, Colombard, and Folle Blanche; distilled in the continuous alambic armagnacais still; three zones: Bas-Armagnac, Ténarèze, Haut-Armagnac; more rustic and individually variable in character than Cognac; contextually significant for understanding the Gascon wine culture |
| Gros Manseng | Indigenous Southwest French grape; larger-berried counterpart to Petit Manseng; harvested earlier; used for dry Jurançon Sec and Pacherenc du Vic-Bilh Sec; also blended into Côtes de Gascogne IGP; aromatic profile of grapefruit, white peach, green apple, dried herbs, mineral salinity |
| Causse | French term for a limestone karst plateau; the high causse above the Lot River valley in Cahors is the source of the region's most structured, mineral, age-worthy Malbec; thin topsoil over fractured Jurassic limestone; extreme drainage forces low yields and concentrated fruit |

---

## Quiz: Southwest France: Ancient Varieties and Hidden Treasures

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. What is the "privilege of Bordeaux," and why is it historically significant for understanding Southwest France as a wine region?**
- A) A trade agreement that gave Bordeaux exclusive rights to use Merlot and Cabernet Sauvignon, forcing Southwest France to develop indigenous varieties
- B) A medieval system that required upland Southwest wines to wait until Bordeaux had shipped its own vintage before they could transport their barrels downriver, because effectively suppressing Southwest French wine from reaching the English market for centuries
- C) A royal decree that exempted Bordeaux wines from taxation, allowing them to undercut Southwest French wines in domestic markets
- D) A classification system that ranked Bordeaux châteaux above all Southwest French appellations in export priority

**Correct: B**

---

**Q2. Malbec is known by two local names in Cahors. Which of the following correctly identifies both names and clarifies the potential confusion?**
- A) "Côt" and "Pressac", because Pressac is the same name used in Saint-Émilion for Malbec, creating no confusion
- B) "Côt" and "Auxerrois", because the second name causes confusion because there is also a white grape called Auxerrois in Burgundy; the two are completely unrelated
- C) "Côt" and "Malbec Noir", because the qualifier "Noir" distinguishes the Cahors red from any white variety
- D) "Auxerrois" and "Malbec de Quercy", because both names are unique to Cahors and create no confusion with grapes elsewhere

**Correct: B**

---

**Q3. The "Black Wine" legend of Cahors describes wine that was historically so dense it was used to darken Bordeaux. Which specific terroir within the Cahors appellation is responsible for the most structured, mineral, and deeply pigmented wines?**
- A) The alluvial valley floor terraces closest to the Lot River, where fertile gravel soils produce concentrated, high-extraction fruit
- B) The causse, because the high limestone karst plateau above the valley, where thin soils over fractured Jurassic limestone force low yields and extreme concentration
- C) The middle terrace zone of clay-limestone, which produces the maximum tannin extraction due to its iron-rich subsoil
- D) The south-facing riverside slopes, where direct water reflection raises temperatures and accelerates full phenolic maturity

**Correct: B**

---

**Q4. A guest sitting at a steak dinner says they usually order "a big Argentine Malbec." You want to introduce them to Cahors. What is the most accurate and compelling comparison to make?**
- A) "Argentine and Cahors Malbec are identical, because it's the same grape grown under the same conditions, so you'll find exactly what you're used to."
- B) "Cahors Malbec is actually lighter-bodied than Argentine Malbec, with less tannin and more aromatic freshness, because it's a gentler version of the same grape."
- C) "This is where Malbec actually comes from. Before Argentina, it grew here on limestone above the Lot River. The same grape, but the causse limestone makes it darker, more mineral, more austere than Mendoza. If Argentine Malbec is the warm, plush version, Cahors is the original, because structured, mineral, built to age."
- D) "Argentine Malbec was developed from a completely different clone than Cahors Malbec, because they share a name but are essentially different grapes in terms of flavor profile."

**Correct: C**

---

**Q5. Micro-oxygenation was invented in Madiran in 1991. Which producer developed it, what specific problem was it designed to solve, and what is its global significance?**
- A) Alain Brumont at Château Bouscassé; it was developed to increase Tannat's fruit concentration by exposing wine to oxygen during fermentation; it is now used exclusively in Madiran
- B) Patrick Ducournau at Château Montus; it was developed to manage Tannat's extreme tannin levels by introducing controlled micro-quantities of oxygen to accelerate tannin polymerization; it is now used in wine production worldwide
- C) Jean-Luc Baldès at Clos Triguedina; it was designed to replicate the oxidative character of barrel aging without purchasing new oak barrels; it spread to Cahors before reaching international markets
- D) Patrick Ducournau at Château Montus; it was designed to reduce Tannat's alcohol levels during extended fermentation; it spread globally as a tool for managing high-alcohol wines in warm climates

**Correct: B**

---

**Q6. Which of the following correctly describes Alain Brumont's significance for the Madiran appellation?**
- A) He invented the Tannat grape variety by crossing Cabernet Franc with an indigenous Southwest variety in the 1970s
- B) He developed Pacherenc du Vic-Bilh as a new appellation separate from Madiran, enabling the production of white wines from Gros Manseng and Petit Manseng
- C) He took over Château Bouscassé and built Château Montus from scratch, making uncompromising high-Tannat wines that attracted international critical attention and transformed Madiran from an obscure regional appellation into a wine of global recognition
- D) He lobbied the French government to lower the minimum Tannat requirement in Madiran from 80% to 40%, making the wines more commercially accessible

**Correct: C**

---

**Q7. Pacherenc du Vic-Bilh is described as "the white wine AOP of Madiran." Which of the following correctly describes the relationship between the two appellations?**
- A) Pacherenc du Vic-Bilh is a sub-zone within the Madiran AOP that produces white wines in the lower valley sections
- B) Pacherenc du Vic-Bilh covers the same geographic area as Madiran but applies exclusively to white wines made from Arrufiac, Petit Courbu, Gros Manseng, and Petit Manseng, because in both dry and sweet styles
- C) Pacherenc du Vic-Bilh is a separate AOP located north of Madiran that uses exclusively Petit Manseng for sweet wines
- D) Pacherenc du Vic-Bilh is the old name for Madiran, replaced in 1948 when the appellation was reorganized to separate red and white wine production

**Correct: B**

---

**Q8. A guest orders the cheese course and asks for a sweet wine that is "not Sauternes." You want to recommend Monbazillac. What is the most accurate floor pitch?**
- A) "Monbazillac is made from Petit Manseng desiccated by Pyrenean winds, because it has a completely different production method and flavor profile from Sauternes, though both are sweet."
- B) "Monbazillac is from the Dordogne, same grapes and same botrytis process as Sauternes, on a south-facing hillside across the river from Bergerac. The best estates produce wine that critics compare to Sauternes premiers crus, because at one-third the price. It is the honest Sauternes alternative."
- C) "Monbazillac is lighter and more aromatic than Sauternes, made primarily from Sauvignon Blanc rather than Sémillon, giving it more freshness and less richness."
- D) "Monbazillac uses a different style of botrytis than Sauternes, because here it is called 'grey rot' rather than 'noble rot,' which produces a more savory, less honeyed character."

**Correct: B**

---

**Q9. What makes Pécharmant distinct from the broader Bergerac AOP, and why does it matter for wine list positioning?**
- A) Pécharmant uses different grape varieties from Bergerac, primarily Malbec and Fer Servadou, which produce a more rustic, indigenous character than Bordeaux-variety Bergerac
- B) Pécharmant is a white wine only sub-appellation within Bergerac, defined by its Sémillon-dominant dry wines from hilltop vineyards
- C) Pécharmant sits on hillsides northeast of Bergerac city with iron-rich clay subsoil (tran), producing more structured, age-worthy red wines than flat-terrain Bergerac, because making it the appellation to recommend when a guest wants a step above entry-level Bergerac Rouge
- D) Pécharmant is the only Bergerac sub-appellation permitted to use new French oak barrels, which accounts for its higher price point and more structured character

**Correct: C**

---

**Q10. What is the key difference between Jurançon Sec and Jurançon (the sweet version), and which grape is primarily responsible for each?**
- A) Both styles are made from Petit Manseng; Jurançon Sec is harvested earlier for dryness and Jurançon is left on the vine for sweetness
- B) Jurançon Sec is dry, made primarily from Gros Manseng harvested at standard ripeness; Jurançon is sweet, made primarily from Petit Manseng concentrated through passerillage on the vine
- C) Jurançon Sec uses Sauvignon Blanc and Sémillon; Jurançon uses Petit Manseng, because the appellation straddles both Bordeaux-variety and indigenous-variety production
- D) The distinction is purely stylistic; both wines use the same blend of Gros and Petit Manseng; the winemaker decides whether to ferment to dryness or leave residual sugar

**Correct: B**

---

**Q11. Explain passerillage as it occurs in Jurançon Petit Manseng. How does it differ from botrytis concentration, and what flavor distinction results?**
- A) Passerillage and botrytis are essentially the same process, because both involve fungal activity on the grape skin that concentrates sugar; the difference is purely technical rather than flavor-relevant
- B) Passerillage concentrates grapes through botrytis infection on thick-skinned varieties like Petit Manseng; the difference from Sauternes is only that it occurs later in the harvest season
- C) Passerillage is concentration through desiccation on the vine, driven by cold, dry mountain winds rather than botrytis, producing a flavor profile of tropical fruit, dried apricot, and candied citrus peel with clean acidity, without the mushroom-honey overlay of noble rot
- D) Passerillage refers to harvesting Petit Manseng at extreme overripeness by manually drying bunches on trays indoors after picking, because a process unique to the Jurançon AOP

**Correct: C**

---

**Q12. The Henri IV birth legend connects Jurançon to which city, and why is this story useful for floor service?**
- A) The legend is set in Bordeaux, and Jurançon's connection to it helps explain why the Southwest was historically under Bordeaux's commercial influence
- B) The legend is set in Pau, where Henri IV's lips were touched with Jurançon wine and garlic at birth in 1553, because a story that immediately grounds the wine in French historical identity and gives guests a vivid, memorable connection to the appellation
- C) The legend is set in Paris and refers to Henri IV's famous statement that Paris was worth converting to Catholicism; the connection to Jurançon was added later by regional marketing associations
- D) The legend is set in Saint-Jean-Pied-de-Port, connecting it to the Camino de Santiago pilgrimage route and making it relevant for guests with Spanish or Basque connections

**Correct: B**

---

**Q13. A guest interested in Priorat and "natural wine" asks for an unusual French bottle they have never tried. Based on this module, which Southwest France recommendation is most appropriate, and why?**
- A) Château Lagrezette Cahors, because because the Richemont Group ownership guarantees consistent quality and the Malbec grape is internationally familiar
- B) Domaine Ilarria or Domaine Arretxea Irouléguy, because biodynamic farming on Pyrenean schist terraces, Tannat-driven structure, tiny production, rarity value, and a Basque cultural identity unlike any other French region
- C) Domaine Cauhapé Jurançon, because because the mountain whites offer the freshness and mineral character associated with natural wine production, and the small-estate ethos aligns with natural wine values
- D) Clos Triguedina "New Black Wine" Cahors, because 200-year-old vines on the high causse, marketed explicitly as a reference to the medieval "Black Wine" legend

**Correct: B**

---

**Q14. Côtes de Gascogne IGP is described as "one of the best value crisp white wine categories in France." What accounts for both its value and its specific flavor profile?**
- A) Côtes de Gascogne is made from Petit Manseng harvested early for dryness; its value reflects low vineyard land costs in the Gers, and its profile of tropical fruit and mineral freshness comes from altitude viticulture
- B) Côtes de Gascogne is made from the same Ugni Blanc and Colombard used for Armagnac distillation, supplemented increasingly by Gros Manseng; the light, crisp, aromatic character results from early harvesting and protective winemaking; value reflects the IGP's volume-driven commercial positioning
- C) Côtes de Gascogne is made from Sauvignon Blanc grown in the same soils as Bergerac Sec; its lower price reflects simpler winemaking rather than terroir differences
- D) Côtes de Gascogne IGP is made from Carignan and Grenache Blanc; the Gascon soil's high calcium carbonate content produces the crisp acidity that defines the style

**Correct: B**

---

**Q15. Which of the following correctly describes Irouléguy's production scale and why it matters for wine list positioning?**
- A) Irouléguy covers approximately 2,200 hectares with dozens of independent estates; it is the Southwest's largest appellation by vineyard area and the most commercially available
- B) Irouléguy covers approximately 220 hectares, is dominated by two cooperatives, and has only a small number of independent domaines; its tiny production makes it genuinely rare on wine lists outside specialist programs, giving it strong rarity-value positioning with adventurous guests
- C) Irouléguy is a negotiant-dominated appellation like many Burgundy appellations; the Cave d'Irouléguy is not a cooperative but a large négociant house that controls most distribution
- D) Irouléguy was elevated from IGP to AOP status in 2019; before that date, the wines could not be legally identified by grape variety on the label

**Correct: B**

---

**Q16. A corporate hospitality director asks you to recommend a Southwest French wine for a high-volume by-the-glass program targeting guests who typically order French red wine. Which is the best recommendation from this module, and why?**
- A) Madiran, because Tannat's extreme tannin structure makes it broadly accessible for guests who default to French red wine; its low price point makes it viable for BTG programs
- B) Bergerac Rouge, because Bordeaux varieties on legitimate Dordogne terroir, familiar flavor profile (Merlot-dominant blends), significantly lower price than comparable Bordeaux AOC, and a "Bordeaux-adjacent discovery" story that works in service
- C) Irouléguy rouge, because the rarity value elevates the BTG program's prestige, and the Basque cultural story provides strong table conversation
- D) Jurançon Sec, because dry white wine from Gros Manseng is the most versatile food pairing option and the best way to introduce guests to Southwest France's indigenous varieties

**Correct: B**

---

**Q17. Compare Tannat in Madiran to Tannat in Irouléguy. What are the key differences in terroir and the resulting wine character?**
- A) Tannat in Madiran grows on schist and sandstone at high altitude; in Irouléguy it grows on clay-limestone at lower elevation, because Irouléguy therefore produces softer, more approachable Tannat-based wines
- B) Madiran Tannat grows on southeast-facing clay-limestone hillsides at moderate altitude with Atlantic-influenced climate; Irouléguy Tannat grows on steep terraced schist and sandstone at higher altitude in the Basque Pyrenees with greater rainfall, because Irouléguy wines tend toward more mineral, lithic character with altitude-driven freshness alongside Tannat's structural grip
- C) Tannat in both appellations is identical in character because both grow in the same Pyrenean climate; the key distinction is production method, not terroir
- D) Madiran uses 100% Tannat by regulation; Irouléguy blends Tannat with Gros Manseng and Petit Manseng, which softens the tannin structure significantly

**Correct: B**

---

**Q18. The module describes Southwest France as a region where "indigenous varieties exist nowhere else." Which of the following list of varieties is entirely indigenous to the Southwest and found in negligible commercial quantities outside this region?**
- A) Tannat, Malbec, Cabernet Franc, Muscadelle
- B) Tannat, Petit Manseng, Fer Servadou/Braucol, Négrette, Len de l'El, Mauzac
- C) Tannat, Grenache, Carignan, Ugni Blanc
- D) Petit Manseng, Gros Manseng, Viognier, Marsanne

**Correct: B**

---

**Q19. A guest finishing dinner orders a chocolate dessert and asks for a wine pairing suggestion. You have both Banyuls (covered in Module 20) and Monbazillac on your list. Which is the more appropriate pairing for the chocolate, and which for the cheese course that followed?**
- A) Banyuls with cheese; Monbazillac with chocolate, because Monbazillac's sweetness matches the chocolate while Banyuls's rancio character complements aged cheese
- B) Banyuls with chocolate, because the classic pairing, with rancio character of coffee, dark fruit, and walnut mirroring the cocoa; Monbazillac with cheese, particularly a blue or aged cow's milk, because the botrytis-driven honey and apricot notes complement the savory dairy
- C) Both wines work equally well with both courses; the guest's personal preference is the only relevant consideration
- D) Monbazillac with chocolate, because the Sémillon-based sweetness matches chocolate's richness; Banyuls is only appropriate with anchovy dishes and should not be served with dessert

**Correct: B**

---

**Q20. A guest who has never explored Southwest France asks you to describe the region in one sentence. Based on the module's core narrative, which of the following best captures what makes Southwest France distinct?**
- A) "Southwest France is Bordeaux's cheaper neighbor, because the same grapes, the same techniques, and the same terroir at lower prices because the appellations are less famous."
- B) "Southwest France is a collection of minor appellations that exist primarily to provide value alternatives to Bordeaux and Loire, using indigenous varieties that were never important enough to spread to other regions."
- C) "Southwest France is a vast arc of wine country from Bergerac to the Basque Pyrenees where ancient indigenous varieties, Tannat, Petit Manseng, Malbec, Fer Servadou, survived centuries of commercial suppression by Bordeaux because the terroirs that suit them exist nowhere else on earth, producing wines with stories and characters that you will not find anywhere else in France."
- D) "Southwest France is historically significant primarily because of Armagnac; its wine production is a secondary industry that developed only in the twentieth century as Armagnac demand declined."
