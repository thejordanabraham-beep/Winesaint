...
## Section 1: Why Burgundy Matters — The Terroir Argument
...
## Section 3: The Four-Tier Classification System — The Most Important Hierarchy in Wine
...
## Section 4: The Business of Burgundy — Domaine, Négociant, and Cooperative
...
## Section 5: The Great Figures of Burgundy
...
## Section 6: Reading a Burgundy Label and Floor Navigation
...
|------|---------------------|
| Grand Cru (top producers) | $200 – $25,000+ |
| Premier Cru (top producers) | $80 – $400+ |
| Village (top producers) | $50 – $150 |
| Regional | $20 – $60 |
...
**Guest with a $100–$150 budget for red Burgundy:**
"At this level you're in Premier Cru territory from good producers or village wines from the very best. I'd suggest Chambolle-Musigny — it's the most elegant, fragrant Pinot Noir in the Côte d'Or. If you want more structure, Gevrey-Chambertin at the same price is richer and more age-worthy."

**Guest asking about white Burgundy under $80:**
"Mâcon-Villages and Pouilly-Fuissé give you classic Burgundy Chardonnay — rounder and richer than Chablis — at a price that makes it genuinely accessible. For something more mineral and precise, Chablis at this price is exceptional with seafood."

**Guest interested in Grand Cru:**
"The most accessible Grand Cru entry point is usually Corton-Charlemagne in white or Corton in red — larger vineyards, more production, lower prices than the Côte de Nuits. From there the ceiling is effectively unlimited."

**Guest asking about Domaine de la Romanée-Conti:**
"DRC is the most sought-after wine in the world. They make fewer than 7,000 cases total across all their wines combined — which is less than a mid-sized Napa winery produces of a single bottling. The Romanée-Conti itself is fewer than 5,000 bottles. At those volumes, the price is almost beside the point."
...
| Term | Definition |
|------|-----------|
| Terroir | The combination of soil, geology, microclimate, slope, and aspect that gives a specific vineyard parcel its distinctive character — the foundational concept of Burgundian classification |
| Côte d'Or | The 50km limestone escarpment between Dijon and Santenay containing Burgundy's greatest vineyards; divides into the Côte de Nuits (north) and Côte de Beaune (south) |
| Côte de Nuits | The northern half of the Côte d'Or; dominated by Pinot Noir; home to most of Burgundy's great red Grand Crus including Chambertin, Musigny, and all of the DRC Grand Crus |
| Côte de Beaune | The southern half of the Côte d'Or; produces both Pinot Noir and Chardonnay; home to the great white Grand Crus (Montrachet, Corton-Charlemagne) and celebrated red villages (Pommard, Volnay) |
| Grand Cru | The highest tier of Burgundy's classification; approximately 33 vineyards, each its own AOC; the vineyard name alone constitutes the appellation; represents ~1.5% of total production |
| Premier Cru | The second-highest tier; designated vineyard parcels within a village AOC; labeled with village name + vineyard name or "1er Cru"; approximately 640 designated vineyards |
| Village AOC | The second tier of the hierarchy; wines sourced from within a specific commune's boundaries; the village name is the appellation (e.g., "Meursault," "Gevrey-Chambertin") |
| Bourgogne Régionale | The base tier of the Burgundy classification; fruit may originate from anywhere in the region; labeled as "Bourgogne Pinot Noir" or "Bourgogne Chardonnay"; approximately 50% of production |
| Domaine | An estate producer who farms owned or leased vineyards and produces wine exclusively from their own fruit; the preferred model for terroir expression |
| Négociant | A merchant house that purchases grapes, must, or finished wine from growers and bottles under its own label; historically dominant in Burgundy; top négociants now rival domaine quality |
| Monopole | A Grand Cru vineyard with a single owner — the rarest and most prestigious category; examples include Romanée-Conti and La Tâche (both DRC), Clos de Tart (Artemis Domaines) |
| Climat | Burgundy's term for a specific, named, and legally delimited vineyard parcel — the fundamental unit of terroir; each Grand Cru and Premier Cru is a climat; inscribed on UNESCO's World Heritage list in 2015 |
| Napoleonic Succession Law | The provision of the Napoleonic Code (1804) mandating equal inheritance among all heirs; over 200 years of successive division, it created Burgundy's fragmented ownership structure in which a single Grand Cru may have 80+ owners |
| Biodynamics | A holistic farming philosophy that treats the vineyard as a living ecosystem, guided by lunar and cosmic cycles, using only organic inputs; practiced by DRC, Domaine Leroy, and many of Burgundy's finest estates |

---

## Quiz — Burgundy: The Architecture of Terroir

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. A label reads "Chambertin" with no other geographic identifier. What does this indicate?**
- A) A village-level wine from the commune of Gevrey-Chambertin
- B) A Premier Cru wine from the Côte de Nuits
- C) A Grand Cru wine — the vineyard name constitutes its own AOC
- D) A regional Bourgogne wine named after the Chambertin vineyard style

**Correct: C**

---

**Q2. The Côte d'Or faces which direction, and why does that matter?**
- A) West-facing; it captures afternoon sun while avoiding cold morning air
- B) East to southeast; it receives morning sun while remaining protected from prevailing westerly winds
- C) North-facing; cooler orientation preserves acidity in both Pinot Noir and Chardonnay
- D) South-facing; maximum sun exposure is required for ripening at this latitude

**Correct: B**

---

**Q3. Approximately how many Grand Cru vineyards exist in Burgundy (Côte d'Or and Chablis combined)?**
- A) 12
- B) 33 (Côte d'Or) + 7 (Chablis) = 40 total
- C) 640
- D) 100
...
**Q4. What distinguishes a domaine from a négociant in Burgundy?**
- A) Domaines produce only red wine; négociants produce only white
- B) Domaines sell exclusively to restaurants; négociants sell to retail
- C) Domaines farm their own vineyards and produce wine from their own fruit; négociants purchase grapes, must, or finished wine from growers
- D) Domaines must hold at least one Grand Cru vineyard; négociants do not

**Correct: C**

---

**Q5. A guest points to a bottle labeled "Gevrey-Chambertin Premier Cru Les Cazetiers." What grape is in the bottle, and how do you know?**
- A) Chardonnay — because Gevrey-Chambertin is in the Côte de Beaune
- B) Pinot Noir — because Gevrey-Chambertin is a Côte de Nuits village where red wine dominates
- C) Gamay — because Les Cazetiers is a specific Beaujolais climat
- D) Either Pinot Noir or Chardonnay — the label would need to specify

**Correct: B**

---

**Q6. What was Henri Jayer's most celebrated single Premier Cru wine, and what made the vineyard's history unusual?**
- A) Musigny; it was the last Grand Cru replanted after phylloxera
- B) Cros Parantoux; it was previously used for artichoke farming and required dynamite to plant vines
- C) Chambolle-Musigny Les Amoureuses; it was planted entirely with pre-phylloxera vine material
- D) Vosne-Romanée Les Suchots; it had been classified as village-level until Jayer petitioned for Premier Cru status

**Correct: B**

---

**Q7. Domaine de la Romanée-Conti holds a monopole on Romanée-Conti and La Tâche. What does "monopole" mean in Burgundy?**
- A) A vineyard that produces only one grape variety
- B) A Grand Cru vineyard with a single owner
- C) A vineyard licensed exclusively to one négociant for distribution
- D) An appellation controlled by one cooperative

**Correct: B**

---

**Q8. Napoleonic succession law shaped Burgundy's ownership structure. What was its primary effect?**
- A) It consolidated estates in the hands of the Church, which then managed them for centuries
- B) It required equal inheritance among all heirs, causing vineyards to be subdivided with each generation over 200 years
- C) It banned non-French citizens from owning Burgundy vineyards, concentrating ownership among a small group of local families
- D) It established a government agency to purchase and redistribute vineyard land to small growers

**Correct: B**

---

**Q9. A guest asks the difference between a "Village" Meursault and a "Premier Cru" Meursault. What is the most accurate and useful answer?**
- A) Village Meursault is made from Pinot Noir; Premier Cru is Chardonnay
- B) There is no practical difference — Premier Cru simply indicates a larger production volume
- C) Village Meursault can source fruit from anywhere in Burgundy; Premier Cru is vineyard-specific
- D) Village Meursault draws from the entire commune; Premier Cru comes from a specific designated parcel within the commune with proven superior character — expect more complexity, concentration, and a meaningfully higher price

**Correct: D**

---

**Q10. Lalou Bize-Leroy is associated with which of the following achievements?**
- A) Founding the négociant house Maison Louis Jadot and establishing its modern quality standards
- B) Serving as co-director of DRC until 1992 and founding Domaine Leroy with extreme low-yield biodynamic farming
- C) Classifying all 640 Premier Cru vineyards as part of her work with the INAO
- D) Planting the first Chardonnay vines in the Côte de Nuits in the 1960s

**Correct: B**

---

**Q11. The April 2021 frost in Burgundy is notable because:**
- A) It was the first frost in Burgundy since 1965 and prompted a complete revision of viticultural practices
- B) It arrived after early budbreak due to warmer springs, destroying up to 80% of some appellations' crops
- C) It only affected Chablis, leaving the Côte d'Or unaffected due to its inland position
- D) It damaged primarily white wine vineyards but left Pinot Noir largely intact because of its thicker skin

**Correct: B**

---

**Q12. A label reads "Bourgogne Pinot Noir" with a prominent producer name and no village or vineyard name. What tier of the classification is this, and what does it indicate about the fruit source?**
- A) Village AOC; fruit must come from a single commune
- B) Premier Cru; the absence of a vineyard name indicates the producer blended multiple Premier Cru parcels
- C) Regional AOC (Bourgogne Régionale); fruit may originate from anywhere within Burgundy
- D) Grand Cru; "Bourgogne Pinot Noir" is the formal name for a wine at the classification summit

**Correct: C**

---

**Q13. The Cistercian monks at the Clos de Vougeot are credited with:**
- A) Planting the first Pinot Noir vines in Burgundy around 900 CE
- B) Systematically mapping the Côte d'Or by tasting wines from different parcels over centuries and creating the first terroir records
- C) Establishing the négociant system by selling surplus wine to merchants in Beaune
- D) Introducing biodynamic farming to Burgundy in the 12th century

**Correct: B**

---

**Q14. A guest wants a Burgundy recommendation under $100 that demonstrates the region's terroir concept clearly. Which is the strongest choice?**
- A) A Bourgogne Régionale from a prestigious négociant like Bouchard Père et Fils
- B) A village-level Chambolle-Musigny or Meursault from a respected domaine — the village identity is apparent in the wine, and the price is accessible
- C) A Premier Cru Chambertin from an obscure producer at a discounted price
- D) Any Grand Cru from a cooperative, which offers significantly lower prices than domaine wines

**Correct: B**

---

**Q15. The DRC produces approximately how many cases per year across all its wines combined?**
- A) 75,000 cases
- B) 35,000 cases
- C) 7,000 cases
- D) 450 cases
...
**Q16. Which statement most accurately describes the relationship between the vineyard classification and the producer in Burgundy?**
- A) Grand Cru classification guarantees quality regardless of who made the wine
- B) The classification identifies the land's pedigree — a floor, not a guarantee — meaning producer skill matters as much as vineyard designation
- C) Village wines from top producers are always inferior to Grand Cru wines from any producer
- D) The INAO re-evaluates Grand Cru status every ten years based on wine quality, so the classification is a current quality guarantee

**Correct: B**

---

**Q17. A guest points to a wine list and asks what "1er Cru" means on a Burgundy. What is the correct answer?**
- A) It means the wine was the first pressing of the harvest — the best quality juice
- B) It is a legally designated vineyard parcel within a village appellation, classified by the French wine authority as historically producing superior wine — a step above village level and below Grand Cru
- C) It means the winery is in its first year of operation — "premier" refers to founding date
- D) It indicates the wine is from the first year it was released under the current winemaker's label

**Correct: B**

---

**Q18. What is the approximate percentage of Burgundy's total production represented by Grand Cru wines?**
- A) 15%
- B) 8%
- C) 1.5–2%
- D) 0.1%
