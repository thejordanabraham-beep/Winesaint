...
## Section 1: Why France Defines Wine
...
## Section 2: The AOC/AOP System, How French Wine Is Classified
...
## Section 3: Climate Zones and the Logic of French Wine Geography
...
## Section 4: Major Grape Varieties, The French Canon
...
## Section 5: The French Wine Classification Systems
...
## Section 6: How to Sell French Wine on the Floor
...
## Section 7: Vintage Context for France
...
| Term | Definition |
|------|-----------|
| AOC / AOP | Appellation d'Origine Contrôlée / Appellation d'Origine Protégée. France's top tier of wine classification, guaranteeing geographic origin and adherence to specific production rules; AOP is the EU-aligned term adopted in 2009 |
| INAO | Institut National de l'Origine et de la Qualité, the French government body founded in 1935 that creates, regulates, and enforces all AOC/AOP designations for wine and food products |
| Terroir | The French concept (from terre, "land") that the totality of a vineyard's natural environment, soil, subsoil, topography, aspect, drainage, and mesoclimate, is the primary determinant of a wine's character and cannot be replicated elsewhere |
| Appellation | A legally defined geographic area with specific production rules; in France, using an appellation name on a label requires compliance with all INAO regulations for that appellation |
| IGP | Indication Géographique Protégée (formerly Vin de Pays), the middle tier of French wine classification; requires a regional origin but permits more flexibility in grape varieties and yields than AOC; IGP Pays d'Oc is the most commercially significant |
| Négociant | A wine merchant (or house) that purchases grapes, juice, or finished wine from growers and sells it under their own label; the dominant commercial model in Champagne (NM) and Burgundy |
| Domaine | A wine estate that grows its own grapes and makes its own wine; in Burgundy, the move from négociant to domaine bottling in the 1970s–1990s was a major quality revolution |
| Récoltant-Manipulant (RM) | A Champagne grower who produces wine exclusively from their own vineyards; identified by the "RM" code on the label; associated with site-specific, terroir-driven Champagnes as distinct from large-house blends |
| Cru | Literally "growth", a specific vineyard or ranked classification level; in Burgundy, refers to specific classified vineyards; in Beaujolais, refers to the ten named villages; in Bordeaux 1855, refers to ranked châteaux |
| Grand Cru | The highest classification of vineyard or wine in French wine law; in Burgundy, approximately 33 Grand Cru sites each have their own AOC; in Alsace, 51 Grand Cru vineyards are designated for Riesling, Gewürztraminer, Pinot Gris, and Muscat only |
| Premier Cru | The classification level directly below Grand Cru; in Burgundy, approximately 600 Premier Cru vineyards appear on labels as "[Village] Premier Cru" or with the specific vineyard name; in Bordeaux 1855, refers to the five châteaux at the top of the hierarchy |
| Millésime | The French word for vintage, the year in which the grapes were harvested; on a Champagne label, a millésimé wine is a declared single-vintage Champagne |
| Vendange | Harvest, the act of picking grapes; Vendanges Tardives (VT) in Alsace means "late harvest," indicating grapes picked with higher sugar levels for richer, often off-dry to sweet wines |
| Élevage | The period between fermentation and bottling during which a wine is raised (elevated), including maturation in barrel, tank, or bottle; the term encompasses all handling between the end of primary fermentation and release, including racking, blending, and fining |

---

## Quiz: France: The Blueprint for the Wine World
**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. A guest orders a glass of Chablis and asks what grape it is. Your answer?**
- A) Sauvignon Blanc, because Chablis is in the Loire Valley
- B) Chardonnay, because Chablis AOC rules permit only Chardonnay
- C) Pinot Blanc, because Chablis is an Alsatian appellation
- D) Aligoté, because Chablis is Burgundy's secondary white variety

**Correct: B**

---

**Q2. The 1855 Bordeaux Classification was created for what occasion?**
- A) The founding of the INAO in 1935
- B) The centennial celebration of Bordeaux's first Grand Cru estates
- C) Napoleon III's Paris Exposition Universelle
- D) The first international wine auction at Christie's London

**Correct: C**

---

**Q3. Which is the primary climate type for Bordeaux?**
- A) Continental
- B) Mediterranean
- C) Oceanic/Maritime
- D) Mountain/Alpine
...
**Q4. Which French grape variety is most associated with Bandol, where the AOC requires it at a minimum of 50%?**
- A) Grenache
- B) Syrah
- C) Carignan
- D) Mourvèdre
...
**Q5. A guest is intimidated by French wine labels and doesn't know where to start. What is the most effective framing to help them navigate?**
- A) Suggest they only order wines with varietal labels, such as those from Alsace or IGP Pays d'Oc
- B) Explain that in France, the region name functions as the variety name, because Chablis means Chardonnay, Sancerre means Sauvignon Blanc, and so on
- C) Recommend sticking to Champagne and Bordeaux since those are the most internationally recognized
- D) Advise them to use a wine app to scan labels before ordering

**Correct: B**

---

**Q6. Château Mouton Rothschild was elevated to First Growth status in the 1855 Bordeaux Classification in which year?**
- A) 1855, because it was always a First Growth
- B) 1961
- C) 1973
- D) 1990
...
**Q7. In the Burgundy classification system, what is classified, the producers, the châteaux, or the vineyards?**
- A) The châteaux, as in Bordeaux
- B) The producers based on their track record over ten years
- C) The vineyards, because the land itself
- D) Both vineyards and producers are co-classified

**Correct: C**

---

**Q8. What does the designation "RM" on a Champagne label indicate?**
- A) Réserve Millésimée, because a vintage-declared Champagne held longer than standard
- B) Récoltant-Manipulant, because a grower who makes Champagne from their own vineyards
- C) Rosé Mousseux, because a Champagne produced using the rosé method
- D) Régime Modifié, because a classification indicating reduced dosage

**Correct: B**

---

**Q9. Which four grape varieties are the ONLY ones permitted to use the Grand Cru designation in Alsace?**
- A) Riesling, Gewürztraminer, Pinot Blanc, Muscat
- B) Riesling, Gewürztraminer, Pinot Gris, Sylvaner
- C) Riesling, Gewürztraminer, Pinot Gris, Muscat
- D) Riesling, Pinot Gris, Pinot Blanc, Pinot Noir

**Correct: C**

---

**Q10. Pétrus in Pomerol is widely considered one of the greatest wines in Bordeaux. What classification does it hold under the 1855 system?**
- A) Premier Grand Cru Classé
- B) Deuxième Cru Classé
- C) It holds no classification, because the 1855 did not include Pomerol
- D) Premier Cru Supérieur, alongside Château d'Yquem

**Correct: C**

---

**Q11. Sauvignon Blanc grown on Kimmeridgian marl in which Loire Valley appellation produces wines with a characteristic flint and smoke minerality?**
- A) Vouvray
- B) Muscadet Sèvre-et-Maine
- C) Sancerre
- D) Chinon
...
**Q12. Which climate zone applies to Champagne, and why does it matter for wine style?**
- A) Mediterranean, because hot dry summers allow full ripening of Pinot Noir and Chardonnay
- B) Oceanic/Maritime, because moderate temperatures and significant rainfall create variable vintages and high-acid base wines ideal for sparkling wine production
- C) Continental, because extreme diurnal variation produces the grape concentration required for premium Champagne
- D) Mountain/Alpine, because altitude moderates temperature and extends the growing season

**Correct: B**

---

**Q13. The concept of terroir in French wine holds that the most important variable in wine quality is:**
- A) The winemaker's technique and experience
- B) The grape variety selected for planting
- C) The specific place, because including soil, subsoil, topography, drainage, aspect, and mesoclimate
- D) The vintage conditions in any given year

**Correct: C**

---

**Q14. How many Cru Beaujolais villages are there, and how do they differ from Burgundy's Grand Cru system?**
- A) Ten Cru villages; unlike Burgundy, the Beaujolais Crus are not ranked in a hierarchy, because each is simply its own appellation
- B) Twelve Cru villages; they are ranked in a hierarchy from Premier Cru to Grand Cru similar to Burgundy
- C) Eight Cru villages; they are sub-classified by soil type rather than by prestige hierarchy
- D) Ten Cru villages; they are classified within the Burgundy Grand Cru system and share its legal structure

**Correct: A**

---

**Q15. Malbec is now globally associated with Argentina. What is its French origin, and what wine style does it produce there?**
- A) It originated in Bordeaux's Left Bank and was historically used in Médoc blends
- B) It originated in Cahors in Southwest France, where it produces a deeply colored, tannic wine historically called the "Black Wine of Cahors"
- C) It originated in Languedoc as a blending variety and was exported to Argentina in the twentieth century
- D) It originated in the Loire Valley and was widely planted before phylloxera eliminated it from France

**Correct: B**

---

**Q16. A collector asks you to explain the difference between the 2009 and 2010 Bordeaux vintages. How do you characterize them?**
- A) 2009 was a cooler, more structured year; 2010 was warmer and more immediately approachable
- B) Both were outstanding, because 2009 was warmer and more opulent; 2010 was more structured and classical, with greater long-term aging potential
- C) 2009 was a difficult vintage with high rain; 2010 was the recovery vintage that produced exceptional wines
- D) They were essentially identical in style, both rated as exceptional by all major critics

**Correct: B**

---

**Q17. The three tiers of French wine classification from lowest to highest are:**
- A) IGP / Vin de France / AOC
- B) Vin de France / IGP / AOC
- C) AOC / IGP / Vin de France
- D) Vin de Pays / Vin de Table / AOC

**Correct: B**

---

**Q18. Chenin Blanc is described in this module as extraordinarily versatile. Which Loire Valley appellations are most associated with this variety?**
- A) Sancerre, Pouilly-Fumé, and Muscadet
- B) Vouvray, Savennières, Coteaux du Layon, and Quarts de Chaume
- C) Chinon, Bourgueil, and Saumur-Champigny
- D) Montlouis, Touraine, and Crémant de Loire only

**Correct: B**

---

**Q19. A guest says they love rich, aromatic white wines and usually order Viognier. You want to suggest something from France they may not have tried. What do you recommend and why?**
- A) Chablis, because because it shares Viognier's richness and can substitute in most food pairings
- B) Sancerre, because because its gooseberry and flinty notes appeal to Viognier drinkers who enjoy aromatics
- C) Condrieu, because Viognier's home in the Northern Rhône, producing apricot blossom and white peach aromatics at higher quality than most non-French versions
- D) Vouvray, because because Chenin Blanc's off-dry sweetness is the closest match to Viognier's aromatic profile

**Correct: C**

---

**Q20. What is élevage, and why does it matter to a wine professional advising guests on specific Bordeaux selections?**
- A) The French term for the annual INAO harvest certification process required before a château may sell its wine
- B) The period between fermentation and bottling during which a wine is matured, because including barrel aging, blending, fining, and all handling before release; it determines the oak character, texture, and readiness of the finished wine
- C) The practice of late harvesting in Bordeaux, equivalent to Vendanges Tardives in Alsace
- D) A French legal term for the required minimum aging before a classified Bordeaux may be sold to the public
