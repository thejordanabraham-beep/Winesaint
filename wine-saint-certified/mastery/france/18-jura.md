...
## Section 1: Geography, Geology, and the Foundation of Singularity
...
## Section 2: The Grapes, Indigenous Treasures and What Each One Does
...
## Section 3: Ouillé vs. Sous Voile, The Defining Divide
...
## Section 4: Vin Jaune, Vin de Paille, and the Singular Wines of the Jura
...
## Section 5: The Four Appellations, Key Producers, and the Natural Wine Capital of France
...
| Term | Definition |
|------|------------|
| **Ouillé** | Winemaking approach in which barrels are regularly topped up to replace evaporated wine, preventing oxygen accumulation and producing fresh, mineral-driven, non-oxidative whites. The dominant style in modern Jura white wine production. |
| **Sous voile** | "Under veil." Winemaking approach in which barrels are not topped up, allowing a film of flor yeast to develop on the wine's surface. The basis of Vin Jaune production and the source of the Jura's oxidative wine character. |
| **Flor** | A film of Saccharomyces cerevisiae yeast that develops on the surface of wine in partially filled, unsealed barrels. Flor metabolizes oxygen at the wine surface, mediating rather than preventing oxidation, and produces acetaldehyde, the compound responsible for nutty, curry, and dried-fruit aromas in sous voile wines. Biologically parallel to but genetically distinct from Sherry flor. |
| **Voile** | The French term for the flor film in Jura wine production. Literally "veil." |
| **Clavelin** | The distinctive squat bottle used exclusively for Vin Jaune, holding exactly 62 centiliters. The volume represents the approximate amount of wine remaining from one liter after six years of barrel aging and evaporation. |
| **Vin Jaune** | "Yellow wine." Produced exclusively from Savagnin, aged for a minimum of six years and three months in barrel sans ouillage (without topping up) under flor. Bottled in clavelin. Characterized by curry, walnut, dried fruit, and savory complexity. The most singular white wine in France. |
| **Vin de Paille** | "Straw wine." Produced from Chardonnay, Savagnin, and/or Poulsard dried on straw mats, racks, or hanging for a minimum of six weeks after harvest. The drying concentrates sugars to produce a sweet, complex wine with 80–150 g/l residual sugar, aged minimum three years. |
| **Savagnin** | The Jura's defining indigenous white grape variety; genetically identical to Traminer. Produces crystalline, mineral wines when vinified ouillé; the exclusive basis of Vin Jaune when vinified sous voile. |
| **Poulsard / Ploussard** | Indigenous Jura red grape producing the most delicate red wine in France, pellucid, barely pink in color, with minimal anthocyanins. Strawberry, cherry, rose, and iron-like character. Almost always served slightly chilled. |
| **Trousseau** | Indigenous Jura red grape producing deeply colored, structured wines, the counterpart to Poulsard's delicacy. Black cherry, violet, black pepper; firm fine-grained tannins; ages well for decades. |
| **Marne grise** | Grey Liassic marl, the most prized soil type in the Jura, dominating the finest mid-slope vineyard sites. Ideal for Savagnin and Vin Jaune production. Also called blue marl (imprecisely). |
| **Château-Chalon** | The Jura's most prestigious appellation (54 hectares), restricted exclusively to Vin Jaune from Savagnin. One of France's most strictly controlled AOCs; collective vintage declarations have prevented production in 1974, 1980, 1984, and 2001. |
| **Crémant du Jura** | The Jura's traditional-method sparkling wine appellation, produced from Chardonnay, Pinot Noir, Poulsard, and/or Trousseau with minimum nine months on lees. |
| **Revermont** | The west-facing escarpment of the Jura plateau along which the region's vineyards are planted, between 250 and 450 meters elevation, running north-south across 105 kilometers. |

---

## Quiz: Jura: Vin Jaune, Oxidation, and France's Most Singular Wine Region

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. The Jura is located approximately how far east of Burgundy's Côte d'Or?**
- A) 20 kilometers
- B) 50 kilometers
- C) 80 kilometers
- D) 130 kilometers
...
**Q2. What is the fundamental geological difference between the Jura and Burgundy?**
- A) The Jura is volcanic; Burgundy is sedimentary
- B) Burgundy is approximately 80% limestone; the Jura is approximately 80% marl
- C) The Jura has no limestone; Burgundy has no clay
- D) Burgundy is older geologically; Jura soils date only to the Pleistocene

**Correct: B**

---

**Q3. What does "ouillé" mean in the context of Jura winemaking?**
- A) Aged under flor yeast without topping up
- B) Dried on straw mats before pressing
- C) Barrels regularly topped up to prevent oxidation
- D) Blended from multiple grape varieties

**Correct: C**

---

**Q4. Flor yeast in Vin Jaune production is biologically classified as:**
- A) Botrytis cinerea in a protective film form
- B) Saccharomyces cerevisiae in a film-forming expression
- C) Lacto-bacterial culture that forms on wine surfaces
- D) An entirely different yeast species from Sherry flor with no genetic relationship

**Correct: B**

---

**Q5. What precise volume does a clavelin bottle hold, and why?**
- A) 500ml; the volume of a standard half-bottle plus a 50ml pour
- B) 75cl; the standard French wine bottle volume
- C) 62cl; the approximate amount remaining from one liter of wine after six years of evaporation during Vin Jaune aging
- D) 62cl, regulated by a 17th-century royal decree standardizing Jura wine measurements

**Correct: C**

---

**Q6. Château-Chalon AOC is restricted to:**
- A) All white wines from the village of Château-Chalon only
- B) Vin Jaune and Vin de Paille from Savagnin
- C) Vin Jaune exclusively, produced from Savagnin, across four communes
- D) All wines produced within the village's communal boundaries

**Correct: C**

---

**Q7. In which vintages did the Château-Chalon producers collectively decide not to bottle any wine?**
- A) 1972, 1977, 1987, 1992
- B) 1974, 1980, 1984, 2001
- C) 1968, 1975, 1991, 2002
- D) 1978, 1983, 1990, 2003

**Correct: B**

---

**Q8. Why is Poulsard described as the most delicate red wine in France?**
- A) It is always harvested early, before full phenolic development
- B) Its skins contain minimal anthocyanins, making deep color extraction impossible regardless of maceration length
- C) It is legally required to be produced with less than 10 days of maceration
- D) Its thin skins break down quickly, requiring very brief maceration to avoid bitterness

**Correct: B**

---

**Q9. Trousseau's connection to Iberian viticulture was established through:**
- A) Trade records showing vine cuttings shipped from the Jura to Portugal in the 17th century
- B) DNA analysis identifying Trousseau as a parent of several Portuguese grape varieties
- C) Ampelographic comparison showing identical leaf shape between Trousseau and Touriga Nacional
- D) Historical documents from the Cistercian order recording vine transplantation

**Correct: B**

---

**Q10. What is the minimum drying period required for Vin de Paille grape production?**
- A) Two weeks
- B) Four weeks
- C) Six weeks
- D) Eight weeks
...
**Q11. A guest asks why Jura Chardonnay tastes so different from Meursault or Puligny-Montrachet. What is the most accurate explanation?**
- A) Jura winemakers intentionally add minerals during production
- B) The Jura's warmer climate produces more aromatic Chardonnay
- C) The Jura's marl-dominated soils, higher rainfall, and local clone selection produce sharper acidity, less fruit richness, and more mineral and saline character than Burgundy's limestone-dominated terroir
- D) Jura Chardonnay is always aged in new oak, which masks fruit expression

**Correct: C**

---

**Q12. L'Étoile AOC takes its name from:**
- A) The five-pointed star shape of the appellation's geographic boundaries
- B) Pentacrine fossils, five-pointed crinoid fragments, abundant in its limestone soils
- C) A historic château whose coat of arms featured a star
- D) The five permitted grape varieties that may be grown within its boundaries

**Correct: B**

---

**Q13. Jean-François Ganevat's foundational winemaking experience before establishing his Jura domaine was working under:**
- A) Jacques Puffeney at his Arbois estate
- B) Pierre Overnoy at Domaine Overnoy-Houillon
- C) Henri Jayer in Burgundy
- D) Aubert de Villaine at Domaine de la Romanée-Conti

**Correct: C**

---

**Q14. The minimum aging requirement for Vin Jaune in barrel is:**
- A) Three years
- B) Four years and six months
- C) Five years
- D) Six years and three months

**Correct: D**

---

**Q15. A table orders Vin Jaune with the cheese course. Which cheese and at what aging level represents the canonical Jura pairing?**
- A) Époisses, washed rind, any age
- B) Comté, aged 24 months or longer
- C) Reblochon, young and creamy
- D) Roquefort, aged minimum 3 months

**Correct: B**

---

**Q16. A guest who identifies themselves as a natural wine enthusiast asks for your best recommendation from the Jura. Which producer should you lead with, and why?**
- A) Henri Maire, because of the estate's size and consistent quality across the full Jura range
- B) Domaine de la Pinte, as the largest biodynamic estate in the appellation
- C) Jean-François Ganevat, because he is the most important natural wine producer in the Jura and among the most significant in all of France, biodynamic farming, single-parcel old-vine wines, deeply influential on the global natural wine movement
- D) Stéphane Tissot, because his wines are the most widely available and represent the best value

**Correct: C**

---

**Q17. The geological term for the multi-colored Triassic-era marls found in lower-elevation Jura vineyard sites is:**
- A) Calcaire à gryphées
- B) Marne grise
- C) Marnes irisées
- D) Éboulis calcaire
...
**Q18. What is the primary food preparation associated with Vin Jaune in Jurassien cuisine?**
- A) Fondue Comtoise. Comté melted with Vin Jaune and cream
- B) Coq au vin Jurassien, chicken braised in Vin Jaune with morel mushrooms and cream
- C) Quenelles de brochet, pike dumplings poached in Vin Jaune sauce
- D) Boeuf bourguignon prepared with Vin Jaune instead of Burgundy

**Correct: B**

---

**Q19. Which of the following statements about an open bottle of Vin Jaune is accurate?**
- A) It must be consumed within 24 hours of opening or it oxidizes completely
- B) It should never be decanted as this destroys the flor character
- C) It keeps for weeks or months without meaningful decline due to its oxidative nature and high alcohol
- D) It should be resealed with a vacuum pump immediately after pouring

**Correct: C**

---

**Q20. Savagnin, the Jura's defining white grape, is genetically identical to which European variety?**
- A) Gewürztraminer
- B) Grüner Veltliner
- C) Traminer
- D) Pinot Gris
