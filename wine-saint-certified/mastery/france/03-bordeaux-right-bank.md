...
## Section 1: Right Bank Geography — Clay, Iron, and Merlot
...
## Section 2: Pomerol — No Classification, No Compromise
...
## Section 3: St-Émilion — The Classification That Won't Stop Changing
...
## Section 4: Satellite Appellations and the Right Bank Value Story
...
Notable estates include Château Belles-Graves, Château Siaurac (owned by the same family as Vieux Château Certan for a period), and Château Bertineau-St-Vincent. These are wines for the glass program — Merlot-lovers who cannot spend $80 on a bottle but want the Right Bank experience delivered honestly.
...
## Section 5: Right Bank vs. Left Bank — The Service Conversation
...
| Feature | Right Bank (Pomerol / St-Émilion) | Left Bank (Pauillac) |
|---|---|---|
| Dominant grape | Merlot (70–100%) | Cabernet Sauvignon (60–80%) |
| Primary soil | Clay and limestone | Deep gravel |
| Flavor profile | Plum, chocolate, truffle, dark cherry | Cassis, cedar, graphite, tobacco |
| Texture | Round, velvety, full mid-palate | Linear, structured, firm tannins |
| Approachability | Often accessible at 5–10 years | Typically needs 10–15+ years |
| Peak aging window | 10–25 years (best wines: 40+) | 15–40 years (best wines: 50+) |
| Price range (top) | Pétrus: $2,000–$5,000+ | Pétrus-equivalent: Latour $1,000–$3,000+ |
| Key producer | Pétrus (Moueix family) | Château Latour, Château Lafite |
| Guest profile | Seeks richness now; entertaining tonight | Collector; laying down; patient investor |
...
| Term | Definition |
|------|------------|
| **Pomerol** | The smallest major appellation in Bordeaux (~800 ha), located northeast of Libourne on the Dordogne's right bank. Produces Merlot-dominant wines of extraordinary richness from clay-based soils. Never officially classified. |
| **Crasse de Fer** | Literally "iron pan" — the iron-rich, smectite clay layer that defines the Pomerol plateau's most celebrated terroir. Dense and water-retentive; responsible for the concentration and buffered ripening of Pétrus and its neighbors. |
| **Argile Bleue** | "Blue clay" — the specific dense clay deposit at the center of the Pomerol plateau beneath the *crasse de fer*. Pétrus's core soil; extraordinarily water-retentive and heat-reflective. |
| **Pétrus** | The reference wine of Pomerol and the Right Bank; ~11.5 hectares of blue clay; almost entirely Merlot; owned and managed by the Moueix family; no official classification but commands prices above all classified First Growths in many vintages. |
| **Moueix (Négociant)** | Jean-Pierre Moueix was the Libourne-based merchant who built Pétrus's international reputation from the 1940s onward. The Moueix family also manages Trotanoy and other Right Bank estates. In Bordeaux, the *négociant* system involves merchants who purchase, age, and sell wine — often managing entire estates. |
| **St-Émilion Premier Grand Cru Classé A (PGCCA)** | The summit tier of St-Émilion's classification. Historically held by Cheval Blanc and Ausone only; Angélus and Pavie were added controversially in 2012. Cheval Blanc and Ausone exited the classification voluntarily during the 2022 revision controversy. |
| **Limestone Plateau (St-Émilion)** | The *Plateau Calcaire* — the highest and most mineral soil zone in St-Émilion, where thin topsoil over ancient marine limestone produces the appellation's most structured, age-worthy wines. Home to Ausone. |
| **Calcaire à Astéries** | The specific Oligocene fossil-bearing limestone that forms the subsoil across much of St-Émilion and the broader Right Bank. Porous, calcium-rich, and moisture-retaining; allows vine roots to penetrate deeply. |
| **Cabernet Franc** | A parent variety of both Cabernet Sauvignon and Merlot; thrives on the limestone and clay-limestone soils of the Right Bank. Provides aromatic lift, structural backbone, and complexity in Right Bank blends. Constitutes ~57% of Cheval Blanc's blend and ~50% of Lafleur's. |
| **Micro-Château** | Term for the smallest elite estates in Bordeaux — particularly Le Pin (2 hectares, ~700 cases) — where extreme scarcity amplifies price and collector desirability. |
| **En Primeur** | Bordeaux's futures system: wines are offered for sale while still in barrel, approximately six months after harvest, at a negotiated release price. Buyers receive the wine 18–24 months later after bottling. Historically advantageous for top Right Bank estates in celebrated vintages. |
| **Satellite Appellation** | In St-Émilion's context, the four appellations permitted to append "St-Émilion" to their name: Lussac, Montagne, Puisseguin, and St-Georges. Produce wines in the same Merlot-Cabernet Franc tradition at accessible prices. |
| **Lalande-de-Pomerol** | Appellation immediately adjacent to Pomerol, separated by the Barbanne river; similar clay-gravel soils without the concentrated *crasse de fer*; produces genuine Right Bank character at substantially lower prices. |
| **Assemblage** | The blending process by which a final wine is composed from individual lots — by variety, parcel, and barrel type. Right Bank assemblage decisions (how much Cabernet Franc to include; which parcels make the grand vin) define the character of every vintage. |

---

## Quiz — Bordeaux Right Bank

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. What geological feature most distinguishes Right Bank soils from Left Bank soils in Bordeaux?**
- A) The Right Bank has deeper gravel deposits and better drainage
- B) The Right Bank features predominantly clay and limestone, while the Left Bank is dominated by deep gravel beds
- C) The Right Bank sits on volcanic basalt, which gives Merlot its mineral character
- D) Both banks share identical soils; the distinction is purely climatic

**Correct: B**

---

**Q2. Why does Merlot dominate the Right Bank while Cabernet Sauvignon dominates the Left Bank?**
- A) Merlot was introduced to the Right Bank by decree in 1936 and Cabernet was banned
- B) Cabernet Sauvignon was historically too expensive to plant on the Right Bank
- C) Merlot's earlier ripening and clay affinity suit the Right Bank's soils, while Cabernet's deep roots and need for drainage are best served by the Left Bank's gravel
- D) Merlot is hardier in cold maritime climates, which are more pronounced on the Right Bank

**Correct: C**

---

**Q3. What is the *crasse de fer* and why is it important to Pomerol's top terroirs?**
- A) A type of limestone formation found on the St-Émilion plateau that reflects heat upward onto grape clusters
- B) An iron-rich, dense clay layer on the Pomerol plateau that retains water and buffers vine stress, contributing to the concentration and consistency of wines like Pétrus
- C) A gravel deposit running through the center of Pomerol that provides exceptional drainage for Cabernet Franc
- D) A winemaking technique used to clarify young Pomerol wines before aging

**Correct: B**

---

**Q4. How many official classification tiers does Pomerol have?**
- A) Five, matching the 1855 Médoc Classification
- B) Three — Premier Grand Cru, Grand Cru Classé, and Grand Cru
- C) None — Pomerol has never been officially classified
- D) Two — First Growth and Second Growth, established in 1945

**Correct: C**

---

**Q5. Pétrus is harvested only in the afternoon. What is the primary reason for this practice?**
- A) Afternoon sun ensures maximum sugar concentration in the berries before picking
- B) Morning dew evaporates by afternoon, preventing dilution of the must with excess water in the fruit
- C) Afternoon harvesting is a legal requirement for all Pomerol estates under AOC regulations
- D) The pickers arrive from Libourne and require travel time each morning

**Correct: B**

---

**Q6. What makes Château Cheval Blanc unusual among St-Émilion estates?**
- A) It produces 100 percent Merlot with no blending varieties, like Pétrus
- B) It is the only Right Bank estate aged entirely in new oak
- C) Its blend is approximately 57 percent Cabernet Franc and 40 percent Merlot — an atypical majority of Cabernet Franc in a Merlot-dominated appellation
- D) It was the only St-Émilion estate classified in the original 1855 Paris Exposition

**Correct: C**

---

**Q7. Which soil zone in St-Émilion produces the most mineral, structured, and age-worthy wines — often described as the most "Burgundian" in Bordeaux?**
- A) The Pied de Côtes, where sandy soils near Pomerol produce soft, early-drinking Merlot
- B) The Limestone Plateau (*Plateau Calcaire*), where thin topsoil over ancient marine limestone forces concentrated, mineral expression
- C) The gravel beds near Libourne, which replicate Left Bank drainage conditions
- D) The Côtes (slopes), where deep clay-limestone soils produce the richest and most immediately approachable wines

**Correct: B**

---

**Q8. What is the status of St-Émilion's 2022 classification revision?**
- A) It was successfully implemented and is now the official ranking in use
- B) It was postponed until 2030 due to climate-related concerns about vintage consistency
- C) It was annulled by a French court following legal challenges; the classification situation remains unresolved and contested
- D) It was abandoned and replaced with the permanent 2012 classification

**Correct: C**

---

**Q9. Château Ausone is associated with which soil type and which stylistic characteristic in St-Émilion?**
- A) Sandy gravel near Pomerol; rich, opulent, immediately approachable
- B) The Limestone Plateau; mineral, structured, austere in youth, requiring long aging
- C) Clay-dominant slopes; powerful and extracted in the Parker style
- D) Deep alluvial soils; round and velvety, driven by high Merlot percentage

**Correct: B**

---

**Q10. Château Le Pin is considered a "micro-château." What does this mean in context, and why does it affect price?**
- A) The estate uses miniature barrels for aging, which concentrates flavor more rapidly
- B) Le Pin produces wine under a different appellation than Pomerol due to its tiny size
- C) Le Pin covers just 2 hectares and produces fewer than 700 cases per year; extreme scarcity combined with a deliberately opulent, sought-after style drives prices to rival Pétrus
- D) The term refers to the château building, which is unusually small by Bordeaux standards but has no bearing on price

**Correct: C**

---

**Q11. A guest at your restaurant tells you they love the plush, velvety texture of Bordeaux and want something drinking beautifully tonight — not a wine that needs another decade. Which recommendation is most appropriate?**
- A) A young Pauillac First Growth — the tannins are firm but the fruit will show well with decanting
- B) A St-Émilion Grand Cru Classé or a Pomerol from a ripe recent vintage — the Merlot-dominant Right Bank delivers the round, approachable texture they're describing
- C) An aged St-Estèphe — the high clay content means it is always approachable young
- D) A Graves red — the gravel soils produce softer tannins than any other Bordeaux appellation

**Correct: B**

---

**Q12. Which of the following Right Bank appellations is most often recommended as a value alternative to Pomerol, based on adjacent terroir and similar Merlot-dominant style?**
- A) Margaux
- B) Fronsac
...
**Q13. Which family is responsible for building Pétrus's global reputation through négociant activity, and which member currently manages the estate?**
- A) The Rothschild family; Éric de Rothschild
- B) The Moueix family; Jean-Pierre Moueix built the reputation, Christian Moueix now manages
- C) The Thienpont family; Jacques Thienpont founded Pétrus in 1979
- D) The Guinaudeau family; they have managed the estate since 1985

**Correct: B**

---

**Q14. A guest is interested in Bordeaux as an investment and asks about the most "collectible" Right Bank wines. Which two estates represent the clearest luxury-object investment story?**
- A) Château Angélus and Château Pavie — both elevated to PGCCA in 2012 and widely recognized globally
- B) Château Ausone and Château Canon — the most structurally age-worthy estates on the limestone plateau
- C) Pétrus and Le Pin — extreme scarcity, cult status, and prices that appreciate at auction make these the clearest investment conversation
- D) Vieux Château Certan and L'Église-Clinet — critics' darlings with rising prices and limited production

**Correct: C**

---

**Q15. Château Lafleur is unusual among Pomerol's top estates for what reason, and how does it affect the wine's style?**
- A) It ages its wine in large-format oak foudres rather than standard 225-liter barriques, producing a lighter, more aromatic style
- B) Its blend includes approximately 50 percent Cabernet Franc — exceptionally high for Pomerol — contributing structure, minerality, and austerity that require 15–20 years of aging
- C) It produces no second wine, meaning all production goes into the grand vin regardless of quality
- D) It is the only Pomerol estate certified biodynamic, which adds freshness and aromatic lift to an otherwise opulent style

**Correct: B**

---

**Q16. Which of the following food pairings is best suited to a young Right Bank Bordeaux from St-Émilion or Pomerol?**
- A) Grilled halibut with lemon beurre blanc — the delicate texture complements the wine's earthiness
- B) Duck confit, braised short ribs, or a mushroom-forward dish — the richness and umami of these preparations match the wine's plush texture and truffle notes
- C) A Caesar salad — the acidic dressing cuts through the wine's tannins effectively
- D) Seared scallops with a light cream sauce — the wine's mineral character bridges seafood and richness

**Correct: B**

---

**Q17. What are the four St-Émilion satellite appellations, and what do they share in common with St-Émilion proper?**
- A) Fronsac, Canon-Fronsac, Lalande-de-Pomerol, and Bourg — they share similar Cabernet Sauvignon dominance
- B) Lussac, Montagne, Puisseguin, and St-Georges — they may append "St-Émilion" to their name and produce wines in the same Merlot-and-Cabernet Franc tradition from clay-limestone soils
- C) Castillon, Francs, Bourg, and Blaye — they surround St-Émilion and share its classification system
- D) Lussac, Montagne, Fronsac, and Lalande — they are classified under the broader St-Émilion Grand Cru appellation

**Correct: B**

---

**Q18. How does the en primeur system function, and why is it particularly relevant for top Right Bank estates?**
- A) En primeur means wines are sold directly from the château without going through the négociant system — a practice pioneered by Right Bank micro-châteaux
- B) En primeur is Bordeaux's futures system: wines are offered for sale while still in barrel at a release price, with delivery 18–24 months later after bottling. For sought-after Right Bank wines in celebrated vintages, securing an allocation en primeur can be the only way to access the wine at list price
- C) En primeur refers to the practice of drinking Bordeaux young, before tannins have fully integrated — common on the Right Bank but discouraged on the Left
- D) En primeur is a classification tier below Grand Cru Classé in St-Émilion, covering estates that did not qualify for the formal classification
