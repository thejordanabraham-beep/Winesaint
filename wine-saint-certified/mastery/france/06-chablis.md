...
- Explain the oak debate in Chablis — the traditionalist unoaked school versus the Raveneau/Dauvissat approach — and describe how old-barrel aging differs from new-oak flavoring
...
## Section 1: Geography and Why Chablis Is an Island
...
## Section 2: Kimmeridgian Limestone — The Geology That Defines the Style

No single geological formation has generated more reverence — and more argument — in the wine world than Kimmeridgian limestone. Understanding it precisely is essential for anyone selling Chablis at the fine wine level.
...
## Section 3: Oaked vs. Unoaked — The Great Chablis Debate
...
Champions of the unoaked school include **Jean-Marc Brocard** (over 60 hectares; clean, modern, stainless-fermented; excellent entry point for guests new to the region), **Domaine Vocoret**, and the **La Chablisienne** cooperative (which vinifies roughly one-third of all Chablis production and produces reliable, accessible wines at all quality tiers — the best introduction to the region for a guest with limited Chablis experience). **William Fèvre** — the largest estate owner in Chablis Grand Cru, now owned by Champagne house Henriot — uses primarily stainless steel for village and Premier Cru wines, with some new oak influence at Grand Cru level. The wines are consistent, well-made, and widely available.
...
## Section 4: Wine Character, Aging, and Food Pairing
...
**Visual profile:** Pale gold, often with greenish tints in youth, particularly in cooler vintages and stainless-fermented wines. Premier and Grand Cru from older vintages deepen to golden yellow with hints of honey. The color should never show orange or amber in wines under 15 years old — that indicates premature oxidation.
...
## Section 5: Chablis on the Floor — Common Misconceptions and Sales Strategy
...
| Term | Definition |
|------|------------|
| **Kimmeridgian Limestone** | Marine sedimentary rock (marl) from the Jurassic period, approximately 155 million years old, forming the bedrock of Chablis's Grand Cru and Premier Cru vineyards; a mix of limestone and clay containing abundant fossilized marine life |
| **Exogyra virgula** | A tiny Jurassic oyster, extinct for 65+ million years, whose comma-shaped fossilized shells are visible in Chablis vineyard soil; the biological basis for the region's famous mineral-oyster character |
| **Portlandian Limestone** | A harder, less clay-rich Jurassic limestone formation found on the plateau and outlying sites around Chablis; associated with Petit Chablis and some village Chablis; produces wines of lesser depth than Kimmeridgian sites |
| **Petit Chablis** | The entry-level Chablis appellation; outlying vineyard sites, often on Portlandian limestone; simple, fresh, early-drinking; $15–$25 |
| **Premier Cru** | The third tier of the Chablis hierarchy; 40 named vineyard sites grouped under 17 labels; south and southeast-facing Kimmeridgian slopes; $35–$80; key examples include Montée de Tonnerre, Fourchaume, and Vaillons |
| **Montée de Tonnerre** | Considered the finest Premier Cru in Chablis by many critics; adjacent to the Grand Cru slope; produces wines of Grand Cru intensity and mineral precision at Premier Cru prices |
| **Les Clos** | The largest and generally considered greatest of Chablis's seven Grand Cru vineyards (approximately 26 hectares); south-southwest-facing; produces the most powerful and age-worthy Chablis |
| **Silex (Flint)** | A descriptive tasting term for the struck-stone, gunsmoke, or mineral aromatic character found in Premier and Grand Cru Chablis; the defining sensory hallmark of Kimmeridgian limestone terroir |
| **Aspersion** | The frost-protection method in which overhead sprinklers coat vine buds in a thin layer of water that freezes; the resulting ice layer, held at 0°C, insulates the bud from ambient temperatures that drop below freezing |
| **Bougies** | Oil-burning smudge pots (heaters) placed in vineyards to combat spring frost in Chablis; less common today due to environmental concerns but still used by some producers |
| **Foudre** | A large neutral oak cask (typically 600–2,500 liters or more); used by Raveneau, Dauvissat, and other traditional Chablis producers for fermentation and aging; imparts no oak flavor but allows slow oxidative development and textural complexity |
| **Raveneau / Dauvissat** | The two benchmark Chablis producers; both use old oak barrels; universally regarded as producing Burgundy's greatest whites from Chablis; tiny production, allocated through mailing lists; Raveneau's Les Clos and Dauvissat's Les Preuses are benchmark Grand Crus |
| **Sur Lie** | "On the lees" — extended contact between finished wine and the spent yeast cells after fermentation; adds texture, complexity, and a subtle richness to the wine; used by traditional Chablis producers during barrel aging |
| **La Moutonne** | A monopole Grand Cru-quality vineyard in Chablis owned by Domaine Long-Depaquit; straddles the Vaudésir and Les Preuses Grand Crus but is sold under its own name; quasi-eighth Grand Cru |

---

## Quiz — Chablis: Limestone, Frost, and the Purest Expression of Chardonnay

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. Chablis is located approximately how far northwest of Beaune, and in which département?**
- A) 50 kilometers northwest, in the Côte d'Or département
- B) 110 kilometers northwest, in the Yonne département
- C) 130 kilometers northeast, in the Saône-et-Loire département
- D) 75 kilometers northwest, in the Aube département

**Correct: B**

---

**Q2. What is the geological name for the ancient marine sedimentary rock that defines the Grand Cru and Premier Cru vineyards of Chablis?**
- A) Portlandian limestone
- B) Bathonian limestone
- C) Kimmeridgian limestone
- D) Toarcian marl
...
**Q3. The fossilized organism most associated with Chablis's Kimmeridgian soil is:**
- A) A prehistoric ammonite called Dactylioceras
- B) A Jurassic belemnite called Belemnella
- C) A tiny Jurassic oyster called Exogyra virgula
- D) A planktonic foraminifera called Globigerina

**Correct: C**

---

**Q4. How does the aspersion frost-protection method work?**
- A) Alcohol-burning heaters raise air temperature around the vine canopy
- B) Overhead sprinklers coat the vine bud in water that freezes, and the resulting ice layer insulates the bud from temperatures below 0°C
- C) Wind machines circulate warmer air from above the frost inversion layer down to ground level
- D) Smudge pots burn oil to create a thermal blanket that prevents cold air from settling in low-lying areas

**Correct: B**

---

**Q5. Which of the following is NOT one of the seven Chablis Grand Cru vineyards?**
- A) Vaudésir
- B) Grenouilles
- C) Montée de Tonnerre
- D) Blanchots

**Correct: C** *(Montée de Tonnerre is a Premier Cru, not a Grand Cru)*

---

**Q6. Which Grand Cru is generally considered the greatest in Chablis — the largest, most powerful, and most age-worthy?**
- A) Valmur
- B) Grenouilles
- C) Bougros
- D) Les Clos
...
**Q7. What is La Moutonne, and which producer owns it?**
- A) A Premier Cru lieu-dit owned by William Fèvre
- B) A monopole that straddles the Vaudésir and Les Preuses Grand Crus, owned by Domaine Long-Depaquit
- C) A cooperative blend of all seven Grand Cru vineyards, produced by La Chablisienne
- D) A single-hectare Grand Cru owned by Domaine Raveneau

**Correct: B**

---

**Q8. Domaine François Raveneau and Domaine René & Vincent Dauvissat are considered the benchmark Chablis producers. Which statement about their winemaking is accurate?**
- A) Both use 100% new oak barrels to add complexity to their Grand Cru wines
- B) Both ferment exclusively in stainless steel and bottle immediately to preserve freshness
- C) Both ferment and age in old oak barrels (3–5+ years of use) that add textural complexity without new-oak flavor
- D) Both block malolactic fermentation entirely to preserve the wines' natural acidity

**Correct: C**

---

**Q9. Which producer is the best recommendation for a guest who is completely new to Chablis and wants an accessible, approachable introduction at modest prices?**
- A) Domaine Raveneau
- B) Domaine Dauvissat
- C) La Chablisienne cooperative
- D) Domaine Billaud-Simon Premier Cru

**Correct: C**

---

**Q10. A guest tells you they don't like Chardonnay because they find it too oaky and buttery. Which response best represents a floor-appropriate Chablis recommendation?**
- A) "Chablis isn't really Chardonnay — it has a different grape variety that produces a leaner style."
- B) "Chablis is 100% Chardonnay, but nothing like what you're describing. There's no oak flavor, no butter, no tropical fruit — it tastes like stone, sea salt, and lemon. It might genuinely change your mind."
- C) "I'd recommend staying away from Chablis — it can be quite acidic, which many guests don't enjoy."
- D) "The oaky style of Chablis is only found at Grand Cru level, so I'd suggest we start with a Petit Chablis."

**Correct: B**

---

**Q11. A guest reads "Chablis" on your wine list and says, "Isn't that just cheap jug wine?" What is the most accurate and effective response?**
- A) "You're right that basic Chablis can be quite simple, but our selection is from a better producer."
- B) "Chablis is the name of an actual village in Burgundy, France — that's where the term comes from. American producers used it as a generic label for decades, which created confusion. Genuine Chablis is a completely different wine — one of Burgundy's most distinctive."
- C) "All French wine labeled Chablis is legally required to meet strict quality standards, so jug wines are not comparable."
- D) "The jug wine you're thinking of was actually labeled 'Burgundy,' not Chablis."

**Correct: B**

---

**Q12. What approximate aging window would you recommend for a Chablis Premier Cru from Montée de Tonnerre in a strong vintage, from a producer like Billaud-Simon?**
- A) Drink immediately — Premier Cru Chablis does not benefit from aging
- B) 1–2 years after release
- C) 5–12 years, with the best examples capable of 15 years in exceptional vintages
- D) 20–30 years minimum

**Correct: C**

---

**Q13. What distinguishes Portlandian limestone from Kimmeridgian limestone, and which appellation tier is most associated with Portlandian soils?**
- A) Portlandian is older, richer in clay, and associated with Grand Cru vineyards
- B) Portlandian is harder and less clay-rich, drains faster, and is most associated with Petit Chablis and outlying village sites
- C) Portlandian contains more fossilized marine life and produces wines of greater mineral complexity
- D) Portlandian is found exclusively in the Premier Cru vineyards on the right bank of the Serein

**Correct: B**

---

**Q14. A table orders fresh oysters. What is the most compelling and accurate floor statement for recommending Chablis as the pairing?**
- A) "Chablis is a reliable pairing for shellfish because it's the driest white wine in Burgundy."
- B) "The high acidity in Chablis cuts through the brininess of oysters effectively."
- C) "The soil that Chablis grows in is 155-million-year-old seafloor — you can see fossilized oyster shells in the rock. That's why it has that briny, mineral quality that pairs so naturally with fresh shellfish."
- D) "We recommend Chablis with oysters because it's unoaked and therefore doesn't overwhelm delicate flavors."

**Correct: C**

---

**Q15. Which of the following best describes the ideal serving temperature for Chablis Premier Cru on the floor?**
- A) Room temperature, approximately 18–20°C, to allow the wine's aromatics to open fully
- B) 14–16°C, the standard white Burgundy service temperature
- C) 9–11°C (48–52°F), cold enough for the mineral quality to register cleanly and the acidity to lift rather than shock
- D) 6–8°C, the same temperature as Champagne service

**Correct: C**

---

**Q16. Which two vintages saw catastrophic frost damage in Chablis, with some producers losing 80–100% of their crop?**
- A) 2010 and 2015
- B) 2003 and 2012
- C) 2016 and 2021
- D) 2008 and 2017
...
**Q17. A guest is a committed Champagne drinker but wants to explore still wines. Which recommendation — and rationale — is most appropriate for directing them to Chablis?**
- A) "Chablis is made from Chardonnay, which is one of the grapes in Champagne, so the flavors should feel familiar."
- B) "Chablis Grand Cru shares Champagne's chalk-limestone geology, high acidity, and saline mineral character — it's the closest still wine to Champagne in style profile. If you love the freshness of Champagne, this is the natural bridge."
- C) "Chablis is produced using the traditional method, similar to Champagne, which gives it comparable texture and depth."
- D) "Champagne and Chablis are neighbors geographically, so the wine styles are very similar."

**Correct: B**

---

**Q18. Which Chablis Premier Cru is most often singled out by critics as approaching Grand Cru quality — and why?**
- A) Vaillons, because it faces directly south and achieves the highest natural sugar levels of any Premier Cru
- B) Fourchaume, because it is the largest Premier Cru by acreage and has the most consistent production
- C) Montée de Tonnerre, because it sits adjacent to the Grand Cru slope, achieves exceptional concentration and mineral tension, and is considered the finest Premier Cru site
- D) Butteaux, because its deep Kimmeridgian soil produces wines of unusual weight and richness for the appellation

**Correct: C**

---

**Q19. A guest asks why Chablis Grand Cru costs $80–$200+ when it's "just Chardonnay." Which argument best justifies the price with accuracy and floor confidence?**
- A) Grand Cru Chablis is aged in 100% new French oak, which accounts for the cost differential
- B) The seven Grand Cru vineyards total a very small area; yields are tightly limited; frost can wipe out the entire harvest in a single night; and the greatest producers (Raveneau, Dauvissat) produce only a few thousand bottles per year — scarcity and quality combined drive the price
- C) Grand Cru Chablis requires a minimum of ten years of aging before release, which adds significantly to the production cost
- D) The fossilized oyster shells in the soil must be hand-sorted from the vineyard annually, adding significant labor costs

**Correct: B**

---

**Q20. What is the complete list of the seven Chablis Grand Cru vineyards?**
- A) Blanchots, Bougros, Les Clos, Grenouilles, Les Preuses, Valmur, Vaudésir
- B) Blanchots, Bougros, Les Clos, Montée de Tonnerre, Les Preuses, Valmur, Vaudésir
- C) Blanchots, Bougros, Les Clos, Grenouilles, Fourchaume, Valmur, Vaudésir
- D) Blanchots, Les Clos, Grenouilles, Les Preuses, Montmains, Valmur, Vaudésir
