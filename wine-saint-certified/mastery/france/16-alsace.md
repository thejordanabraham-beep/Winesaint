...
## Section 1: History and Identity, A Region With Four Passports
...
## Section 2: Grape Varieties, Noble, Supporting, and Blended
...
## Section 3: The Grand Cru System, Geology Mapped to Quality
...
## Section 4: Vendange Tardive and Sélection de Grains Nobles, Late Harvest Done the Alsatian Way
...
## Section 5: Key Producers, The Houses That Define Alsace
...
## Section 6: Floor Application, Selling Alsace at the Table
...
| Term | Definition |
|------|-----------|
| Grand Cru (Alsace) | A legally designated single vineyard of exceptional quality. Alsace has 51 Grand Cru sites covering approximately 850 hectares. Only the four Noble varieties (Riesling, Gewurztraminer, Pinot Gris, Muscat) are generally permitted. Each Grand Cru has defined boundaries, maximum yields (typically 55 hl/ha), and minimum ripeness standards. |
| Vendange Tardive (VT) | "Late harvest", wines made from the four Noble varieties harvested at minimum must weights of 244 g/l (Riesling/Muscat) or 270 g/l (Gewurztraminer/Pinot Gris). Not necessarily sweet; may or may not involve botrytis. Concentration may come from passerillage (natural dehydration) or noble rot. |
| Sélection de Grains Nobles (SGN) | Alsace's highest late-harvest designation: individually selected botrytized berries, harvested at minimum 276 g/l (Riesling/Muscat) or 306 g/l (Gewurztraminer/Pinot Gris). Equivalent to German Trockenbeerenauslese. Produced only in exceptional vintages with significant botrytis development. |
| Edelzwicker | Literally "noble blend", a blended wine that may contain any Alsatian varieties in any proportion. Typically positioned as an accessible, inexpensive entry-level wine. No minimum requirement for Noble variety content. |
| Gentil | A blended wine requiring a minimum 50% Noble varieties (Riesling, Gewurztraminer, Pinot Gris, Muscat), each vinified separately before blending. Positioned above Edelzwicker in the quality hierarchy. |
| Vosges Mountains rain shadow | The climatic phenomenon by which the Vosges Mountains (rising to 1,424 meters) block Atlantic weather systems, causing the western slopes to receive over 2,000mm of annual rainfall while the eastern (Alsatian) side receives only 500–600mm. This creates one of France's driest wine regions at northern latitudes. |
| Noble varieties | The four legally recognized premium varieties in Alsace, Riesling, Gewurztraminer, Pinot Gris, and Muscat, that alone are permitted on Grand Cru sites and eligible for VT and SGN designations. |
| Passerillage | The natural concentration of grapes through dehydration and desiccation on the vine (as opposed to concentration via botrytis). In VT production, passerillage can produce intense, dried-fruit concentration without fungal intervention. Not the same as noble rot and typically produces wines without the honey-mushroom botrytis character. |
| Biodynamic viticulture | A holistic farming approach treating the vineyard as a self-sustaining ecosystem, following a lunar planting calendar and using only natural preparations (herbal teas, compost). In Alsace, major practitioners include Zind-Humbrecht, Domaine Weinbach, Josmeyer, and Albert Mann. Alsace leads France in biodynamic adoption, facilitated by its low disease pressure from dry climate. |
| Clos Sainte Hune | A 1.67-hectare walled monopole within Grand Cru Rosacker in Hunawihr, owned exclusively by Domaine Trimbach. Planted on Muschelkalk limestone, it produces Alsace's most celebrated dry Riesling, bone-dry, intensely mineral, and capable of evolving for decades. Notably, the Grand Cru Rosacker designation does not appear on the label. |
| Gewurztraminer | A pink-skinned variety that is Alsace's most recognizable wine internationally: explosive aromatics (lychee, rose petal, ginger, smoke), full body, high alcohol (13.5–14.5%), and naturally low acidity. Named "spiced Traminer" from its likely origin in Tramin (Alto Adige, Italy). The world's largest concentration, approximately 2,700 hectares, grows in Alsace. |
| Rangen | Alsace's southernmost and most extreme Grand Cru, located in Thann. Slopes of 45–68% on volcanic schist and basalt. Produces wines of exceptional mineral concentration and intensity. Zind-Humbrecht is the benchmark producer. The volcanic soils here are unique in Alsace and produce a character found nowhere else in the region. |
| Flûte d'Alsace | The tall, slender bottle format legally mandated for all AOC Alsace wines (excluding Crémant). The bottle shape echoes German Riesling presentation and was codified during the German administrative periods of Alsace's history. It creates immediate visual identity but contributes to guest confusion about whether the wine is French or German. |

---

## Quiz: Alsace: The Rhine's French Side
**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. Alsace changed nationality between France and Germany how many times between 1870 and 1945?**
- A) Two times
- B) Three times
- C) Four times
- D) Five times
...
**Q2. Colmar, in the heart of Alsace's wine region, receives approximately how much annual rainfall?**
- A) 800mm, because similar to western Bordeaux
- B) 700mm, because similar to Burgundy's Côte d'Or
- C) 500mm, because comparable to parts of southern Spain
- D) 350mm, because comparable to Provence

**Correct: C**

---

**Q3. Which geological feature is primarily responsible for Alsace's low annual precipitation?**
- A) The Rhine River valley acting as a natural drainage channel
- B) The Vosges Mountains blocking Atlantic weather systems from the west
- C) Alsace's continental interior position, far from any ocean
- D) The Black Forest on the German side creating a barrier to eastern moisture

**Correct: B**

---

**Q4. Which four grape varieties are legally classified as "Noble varieties" in Alsace, the only ones permitted on Grand Cru sites and eligible for VT and SGN designations?**
- A) Riesling, Gewurztraminer, Pinot Blanc, Muscat
- B) Riesling, Sylvaner, Pinot Gris, Gewurztraminer
- C) Riesling, Gewurztraminer, Pinot Gris, Muscat
- D) Riesling, Pinot Gris, Pinot Noir, Muscat

**Correct: C**

---

**Q5. A guest at your table orders Vietnamese spring rolls with a chili-lime dipping sauce. She asks for a wine recommendation. Which Alsace variety is the best choice and why?**
- A) Pinot Gris, because its smoky, full-bodied character provides a contrast to the light spring roll wrapper
- B) Dry Riesling, because its high acidity and aromatic complexity complement citrus, herbs, and chili without fighting them
- C) Gewurztraminer, because its sweetness will neutralize the heat of the chili sauce
- D) Muscat, because its grape-forward, dry style is the most versatile pairing in Alsace for Asian food

**Correct: B**

---

**Q6. How does Alsace Grand Cru labeling differ from Burgundy Grand Cru labeling?**
- A) Alsace Grand Cru wines do not carry the vineyard name, only the village name; Burgundy Grand Crus carry the vineyard name
- B) Alsace Grand Cru wines carry both the grape variety and the specific Grand Cru site name; Burgundy Grand Crus carry only the site name with the grape variety implied by the appellation
- C) Alsace Grand Cru wines are ranked 1–51 by quality, like Burgundy's Premiers Crus
- D) Alsace Grand Cru wines must be made from a single variety; Burgundy Grand Crus require blending two or more varieties

**Correct: B**

---

**Q7. Vendange Tardive (VT) is best described as:**
- A) A sweet wine designation requiring botrytis-affected grapes from Noble varieties
- B) A ripeness designation for Noble varieties harvested at specified minimum must weights; the wine may or may not be affected by botrytis and may or may not be sweet
- C) A sparkling wine made from late-harvested Pinot Blanc and Auxerrois
- D) A dry wine category requiring extended lees aging, comparable to Muscadet Sur Lie

**Correct: B**

---

**Q8. What is passerillage, and how does it differ from botrytis as a concentration mechanism in VT wines?**
- A) Passerillage is a French term for botrytis; the two words describe the same process
- B) Passerillage is the concentration of grape sugars through cryo-extraction (freezing the grapes); botrytis involves fungal infection
- C) Passerillage is the natural dehydration and desiccation of grapes on the vine without fungal infection; botrytis uses Botrytis cinerea to concentrate sugars and add honey-mushroom complexity
- D) Passerillage refers to blending partially dried grapes with fresh juice; botrytis affects whole clusters uniformly

**Correct: C**

---

**Q9. Sélection de Grains Nobles (SGN) is the Alsatian equivalent of which German category?**
- A) Spätlese
- B) Auslese
- C) Beerenauslese
- D) Trockenbeerenauslese (TBA)

**Correct: D**

---

**Q10. A guest who says "I never drink sweet wine" is hesitating over a Gewurztraminer on your list. You suspect the wine is dry but know the aromatics are intensely exotic. What is the most effective response?**
- A) Acknowledge that Gewurztraminer is always sweet and suggest a Riesling instead
- B) Explain that Gewurztraminer's aromatics, lychee, rose petal, ginger, can smell sweet even when the wine is completely dry, and invite the guest to try it on that basis
- C) Describe the wine as "medium-bodied and subtle" to lower the guest's aromatic expectations
- D) Recommend a Pinot Gris instead, as it has less aromatic intensity and is therefore less likely to be mistaken for a sweet wine

**Correct: B**

---

**Q11. Clos Sainte Hune is produced by Trimbach within which Grand Cru vineyard?**
- A) Schlossberg
- B) Brand
- C) Rosacker
- D) Rangen
...
**Q12. Olivier Humbrecht of Domaine Zind-Humbrecht holds which distinction relevant to the French wine world?**
- A) He was the first winemaker to receive a three-star rating from the Michelin Guide for his tasting room
- B) He was the first French winemaker to earn the Master of Wine (MW) title
- C) He was the first Alsatian producer to receive Grand Cru designation for his estate-owned vineyards
- D) He founded the Alsace Grand Cru system and lobbied for its creation in 1975

**Correct: B**

---

**Q13. Which Grand Cru is grown on volcanic schist and basalt at slopes of 45–68%, making it the most extreme site in Alsace?**
- A) Schlossberg
- B) Hengst
- C) Brand
- D) Rangen
...
**Q14. A guest is eating pan-roasted duck breast with a mushroom cream sauce. Of the Alsace Noble varieties, which is the most appropriate recommendation?**
- A) Muscat, because its dry, grapey freshness will contrast the richness of the cream sauce
- B) Riesling, because its high acidity will cut through the fat in the sauce
- C) Pinot Gris, because its full body, smoky texture, and affinity for mushroom and pork preparations make it the natural pairing
- D) Gewurztraminer, because its spice character will amplify the seasoning of the duck

**Correct: C**

---

**Q15. Hugel et Fils is primarily credited with which contribution to Alsatian wine history?**
- A) Introducing biodynamic viticulture to Alsace and training Olivier Humbrecht before his MW studies
- B) Creating the first walled monopole (clos) in Alsace's Grand Cru system
- C) Advocating for and codifying the Vendange Tardive and Sélection de Grains Nobles legal designations, formalized in 1984
- D) Establishing the Crémant d'Alsace appellation in 1976

**Correct: C**

---

**Q16. Why do Trimbach and (historically) Hugel sometimes decline to label their wines with the Grand Cru designation even when grapes come from Grand Cru sites?**
- A) Their vineyards were designated after the initial 1975 classifications and they dispute the later additions
- B) Both houses believe that house style and producer reputation are more meaningful quality signals than appellation designation, and they prefer proprietary lieu-dit names they have built into recognized brands
- C) AOC regulations prevent négociant houses from using Grand Cru designations on wines made from purchased grapes
- D) Grand Cru designation requires single-variety wines, and both houses traditionally blend varieties

**Correct: B**

---

**Q17. Alsatian Muscat presents a counterintuitive characteristic compared to most other global Muscat wines. What is it?**
- A) Alsatian Muscat is always blended with Riesling to reduce its natural sweetness
- B) Alsatian Muscat is vinified as a red wine rather than a white despite the grape's light skin color
- C) Alsatian Muscat is made completely dry, despite an aromatic profile (orange blossom, fresh grapes, lemon zest) that guests typically associate with sweet wine
- D) Alsatian Muscat undergoes extended oak aging, giving it a structure that eliminates its typical floral aromatics

**Correct: C**

---

**Q18. Marcel Deiss advocates a controversial approach to Grand Cru wines in Alsace. What is it?**
- A) He produces Grand Cru wines exclusively from Sylvaner, a variety normally excluded from Grand Cru designation
- B) He produces field-blend wines from Grand Cru sites by planting and fermenting multiple varieties together (complantation), arguing this was the historic Alsatian practice and better expresses terroir
- C) He ages all Grand Cru wines in new French oak barrels, contradicting Alsace's traditional foudre-only approach
- D) He harvests Grand Cru fruit earlier than the legal minimum ripeness to preserve acidity, making his wines technically ineligible for Grand Cru designation

**Correct: B**

---

**Q19. At what temperature should Gewurztraminer and off-dry Riesling ideally be served to allow their aromatic complexity to fully express?**
- A) 6–8°C (43–46°F), because the same as most refrigerated whites
- B) 8–10°C (46–50°F), because slightly warmer than Champagne service temperature
- C) 12–14°C (54–57°F), because warm enough for aromatics to lift from the glass
- D) 16–18°C (61–64°F), because red wine cellar temperature

**Correct: C**

---

**Q20. A guest is considering a Vendange Tardive Gewurztraminer to accompany her foie gras course but says she is worried the wine will be "too sweet and cloying." How do you address her concern?**
- A) Suggest she order a bone-dry Riesling instead, as VT wines are definitionally too sweet to pair with rich preparations
- B) Explain that VT is a ripeness designation, not a sweetness guarantee, because the wine has concentration and body, but the richness complements rather than overwhelms foie gras. The spice and aromatics of the Gewurztraminer rise above the opulence of the dish in a way a dry wine cannot
- C) Assure her the wine is actually classified as dry under the 2021 sweetness labeling regulations
- D) Offer to pair the foie gras with Sauternes instead, which is a more internationally recognized sweet wine pairing
