...
**Level:** Portugal Mastery — Vinho Verde & Minho
**Module:** 5
...
## Section 1: The Minho — Northwest Portugal's Green Corner
...
## Section 4: The Other Grapes of Vinho Verde
...
## Section 5: The Commercial Reality — What Most People Know and What They're Missing
...
## Section 6: Floor Strategy — The Vinho Verde Conversation
...
| Term | Definition |
|------|------------|
| **Vinho Verde** | "Green wine" — Portugal's largest DOC, covering the Minho region of northwest Portugal. The name refers to the wines' youthful freshness, not their color. Encompasses nine sub-zones, producing white, rosé, and red wines. |
| **Minho** | The historic northwestern province of Portugal — the wettest and greenest wine region in the country — bounded by the Atlantic to the west, Galicia (Spain) to the north, and the Douro River to the south. The geographic identity behind the Vinho Verde DOC. |
| **Monção e Melgaço** | The northernmost and most prestigious sub-zone of Vinho Verde, positioned along the Minho River on the Spanish border. The heartland of Alvarinho; the only sub-zone permitted to label wines by variety name alone without prominent DOC reference. |
| **Alvarinho** | Portugal's most prestigious white wine grape, dominant in Monção e Melgaço. Genetically identical to Albariño in Rías Baixas, Spain. Produces fuller-bodied, more mineral, and less immediately aromatic wines than its Spanish counterpart, due to the warmer, more sheltered inland climate of the sub-zone. |
| **Loureiro** | The most aromatic white grape in the Vinho Verde DOC. Produces wines with distinctive lime blossom, orange flower, and citrus peel character; lighter-bodied than Alvarinho. Dominant in the Lima sub-zone and prominent in DOC blends. |
| **Arinto (Pedernã)** | High-acid white grape used throughout Vinho Verde, known in the DOC as Pedernã. Contributes structural acidity, lemon, and green apple character. Essential blending component; separately the primary variety of the Bucelas DOC near Lisbon. |
| **Avesso** | White grape dominant in the Amarante and Baião sub-zones of Vinho Verde. Produces rounder, more textured wines with white peach and tropical fruit character — fuller-bodied than Loureiro and notably richer than the commercial Vinho Verde template. |
| **Azal** | High-acid, lean white grape historically grown in the Basto sub-zone. Rarely seen as a varietal bottling; used in blends to reinforce acidity and freshness. Produces very lean, lemon-dominant wines. |
| **Vinhão** | The primary red grape variety of Vinho Verde — deeply pigmented (one of the most colored red wines in Europe), high in tannin, and sharply acidic. Known as Sousão elsewhere in Portugal. Traditional pairing with the Minho's fatty pork-based cuisine. |
| **Pétillance** | Light effervescence in Vinho Verde, originally from dissolved CO₂ retained from incomplete malolactic fermentation; in modern commercial production, from deliberate CO₂ addition before bottling. A hallmark of the mass-market style, absent in most serious dry Vinho Verde. |
| **Soalheiro** | Benchmark estate in Monção e Melgaço, founded by the Cerdeira family. Among the first to establish serious dry Alvarinho production in the sub-zone. Reference producer for structured, mineral, age-worthy Alvarinho; flagship Primeiras Vinhas from vines planted 1974. |
| **Anselmo Mendes** | Monção e Melgaço's most prominent winemaker-consultant and estate owner. Producer of Muros Antigos and Contacto (extended skin-contact Alvarinho). Defines the experimental and serious end of the sub-zone's production. |
| **Contacto** | Anselmo Mendes' extended skin-contact Alvarinho, macerated on skins for several days before pressing. Produces a textured, amber-tinged wine with phenolic structure and complexity well outside the conventional Vinho Verde template. |
| **Lima sub-zone** | Sub-zone of Vinho Verde along the Lima River, immediately south of Monção e Melgaço. The heartland of Loureiro production — more aromatic and delicate than Alvarinho, with strong floral and citrus character. |
| **Bacalhau** | Salt cod — Portugal's most iconic ingredient and one of the primary food pairings for Vinho Verde. Prepared in hundreds of traditional ways throughout the Minho and the rest of Portugal; its saline, savory character pairs directly with Vinho Verde's acidity and minerality. |

---

## Quiz — Vinho Verde and Minho

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. The name "Vinho Verde" — "green wine" — refers to:**
- A) The greenish tint of the wine in the glass
- B) The use of unripe, green grapes in the blend
- C) The wines' youthful freshness and the green landscape of the Minho
- D) The predominance of green-skinned grape varieties in the DOC

**Correct: C**

---

**Q2. The five principal rivers that define Vinho Verde's sub-zone geography are:**
- A) Douro, Tejo, Guadiana, Minho, and Sado
- B) Lima, Minho, Cávado, Ave, and Douro
- C) Minho, Lima, Tâmega, Sousa, and Vouga
- D) Cávado, Ave, Lima, Mondego, and Douro

**Correct: B**

---

**Q3. Which Vinho Verde sub-zone is the only one permitted to label its wines by variety name alone — without prominent DOC reference?**
- A) Lima
- B) Braga
- C) Baião
- D) Monção e Melgaço
...
**Q4. Alvarinho from Monção e Melgaço differs from Rías Baixas Albariño primarily because:**
- A) Alvarinho is a lighter, more aromatic, and lower-alcohol style due to more Atlantic exposure
- B) Monção e Melgaço's warmer, more sheltered inland microclimate produces fuller-bodied, more mineral, and less immediately floral wines
- C) Alvarinho and Albariño are distinct grape varieties with different flavor profiles despite their shared name
- D) Alvarinho must be made with extended skin contact under DOC regulations, giving it more tannin

**Correct: B**

---

**Q5. Soalheiro's Primeiras Vinhas is sourced from:**
- A) Recently planted high-density Alvarinho vines selected for aromatic concentration
- B) A blend of young Alvarinho vines from across the Monção e Melgaço sub-zone
- C) Alvarinho vines planted in 1974, among the oldest in the sub-zone
- D) A single riverside plot farmed biodynamically since 2005

**Correct: C**

---

**Q6. Loureiro's primary aromatic profile is best described as:**
- A) Stone fruit, apricot, and almond — a rich and textured northern white style
- B) Lime blossom, orange flower, white flowers, and fresh lime peel — the most aromatic white variety in the DOC
- C) Lemon, chalk, and green apple — lean and austere with a long mineral finish
- D) Peach, pineapple, and slight creaminess — a rounder, more tropical white style

**Correct: B**

---

**Q7. Arinto (Pedernã) contributes which primary characteristic in Vinho Verde blends?**
- A) Broad tropical fruit aromatics and textural weight
- B) Deep color and tannic structure
- C) Structural acidity, lemon, and green apple freshness
- D) Floral intensity and lime blossom aromatics

**Correct: C**

---

**Q8. Avesso is associated primarily with which Vinho Verde sub-zones?**
- A) Monção e Melgaço and Lima — the two northern prestige sub-zones
- B) Basto and Sousa — inland, cooler sub-zones with higher altitude
- C) Cávado and Ave — the coastal sub-zones closest to the Atlantic
- D) Amarante and Baião — the southernmost sub-zones along the Douro

**Correct: D**

---

**Q9. Vinhão — the primary red grape of Vinho Verde — is notable for:**
- A) Its pale color, low tannin, and light cranberry character — suitable for rosé
- B) Its deep pigmentation (one of the most colored reds in Europe), high tannin, and sharp acidity
- C) Its ability to produce structured, age-worthy red wines similar to Douro Touriga Nacional
- D) Its aromatic similarity to Vinhão's Spanish counterpart, Garnacha

**Correct: B**

---

**Q10. The pétillance in commercial Vinho Verde is produced by:**
- A) Secondary fermentation in bottle using the traditional (Champenoise) method
- B) Extended lees contact during aging, which naturally generates CO₂
- C) Deliberate CO₂ addition before bottling — or, historically, from CO₂ trapped from incomplete malolactic fermentation
- D) Wild yeast fermentation that produces a natural effervescence throughout the wine's life

**Correct: C**

---

**Q11. Anselmo Mendes' Contacto is significant within the Vinho Verde DOC because:**
- A) It is the highest-volume commercial Alvarinho produced for the export market
- B) It is the first certified organic wine from the Monção e Melgaço sub-zone
- C) It uses extended skin contact on Alvarinho, producing a textured, amber-tinged wine well outside the conventional Vinho Verde template
- D) It is produced from Vinhão — demonstrating the red wine potential of Monção e Melgaço

**Correct: C**

---

**Q12. The commercial mass-market Vinho Verde style is characterized by:**
- A) High alcohol (14–15%), full body, and extended oak aging
- B) Light pétillance, low alcohol (8–10%), slight residual sweetness, and immediate refreshment
- C) Dry, still, mineral structure and significant aging potential
- D) Deep color, high tannin, and earthy complexity from granite soils

**Correct: B**

---

**Q13. A guest who regularly orders Rías Baixas Albariño asks if there is "something similar but more structured and mineral." Your best Vinho Verde recommendation is:**
- A) Any entry-level commercial Vinho Verde from a large cooperative — the refreshing style they know
- B) A Loureiro from the Lima sub-zone — more floral and aromatic than Albariño
- C) Alvarinho from Monção e Melgaço (Soalheiro or Anselmo Mendes) — fuller body, more mineral weight, and greater depth
- D) An Avesso from Baião — the richest and most tropical white in the DOC

**Correct: C**

---

**Q14. Vinho Verde is one of the oldest wine appellations in Portugal. It was officially demarcated in:**
- A) 1756
- B) 1865
- C) 1908
- D) 1952
...
**Q15. A table orders sashimi, oysters on the half shell, and grilled branzino. Your Vinho Verde recommendation:**
- A) Is inappropriate — Vinho Verde's acidity is too aggressive for raw and delicate preparations
- B) Is ideal across all three dishes — high acidity, saline minerality, and moderate alcohol match seafood and raw preparations precisely
- C) Works only for the grilled branzino — oysters require a richer, oaked white
- D) Works only as an aperitif before the meal; a fuller white is needed once food is served

**Correct: B**

---

**Q16. The Lima sub-zone of Vinho Verde is primarily associated with which grape variety and wine style?**
- A) Alvarinho — full-bodied, mineral, and structured, comparable to Monção e Melgaço
- B) Avesso — textured, white peach character with tropical inflection
- C) Azal — lean, high-acid, and lemon-dominant, consumed primarily within Portugal
- D) Loureiro — delicate, intensely floral and aromatic, with lime blossom and citrus character

**Correct: D**

---

**Q17. A guest says: "I love Vinho Verde — it's so light and bubbly." You want to introduce them to a more serious expression. The most effective approach is:**
- A) Explain that real Vinho Verde is not bubbly and that they have been drinking an inauthentic product
- B) Frame the serious tier as a discovery: "That's the summer style — there's a whole other tier that's bone dry, still, and much more structured. Would you like to try it?"
- C) Recommend a red Vinhão to demonstrate the DOC's range before moving to dry whites
- D) Suggest they try Albariño from Rías Baixas instead, which is more consistent in quality

**Correct: B**

---

**Q18. Which of the following best distinguishes Monção e Melgaço's climate from the coastal Vinho Verde sub-zones?**
- A) Monção e Melgaço is cooler and wetter, receiving the most Atlantic influence in the DOC
- B) Monção e Melgaço is warmer and drier due to a rain-shadow effect from the Serra do Gerês mountains, producing longer hang time and fuller-bodied Alvarinho
- C) Monção e Melgaço receives the same climate as Val do Salnés in Rías Baixas — there is no meaningful difference
- D) Monção e Melgaço has a continental climate with extreme winter cold, requiring frost protection for Alvarinho

**Correct: B**

---

**Q19. Quinta de Santiago's style of Alvarinho is best described as:**
- A) Immediately aromatic and intensely floral — the most accessible style in Monção e Melgaço
- B) High-volume and commercially driven — the reference for consistent, affordable Alvarinho
- C) Initially tight and mineral, emphasizing granite and restraint over aromatic expressiveness, opening with bottle age
- D) Skin-contact and textured, similar to Anselmo Mendes' Contacto in winemaking philosophy

**Correct: C**

---

**Q20. For a guest who enjoys Albariño but "wants something with a little more texture and a tropical note," the correct Vinho Verde recommendation from the module is:**
- A) Azal from Basto — lean acidity and austerity, though very high in acid
- B) Avesso from Amarante or Baião — rounder body, white peach and tropical fruit, higher weight than the northern varieties
- C) Loureiro from Lima — the most aromatic white in the DOC, with floral and lime blossom intensity
- D) A commercial Vinho Verde blend — lighter alcohol and slight sweetness provides approachability

**Correct: B**

---

*End of Module 5 — Vinho Verde and Minho: Portugal's Atlantic Garden*

*Next: Module 6 — The Douro Valley: Portugal's Greatest Red Wine Region*
