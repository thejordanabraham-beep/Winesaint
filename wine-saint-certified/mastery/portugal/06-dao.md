...
## Section 1: Geography — The Granite Bowl of North-Central Portugal
...
## Section 2: Granite — The Soil That Defines Everything
...
## Section 3: The Red Grapes — Four Varieties and How They Build a Wine
...
A typical quality Dão red blend might run 40 to 50 percent Touriga Nacional for aromatics and structure, 30 to 40 percent Tinta Roriz for backbone and fruit, with Alfrocheiro and Jaen filling the remaining share for texture and perfume. The exact proportions vary by producer philosophy and vintage character. DOC rules cap any single variety at 80 percent of the blend, actively encouraging this multi-variety approach.
...
## Section 4: White Dão — Encruzado and the Burgundy Parallel
...
**Quinta de Saes**, also associated with Álvaro Castro's extended properties, focuses specifically on white production and is considered a separate project emphasizing Encruzado's mineral and textural range.

**Wines & Winemakers** is a newer project from winemaker Carlos Lucas that has attracted considerable critical attention for its site-focused, low-intervention approach to both reds and whites.
...
## Section 5: The Cooperative Era and the Quality Revolution
...
**Luís Pato** — primarily known as the transformative figure who proved Bairrada's Baga could make serious wine — also produces Dão wines, demonstrating the region's appeal to quality-focused producers working across central Portugal.
...
## Section 6: The Floor Strategy — Selling Dão
...
| Term | Definition |
|------|------------|
| **Dão DOC** | Portugal's highest-quality designation covering approximately 20,000 planted hectares in north-central Portugal; the DOC regulates permitted varieties, maximum yields, minimum aging, and alcohol levels |
| **Serra da Estrela** | Portugal's highest mountain range, forming the eastern boundary of the Dão DOC; blocks continental influence from inland Spain and contributes to the region's cool interior climate |
| **Serra do Caramulo** | Mountain range forming the western boundary of Dão; intercepts Atlantic weather systems and reduces maritime influence inside the appellation |
| **Mondego River** | One of Portugal's few entirely domestic rivers; drains the Dão region and shapes the variation in elevation and site exposure across the appellation |
| **Granite** | The dominant bedrock and soil parent material in Dão; coarse-grained, acidic (pH 4.5–5.5), low-fertility, and well-draining; forces vine roots deep into fractured subsoil and produces naturally high-acid, mineral, finesse-forward wines |
| **Touriga Nacional** | Dão's prestige red variety; deeply colored, intensely aromatic (violets, blackberries, black tea), firm fine-grained tannins; the same variety used for the finest Ports; low-yielding (25–30 hl/ha), late-ripening |
| **Tinta Roriz** | Local name in northern Portugal for Tempranillo; provides structural backbone, red-fruit brightness, and aging potential in Dão blends; earlier-ripening and more productive than Touriga Nacional |
| **Alfrocheiro** | Indigenous Dão red variety; deeply colored, intensely aromatic (blackberry, violet, pepper), soft tannins; used in blends to add immediate aromatic appeal and textural richness |
| **Jaen** | Dão name for Mencía (Spain); adds perfume (rose petal, violet, red fruit) and moderate tannins to blends; nearly disappeared during the cooperative era, now being revived by quality producers |
| **Encruzado** | Dão's premier white variety; indigenous, high-acid, full-bodied, with stone fruit and mineral character; handles oak well; ages 10–15 years; frequently compared to white Burgundy in texture and structural complexity |
| **Cooperative era** | The period from the 1950s through the 1990s when cooperatives controlled over 90% of Dão production; co-ops paid by weight, suppressing quality, blending indiscriminately, and aging wines in poorly maintained casks — nearly destroying Dão's reputation |
| **Reserva** | Dão DOC designation requiring at minimum 12 months total aging for red wines (with at least 6 months in bottle); in practice, quality producers age Reserva reds 18–36 months before release |
| **Quinta da Pellada** | Álvaro Castro's estate; widely considered one of Dão's most important producers for both red and white wines; a founding figure of the quality revolution |
| **Quinta dos Roques** | Pioneering Dão estate from the 1990s; the benchmark producer for consistent, terroir-driven quality across red and white; the reference estate for sommeliers learning the region |
| **Diurnal variation** | The daily temperature swing between warm days and cool nights; in Dão, summer diurnal swings preserve natural acidity in grapes despite warm daytime ripening temperatures — a key mechanism of the region's freshness |

---

## Quiz — Dão: Portugal's Burgundy — Granite, Touriga Nacional, and the Cool Interior

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. Which three mountain ranges form the natural enclosure of the Dão wine region?**

- A) Serra da Estrela, Serra da Arrábida, and Serra do Montemuro
- B) Serra do Caramulo, Serra da Estrela, and Serra do Açor
- C) Serra da Lousã, Serra do Gerês, and Serra da Estrela
- D) Serra do Buçaco, Serra de Sintra, and Serra do Caramulo

**Correct: B**

---

**Q2. What is the approximate elevation range of most Dão vineyards?**
...
**Q3. A guest asks why Dão wines have such natural freshness and acidity despite warm daytime temperatures. What is the most technically accurate explanation?**

- A) The Atlantic Ocean provides a constant cooling breeze across the region
- B) The Mondego River lowers local temperatures through evaporation
- C) Granite soils are low in potassium, which correlates with higher acid retention in grapes; combined with cool nights, this preserves natural acidity
- D) Dão regulations require harvest before full sugar accumulation to maintain freshness

**Correct: C**

---

**Q4. Dão's granite soils are described as producing wines of "natural elegance rather than weight." Which soil characteristic most directly drives this outcome?**

- A) High calcium carbonate content that softens tannins during fermentation
- B) Low fertility and excellent drainage that limits vine vigor and yield, concentrating flavor without fat or extract
- C) High magnesium levels that promote acidity and reduce alcohol
- D) Dark coloration that retains heat and extends the ripening season

**Correct: B**

---

**Q5. Touriga Nacional is the same grape variety used in the production of:**

- A) Vinho Verde
- B) Madeira
- C) Port wine
- D) Moscatel de Setúbal

**Correct: C**

---

**Q6. Which of the following correctly describes Touriga Nacional's yield level compared to other Dão red varieties?**

- A) It is among the highest-yielding, which is why cooperatives favored it
- B) It is moderate, roughly equivalent to Tinta Roriz
- C) It is among the lowest-yielding, rarely exceeding 25–30 hl/ha
- D) Yield varies dramatically by vintage with no consistent pattern

**Correct: C**

---

**Q7. Jaen — Dão's aromatic red variety prized for perfume and freshness in blends — is genetically identical to which Spanish variety?**
...
**Q8. DOC regulations in Dão cap any single variety at 80% of a red blend. What is the intended effect of this rule?**

- A) To prevent Touriga Nacional from dominating the market
- B) To encourage multi-variety blending and preserve regional complexity
- C) To protect cooperative production from competition by single-variety estate wines
- D) To maintain lower alcohol levels by requiring early-ripening variety inclusion

**Correct: B**

---

**Q9. Which of the following best describes Encruzado's aging potential and stylistic comparison?**

- A) It is a fresh, early-drinking white similar to Vinho Verde; best consumed within 18 months
- B) It is full-bodied and mineral, handles oak well, ages 10–15 years, and is frequently compared to white Burgundy in texture and structural complexity
- C) It is a lightly oaked, aromatic variety best compared to Alsatian Riesling
- D) It is a light-to-medium bodied white best suited for unoaked, high-acid styles similar to Vinho Verde's Loureiro

**Correct: B**

---

**Q10. A guest tells you they love white Burgundy but finds the prices unsustainable. Which Dão producer and variety would you most logically recommend, and why?**

- A) Quinta dos Roques Encruzado — same structural weight, mineral character, and oak integration as white Burgundy at a fraction of the price
- B) Quinta do Crasto Branco — same producer philosophy as the Douro but applied to Dão whites
- C) Luís Pato Bical — a structured Bairrada white that crosses the border into Dão territory
- D) Sogrape Dão Branco — the cooperative-era standard-bearer for accessible, affordable white wine

**Correct: A**

---

**Q11. During the cooperative era in Dão, cooperatives paid grape growers by weight. What was the primary consequence of this payment structure?**

- A) It incentivized the planting of low-yielding, high-quality varieties like Touriga Nacional
- B) It encouraged high yields and penalized quality-focused varieties, resulting in wines of poor character
- C) It created a surplus of Encruzado, which depressed white wine prices across Portugal
- D) It standardized quality across the region by eliminating vintage variation

**Correct: B**

---

**Q12. Which event or policy change made it legally possible for private Dão producers to bottle their own estate wine rather than selling grapes to cooperatives?**

- A) The creation of the Dão DOC in 1975
- B) Portugal's entry into the European Union in 1986 and subsequent legislative changes
- C) The Paris Wine Tasting of 1976, which elevated Portuguese wines internationally
- D) The Mondego River flood of 1983, which forced cooperative restructuring

**Correct: B**

---

**Q13. Álvaro Castro is associated with which Dão estate, and what is his significance to the region?**

- A) Quinta dos Roques; he was the first to plant Touriga Nacional in Dão after the cooperative era
- B) Quinta da Pellada; he is widely considered the most respected individual winemaker in Dão, a founding figure of the quality revolution
- C) Niepoort; he brought Douro winemaking philosophy to Dão and established its first international export market
- D) Casa de Santar; he built the first modern winery in Dão after receiving EU agricultural subsidies

**Correct: B**

---

**Q14. A guest who regularly orders Barolo and aged Rioja Gran Reserva is asking for a recommendation they haven't tried. Which of the following is the most accurate floor pitch for Dão?**

- A) "Dão is Portugal's version of Beaujolais — light, fresh, immediately enjoyable, perfect for this kind of occasion"
- B) "Dão is built for exactly this kind of palate: finesse-first, firmly structured, mineral, needs time, and rewards patience the same way Barolo and Gran Reserva do — except it's underpriced"
- C) "Dão is closest to Alentejo — ripe, full-bodied, fruit-forward, easy to enjoy now"
- D) "Dão is best for guests who prefer white wine; the reds are technically structured but not complex enough for a Barolo drinker"

**Correct: B**

---

**Q15. Which of the following food pairings is most logically suited to a young, structured Dão red that has not yet developed significant tertiary complexity?**

- A) Delicate steamed fish with citrus butter
- B) Roast chicken with herbs and garlic, or a mushroom-based pasta
- C) Fresh oysters with mignonette
- D) A fruit-forward cheese plate with honeycomb and dried apricot

**Correct: B**

---

**Q16. Niepoort's involvement in Dão is significant because:**

- A) Niepoort founded the region's first cooperative and later transitioned to estate bottling
- B) Niepoort, primarily known for Port and Douro table wines, established a Dão project that exemplifies the minimal-intervention, freshness-focused approach transforming Portuguese wine
- C) Niepoort purchased Quinta dos Roques and converted it to a biodynamic estate
- D) Niepoort introduced Cabernet Sauvignon to Dão as part of a modernization program funded by the Portuguese government

**Correct: B**

---

**Q17. The "Portuguese Burgundy" comparison applied to Dão is best understood as a reference to which set of shared characteristics?**

- A) Both regions use identical grape varieties, oak protocols, and DOC-equivalent classification systems
- B) Both regions produce finesse-first red wine from ancient, nutrient-poor soils, with structural elegance prioritized over extraction and power, and significant aging potential
- C) Both regions are located at similar latitudes and receive the same average annual rainfall
- D) Both regions are most famous for their white wines, with red wine representing a secondary commercial output

**Correct: B**

---

**Q18. A Dão red Reserva is released with a harvest date eight years ago. How should you describe its likely drinking window to a guest?**

- A) "It's past its peak — Dão Reservas are best within five years of harvest"
- B) "It's entering its drinking window — this is about when Dão Reservas begin showing integrated tannins and tertiary complexity; it will hold another five to ten years"
- C) "It's too young — a Dão Reserva needs at least fifteen years before it's approachable"
- D) "It doesn't matter — Dão reds don't age significantly after three years"

**Correct: B**

---

**Q19. Which of the following correctly ranks Dão's four principal red varieties from latest-ripening to earliest-ripening?**

- A) Touriga Nacional → Alfrocheiro → Tinta Roriz → Jaen
- B) Jaen → Tinta Roriz → Alfrocheiro → Touriga Nacional
- C) Touriga Nacional → Jaen → Alfrocheiro → Tinta Roriz
- D) Alfrocheiro → Tinta Roriz → Jaen → Touriga Nacional

**Correct: C**

---

**Q20. The value case for Dão relative to Burgundy and Barolo rests primarily on which argument?**

- A) Dão wines are simpler and easier to produce, which reduces cost
- B) Dão remains underpriced relative to quality because international market recognition has not yet caught up to the region's current output — a gap that is closing
- C) Dão's cooperative system keeps production costs low and passes savings to consumers
- D) Dão wines have lower alcohol levels, which reduces taxation and lowers retail pricing in most export markets
