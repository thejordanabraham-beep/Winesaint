...
**Level:** California Mastery — Napa Valley Sub-AVAs
**Module:** 02
**Audience:** Corporate hospitality professionals: servers, sommeliers, floor managers
**Estimated Duration:** 50 minutes
**Prerequisites:** Wine Saint Certified California Mastery Module 01. Napa Valley
...
## Section 1: Rutherford, The Dusty Heart of Napa
...
## Section 2: Oakville, Elegance at the Center
...
- **Opus One**: The historic joint venture between Robert Mondavi and Baron Philippe de Mouton Rothschild. Launched in 1979, Opus One represented the first major statement that Napa could compete with Bordeaux on Bordeaux's own terms. Still benchmarked for blending precision and longevity.
...
## Section 3: Stags Leap District, Iron Fist in a Velvet Glove
...
## Section 4: Howell Mountain, Power, Patience, and Volcanic Stone

### Geography and Soils

Howell Mountain was the first mountain AVA designated in Napa Valley, earning its appellation in 1983. Entirely above 1,400 feet elevation, reaching up to 2,200 feet, it occupies the northeastern extension of the Vaca Range and is defined as much by what it sits above as what it is: the fog line.
...
## Section 5: Diamond Mountain District, Precision in Red Volcanic Soil
...
## Section 6: Mount Veeder and Spring Mountain, The Mayacamas Mountain AVAs
...
## Section 7: Carneros, Napa's Cool-Climate Counterpoint
...
## Section 8: Calistoga, Where the Valley Runs Hot
...
## Floor Application: Matching Guest to AVA

The following scenarios represent the most common guest requests and the correct sub-regional response. These should be automatic.

| Guest Says | Your Answer | Key Producer(s) |
|---|---|---|
| "Most powerful, longest-lived Napa Cab" | Howell Mountain | Dunn Vineyards |
| "Elegant, perfumed Napa Cab" | Oakville | Opus One, Far Niente |
| "Classic Napa Cab, not too heavy" | Stags Leap District | Stag's Leap Wine Cellars |
| "Something I can enjoy tonight" | Stags Leap or Oakville | Stag's Leap SLV, Far Niente |
| "Most famous vineyard in America" | Oakville: To-Kalon | Robert Mondavi Winery |
| "What happened at the 1976 tasting?" | Stag's Leap Wine Cellars (Cab) + Chateau Montelena (Chard) | Both in Napa |
| "I want Pinot or Chardonnay from Napa" | Carneros | Domaine Carneros, Cuvaison |
| "Something with real mineral character" | Diamond Mountain or Howell Mountain | Diamond Creek, Dunn |
...
| Term | Definition |
|---|---|
| **Rutherford Dust** | The distinctive dusty, cocoa-powder tannic texture associated with Rutherford Cabernet Sauvignon, coined by André Tchelistcheff. A textural descriptor, not an aromatic one. |
| **Hardpan** | A dense subsurface soil layer impermeable to roots, found 4–8 feet below Rutherford's surface. Forces lateral root spread and is implicated in Rutherford's distinctive textural complexity. |
| **Volcanic Tufa** | Porous hardened volcanic ash forming Howell Mountain's dominant soil type. Extreme drainage and low fertility; forces tiny yields and concentrated fruit. |
| **Growing Degree Days (GDD)** | A measure of heat accumulation during the growing season. Region I = <2,500 GDD (cool); Region III = 3,000–3,500 GDD (warm). The key metric for matching grape variety to climate. |
| **Judgment of Paris (1976)** | Steven Spurrier's blind tasting in Paris in which California wines defeated French wines. Stag's Leap Wine Cellars 1973 Cabernet beat Bordeaux first growths; Chateau Montelena 1973 Chardonnay beat white Burgundy. |
| **Diurnal Range** | The difference between daytime high and nighttime low temperatures. Wide diurnal range (40–45°F in Rutherford) preserves acidity and aromatic complexity while allowing daytime heat to build ripeness. |
| **To-Kalon Vineyard** | The most celebrated single vineyard in America, located in Oakville. Split between Robert Mondavi Winery and Andy Beckstoffer. A primary source for Opus One and several cult-level Cabernets. |
| **AVA (American Viticultural Area)** | A federally defined wine grape-growing region distinguished by geographic features. Designation requires a petition proving distinctive characteristics; it does not regulate grape varieties or yields (unlike French AOC). |
| **Phenolic Ripeness** | The maturity of grape skins, seeds, and stems, specifically tannins and color pigments, distinct from sugar ripeness. Mountain AVA producers harvest for phenolic ripeness to avoid harsh, green tannins. |
| **Méthode Traditionnelle** | The sparkling wine production method involving secondary fermentation in bottle, as used in Champagne and by Carneros producers like Domaine Carneros and Artesa. |

---

## Module Quiz

*Select the best answer for each question. Correct answers are marked with ✓.*

---

**1. "Rutherford Dust" refers to:**

A) An aroma of mineral earth caused by volcanic soil
B) ✓ A dusty, cocoa-powder tannic texture unique to Rutherford Cabernet
C) The fine topsoil layer that blows across the vineyard during harvest
D) A term for Rutherford's distinctive grey clay soils

---

**2. The hardpan layer in Rutherford soils is significant because it:**

A) Retains water and prevents drought stress
B) Creates a cool microclimate that slows ripening
C) ✓ Forces vine roots to spread laterally rather than vertically, mining a wide area of soil
D) Prevents phylloxera from penetrating the root zone

---

**3. At the 1976 Judgment of Paris, which two California wines defeated their French counterparts?**

A) Opus One Cabernet and Domaine Carneros Chardonnay
B) Caymus Special Selection and Stag's Leap Wine Cellars
C) ✓ Stag's Leap Wine Cellars 1973 Cabernet and Chateau Montelena 1973 Chardonnay
D) Inglenook Cabernet and Far Niente Chardonnay

---

**4. Howell Mountain Cabernet is typically described as:**

A) Silky and perfumed with early accessibility
B) ✓ Dense, monolithic, and unapproachable under 10 years from vintage
C) Light-bodied with bright red fruit and moderate tannin
D) Full-bodied but soft, suitable for immediate drinking

---

**5. Carneros is classified as Region I climate because:**

A) It sits at high elevation above the fog line
B) Its volcanic soils naturally cool the root zone
C) ✓ Cold wind and fog from San Pablo Bay reduce heat accumulation to fewer than 2,500 GDD
D) It is the northernmost AVA in Napa Valley

---

**6. Andy Beckstoffer's significance in Napa Valley is best described as:**

A) The founder of Opus One and pioneer of Bordeaux-blend production
B) ✓ The most powerful independent grape grower, who licenses prestigious vineyard names without producing wine himself
C) The winemaker responsible for identifying Rutherford Dust
D) The originator of the mountain AVA designation system

---

**7. Diamond Creek Vineyards' most notable contribution to Napa wine culture is:**

A) Producing the first Napa wine to be exported to France
B) Establishing Diamond Mountain District's AVA designation
C) ✓ Bottling three distinct soil types. Volcanic Hill, Red Rock Terrace, and Gravelly Meadow, as separate wines from the same estate
D) Creating the first Napa Valley sparkling wine

---

**8. A guest requests "an elegant, perfumed Napa Cabernet with silky tannins." The best sub-regional recommendation is:**
...
**9. Which of the following best describes the climate difference between Calistoga and Carneros?**

A) Calistoga is cooler due to higher elevation; Carneros is warmer due to southern exposure
B) ✓ Calistoga receives minimal marine influence and accumulates the most heat on the valley floor; Carneros sits directly in the path of San Pablo Bay fog and wind
C) Both have similar climates, differing only in soil type
D) Carneros is warmer due to its volcanic soils; Calistoga is moderated by mountain shade

---

**10. Pride Mountain Vineyards is notable because:**

A) It was the first winery established in Napa Valley's mountain AVAs
B) It produces Napa's oldest continuously farmed Zinfandel vines
C) ✓ Its estate straddles the Napa–Sonoma county line, requiring the winery to track and separately label fruit from each county
D) It was founded as the West Coast facility for a French Champagne house

---

**11. The volcanic palisades (cliffs) in the Stags Leap District directly affect wine style by:**

A) Reflecting heat onto the vineyards and accelerating ripening
B) Blocking cold marine air from reaching the eastern valley floor
C) ✓ Casting afternoon shadow over the vineyards, moderating heat and producing softer, more accessible tannins
D) Creating wind channels that reduce humidity and disease pressure

---

**12. Rutherford's "Goldilocks Zone" designation refers to the fact that:**

A) Its soil is a perfect balance of sand, silt, and clay
B) ✓ It sits far enough north to escape cool marine influence but far enough south to avoid Calistoga's extreme heat, achieving optimal temperature balance
C) Its yields are precisely calibrated between too much and too little production
D) It has the perfect combination of morning sun and afternoon shade

---

*End of Module 02. Napa Valley Sub-AVAs*

*Next module: 03-sonoma-county.md. The Other Side of the Mayacamas*