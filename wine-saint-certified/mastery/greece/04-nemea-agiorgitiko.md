...
**Level:** Greece Mastery — Nemea & Agiorgitiko
**Module:** 04
...
## Section 1: A Place Called Nemea, Geography, History, and the Weight of Mythology
...
## Section 2: Altitude as Architecture, How Elevation Divides Nemea into Three Distinct Wine Regions
...
## Section 3: Agiorgitiko, The Grape, the Name, and the Character
...
## Section 4: Agiorgitiko's Versatility, Rosé, Reserve, and the Sweet Wine Tradition
...
## Section 5: The Producers, Domaine Skouras, Gaia Wines, and the Nemea Estate Landscape
...
## Section 6: Agiorgitiko on the Floor, Pairing, Positioning, and the Guest Conversation
...
| Term | Definition |
|------|------------|
| **Agiorgitiko** | The primary indigenous red grape of the Peloponnese, defining Nemea PDO; name translates as "St. George's grape"; characterized by deep ruby color, red and dark fruit, moderate acidity, and medium-firm tannins |
| **Nemea PDO** | Protected Designation of Origin in the northeastern Peloponnese, Corinthia regional unit; requires 100% Agiorgitiko; one of Greece's most important red wine appellations |
| **Nemean Lion** | The monstrous lion of Greek mythology slain by Heracles as his first labor at Nemea; the mythological basis for Agiorgitiko's "Blood of Hercules" designation |
| **Blood of Hercules** | Ancient and modern poetic descriptor for Agiorgitiko, referencing the grape's deep ruby color and the mythological connection between Nemea, Heracles, and the Nemean Lion |
| **Low Nemea** | The valley floor zone below 300 meters elevation; characterized by red clay soils, intense heat, high alcohol, and very ripe, sometimes overworked fruit profiles |
| **Mid-altitude Nemea** | The premium zone between 300 and 600 meters elevation; complex soils (red clay, limestone, sandy loam), meaningful diurnal temperature swing, and the source of Nemea's finest structured red wines |
| **High Nemea / Asprokambos** | The cool, elevated zone between 600 and 900 meters; longer growing season, high natural acidity, lighter-style reds, and the primary source of Nemea's high-quality rosé production |
| **Koutsi** | Village and vineyard area within the mid-altitude premium zone of Nemea; the source of Gaia Wines' benchmark single-vineyard Estate Agiorgitiko |
| **Domaine Skouras** | Pioneer quality estate based in Argos, Peloponnese; founded by George Skouras (Burgundy-trained); flagships include Megas Oenos (Agiorgitiko/Cabernet blend) and Grande Cuvée (pure Agiorgitiko) |
| **Gaia Wines** | Dynamic dual-focus estate producing Agiorgitiko in Nemea and Assyrtiko on Santorini; founded by Yiannis Paraskevopoulos and Leon Karatsalos; known for Estate Agiorgitiko (Koutsi), Notios, and Gaia Assyrtiko |
| **Megas Oenos** | Domaine Skouras's flagship blend of Agiorgitiko and Cabernet Sauvignon; one of the Peloponnese's most recognized internationally styled wines |
| **Notios** | Gaia Wines' accessible, fruit-forward Agiorgitiko range; one of the most commercially successful Greek wines in export markets; designed for early drinking and by-the-glass service |
| **Nemean Games** | One of the four Panhellenic Games of ancient Greece, held at the sanctuary of Zeus in Nemea; among the oldest documented athletic and religious festivals in the Greek world |
| **Diurnal temperature swing** | The difference between daytime high and nighttime low temperature within a 24-hour period; critical in mid-altitude Nemea for achieving phenolic ripeness while preserving acidity and aromatic precision |
| **Nemea Reserve** | The PDO reserve classification for Nemea, requiring additional oak and bottle aging before release; the tier at which Agiorgitiko is most capable of competing with serious international reds |

---

## Quiz: Nemea & Agiorgitiko

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. In which regional unit of the Peloponnese is the Nemea PDO located?**
- A) Achaia
- B) Laconia
- C) Corinthia
- D) Messinia
...
**Q2. What does the name "Agiorgitiko" mean in English?**
- A) The grape of the gods
- B) St. George's grape
- C) The blood of the earth
- D) Hercules' gift
...
**Q3. Which mythological event is the basis for Agiorgitiko's ancient descriptor "the Blood of Hercules"?**
- A) Hercules' battle with the Hydra at Lerna
- B) Hercules' theft of the Mares of Diomedes
- C) Hercules' slaying of the Nemean Lion, his first labor
- D) Hercules' capture of the Cretan Bull

**Correct: C**

---

**Q4. The Nemean Games were one of the four Panhellenic festivals of ancient Greece. Which god were they held in honor of?**
- A) Dionysus
- B) Apollo
- C) Poseidon
- D) Zeus
...
**Q5. At what elevation range is Nemea's premium quality zone: where the best structured red wines are typically produced?**
- A) Below 300 meters
- B) 300–600 meters
- C) 600–900 meters
- D) Above 900 meters
...
**Q6. A guest orders the most expensive Nemea on your list and asks why it costs significantly more than the entry-level Nemea. Which explanation is most accurate?**
- A) The expensive wine is made from a different grape variety with higher market value
- B) The expensive wine uses imported French oak, which is cost-prohibitive for entry-level production
- C) The expensive wine likely comes from higher-elevation vineyards with more complex soils, smaller yields, and additional aging, producing a more structured, age-worthy wine
- D) The expensive wine is a cooperative bottling with greater consistency across vintages

**Correct: C**

---

**Q7. Which of the following best describes the climate and wine style of the High Nemea / Asprokambos zone?**
- A) Hot and dry with very ripe, high-alcohol reds dominated by stewed dark fruit
- B) Cool, with long growing seasons, higher natural acidity, and wines suited to rosé and lighter-style reds
- C) Warm continental with significant rainfall and deeply tannic, full-bodied reds
- D) Identical in character to valley-floor Nemea but with marginally higher elevation

**Correct: B**

---

**Q8. Which two producers are most important to know for building a comprehensive Nemea-focused Greek wine program?**
- A) Boutari and Tsantali
- B) Domaine Skouras and Gaia Wines
- C) Ktima Gerovassiliou and Alpha Estate
- D) Domaine Spiropoulos and Ktima Mercouri

**Correct: B**

---

**Q9. Gaia Wines is described as a "dual-focus estate." What does this mean?**
- A) The estate produces both red and white wines under a single Nemea PDO label
- B) The estate produces both still and sparkling wines from Agiorgitiko at different elevations
- C) The estate produces Agiorgitiko in Nemea and Assyrtiko on Santorini, anchoring both the north and south of Greek wine
- D) The estate operates two separate wineries within the Nemea PDO at different altitude zones

**Correct: C**

---

**Q10. Domaine Skouras's Megas Oenos is best described as:**
- A) A 100% Agiorgitiko reserve, aged for a minimum of 36 months in French oak
- B) A blend of Agiorgitiko and Cabernet Sauvignon, combining Greek variety character with international structure
- C) A high-altitude rosé from Asprokambos, vinified using extended cold maceration
- D) A late-harvest, naturally sweet Agiorgitiko modeled on the Mavrodaphne tradition

**Correct: B**

---

**Q11. How does Agiorgitiko's acidity compare to Xinomavro, and what practical consequence does this have for floor service?**
- A) Agiorgitiko has higher acidity, making it more demanding and better suited to long aging before service
- B) The two varieties have identical acidity profiles, so no practical distinction applies
- C) Agiorgitiko has lower acidity, making it more immediately approachable and the better recommendation for guests new to Greek reds
- D) Agiorgitiko's acidity is unpredictable and varies so much by vintage that no general guidance applies

**Correct: C**

---

**Q12. A guest who normally drinks Malbec asks for a recommendation on a Greek red wine. Which approach is most effective?**
- A) Recommend Xinomavro from Naoussa, emphasizing its similarity to Barolo's tannic structure and austerity
- B) Recommend Agiorgitiko, describing its velvety texture and cherry-dark fruit character as a bridge from Malbec, adding the Hercules mythology as a conversation point
- C) Recommend Mavrodaphne of Patras, explaining that its sweetness will appeal to guests used to ripe New World reds
- D) Explain that Greek reds are too different from Malbec for the guest to enjoy and suggest a Syrah instead

**Correct: B**

---

**Q13. What is the classic and most traditional food pairing for Agiorgitiko in the Peloponnese?**
- A) Grilled octopus with lemon and olive oil
- B) Salted cod (bakaliaros) with garlic sauce
- C) Grilled or roasted lamb
- D) Fried cheese (saganaki) with honey

**Correct: C**

---

**Q14. What characterizes wines from the valley floor of Nemea (below 300 meters)?**
- A) High natural acidity, light color, and floral aromatics best suited to rosé production
- B) Balanced ripeness and structure, the zone producing Nemea's most complex and age-worthy reds
- C) Very high alcohol, deep color, and ripe fruit that can tend toward heaviness when yields are not managed carefully
- D) Elegant, Burgundian-style reds with minimal oak and low tannin

**Correct: C**

---

**Q15. Gaia Wines' benchmark single-vineyard Agiorgitiko: Estate Agiorgitiko, comes from which village area within the Nemea PDO?**
- A) Asprokambos
- B) Koutsi
- C) Argos
- D) Corinth
...
**Q16. Which statement most accurately describes Agiorgitiko's tannin structure?**
- A) Very high tannin with aggressive astringency, requiring at least a decade of aging before the wine is approachable
- B) Virtually no tannin, producing a smooth, Beaujolais-like wine with no aging potential
- C) Medium-firm tannins with a potentially velvety or polished texture when well-made, providing structure without harshness
- D) Unpredictable tannin that varies wildly by producer, making generalizations about the variety impossible

**Correct: C**

---

**Q17. A guest at your table is an experienced Burgundy drinker looking for something unusual. Which Nemea wine style is most likely to intrigue them and why?**
- A) A valley-floor Nemea with very high alcohol and deep extraction, the richness will contrast with Burgundy in an interesting way
- B) A high-altitude Agiorgitiko from Asprokambos, the cooler climate, lighter body, and aromatic lift will offer the structural elegance familiar to a Burgundy palate while being distinctly Greek
- C) A Notios-range Agiorgitiko, the fruit-forward simplicity will demonstrate Greece's accessible side
- D) A Mavrodaphne of Patras, the oxidative sweet style is the most technically sophisticated Greek red and will impress an advanced palate

**Correct: B**

---

**Q18. Which of the following best distinguishes Agiorgitiko from Xinomavro as a floor recommendation?**
- A) Agiorgitiko is exclusively a white wine variety, while Xinomavro produces only reds
- B) Xinomavro is best known for rosé production, while Agiorgitiko produces only structured reserve reds
- C) Agiorgitiko is approachable, fruit-forward, and accessible young; greece's "friendly" noble red; Xinomavro is austere, high-acid, demanding, and more rewarding with age and food
- D) The two varieties are stylistically identical and the distinction has no practical relevance for floor service

**Correct: C**

---

**Q19. Agiorgitiko rosé from the High Nemea / Asprokambos zone is frequently compared to which other rosé region in terms of structural precision and aromatic freshness?**
- A) Tavel, Rhône Valley
- B) Provence, southern France
- C) Navarra, Spain
- D) Cerasuolo d'Abruzzo, Italy

**Correct: B**

---

**Q20. A new sommelier on your team asks you to summarize the most important single fact about Nemea for a guest-facing conversation. Which response is most effective?**
- A) "Nemea is a PDO appellation requiring 100% Agiorgitiko with strict yield controls and minimum alcohol levels that vary by classification tier."
- B) "Nemea is one of the oldest wine regions in Greece, the site of Hercules' first labor in mythology, and the home of Agiorgitiko, a grape the ancient Greeks called the Blood of Hercules because of its deep ruby color. It's Greece's most approachable red wine story."
- C) "Nemea is located in the Corinthia regional unit of the northeastern Peloponnese, between the ancient cities of Corinth and Argos, at latitudes comparable to northern Tuscany."
- D) "Nemea's three altitude zones, below 300 meters, 300–600 meters, and 600–900 meters, each produce materially different wine styles from the same Agiorgitiko grape."
