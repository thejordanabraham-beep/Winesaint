...
**Level:** Greece Mastery — Santorini & Assyrtiko
**Module:** 02
...
## Section 1: The Island at the Edge of the World, Santorini's Geography and Geological Origins
...
## Section 2: The Geology Beneath the Glass, Volcanic Soil, Mineral Character, and Why Terroir Is Not a Metaphor Here
...
## Section 3: Kouloura, Ancient Viticulture Adapted to an Extreme Environment
...
## Section 4: Assyrtiko, The Grape, Its Structure, and Its Developmental Arc
...
## Section 5: Nykteri, Vinsanto, and the Full Range of Santorini's Wine Styles
...
| Term | Definition |
|------|------------|
| Santorini (Thira) | A caldera island in the southern Cyclades, formed by the catastrophic Minoan volcanic eruption (~1600 BCE); Greece's most distinctive white wine appellation and home to the world's most unique volcanic wine terroir |
| Minoan Eruption | One of the largest volcanic eruptions in recorded human history (~1600 BCE), which destroyed the Minoan civilization, created Santorini's caldera, and deposited the volcanic ash and pumice soil that defines the island's viticulture |
| Caldera | The collapsed crater of a volcanic eruption; Santorini's western harbor is a caldera, a body of water several hundred meters deep formed when the volcano's magma chamber emptied and the summit collapsed |
| Aspa | Fine white volcanic ash that constitutes the primary soil component of Santorini's vineyards; extremely porous, free-draining, low in organic matter, and rich in volcanic minerals; the physical reason phylloxera cannot establish on the island |
| Kouloura | The traditional circular basket vine-training system of Santorini; the vine is shaped into a low spiral ring so that grape clusters hang inside the basket, protected from the meltemi wind and shaded from direct sun by the vine canopy |
| Meltemi | A strong, dry northerly wind that blows across the Aegean from approximately May through September; on Santorini, a major viticultural moderating force that reduces temperatures, limits disease pressure, and creates the environmental pressure kouloura was designed to address |
| Phylloxera | A root-feeding louse (*Daktulosphaira vitifoliae*) that devastated European viticulture from the 1860s onward; unable to spread through Santorini's porous volcanic ash, meaning the island's vines have never been grafted onto American rootstock and remain pre-phylloxera survivors on their own roots |
| Assyrtiko | An indigenous white variety endemic to Santorini; characterized by extraordinary natural acidity (7–8 g/l tartaric), saline volcanic mineral character, and exceptional aging potential; now planted across Greece and in small quantities internationally |
| Nykteri | A PDO-regulated Santorini white wine style: minimum 75% Assyrtiko blended with Athiri and Aidani, minimum 13.5% ABV, often partially oak-aged; named for the traditional practice of night (nykta) harvesting to preserve freshness |
| Vinsanto | Santorini's PDO sweet wine; produced from sun-dried grapes (minimum 5 days of desiccation), fermented to high residual sugar, then aged oxidatively in barrel for a minimum of two years; Assyrtiko, Athiri, and Aidani; one of Greece's greatest wines and a historic rival to Sauternes, Tokaji, and Vin Santo of Tuscany |
| TDN (trimethyldihydronaphthalene) | An aromatic compound that develops in high-acid, low-pH wines exposed to UV radiation; responsible for the "petrol" or "waxy" quality that appears in aged Santorini Assyrtiko (and aged Riesling); a marker of genuine aging rather than premature oxidation |
| Kavalieros | Single-vineyard Assyrtiko from Domaine Sigalas; sourced from old-vine material on the island's northern slope; considered the benchmark single-parcel expression of Santorini Assyrtiko and one of Greece's most internationally recognized wines |
| Cuvée Monsignori | Single-vineyard Assyrtiko from Argyros Estate; produced from documented ancient-vine material; among the most age-worthy dry whites in Greece and a prestige anchor for the estate alongside its Vinsanto portfolio |
| Own-rooted vine | A vine that grows on its own root system rather than being grafted onto phylloxera-resistant American rootstock; Santorini is one of the only major wine regions on earth where commercial vines grow ungrafted, due to the volcanic soil's impermeability to phylloxera |

---

## Quiz: Santorini & Assyrtiko

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. The caldera that forms Santorini's western harbor was created by:**
- A) A series of minor earthquakes over thousands of years
- B) The Minoan volcanic eruption, approximately 1600 BCE
- C) The gradual erosion of limestone cliffs by the Aegean Sea
- D) A tsunami originating from the coast of Turkey

**Correct: B**

---

**Q2. The primary soil component of Santorini's vineyards is:**
- A) Clay and loam over granite bedrock
- B) Calcareous limestone with sandy topsoil
- C) Volcanic ash (aspa) and pumice from ancient eruptions
- D) Alluvial gravel deposited by prehistoric river systems

**Correct: C**

---

**Q3. Why are Santorini's vines ungrafted: a rarity among major wine regions?**
- A) Greek law prohibits grafting onto American rootstock
- B) The volcanic ash soil prevents phylloxera from traveling through the ground to infect vine roots
- C) Grafted vines cannot survive the island's extreme heat and wind
- D) The phylloxera epidemic never reached the Cyclades because of the island's remote location

**Correct: B**

---

**Q4. What is the kouloura training system, and why was it developed?**
- A) A vertical trellis system designed to maximize sun exposure during cool vintages
- B) A circular basket vine shape that protects grape clusters from the meltemi wind and preserves moisture from morning dew
- C) An overhead pergola system that shades grapes from excessive UV radiation
- D) A high-wire system that elevates clusters above ground-level frost

**Correct: B**

---

**Q5. The meltemi is best described as:**
- A) A warm, moisture-laden southerly wind that increases disease pressure during flowering
- B) A hot, dry easterly wind that causes early harvest in low-altitude vineyards
- C) A strong, dry northerly wind that cools Santorini through the growing season and intensifies during summer
- D) A periodic rainstorm system from the Ionian Sea that replenishes soil moisture

**Correct: C**

---

**Q6. Which of the following best describes the aromatic profile of a young Santorini Assyrtiko (0–4 years)?**
- A) Ripe peach, vanilla, toasted oak, and butterscotch
- B) Lemon, grapefruit, white flowers, and saline volcanic minerality
- C) Dried apricot, marmalade, honey, and oxidative nuttiness
- D) Blackcurrant, graphite, cedar, and dark spice

**Correct: B**

---

**Q7. The aromatic compound TDN: associated with a "petrol" or "waxy" quality in aged Assyrtiko, is most likely to develop in wines characterized by:**
- A) High pH, low acidity, and significant new oak aging
- B) Neutral soil, moderate alcohol, and cool-climate fruit
- C) High acidity, low pH, and significant UV exposure
- D) Late harvest, botrytis influence, and elevated residual sugar

**Correct: C**

---

**Q8. Under current PDO regulations, Nykteri must include:**
- A) 100% Assyrtiko, harvested at night, with no oak aging permitted
- B) At least 75% Assyrtiko, blended with Athiri and Aidani, at a minimum of 13.5% ABV
- C) Equal proportions of Assyrtiko, Athiri, and Aidani, barrel-aged for at least 12 months
- D) At least 85% Aidani with Assyrtiko and Athiri as permitted additions

**Correct: B**

---

**Q9. Vinsanto's production involves:**
- A) Cryoextraction of frozen grapes, followed by slow fermentation and stainless steel aging
- B) Botrytis-affected grapes harvested at late maturity and fermented in new French oak
- C) Sun-drying of harvested grapes for a minimum of five days, followed by fermentation and oxidative barrel aging
- D) Partial fermentation of fresh grapes with the addition of neutral grape spirit to arrest fermentation

**Correct: C**

---

**Q10. Which producer is most strongly associated with establishing the international benchmark for dry Santorini Assyrtiko?**
- A) Argyros Estate
- B) Santo Wines
- C) Gavalas
- D) Domaine Sigalas
...
**Q11. Argyros Estate's 30-year Vinsanto is most accurately compared to which other wines in terms of complexity and aging potential?**
- A) Barolo Riserva and aged Rioja Gran Reserva
- B) Vin de Constance and Tokaji Eszencia
- C) Vintage Champagne and aged Chenin Blanc from Vouvray
- D) Pedro Ximénez Sherry and aged Banyuls

**Correct: B**

---

**Q12. What is the significance of vine age in Santorini's vineyards?**
- A) Older vines produce higher yields, improving the economics of production for small estates
- B) Greek appellation law requires minimum vine age of 50 years for PDO Santorini classification
- C) Older vines produce dramatically less fruit per plant, concentrating flavor, mineral character, and structural intensity
- D) Vine age primarily affects color and is relevant mainly for red wine production

**Correct: C**

---

**Q13. A guest at your table orders the Kavalieros from Domaine Sigalas. Which response best demonstrates accurate producer knowledge?**
- A) "That's from the Argyros family, they've been on the island for generations and are the prestige Vinsanto producer."
- B) "Kavalieros is a single-vineyard Assyrtiko from Domaine Sigalas; paris Sigalas is a mathematician who essentially put Santorini on the international map in the 1990s. It's considered one of Greece's finest white wines."
- C) "That's from Santo Wines, they're the cooperative and the most historically significant producer on the island."
- D) "Kavalieros is the Nykteri blend from Sigalas, it's aged in oak to give it more texture than their standard dry Assyrtiko."

**Correct: B**

---

**Q14. A guest who regularly orders Sauternes mentions they are curious about trying something different at the end of the meal. Which Santorini wine would you recommend, and what is your key selling point?**
- A) Classic unoaked Assyrtiko, "It has similar botrytis character to Sauternes but with less residual sugar."
- B) Nykteri, "It's a rich, barrel-aged white that matches the weight and sweetness of Sauternes."
- C) Vinsanto ("It's made from sun-dried grapes, similar in concept to Sauternes, but with higher acidity and a volcanic mineral character that makes it genuinely distinct) the aged Argyros is exceptional."
- D) Reserve Assyrtiko, "It's sweet but not as intense as Sauternes, which makes it a more accessible after-dinner option."

**Correct: C**

---

**Q15. What makes Santorini one of the only major wine regions where commercial vines grow on their own roots?**
- A) The island's extreme isolation prevented American rootstock from being imported after the phylloxera epidemic
- B) The volcanic ash soil is too porous and granular for phylloxera to travel through and infect vine roots
- C) Greek agricultural law designated Santorini a protected heritage zone where grafting is prohibited
- D) The island's vines are a different species from mainland Greek vines and are naturally resistant to phylloxera

**Correct: B**

---

**Q16. How does aged Santorini Assyrtiko differ from the same wine in its youth?**
- A) It loses all acidity with time and becomes flabby, best consumed within two to three years of vintage
- B) It develops oxidative, sherry-like notes due to the lack of sulfur used during production
- C) It transforms from citrus-primary to complex tertiary aromas, lanolin, honey, dried citrus peel, and petrol, while retaining its saline volcanic mineral core
- D) It gains sweetness over time as the residual sugar from incomplete fermentation re-emerges

**Correct: C**

---

**Q17. Santo Wines is best positioned on the floor as:**
- A) The prestige single-vineyard producer with the island's most expensive allocation wines
- B) A traditional family estate that predates the modern quality revolution by multiple generations
- C) An accessible, consistent cooperative-produced entry point that builds island-wide awareness, not the prestige reference
- D) The exclusive producer of Nykteri under the PDO's original cooperative charter

**Correct: C**

---

**Q18. Which of the following most accurately explains why Santorini Assyrtiko has such high natural acidity despite being grown in a warm Mediterranean climate?**
- A) The variety is genetically programmed to produce high acidity regardless of climate, similar to Riesling
- B) Volcanic soil limits water availability and stresses the vine metabolically, while the meltemi cools the island through summer, moderating sugar accumulation without reducing phenolic ripeness
- C) Santorini's high elevation above sea level creates cool growing conditions equivalent to northern Europe
- D) The high salinity of the soil inhibits malolactic fermentation, preserving malic acid in the finished wine

**Correct: B**

---

**Q19. A guest unfamiliar with Greek wine asks what makes Santorini Assyrtiko different from Chablis. What is the most accurate and compelling response?**
- A) "They're essentially the same wine, both high-acid, both mineral, both unoaked. Santorini is just less expensive."
- B) "Chablis is made from Chardonnay on chalk, so it's creamy and rich; Assyrtiko is more acidic and fruity with almost no mineral character."
- C) "Both are mineral and high-acid, but the mineral character is fundamentally different; chablis reads as chalky and oyster shell, while Santorini is saline and volcanic. And Assyrtiko ages in a completely different direction, developing petrol and lanolin rather than Burgundian butter and hazelnut."
- D) "Chablis is always barrel-aged; Santorini is always made in stainless steel, which is why it tastes fresher and more fruit-forward."

**Correct: C**

---

**Q20. Which single word or phrase, used to describe Santorini Assyrtiko on the floor, is most likely to create immediate guest intrigue and differentiate it from all other white wines on a list?**
- A) "Crisp"
- B) "The world's most unique volcanic wine terroir"
- C) "Similar to Sauvignon Blanc but with more body"
- D) "One of Greece's more approachable indigenous whites"
