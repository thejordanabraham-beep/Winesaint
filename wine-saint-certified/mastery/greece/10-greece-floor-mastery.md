...
## Section 1: Reading a Greek Wine List
...
Greek PDO and PGI designations follow the EU classification introduced in 2009, which replaced the older OPAP/OPE/TOAP hierarchy. When you see a PDO (Protected Designation of Origin) on a Greek bottle, you are looking at the equivalent of what used to be called OPAP (for dry wines) or OPE (for naturally sweet wines from sun-dried grapes). The PDO guarantees origin, permitted varieties, and production method (it is the same structural guarantee as a French AOC or Italian DOC. PGI (Protected Geographical Indication) is broader) these are regional wines with more flexibility in variety and style.
...
## Section 2: Greek Wine and Food Pairing
...
## Section 3: Selling Greek Wine with Authority
...
## Section 5: Greek Wine Service Standards
...
1. **Seafood-dominant table:** Assyrtiko over Chablis, Sancerre, Albariño, the volcanic mineral-salt combination is uniquely suited.
2. **Lamb as main:** Xinomavro is one of the great lamb pairings in the world. If you have a serious bottle, recommend it without hesitation.
3. **Guest wants discovery:** Greek wine is the most underdiscovered serious wine program on any well-curated list.
4. **Budget-to-quality ratio:** Quality Greek wine at the $60–90 bottle tier routinely outperforms French and Italian equivalents at the same price, make this case when the guest is price-conscious but quality-driven.
5. **Vegetarian table with complex dishes:** Xinomavro's savory, umami-forward character and Agiorgitiko's suppleness both work exceptionally well with mushroom, eggplant, and legume-based preparations that challenge many red wines.
...
## Section 6: Mastery Synthesis, The Overarching Narrative of Greek Wine
...
| Term | Definition |
|------|------------|
| PDO (Protected Designation of Origin) | EU wine classification equivalent to the former Greek OPAP and OPE designations; guarantees geographic origin, permitted varieties, and production methods for Greek wine |
| PGI (Protected Geographical Indication) | Broader EU classification allowing more varietal and stylistic flexibility than PDO; many of Greece's most innovative wines carry this designation |
| Kouloura | The basket-trained, self-supporting vine-training system traditional to Santorini, in which vines are shaped into circular spirals hugging the ground to protect against wind and retain moisture on the volcanic island |
| Ungrafted vines | Vines growing on their original rootstock, not grafted onto phylloxera-resistant American rootstock; Santorini's volcanic, sandy soils prevented phylloxera infestation, preserving some of the oldest ungrafted Vitis vinifera plantings in the world |
| Phylloxera | The root louse *Daktulosphaira vitifoliae* that devastated European viticulture in the 19th century; its inability to survive in Santorini's volcanic soils is the reason the island's Assyrtiko vines remain ungrafted |
| Assyrtiko | Greece's most internationally recognized indigenous white variety; native to Santorini, now grown across Greece; characterized by high acidity, volcanic minerality, salinity, and exceptional aging potential |
| Xinomavro | Greece's most structurally serious indigenous red variety; native to northern Macedonia; high acid, high tannin, with aromatic complexity (dried rose, tobacco, olive) comparable to Barolo; requires aging |
| Agiorgitiko | Major indigenous red of the Peloponnese, centered in Nemea PDO; supple tannin, dark fruit, Mediterranean spice; the more approachable and food-friendly of Greece's two great red varieties |
| Moschofilero | Pink-skinned aromatic white variety of Mantinia PDO (central Peloponnese); grown at high altitude (~650m); known for rose petal, jasmine, and citrus aromatics with naturally low alcohol |
| Malagousia | Near-extinct white variety rescued by Gerovassiliou in the 1990s; aromatic, medium-bodied, tropical and floral; benchmark producer is Domaine Gerovassiliou in Epanomi, Macedonia |
| Vinsanto | Santorini's naturally sweet wine made from sun-dried Assyrtiko (and sometimes Aidani and Athiri); high residual sugar balanced by Assyrtiko's structural acidity; some commercial releases have extraordinary aging histories |
| Naoussa PDO | Greece's premier red wine appellation in the Imathia region of Macedonia; produces exclusively Xinomavro-based dry reds under strict production regulations |
| Nemea PDO | Major red wine PDO in the northern Peloponnese; produces exclusively Agiorgitiko-based dry reds; the most widely planted PDO for Greek red wine |
| Terroir expression | The ensemble of geological, climatic, and topographic factors that give a wine its irreducible sense of place; Greek wine's case for terroir expression rests on volcanic soils, extreme island microclimates, and varieties that grow nowhere else on earth |
| Flavor bridge | The service technique of connecting an unfamiliar wine to a variety or wine the guest already knows via a shared structural or aromatic characteristic (e.g., "Assyrtiko has the same mineral acidity as Chablis") |

---

## Quiz: Greece Floor Mastery

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. A guest at a seafood-focused table asks for your white wine recommendation. The list includes Assyrtiko from Santorini, Sauvignon Blanc from the Loire, Albariño from Rías Baixas, and Chablis Premier Cru. Which wine is the objectively strongest pairing argument and why?**

- A) Chablis Premier Cru, because Chardonnay's butter notes complement shellfish
- B) Assyrtiko from Santorini, because volcanic minerality and sea-salt character align naturally with Aegean seafood
- C) Albariño from Rías Baixas, because it is the most widely recognized seafood pairing in hospitality
- D) Sauvignon Blanc from the Loire, because its herbaceous character refreshes palate between courses

**Correct: B**

---

**Q2. A guest says, "I only drink Sauvignon Blanc: I don't see any on the list." Using the flavor bridge technique, what is the most effective response?**

- A) Apologize that Sauvignon Blanc is not available and offer a Chardonnay as the closest alternative
- B) Recommend Moschofilero because it is light and white
- C) Recommend Assyrtiko, framing it around shared structural characteristics, high acidity, citrus-mineral profile, while flagging what makes it distinctive
- D) Recommend Malagousia because it has tropical fruit notes similar to New Zealand Sauvignon Blanc

**Correct: C**

---

**Q3. A guest orders braised lamb shoulder. The list includes both a young Xinomavro from Naoussa (current vintage) and a mid-weight Agiorgitiko PDO (3 years old). The guest says they prefer "structured reds with good acidity." Which wine do you recommend and what service note is most important?**

- A) Agiorgitiko; serve at 18°C and no decanting needed
- B) Xinomavro; recommend decanting for at least 45 minutes given its young tannic structure
- C) Xinomavro; serve immediately without decanting to preserve primary fruit
- D) Agiorgitiko; decant for 2 hours to soften the tannins

**Correct: B**

---

**Q4. Which of the following correctly distinguishes PDO from PGI on a Greek wine label?**

- A) PDO wines are always more expensive and higher quality than PGI wines
- B) PDO guarantees geographic origin, permitted varieties, and production methods; PGI is broader and allows more flexibility, and many innovative Greek wines carry PGI status
- C) PGI is the higher classification, equivalent to the old OPAP designation, and PDO is a broader regional designation
- D) PDO applies only to white wines; PGI applies to red and rosé wines

**Correct: B**

---

**Q5. Why are Santorini's Assyrtiko vines ungrafted, and what does this mean for the wine's character?**

- A) Greek winemakers chose not to use American rootstock as a matter of tradition, which affects yields but not wine character
- B) Phylloxera was eradicated in Santorini in the early 20th century, so grafting became unnecessary
- C) Santorini's volcanic, dry, sandy soils are hostile to phylloxera, so the pest never established there; the vines grow on their own roots and some exceed 200 years in age, contributing to concentration and mineral complexity
- D) Ungrafted vines are standard practice across all Greek wine regions because phylloxera never reached Greece

**Correct: C**

---

**Q6. A guest is considering two bottles: a Naoussa Xinomavro from 2012 and a Nemea Agiorgitiko reserve from 2021. They ask which is "more ready to drink tonight." What is the correct professional response?**

- A) The 2021 Agiorgitiko; newer vintages are always more accessible
- B) The 2012 Xinomavro; Xinomavro ages quickly and 12 years is its peak drinking window
- C) The 2021 Agiorgitiko reserve is likely more approachable tonight; the 2012 Xinomavro has reached a stage of tertiary complexity, dried rose, tobacco, leather, that is compelling but more demanding; recommend the Xinomavro if the guest wants something revelatory, the Agiorgitiko if they want something immediately gratifying
- D) Both wines are equivalent in readiness; vintage year is not a reliable guide with Greek wines

**Correct: C**

---

**Q7. What is the correct serving temperature range for a barrel-fermented Assyrtiko from Santorini?**

- A) 6–8°C (43–46°F) to preserve freshness and acidity
- B) 12–14°C (54–57°F) to allow the oak and mineral complexity to express without suppressing aromatics
- C) 16–18°C (61–64°F), the same as a full-bodied white Burgundy
- D) 8–10°C (46–50°F), the same as a standard light white wine

**Correct: B**

---

**Q8. A guest from Athens orders a bottle of Naoussa and watches as you approach the table. They mention a small producer you have never heard of. What is the best professional response?**

- A) Pretend familiarity and change the subject to the wine you have in hand
- B) Acknowledge that you are not familiar with that producer, ask which region they come from, and express genuine interest in learning more
- C) Explain that small Greek producers are often unreliable and redirect the conversation to the wines on your list
- D) Tell the guest that Naoussa wines are all similar in style regardless of producer

**Correct: B**

---

**Q9. Which pairing is the most defensible match for grilled octopus with capers and olive oil?**

- A) Xinomavro from Naoussa, the high tannin cuts through the fat of the olive oil
- B) Malagousia, the tropical aromatic character echoes the char on the octopus
- C) Assyrtiko from Santorini, the high acidity and mineral salinity complement brine and char while cutting through olive oil
- D) Agiorgitiko rosé, the light red fruit profile pairs with lighter seafood preparations

**Correct: C**

---

**Q10. What was Malagousia's status in the early 1990s, and who is primarily credited with its rescue?**

- A) It was widely planted across northern Greece and was being exported to France and Germany
- B) It was on the verge of extinction, surviving in only a handful of neglected plots; it was rescued and championed by Evangelos Gerovassiliou, whose estate in Epanomi remains the benchmark producer
- C) It was a commercially successful variety in Attica that was temporarily banned from production due to overplanting
- D) It had been deliberately discontinued in favor of international varieties and was reintroduced by the Greek government in 2005

**Correct: B**

---

**Q11. A guest on a modest budget asks for a recommendation. The Greek section of the list has a Moschofilero at $14/glass and an entry-level Assyrtiko at $16/glass. The guest is having a light seafood appetizer. What do you recommend and how do you frame it?**

- A) Recommend the Assyrtiko at the slightly higher price because Santorini wines always outperform at any price point
- B) Recommend the Moschofilero by leading with its flavor profile and value, aromatic, light, jasmine and white peach, framing it as a genuine recommendation, not a compromise
- C) Tell the guest there are no great options at that price point and suggest they consider the premium Santorini bottle instead
- D) Recommend the house white because it is the most predictable option

**Correct: B**

---

**Q12. Compare and contrast Xinomavro and Agiorgitiko as they relate to tannin structure and food pairing.**

- A) Both have soft tannins and pair equally well with any red-meat dish regardless of preparation method
- B) Xinomavro has high, firm tannins and high acidity (best with braised lamb, tomato-based preparations, and aged cheeses; Agiorgitiko has supple tannins and medium acidity) more versatile, works with grilled meats, mezze, and lighter preparations
- C) Agiorgitiko has firmer tannins than Xinomavro and requires longer aging before food pairing is appropriate
- D) Both are high-tannin wines, but Agiorgitiko is distinguished by herbal rather than fruit-forward character

**Correct: B**

---

**Q13. The kouloura vine-training system in Santorini serves what primary viticultural purpose?**

- A) It maximizes sun exposure to the grape clusters to increase sugar levels and alcohol
- B) It trains vines vertically to improve airflow and reduce fungal disease in the humid island climate
- C) It shapes vines into low, basket-like spirals to protect grapes from the Meltemi winds and retain moisture in the volcanic, rainless soils
- D) It is a decorative tradition with no functional viticultural benefit in the modern era

**Correct: C**

---

**Q14. A guest asks whether the 2013 Hatzidakis Assyrtiko on your list is "too old." What is the correct response?**

- A) Agree and suggest a more recent vintage instead
- B) Explain that Assyrtiko from Santorini, particularly barrel-aged expressions, has an aging window of 8–15+ years, the 2013 is at an ideal point of maturity, with complex mineral and honeyed notes developing alongside the wine's structural acidity
- C) Explain that all white wines should be consumed within 3 years and offer a current-vintage alternative
- D) Tell the guest that Assyrtiko does not age and the wine may be oxidized

**Correct: B**

---

**Q15. A table orders a wide range of dishes: grilled fish, lamb chops, mezze, and a cheese course with aged graviera. They ask for one white and one red to carry them through the meal. What is the most professional recommendation?**

- A) A light Pinot Grigio for the white and a Chianti for the red, familiar choices that accommodate the range
- B) A barrel-fermented Assyrtiko for the white (structural enough for the fish and cheese, and a through-line of minerality throughout the meal) and a reserve Agiorgitiko for the red (supple enough for the mezze, substantial enough for the lamb)
- C) A Moschofilero for the white and a Xinomavro for the red, the contrast between light and heavy gives the meal variety
- D) One Greek white and one French red; greek reds are not yet sophisticated enough for a full meal pairing

**Correct: B**

---

**Q16. Which Greek wine is described in this program as performing the role of Viognier within the Greek white variety catalog: aromatic, textured, and richly aromatic without high acidity?**
...
**Q17. Which of the following statements about Greek wine's position in a corporate hospitality context is accurate?**

- A) Greek wine is appropriate only for casual dining contexts and does not belong on formal corporate menus
- B) Greek wine offers a price-to-quality ratio that outperforms many mid-tier French and Italian wines at equivalent purchase cost, while also providing a discovery narrative that elevates the guest experience
- C) Greek wine requires extensive guest education before it can be recommended in a professional hospitality setting
- D) Greek wine is primarily recommended for guests of Greek heritage and may alienate other guests

**Correct: B**

---

**Q18. A guest at a business dinner asks for "something impressive" to order for the table. You have a 2011 Kir-Yianni Xinomavro and a 2020 Sigalas Barrel Assyrtiko on the list. The table is ordering both fish and meat. What is the most professional approach?**

- A) Recommend only the Assyrtiko because white wine is universally preferred at business dinners
- B) Recommend the Xinomavro for the whole table because aged reds signal prestige
- C) Recommend both: the Sigalas Barrel Assyrtiko to accompany the fish courses, framing it as one of Greece's benchmark whites from volcanic soil; and the 2011 Kir-Yianni Xinomavro with the meat, noting its 13 years of bottle age and tertiary complexity, then decant the Xinomavro tableside
- D) Recommend a French wine instead because it carries more prestige in a corporate setting

**Correct: C**

---

**Q19. What is the defining professional difference between "delivering information" and "providing hospitality" when recommending Greek wine?**

- A) Information delivery is appropriate for sommeliers; hospitality delivery is appropriate for servers
- B) Providing hospitality means making a single confident recommendation with a brief, specific explanation, inviting the guest into an experience rather than presenting a list of options and asking them to decide
- C) Information delivery includes facts about the winery; hospitality means avoiding technical detail entirely to keep the guest comfortable
- D) There is no practical difference, any recommendation that is factually accurate constitutes hospitality

**Correct: B**

---

**Q20. Which of the following best describes the overarching argument for Greek wine that a floor professional should be able to articulate in 60 seconds or less?**

- A) Greece makes wine in the French style at lower prices, offering equivalent quality for budget-conscious guests
- B) Greece produces international varieties such as Cabernet and Chardonnay alongside local grapes, providing familiar options for guests who prefer known styles
- C) Greek wine is the product of one of the world's oldest wine cultures, volcanic and extreme terroir, ungrafted ancient vines, and over 300 indigenous varieties that grow nowhere else on earth, wines that cannot be replicated and represent a genuine discovery experience at any price point
- D) Greek wine is primarily valuable for its food pairing versatility with Mediterranean cuisine, but less compelling outside that context
