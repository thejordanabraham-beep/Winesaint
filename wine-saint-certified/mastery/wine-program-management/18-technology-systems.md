...
**Level:** Wine Program Management Mastery — Technology & Systems
**Module:** 18
...
**Prerequisites:** Wine Saint Certified Level 2 or equivalent; Modules 1–17 recommended
...
## Section 1: The Modern Wine Program Tech Stack — What You Actually Need
...
## Section 2: POS Integration — Wine Sales Data, Variance Tracking, and Reporting
...
## Section 3: Inventory Management Software — Bevager, BlueCart, MarketMan, and Manual Systems
...
## Section 4: Digital Wine Lists — Tablets, QR Codes, Wine Apps, and Guest Accessibility
...
## Section 5: Wine Preservation Technology — Coravin, Nitrogen Systems, Cruvinet
...
## Section 6: Data-Driven Program Management — Using Your Numbers to Make Better Decisions
...
**POS (Point of Sale) System** — The transactional software platform that records all sales, voids, comps, and payment activity. The primary source of theoretical depletion data for wine variance tracking.

**Theoretical Depletion** — The quantity of wine that should have been consumed based on recorded POS sales, calculated from item counts, BTG pour sizes, and modifier structures.

**Actual Depletion** — The quantity of wine physically depleted between two inventory counts, calculated from opening count plus received stock minus closing count.

**Variance** — The difference between theoretical and actual depletion, expressed as a percentage or absolute quantity. Variance above 10–15% on any SKU warrants investigation.

**Bevager** — A beverage-specific inventory management platform offering mobile count workflows, POS integration, and multi-unit reporting dashboards for corporate restaurant groups.

**BlueCart** — A purchasing and order management platform focused on streamlining distributor ordering, delivery confirmation, and receiving discrepancy tracking across multiple locations.

**MarketMan** — An inventory and purchasing platform covering both food and beverage programs, with strong recipe-costing integration for unified COGS reporting at the group level.

**Coravin** — A wine preservation device that extracts wine through a needle inserted through the cork while replacing volume with argon gas, allowing bottles to remain intact and preserved for weeks to months.

**Cruvinet** — A multi-bottle wine dispensing system that maintains bottles at controlled temperature under continuous inert gas protection, with dedicated dispense taps for high-volume BTG service.

**Nitrogen Blanketing** — A preservation technique using inert nitrogen or nitrogen/argon gas to displace oxygen in an open bottle, extending shelf life by 3–7 days for active BTG service environments.

**QR Code Menu** — A digital menu format accessed by scanning a printed QR code with a smartphone, allowing real-time content updates without reprinting costs.

**Tablet Menu** — An iPad or tablet-based wine list displaying rich content including tasting notes, producer profiles, and pairing suggestions directly at the table.

**Inventory Turnover** — The ratio of annual cost of goods sold to average inventory value, indicating how efficiently a program converts inventory capital into revenue.

**Technology ROI (Return on Investment)** — The financial return generated by a technology investment, calculated by comparing measurable benefits (time saved, revenue recovered, losses prevented) against total platform cost including implementation and ongoing maintenance.

**Data Reporting Cadence** — The structured schedule of daily exception monitoring, weekly operational review, and monthly strategic analysis that converts raw operational data into consistent management decisions.

---

## Quiz — Module 18

**1.** Which of the following best describes the primary purpose of a beverage program technology stack?

A) To replace the need for trained sommeliers with automated systems
B) To generate data that creates better information, less friction, and more time for guest-facing work
C) To satisfy corporate reporting requirements with minimal operator involvement
D) To eliminate the need for physical inventory counts

**Correct: B**

---

**2.** A beverage director notices that the POS tracks all BTG wine sales as "Glass of Red" or "Glass of White" rather than by individual SKU. What is the most significant operational consequence of this configuration?

A) Guests will be unable to use QR code menus effectively
B) Theoretical depletion calculations will be inaccurate, making variance tracking meaningless
C) Inventory management software will be unable to connect to the POS
D) Staff will not be able to process split-bottle orders

**Correct: B**

---

**3.** A server's BTG wine void transactions are consistently higher than the rest of the floor staff, concentrated in the middle of service rather than during setup. This pattern most likely indicates:

A) A POS configuration error that should be reported to the tech support team
B) The server is particularly diligent about correcting order mistakes before they close out
C) A potential transaction-level fraud pattern involving unrecorded cash collection
D) Normal operational variance within acceptable thresholds for a high-volume BTG program

**Correct: C**

---

**4.** Theoretical depletion shows 2.4 bottles of Malbec used in a week based on POS sales. Physical counts show 3.5 bottles depleted. What is the variance percentage, and is it within normal acceptable range?

A) 46% variance — above normal acceptable thresholds and warrants investigation
B) 10% variance — within normal acceptable thresholds
C) 20% variance — within normal acceptable thresholds for high-velocity BTG programs
D) 100% variance — requires immediate escalation to ownership

**Correct: A**

---

**5.** Which inventory management platform is best known for its multi-distributor order consolidation and delivery discrepancy tracking functionality?
...
**6.** A corporate beverage director managing 8 restaurant locations is evaluating inventory management software. Which capability should receive the most weight in the evaluation?

A) The visual design of the mobile count interface
B) Multi-unit reporting that aggregates variance and purchasing data across all locations in a single dashboard
C) Integration with the Vivino wine rating API for guest-facing list features
D) The ability to generate custom cocktail recipe cost cards alongside wine inventory

**Correct: B**

---

**7.** When is a manual spreadsheet-based inventory system most likely to remain a viable choice?

A) In any operation where the beverage director prefers not to learn new software
B) In a multi-unit corporate group where standardization across locations is a stated priority
C) In a single-unit operation with fewer than 80 SKUs and a committed, consistent operator maintaining the system
D) In any operation where the POS system does not support third-party software integration

**Correct: C**

---

**8.** Which statement about Coravin is accurate?

A) Coravin works with all wine closures including screw caps and synthetic corks
B) Coravin replaces extracted wine with pressurized nitrogen gas to prevent oxidation
C) Coravin inserts a needle through the cork and replaces extracted wine with argon gas, leaving the cork structurally intact
D) Coravin is most cost-effective for high-velocity, low-price BTG programs where bottles turn over daily

**Correct: C**

---

**9.** A hotel bar is evaluating whether to install a Cruvinet dispenser system at a capital cost of $14,000. Which factor most strongly justifies this investment?

A) The beverage director prefers the visual aesthetic of a dispenser system over standard bottle service
B) The program pours a minimum of 15–20 BTG glasses per day across the installed wines and the service environment supports the equipment footprint
C) The hotel has several bottles sealed with natural cork closures that are incompatible with nitrogen blanketing
D) The operation uses QR code menus that need a physical wine program anchor point at the bar

**Correct: B**

---

**10.** What is the most significant limitation of a QR code wine menu that links to a PDF of the printed list?

A) QR menus are incompatible with most major smartphone operating systems in current use
B) The QR code must be reprinted every time the menu content changes
C) A PDF behaves as a static document image, not an interactive digital list, and does not deliver the update or searchability benefits of a true digital menu platform
D) PDF menus create automatic ADA liability under federal accessibility law

**Correct: C**

---

**11.** What is the most effective reporting cadence for catching BTG variance before it compounds into a significant monthly loss?

A) Annual variance review during the year-end financial audit
B) Weekly variance review by SKU, supplemented by daily exception alerts above a defined threshold
C) Monthly variance review timed to coincide with distributor invoice reconciliation
D) Real-time variance monitoring by floor managers during each service period

**Correct: B**

---

**12.** Nitrogen blanketing preservation is most appropriate for which use case?

A) Bottles expected to remain open and unsold for 3–4 weeks in a low-volume reserve program
B) High-value bottles sealed with natural cork in a slow-moving BTG program
C) Active BTG service where most bottles are depleted within 1–2 services
D) Bottles sealed with synthetic corks that are incompatible with argon-based systems

**Correct: C**

---

**13.** A multi-unit corporate restaurant group uses three different inventory platforms across its eight locations. What is the primary operational risk of this fragmentation?

A) Individual unit managers will be unable to access their own inventory data without corporate approval
B) Distributor relationships will be weakened by inconsistent ordering formats across locations
C) Cross-location variance comparison and performance benchmarking become unreliable because measurements are not standardized
D) The corporate finance team will be required to maintain fluency in multiple software interfaces simultaneously

**Correct: C**

---

**14.** When evaluating a new inventory software platform, the vendor cannot provide data on average time customers spend completing a physical inventory count before and after implementation. What does this most likely indicate?

A) The platform is too new to have accumulated meaningful usage data from real customers
B) The vendor's customers are subject to confidentiality agreements that prevent sharing performance metrics
C) Real adoption data does not support the time-savings claims made in the sales presentation
D) The platform is designed primarily for food operations and does not track beverage count efficiency separately

**Correct: C**

---

**15.** A beverage director builds a weekly reporting dashboard for all unit managers in a corporate group. Which design principle is most critical for ensuring the dashboard actually gets used?

A) The dashboard should include every available metric from the POS and inventory platform to ensure nothing is omitted
B) The dashboard should be simple enough that any manager — including those without wine expertise — can read it in under five minutes
C) The dashboard should be formatted as a detailed multi-tab spreadsheet to preserve data integrity and auditability
D) The dashboard should be accessible only to the corporate beverage director to prevent misinterpretation by unit managers

**Correct: B**

---

**16.** Which digital wine list format is most appropriate for a high-volume casual dining concept focused on quick table turns?

A) A full tablet menu with integrated producer profiles, vineyard photography, and tasting notes
B) A custom wine app requiring download from the App Store before ordering
C) A simplified physical list supplemented by a QR code linking to the reserve section
D) A Cruvinet dispenser menu displayed at the bar with no table-level wine list

**Correct: C**

---

**17.** A beverage director completes a 30-day preservation audit and finds that 92% of BTG bottles are fully depleted within a single service. What does this data suggest about Coravin investment?

A) Coravin is urgently needed because the program's velocity is putting strain on staff service speed
B) The BTG velocity is already high enough that preservation loss is minimal, and Coravin investment may not address a meaningful revenue leak in this operation
C) The program should immediately upgrade to a Cruvinet system to support the high-volume output
D) Nitrogen blanketing should be discontinued because the data shows it is slowing depletion rates

**Correct: B**

---

**18.** Which description best defines the "theoretical versus actual" variance analysis used in wine program management?

A) Comparing this year's wine sales revenue against last year's revenue to identify program growth trends
B) Comparing the beverage director's proposed wine list against the version approved after ownership review
C) Comparing what the POS records as sold against what physical counts show as depleted, to isolate over-pouring, theft, waste, or counting error
D) Comparing wine costs across different distributors to identify the best theoretical pricing available in the market

**Correct: C**

---

**19.** A corporate beverage director requires all unit managers to submit weekly BTG variance reports every Monday. Two locations consistently submit late or incomplete reports. What is the correct characterization of this situation?

A) The variance data from those locations is still usable because the information arrives eventually and can be incorporated into monthly analysis
B) Late reporting is an acceptable operational trade-off at locations with lower total wine revenue contribution to the group
C) The reporting cadence has failed at those locations — without standardized, timely data, cross-location comparison and early variance detection are both compromised
D) The corporate beverage director should reduce the group's reporting frequency to monthly to improve overall compliance rates

**Correct: C**

---

**20.** A beverage director is preparing a technology ROI analysis for ownership. A new inventory platform costs $2,800 per year and reduces the time spent on inventory counting and purchasing administration by 6 hours per week across the operation. At a fully loaded manager labor rate of $28 per hour, what is the approximate annual labor savings, and does the platform generate positive ROI?

A) $8,736 in annual labor savings — positive ROI of approximately $5,936
B) $4,200 in annual labor savings — positive ROI of approximately $1,400
C) $2,800 in annual labor savings — break-even with no positive ROI
D) $1,680 in annual labor savings — negative ROI, platform costs more than it saves

**Correct: A**

*6 hours/week × $28/hour × 52 weeks = $8,736 annual labor savings. Net ROI = $8,736 − $2,800 = $5,936.*
