...
**Level:** Wine Program Management — Program Vision & Identity
**Module:** 2
...
## Section 1: What Is a Beverage Program Identity?
...
Consider what coherence looks like in practice. At the three-Michelin-star level, programs like those at Eleven Madison Park under the late wine direction of John Ragan or Manresa under Rajat Parr operated from explicit philosophical positions — a preference for restraint, for terroir-driven wines, for producers working in harmony with the land. The lists were large, but they were curated from a consistent worldview. Every producer on the list could be explained by the same set of principles. That is what makes a list a program.
...
## Section 2: Aligning with the Restaurant's Identity
...
## Section 3: Defining Your Program's Personality
...
## Section 4: Writing a Beverage Philosophy
...
## Section 5: Communicating Identity to Guests
...
## Section 6: Evolving the Program Without Losing Its Identity
...
| Term | Definition |
|------|------------|
| Beverage Program Identity | The coherent set of values, commitments, and aesthetic preferences that governs all wine selection, service, and communication decisions in a restaurant context. Distinct from a wine list, which is a procurement and presentation document. |
| Beverage Philosophy Statement | A one-page internal document articulating what a program believes, who its guests are, what it will always and never do, and how it makes decisions about growth. Functions as an active decision-making filter, not a marketing document. |
| Curatorial Logic | The set of principles that explains why a program carries what it carries, with sufficient specificity that a third party could make consistent selections using those principles alone. |
| Geographic Focus | One of the five dimensions of program personality; the degree to which a program specializes in specific producing regions versus surveying the wine world broadly. |
| Stylistic Lean | One of the five dimensions of program personality; the consistent aesthetic preference of a program for particular wine styles — power vs. precision, extraction vs. transparency, interventionist vs. minimal winemaking. |
| Price Architecture | The distribution of value across a list's price tiers; specifically, where the program concentrates its strongest selections and what that concentration communicates about the program's values. |
| Discovery Orientation | One of the five dimensions of program personality; the degree to which a program actively introduces guests to wines, producers, and appellations outside their existing knowledge. |
| Service Philosophy | One of the five dimensions of program personality; whether the program's value is primarily unlocked through expert service interaction or designed to be self-navigating by an engaged guest. |
| Identity Alignment | The degree to which a beverage program's personality coherently reflects and reinforces the restaurant's cuisine, price point, neighborhood, and guest profile. |
| Program Anchor | A producer, region, or category that is foundational to the program's identity — never dropped without serious deliberation, providing continuity during periods of evolution or transition. |
| Buying Calendar | A structured schedule that anticipates regular review and rotation of program sections, preventing stagnation while maintaining curatorial coherence. |
| Program Changelog | An internal document recording significant program additions, deletions, and directional changes with explanations of the reasoning; used to verify that the program is evolving with intention rather than opportunistically. |
| Identity Shift | A deliberate, staged reinvention of a beverage program's core personality, warranted by significant changes in concept, ownership, cuisine direction, or guest profile; distinct from routine seasonal evolution. |
| Stranger Test | An auditing technique in which a hospitality professional with no prior knowledge of a restaurant describes the restaurant's concept, cuisine, and guest profile based solely on the wine list; used to identify misalignment between program identity and curatorial execution. |
| Self-Navigating List | A wine list designed so that a curious, engaged guest can identify remarkable selections without staff assistance, through organizational logic, descriptors, and curation that communicate the program's values legibly. |

---

## Quiz — Program Vision & Identity

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. What is the primary distinction between a wine list and a wine program?**
- A) A wine program is larger and more expensive to build than a wine list
- B) A wine list is a procurement and presentation document, while a wine program is the expression of a coherent set of values applied to all beverage decisions
- C) A wine program requires a full-time sommelier, while a wine list can be managed by floor staff
- D) A wine list focuses on by-the-glass offerings, while a wine program encompasses bottle service only

**Correct: B**

---

**Q2. A beverage director is reviewing two programs: Program A has 40 labels organized around biodynamic producers from the Rhône and its global counterparts. Program B has 400 labels covering every major wine region. Which statement best reflects the module's position on these programs?**
- A) Program B is superior because it gives guests more choices and reduces the risk of running out of popular items
- B) Program A is superior because smaller lists are always more curated and easier for guests to navigate
- C) Program A may be more powerful as a program because it communicates a clear point of view, while Program B risks incoherence if it lacks a unifying philosophy
- D) Program B is superior because corporate hospitality professionals should always maximize guest optionality

**Correct: C**

---

**Q3. A restaurant in a transitional industrial neighborhood with a young, creative clientele is considering its wine program strategy. Based on the module's framework, which approach is most appropriate?**
- A) A high-recognition, self-navigating list with established producers, minimizing guest confusion
- B) A prestige-forward list with trophy bottles from canonical appellations to signal quality
- C) A high-discovery program leading with natural wine and obscure growers, calibrated to the guest profile and neighborhood context
- D) A geographically comprehensive survey list with no dominant stylistic lean

**Correct: C**

---

**Q4. Which of the following is NOT one of the five dimensions of beverage program personality described in this module?**
- A) Geographic focus
- B) Vintage depth
- C) Discovery orientation
...
**Q5. A beverage director at a $65-entrée restaurant notices that the house pour starts at $18 per glass. A colleague at a comparable restaurant starts their house pour at $12. According to the module's framework on price alignment, what is the most important question the beverage director should ask?**
- A) Whether the $18 pour is competitively priced relative to nearby restaurants
- B) Whether the price architecture communicates a consistent message about what guests are receiving for their money at all tiers
- C) Whether the $12 pour creates a perception of inferior quality that the $18 price point avoids
- D) Whether the cost-per-ounce differential justifies the guest-facing price difference

**Correct: B**

---

**Q6. What is the primary function of a beverage philosophy statement, as defined in this module?**
- A) To communicate the program's values to guests on the menu or website
- B) To satisfy ownership's requirement for a formal program document during annual reviews
- C) To serve as an internal decision-making filter — guiding purchasing, training, and curatorial decisions
- D) To provide a public-facing brand narrative for press and marketing use

**Correct: C**

---

**Q7. A new sommelier joins the team and is handed the beverage philosophy on their first day. According to the module, what is the most valuable outcome of reading the philosophy aloud with the sommelier and asking what questions it raises?**
- A) It tests the sommelier's reading comprehension and familiarity with wine terminology
- B) It reveals either gaps in the document or gaps in the sommelier's understanding of hospitality — both useful data
- C) It ensures the sommelier memorizes the key commitments before their first service
- D) It demonstrates to the sommelier that the program has formal documentation, increasing their confidence

**Correct: B**

---

**Q8. A beverage director conducts a "stranger test" and finds that the professional given the list describes a casual American bistro, when the actual restaurant is a formal contemporary European tasting menu. What does this result indicate?**
- A) The stranger lacks sufficient expertise to correctly interpret the list's organizational logic
- B) The program's list design and curation are not communicating the restaurant's concept, indicating a misalignment between identity and execution
- C) The restaurant should consider repositioning its concept to match the impression the list creates
- D) The list needs more expensive bottles to signal its formal positioning

**Correct: B**

---

**Q9. A program's stylistic lean favors transparency, restraint, and minimal intervention. A sales representative offers an allocated, critically acclaimed Napa Cabernet at a competitive price. According to the module's framework, what should guide the decision about whether to add it?**
- A) The wine's critical score and the strength of the allocation
- B) Whether the price per bottle allows for a margin consistent with program targets
- C) Whether the wine's style and the producer's values align with the program's philosophy, regardless of critical acclaim or price
- D) Whether similar programs in the market carry the wine, establishing category legitimacy

**Correct: C**

---

**Q10. Which organizational logic for a wine list best signals that provenance — where a wine comes from — is the program's primary value?**
- A) Organizing by style (structured whites, textured whites, light reds, structured reds)
- B) Organizing by producer with brief biographical notes
- C) Organizing geographically, drilling from country to region to appellation
- D) Organizing by price tier within each color category

**Correct: C**

---

**Q11. A restaurant undergoes a chef transition, and the new chef's cuisine moves from French-influenced bistro cooking to modern Japanese. The beverage director is considering how to respond. Which approach best reflects the module's guidance on identity shifts?**
- A) Immediately replace the French-dominant list with a Sake and Champagne-focused program to match the new cuisine
- B) Maintain the existing list unchanged for one full year to preserve guest loyalty during the transition
- C) Stage the transition — introducing wines that serve the new cuisine alongside anchors from the old program, training staff on the new direction, and retiring the previous identity gradually
- D) Add a sake section and a German Riesling section to the existing list without removing existing categories

**Correct: C**

---

**Q12. A beverage director reviews three server interaction transcripts and finds that the servers' language consistently emphasizes popularity ("it's one of our most popular bottles") rather than the program's values. What does this reveal?**
- A) That the servers are effectively using social proof to guide guests toward good choices
- B) That there is a gap between the written beverage philosophy and the actual service delivery — the program's identity is being lost in execution
- C) That the servers need additional product knowledge training on the specific producers in each category
- D) That the beverage philosophy needs to be rewritten to incorporate popularity-based language

**Correct: B**

---

**Q13. What distinguishes a "program anchor" from other selections on the list?**
- A) Anchors are the highest-priced bottles in each category, representing the program's prestige tier
- B) Anchors are the program's best-selling wines, rotated in based on quarterly revenue performance
- C) Anchors are foundational producers or categories that define the program's identity and are never dropped without serious deliberation, providing continuity during evolution
- D) Anchors are wines held in reserve inventory and not listed publicly, available only to regular guests

**Correct: C**

---

**Q14. A beverage director reviews the program's changelog and discovers that in the last 18 months, 40 new wines were added without any documented rationale. What is the most likely diagnosis?**
- A) The program has been evolving appropriately in response to market availability and seasonal trends
- B) The program is growing its selection strategically to improve guest optionality across all categories
- C) The program has been responding opportunistically to what is available rather than curating from a consistent philosophy, risking identity incoherence
- D) The program director has not been keeping adequate records, but the selections themselves may be sound

**Correct: C**

---

**Q15. A high-discovery beverage program has been built for a neighborhood that has seen significant demographic shifts — long-time residents have largely been replaced by a more conventionally-minded corporate dining clientele. Guest feedback consistently indicates confusion and anxiety about the wine list. Which response is most consistent with the module's framework?**
- A) Maintain the program intact; the new guests will adapt over time as they build familiarity
- B) Conduct a full identity shift immediately, converting to a high-recognition program within a single service period
- C) Assess whether the program's discovery orientation remains aligned with the actual guest profile and, if not, manage a staged transition toward greater recognition-forward curation while preserving the program's core values
- D) Add a brief wine education insert to the menu explaining natural wine and obscure appellations to reduce guest anxiety

**Correct: C**

---

**Q16. Which element of the beverage philosophy statement functions as a "floor of integrity" for the program?**
- A) The statement of what the program believes about wine
- B) The list of things the program will always do — the non-negotiable commitments
- C) The criteria for how the program grows and adds new producers
- D) The description of who the program's guests are and what they are capable of

**Correct: B**

---

**Q17. A beverage director is building a program for a restaurant that competes directly with a nearby establishment known for its deep, sommelier-dependent Burgundy program with high discovery orientation. Which strategic approach does the module's framework support?**
- A) Build a deeper Burgundy program to compete on the same ground and attract the same guests
- B) Identify dimensions along which the competing program is not occupying territory — such as a different geographic focus, higher recognition-orientation, or self-navigating design — and build toward those distinctions
- C) Survey the entire wine world to offer more choices than the competitor across all categories
- D) Lead with Burgundy to establish credibility, then differentiate through by-the-glass programming

**Correct: B**

---

**Q18. According to the module, what is the most important thing to maintain throughout a major identity shift, regardless of how significant the philosophical change is?**
- A) The same price architecture, to avoid alienating price-sensitive guests during the transition
- B) At least 30% of the previous program's anchors, to give regular guests familiar reference points
- C) Consistent quality of execution and sincerity of hospitality, so that guests do not attribute service decline to the new program
- D) The same organizational logic for the list, so that regular guests can navigate it while the selections evolve
