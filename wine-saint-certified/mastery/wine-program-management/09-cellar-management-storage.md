...
**Level:** Wine Program Management — Cellar Operations
**Module:** 9
...
## Section 1: The Science of Wine Storage, Why Conditions Are Everything
...
## Section 3: Receiving and Intake, The First Line of Quality Control
...
## Section 4: Library and Aged Inventory, Building and Managing a Collection Within a Program
...
## Section 5: Security and Loss Prevention, Building a Culture of Accountability Without a Culture of Suspicion
...
## Section 6: Cellar Maintenance and Troubleshooting, Keeping the System Running
...
| Term | Definition |
|------|-----------|
| Ullage | The headspace between the wine and the bottom of the cork in a sealed bottle; increasing ullage over time indicates evaporation caused by a compromised cork or excessive dryness |
| Thermal cycling | Repeated fluctuation between warm and cool temperatures; stresses the cork, promotes microoxidation, and accelerates premature aging in cellared wine |
| Lightstrike | A wine fault caused by UV light exposure, producing sulfurous compounds that generate wet cardboard or struck-match aromas; most prevalent in white and sparkling wines |
| Shrinkage | Unexplained inventory loss, bottles unaccounted for after reconciling physical inventory against receiving records and sales data |
| Floor par | The working quantity of each wine maintained on the floor or in immediate-access cellar storage to support daily service without requiring mid-service restocking runs |
| Bin system | A high-density cellar storage format that holds multiple bottles per compartment (typically by the case or half-case); efficient for high-velocity SKUs but limits individual bottle access |
| Cycle counting | A rolling inventory audit methodology that counts one zone or section of the cellar per week on a rotating schedule, allowing the entire cellar to be counted monthly without a single disruptive full count |
| Drinking window | The range of years during which a given wine is assessed to be at or approaching its peak expression; a function of producer style, vintage character, and storage conditions |
| Library program | A curated selection of wines purchased at or near release and aged in-house under controlled conditions, offered to guests as a differentiated service and revenue opportunity |
| Cork seepage | Visible wine staining or moisture around or beneath the cork or capsule, indicating the bottle seal has been compromised, a primary indicator of heat damage or a defective cork |
| Key control | The administrative practice of tracking who holds physical keys or access codes to restricted areas, with documentation of issuance, changes, and revocation upon staff departure |
| Cellar coordinate | An alphanumeric address assigned to a specific bin, shelf, or rack position in a cellar, enabling any staff member to locate a specific bottle from a written record |
| Provenance | The documented chain of custody and storage history for a wine; in a library context, provenance refers to the establishment's record of having purchased, received in good condition, and stored the wine under professional conditions |
| Secondary lock | An additional physical access barrier within the cellar protecting high-value or library inventory from the general working stock zone; typically a keyed deadbolt or coded subzone |
| Receiving staging area | A designated physical zone near the cellar entry where incoming deliveries are inspected and held before integration into working stock or library inventory |

---

## Quiz: Cellar Management & Storage

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. Your cellar holds steady at 58°F year-round. A colleague argues it should be chilled to exactly 55°F to meet the textbook standard. What is the most accurate response?**
- A) 55°F is mandatory for all fine wine and the cellar should be reconfigured immediately
- B) 58°F is too warm for any long-term cellaring and will cause premature aging
- C) Consistency is more important than hitting exactly 55°F, a steady 58°F is preferable to a cellar that cycles between 52°F and 65°F
- D) Temperature only matters for white wines; reds are not sensitive to variation above 60°F

**Correct: C**

---

**Q2. During a routine inspection, a sommelier notices that bottles stored upright in a display case show increasing ullage after six months. What is the most likely cause?**
- A) The bottles are aging normally and ullage development is expected in all conditions
- B) Upright storage is allowing the corks to dry out and shrink, permitting evaporation and microoxidation
- C) The wines were overfilled at production and are releasing excess pressure
- D) Low temperature in the display case is contracting the wine volume

**Correct: B**

---

**Q3. A delivery arrives during Friday lunch service. The driver needs a signature immediately. What is the correct course of action?**
- A) Sign and accept the delivery to avoid disrupting service; inspect bottles after the rush
- B) Refuse the delivery and reschedule it for a time within your designated receiving window
- C) Have a server sign for the delivery and move the cases to the receiving area for later inspection
- D) Inspect only the top case of each pallet and sign if those cases appear undamaged

**Correct: B**

---

**Q4. Upon opening a case of Barolo, you notice two bottles with corks standing slightly proud of the bottle neck. What does this most likely indicate, and what should you do?**
- A) Normal cork variation from the winery; accept and cellar as usual
- B) Evidence of heat exposure during transit, document the damage, photograph the bottles, note it on the delivery receipt before signing, and contact the distributor the same day
- C) A sign that the wine is ready to drink immediately; route to floor par
- D) Indicate on the delivery receipt that the corks are loose and accept the bottles with a discount negotiated on the spot

**Correct: B**

---

**Q5. You are designing a cellar layout for a 200-seat restaurant with a 1,500-bottle program. Which organizational scheme best serves daily operational efficiency?**
- A) Organize all wine alphabetically by producer name for universal access
- B) Organize by price tier only, with premium wines at the back and house wines near the door
- C) Establish distinct zones by function (floor par near the exit, working stock by category, and a separately secured library zone) with an alphanumeric coordinate system throughout
- D) Organize by vintage, oldest to newest, to simplify drinking window management

**Correct: C**

---

**Q6. Your cellar's relative humidity reads 44% for the third consecutive day. Which consequence is most directly at risk?**
- A) White wines will develop excess acidity from the low-humidity environment
- B) Corks will begin to dry out and contract, increasing the risk of oxidation across your cork-sealed inventory
- C) Wine temperatures will rise because humidity reduction increases ambient heat retention
- D) Lightstrike will become more likely as dry air allows UV penetration through the bottles

**Correct: B**

---

**Q7. A beverage director wants to introduce a library program. Which action should happen first?**
- A) Price the library selections at 3x cost, consistent with the standard bottle pricing formula
- B) Identify bottles for library designation, assign individual tags at receiving documenting provenance and drinking windows, and create a physically separated library zone before any bottles are designated
- C) Wait until the cellar has accumulated aged inventory naturally before formalizing the program
- D) Feature all aged inventory on the wine list simultaneously to generate maximum revenue from the collection

**Correct: B**

---

**Q8. A wine director wants to price a Barolo purchased for $60 per bottle four years ago. The wine now trades at $140 at auction. What is the most financially sound and defensible pricing approach?**
- A) Price at 3x original cost ($180) to maintain standard margin structure
- B) Price at original cost plus a flat $40 aging fee ($100)
- C) Price near current market value ($140) with a premium for in-house provenance and immediate accessibility, significantly above 3x original cost
- D) Price at replacement cost for the current vintage of the same wine

**Correct: C**

---

**Q9. You implement a new cellar access log requiring all staff to record their name, time, and purpose for every cellar entry. A senior server objects, calling it "micromanagement." How should you address this?**
- A) Exempt senior staff from the log requirement to preserve morale
- B) Explain that the log protects everyone: it creates a record that surfaces discrepancies quickly and ensures that no individual is unfairly suspected when bottles go missing
- C) Make the log optional but encourage compliance
- D) Remove the log and rely on camera footage alone

**Correct: B**

---

**Q10. During a cycle count, you find that three bottles of a $200 allocated Cabernet are missing from their designated bin location with no corresponding sales record or documented breakage. What is the correct sequence of investigation?**
- A) Immediately file a police report and suspend all staff with cellar access pending investigation
- B) First reconcile all data records for the SKU (receiving logs, sales records, comp/breakage documentation), then investigate any unresolved discrepancy with HR if the data does not account for the missing bottles
- C) Accept the loss as breakage and adjust inventory records
- D) Increase the price of remaining bottles in the SKU to recover the value of the missing inventory

**Correct: B**

---

**Q11. Your cellar cooling unit fails at 8pm on a Saturday. The cellar is well-insulated. The ambient building temperature is 72°F. What is your first action?**
- A) Open cellar doors to allow air circulation from cooler parts of the building
- B) Contact your HVAC/cellar service provider's emergency line, assess the time window before temperature reaches 65°F, and begin planning temporary alternatives for library inventory if repair will take more than 24 hours
- C) Move all wine to the walk-in refrigerator immediately
- D) Wait until Monday when service providers are available before taking action

**Correct: B**

---

**Q12. Which of the following is the most important single reason to install a continuous-logging thermometer/hygrometer in your cellar?**
- A) It satisfies insurance requirements for fine wine coverage
- B) It replaces the need for human cellar inspections
- C) It enables real-time alerts when temperature or humidity breaches thresholds, allowing intervention before prolonged storage failures damage inventory
- D) It documents cellar conditions for use in marketing the wine program to guests

**Correct: C**

---

**Q13. A longtime sommelier on your team is caught on camera removing a bottle from the library section without logging it. When asked, they say they were tasting it to update the drinking window assessment. What is the most appropriate response?**
- A) Accept the explanation, tasting library wine is a legitimate sommelier responsibility and no documentation is required
- B) Acknowledge the legitimate purpose of tasting library wine while making clear that all cellar removals, including tasting samples, must be logged and pre-approved, then document the conversation and the revised protocol
- C) Immediately terminate the employee for theft
- D) Review camera footage for all prior incidents before responding to the current one

**Correct: B**

---

**Q14. Which scenario represents the greatest long-term threat to a wine program's cellar-aged inventory?**
- A) A single 48-hour power outage in a well-insulated cellar followed by prompt repair
- B) Recurring thermal cycling between 52°F in winter and 68°F in summer across multiple years
- C) A one-time labeling error that assigns bottles to an incorrect cellar coordinate
- D) Storing cork-sealed bottles at a 30-degree angle rather than fully horizontal

**Correct: B**

---

**Q15. A guest at a special dinner event asks why the library Barolo they ordered costs $320 when the same wine is listed on a retail wine shop's website for $180 in the current vintage. How should you respond?**
- A) Apologize and reduce the price to match the retail reference
- B) Explain that the wine they ordered is four years older, has been professionally cellared on-site since purchase, and represents a provenance and drinking experience unavailable at retail, and offer a brief note on what the aging has done to the wine's character
- C) Explain that restaurant wine pricing is always higher than retail due to service overhead
- D) Offer a younger vintage at the lower price point if the guest prefers

**Correct: B**

---

**Q16. You are onboarding a new floor manager who will occasionally pull bottles from the cellar during busy service. What is the minimum cellar training they should receive before their first independent retrieval?**
- A) A review of the wine list and the location of the BTG wines only
- B) A full cellar orientation covering the coordinate system, zone layout, floor par location, and the access log procedure, enabling any trained staff member to locate any wine in under two minutes
- C) Shadowing the sommelier for one service before attempting independent retrievals
- D) Training is not necessary, cellar retrieval should remain the sommelier's exclusive responsibility

**Correct: B**

---

**Q17. Your receiving log shows a case of white Burgundy was received in excellent condition six months ago. When the bottles are opened today, multiple show lightstrike characteristics: a sulfurous, cardboard-like fault. What is the most likely cause?**
- A) The wines were defective at production and the fault was not detectable at receiving
- B) The bottles were stored too cold, producing lightstrike compounds from tartrate precipitation
- C) The bottles were exposed to UV light in the cellar, either from fluorescent lighting, a window, or inadequate light protection in their storage location
- D) The distributor shipped a heat-damaged batch that passed visual inspection but was internally compromised

**Correct: C**

---

**Q18. A flooding event in the cellar submerges the lower two rows of racking for six hours. When the water recedes, you assess the damage. Which action is most critical before restoring inventory to the flooded shelves?**
- A) Taste a bottle from the flooded section to assess whether quality has been affected
- B) Photograph all affected bottles for insurance documentation, assess racking structural integrity before reloading, and inspect individual cork conditions on submerged bottles for signs of contamination
- C) Wipe down all bottles and return them to their bin locations as quickly as possible to minimize service disruption
- D) Discard all bottles that were submerged regardless of condition, as flooding renders all wine unsalvageable

**Correct: B**

---

**Q19. A new general manager proposes eliminating the cellar's secondary lock on the library section to simplify access during busy service. What is the strongest operational argument for maintaining the secondary lock?**
- A) Insurance policies require a secondary lock for all wine collections valued above a certain threshold
- B) The secondary lock creates a physical and psychological barrier that limits library access to deliberate, authorized removals, reducing shrinkage risk, maintaining accountability, and protecting high-value inventory from accidental pulls during service
- C) The secondary lock prevents temperature variation in the library zone by creating an additional air barrier
- D) Health code regulations require separate locked storage for high-value inventory

**Correct: B**

---

**Q20. Which combination of cellar conditions represents the highest overall risk profile for long-term wine storage?**
- A) 57°F / 65% RH / LED lighting / isolated from mechanical vibration
- B) 60°F / 70% RH / incandescent lighting / minor vibration from foot traffic
- C) 68°F / 45% RH / fluorescent lighting / proximity to HVAC equipment
- D) 55°F / 60% RH / no natural light / adjacent to a low-traffic corridor
