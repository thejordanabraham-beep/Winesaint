...
**Level:** Wine Program Management — Inventory Management
**Module:** 8
...
## Section 1: Why Inventory Control Is a Financial Priority
...
## Section 2: Par Levels and Reorder Points
...
## Section 4: FIFO and Stock Rotation
...
## Section 5: Variance and Shrinkage
...
## Section 6: Inventory Technology
...
**Dedicated beverage inventory applications** — BevSpot (now part of the OpenTable ecosystem), Bevager, MarketMan, and others — add a layer of operational intelligence that POS systems alone cannot provide. These platforms typically offer: mobile count interfaces (tap or scan to count bottles on a handheld device), automated variance calculation, ordering integrations with distributors, par level management, and cost reporting dashboards. BevSpot and Bevager both allow count sheets organized by storage location, so counters move through the cellar in physical order rather than alphabetical order, cutting count time by 30–50% in larger operations. MarketMan skews toward higher-volume operations with multi-location management and robust invoice processing.

The tradeoff with dedicated apps is cost and implementation friction. These platforms run $100–$500 per month depending on feature tier and operation size, and they require an initial data entry investment — building out your full SKU library, setting par levels, and mapping storage locations — before they deliver value. For a single-unit restaurant with 60 labels and one manager doing inventory, a well-built spreadsheet may genuinely outperform a $250/month app. For a multi-outlet hotel with 150 SKUs, three storage locations, and a team of four doing counts, a dedicated app pays for itself in labor savings within the first month.
...
| Term | Definition |
|------|------------|
| **Par Level** | The minimum quantity of a specific SKU that must be on hand at all times to meet demand between deliveries, including a safety buffer for volume spikes |
| **Reorder Point** | The inventory level at which a purchase order for a given SKU should be triggered, calculated as: (Average Daily Usage × Lead Time in Days) + Safety Stock |
| **Inventory Turnover** | A ratio measuring how frequently a program cycles through its entire inventory, calculated as: Annual Cost of Goods Sold ÷ Average Inventory Value; higher ratios indicate stronger capital efficiency |
| **Velocity** | The rate at which a specific SKU sells; typically expressed as bottles per day or bottles per week; the primary input for setting par levels |
| **FIFO (First In, First Out)** | The inventory rotation principle requiring that the oldest stock (earliest received) is always sold or issued before newer stock of the same SKU |
| **Variance** | The difference between theoretical on-hand (calculated from opening inventory + purchases − recorded sales) and actual physical count; the core diagnostic metric for shrinkage analysis |
| **Theoretical On-Hand** | The quantity of a SKU that the system calculates should be present based on recorded transactions; serves as the baseline against which physical counts are compared |
| **Shrinkage** | Inventory loss from any cause not captured in recorded sales, including theft, over-pouring, breakage, unauthorized consumption, and administrative error |
| **Spot Check** | A targeted physical count of a subset of high-priority or high-risk SKUs, conducted between full inventory counts to catch variances early |
| **Lead Time** | The elapsed time between placing a purchase order and receiving the product; a critical variable in reorder point calculations |
| **COGS (Cost of Goods Sold)** | The direct cost of wine sold during a period, calculated as: Opening Inventory Value + Purchases − Closing Inventory Value; the fundamental output of a monthly inventory count |
| **Safety Stock** | An additional inventory buffer held above the calculated minimum par level to absorb demand spikes, delivery delays, or count errors without risking a stockout |
| **Gravity-Fed Bin** | A flow-rack shelving system that enforces FIFO automatically: bottles enter from the back and roll forward as product is removed, eliminating manual rotation decisions |
| **Breakage Log** | A written record of wine lost to physical damage, documenting the SKU, quantity, and cause; essential for isolating breakage as a variance source rather than attributing it to theft or over-pouring |
| **Carrying Cost** | The total cost of holding inventory, including physical storage, climate control, insurance, and opportunity cost of capital tied up in unsold product |
...
**Q1. A hotel restaurant carries an average inventory value of $22,000 and has an annual wine COGS of $88,000. What is the inventory turnover, and how should it be interpreted?**
- A) Turnover of 4; the program cycles through inventory approximately once per quarter, which may indicate excess carrying costs
- B) Turnover of 4; this is an ideal ratio for a full-service hotel program and requires no adjustment
- C) Turnover of 0.25; the program is underselling relative to inventory held
- D) Turnover of 22; the program is operating with dangerously low inventory levels

**Correct: A**

---

**Q2. A beverage director wants to set a par level for the house Chardonnay, which sells an average of 6 bottles per day. The distributor delivers every 4 days. Using a 20% safety buffer, what is the correct par level?**
- A) 24 bottles
- B) 29 bottles
- C) 20 bottles
- D) 36 bottles
...
**Q3. The reorder point formula is: (Average Daily Usage × Lead Time) + Safety Stock. A BTG Rosé sells 3 bottles per day, the distributor's lead time is 2 days, and the safety stock is set at 4 bottles. At what on-hand quantity should the manager place a reorder?**
- A) 6 bottles
- B) 9 bottles
- C) 10 bottles
- D) 14 bottles
...
**Q4. Which of the following most accurately describes the financial risk of slow-moving inventory?**
- A) Slow-moving wines increase labor costs because staff must spend more time managing them
- B) Slow-moving wines tie up operating capital, create carrying costs, and increase exposure to undetected storage damage
- C) Slow-moving wines are only a concern in fine dining programs where vintage integrity is critical
- D) Slow-moving wines reduce inventory turnover but do not affect overall program profitability

**Correct: B**

---

**Q5. During a full physical count, the beverage director finds 9 bottles of a Syrah on hand. The theoretical on-hand, calculated from opening inventory plus purchases minus recorded sales, is 13 bottles. What is the variance, and what should the first step of the investigation be?**
- A) Variance of 4 bottles (31%); first step is to review security footage for theft
- B) Variance of 4 bottles (31%); first step is to recount the SKU and verify delivery records to rule out administrative error
- C) Variance of 13 bottles; the count is incorrect and should be repeated
- D) Variance of 4 bottles (31%); first step is to interview bar staff about over-pouring

**Correct: B**

---

**Q6. A bar team consistently pours 5.5 oz per glass instead of the standard 5 oz pour. If the program pours 400 BTG glasses per week, how many extra glasses of wine are being given away per week?**
- A) 20 extra glasses
- B) 40 extra glasses
- C) 10 extra glasses
- D) 80 extra glasses
...
**Q7. FIFO breaks down most commonly at which operational control point?**
- A) During monthly inventory counts, when bottles are rearranged for counting
- B) At the receiving stage, when new stock is placed in front of existing stock for convenience
- C) During service, when bartenders pull bottles based on guest preference
- D) During weekly spot checks, when only a subset of SKUs are reviewed

**Correct: B**

---

**Q8. A beverage director is reviewing variance reports by location. Overall program variance is 5%, but the bar variance is 13% and the cellar variance is 0.8%. What is the most operationally sound conclusion?**
- A) The overall variance is too high; the entire program needs to be audited immediately
- B) The cellar variance indicates that the main storage area is the primary problem
- C) The problem is concentrated at the bar; investigation should focus on bar operations, staff, and shift data
- D) A 13% bar variance is within normal range for high-volume bar service and does not require investigation

**Correct: C**

---

**Q9. Which of the following is NOT a standard cause of inventory variance?**
- A) Staff consumption that is not recorded in POS
- B) Comps issued with proper comp tickets entered into the system
- C) Breakage that occurred during a busy service with no log entry made
- D) Over-pouring at the bar across multiple shifts

**Correct: B**

---

**Q10. A restaurant runs a BTG Sauvignon Blanc. A 750ml bottle yields 5 glasses. After a count, 2.6 bottles are recorded on-hand. How many pours remain?**
- A) 10 pours
- B) 13 pours
- C) 12 pours
- D) 15 pours
...
**Q11. What is the primary advantage of a gravity-fed bin (flow-rack) shelving system in a wine cellar?**
- A) It stores more bottles per square foot than traditional shelving
- B) It enforces FIFO automatically without requiring staff to make rotation decisions
- C) It maintains a lower ambient temperature than standard shelving
- D) It integrates with inventory management software for automated counting

**Correct: B**

---

**Q12. A beverage director is evaluating a dedicated inventory management app that costs $300 per month. The current spreadsheet-based system takes 12 hours of manager time per month to maintain. The manager earns $35 per hour. Is the app financially justified on labor savings alone?**
- A) No; $300/month exceeds the $420/month current labor cost, making the app more expensive
- B) Yes; $420/month in current labor cost exceeds the $300/month subscription, with $120/month in net savings
- C) The comparison is irrelevant because software costs and labor costs cannot be evaluated against each other
- D) No; the app would need to save at least 15 hours per month to justify the cost

**Correct: B**

---

**Q13. Which of the following best describes the relationship between a par level and a reorder point?**
- A) They are the same metric expressed in different units
- B) The par level is the desired maximum quantity; the reorder point is the quantity that triggers a purchase order
- C) The par level is the minimum sufficient quantity to hold on hand; the reorder point is the quantity that triggers a purchase order before reaching zero
- D) The reorder point is always set at exactly 50% of the par level

**Correct: C**

---

**Q14. A wine program consistently runs 1.5% monthly variance for six months, then spikes to 9% in a single month. What is the most defensible investigative approach?**
- A) Assume the spike is a counting error and recount the full inventory
- B) Identify what changed during that specific month — new staff, a catering event, a delivery anomaly — and focus the investigation there
- C) Assume theft is the cause and review security footage first
- D) Expand the acceptable variance threshold to 9% to reflect the new baseline

**Correct: B**

---

**Q15. Which of the following practices most directly supports accurate, consistent monthly COGS calculations?**
- A) Conducting spot checks of BTG wines every Friday
- B) Conducting full physical counts at the same time each month, ideally when inventory is at a natural low point before a delivery
- C) Using a POS-integrated system that automatically tracks theoretical on-hand
- D) Requiring all staff to sign a breakage log at the end of each shift

**Correct: B**

---

**Q16. A beverage director is implementing a new inventory platform. What does the module recommend as the safest implementation approach?**
- A) Cut over immediately and train staff on the new system in live service conditions to accelerate learning
- B) Run the new system in parallel with the old method for 4–6 weeks before fully cutting over
- C) Implement the new system at the start of the fiscal year to align with accounting cycles
- D) Delegate implementation entirely to the software vendor's onboarding team

**Correct: B**

---

**Q17. Why does the module recommend calculating inventory turnover by category rather than in aggregate?**
- A) Category-level turnover is required for regulatory compliance in licensed beverage programs
- B) Aggregate turnover can mask the fact that capital is concentrated in slow-moving categories while others perform well
- C) Category-level turnover is easier to calculate in spreadsheet-based systems
- D) Aggregate turnover calculations are inaccurate because they include non-wine categories

**Correct: B**

---

**Q18. When a breakage log is not maintained, what is the primary operational consequence?**
- A) The program will over-order replacement stock, inflating inventory costs
- B) Breakage cannot be distinguished from theft or over-pouring in variance analysis, compromising the accuracy of the investigation
- C) The program loses the ability to file insurance claims for broken product
- D) Staff will begin reporting breakage on the honor system, which increases variance over time

**Correct: B**

---

**Q19. A manager sets a reorder point for a BTG Pinot Noir at 10 bottles. The actual lead time from the distributor is 4 days, but the manager used a lead time of 2 days in the calculation. What is the most likely consequence?**
- A) The program will over-order, inflating inventory beyond par
- B) The program will trigger reorders too early, creating excess stock near the par level
- C) The program will run out of stock before the replacement order arrives because reorders are triggered too late
- D) The reorder point is unaffected because safety stock absorbs the lead time discrepancy

**Correct: C**

---

**Q20. A hotel beverage director is choosing between BevSpot, a dedicated inventory app at $250/month, and a spreadsheet system. The program has 140 SKUs, three storage locations, and a team of three conducting counts. Which tool is most likely to provide the best return?**
- A) The spreadsheet system, because dedicated apps are only cost-effective for programs with more than 200 SKUs
- B) The dedicated app, because multi-location, multi-user operations benefit most from organized count interfaces, automated variance reporting, and ordering integration
- C) The spreadsheet system, because it integrates more easily with the POS than any third-party app
- D) Neither; operations of this size should use a full ERP system rather than a beverage-specific platform
