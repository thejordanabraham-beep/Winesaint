# By-the-Glass Program Economics: The Engine, the Math, and the Guest Experience
...
- Articulate why the by-the-glass program is the primary revenue and brand-building engine of a restaurant wine program
- Determine the optimal number of BTG selections for a given operation and structure them across entry, mid, and premium tiers
- Calculate pour cost percentage, expected yield, and target selling price using the full BTG cost model, including worked examples at multiple price points
...
Brand perception is the least quantifiable but arguably most durable effect. Guests form their opinion of a restaurant's wine identity almost entirely from the BTG list. A program that pours a generic, private-label Chardonnay by the glass signals nothing. A program that pours a Vermentino from Sardinia, a grower Champagne half-pour, and a Jura Poulsard signals something specific about who is running this program and what they believe. That specificity builds loyalty. Guests return for programs with identities.
...
The most common BTG program mistakes are structural: too many selections, wrong category balance, no tier differentiation, and no coherent identity. Getting the architecture right before choosing specific wines is the first discipline of BTG management.
...
A functioning BTG list allocates selections across the major categories guests expect while leaving room for the program's specific identity.

A baseline structure for 10 BTG selections:

| Category | Allocations | Notes |
|---|---|---|
| Sparkling | 1–2 | At minimum 1; a half-pour option dramatically increases sparkling sales |
| White | 3–4 | At least one crisp/mineral, one richer/oak-influenced |
...
| Tier | Pour Price Range | Bottle Cost Target | Pour Cost % |
|---|---|---|---|
| Entry | $12–$16 | $8–$14 | 22–28% |
...
> **Pro Tip:** Build your BTG list from the inside out. Start with two or three selections you believe in deeply and that your team can talk about with genuine enthusiasm. Build the surrounding selections to complement and contrast with those anchors. A list built around real conviction always outperforms a list assembled to fill category slots.
...
A realistic working yield for 5 oz pours is **4.5 to 4.75 pours per bottle** once over-pouring and residual loss are accounted for. Conservative programs planning for yield use 4.5.

### The Pour Cost Formula

Pour cost percentage is the fundamental metric for evaluating BTG pricing:

**Pour Cost % = (Bottle Cost ÷ Total Revenue from Bottle) × 100**

Or equivalently, for a single glass:

**Pour Cost % = (Cost per Pour ÷ Selling Price per Pour) × 100**

To find cost per pour:
**Cost per Pour = Bottle Cost ÷ Number of Pours**

To find the selling price required to hit a target pour cost:
**Required Selling Price = Cost per Pour ÷ Target Pour Cost %**

### Worked Examples

**Example 1: Entry-tier white wine**

- Bottle cost: $10.00
- Pour size: 5 oz
- Working yield: 4.5 pours per bottle
- Cost per pour: $10.00 ÷ 4.5 = **$2.22**
- Target pour cost: 25%
...
- Bottle cost: $20.00
- Pour size: 5 oz
- Working yield: 4.5 pours
- Cost per pour: $20.00 ÷ 4.5 = **$4.44**
- Target pour cost: 24%
- Required selling price: $4.44 ÷ 0.24 = **$18.50 → price at $18 or $19**

**Example 3: Premium pour at 6 oz**

- Bottle cost: $40.00
- Pour size: 6 oz
- Working yield: 4 pours (6 oz pours allow less cushion for over-pour)
- Cost per pour: $40.00 ÷ 4 = **$10.00**
- Target pour cost: 22%
...
This is worth calculating explicitly for every beverage director. If your program pours 100 BTG glasses per night on average, and 40% of those are over-poured by 0.5 oz:

- Over-poured volume per night: 40 pours × 0.5 oz = 20 oz = approximately **2.5 bottles per night**
- At an average BTG bottle cost of $18, that is **$45 of product given away free every night**
- Annualized at 300 operating days: **$13,500 in unrecovered cost**
...
## Section 4: Oxidation, Quality Control, and Preservation Systems

Oxygen is the enemy of BTG profitability. Once a bottle is opened and the wine is exposed to air, the clock starts. The revenue you can extract from that bottle is now in direct competition with time and chemistry.

### Oxidation Timelines by Wine Style

The rate of oxidation is not uniform across wine styles. Structure, sugar, and SO₂ levels all affect how quickly a wine degrades past service quality:

| Wine Style | Acceptable Open Bottle Window | Notes |
|---|---|---|
| Traditional-method sparkling | 1–2 days | CO₂ loss is rapid; flat sparkling is unsellable |
| Light, unoaked whites (Pinot Grigio, Vinho Verde, Muscadet) | 3–5 days | Low phenolics, minimal protection; prone to reduction then oxidation |
| Aromatic whites (Riesling, Gewurztraminer, Viognier) | 3–5 days | Aromatic compounds degrade quickly; loss of primary varietal character |
| Fuller whites, barrel-aged (Chardonnay, white Burgundy) | 5–7 days | Texture holds; oak and phenolics provide some buffer |
| Light reds (Pinot Noir, Gamay, Barbera) | 3–5 days | Fruit degrades; tannins flatten |
| Medium to full-bodied reds (Cabernet, Syrah, Malbec) | 5–7 days | Phenolic structure provides more protection; watch for reduction |
...
The Coravin system inserts a thin needle through the natural cork, allowing wine to be poured without removing the cork. Argon gas is injected to replace withdrawn wine, preventing oxygen contact. The cork reseals when the needle is withdrawn.
...
Multi-bottle preservation and dispensing systems that store wines under inert gas (argon or nitrogen) while enabling precise measured pours. Units hold 4, 8, or 16 bottles and can maintain wine quality for 3 to 4 weeks once opened.

- Best for: High-volume BTG programs, bar programs where self-service or server efficiency is a priority, operations with 15+ BTG selections
- Investment: $3,000–$8,000 per 8-bottle unit; significant capital cost
- Operational advantage: Near-elimination of open-bottle oxidation loss; consistent pour sizes; temperature control built in
- Best known brands: Enomatic (Italian), WineKeeper, Vinotemp

**Nitrogen Blanket Systems**

Manual inert gas systems (cans of nitrogen or argon/nitrogen blend, e.g., Private Preserve) sprayed into an open bottle before re-corking. Low-tech and inexpensive.

- Best for: Low-volume programs, backup preservation, secondary bottles opened for tasting pours
- Investment: $10–$20 per can; each can yields 80–120 uses
- Effectiveness: Extends open bottle life by 1–3 additional days compared to no preservation; less effective than Coravin or Enomatic for true long-term preservation

**VacuVin**

Rubber stoppers and a hand pump used to remove air from open bottles, creating a partial vacuum.
...
- **Tier 1 (high-velocity):** Selections selling 1+ bottles per day. Minimal preservation concern; focus on over-pour control.
- **Tier 2 (moderate velocity):** Selections selling 3–5 bottles per week. Use nitrogen blanket or VacuVin; monitor closely; pull or price-promote if velocity drops.
- **Tier 3 (low velocity):** Selections selling fewer than 2 bottles per week. Require Coravin or Enomatic; without preservation these selections have no place on a BTG list.

Weekly or biweekly BTG rotations on one or two selections keep the program dynamic, give servers something new to discuss, and allow the program to respond to seasonal shifts in guest preference.

### Tracking Open Bottle Age

Every open bottle should be dated when opened. The simplest system is a chalk marker on the bottle or a dated masking tape label applied when the first pour is drawn. The date tells any server or manager at a glance how long the bottle has been open.

More sophisticated operations use a sheet or tablet-based log at the wine station: bottle name, date opened, number of pours remaining, preservation method used. This log takes 30 seconds per bottle to maintain and creates accountability. Without it, a bottle opened on Tuesday can quietly make it to Friday with no one tracking its age.

### Training Staff to Detect Quality Issues

The front-of-house team is the last quality checkpoint before wine reaches a guest. Servers and sommeliers should be trained to identify:

- **Browning in whites or reds:** Early sign of excessive oxidation; in a white wine, color should be pale gold to light amber at most; obvious browning indicates degradation
...
Sophisticated wine programs understand that guest wine loyalty is built in stages. A guest who arrives as a reflexive Cabernet drinker does not become a Barolo enthusiast by reading a wine list. They become one through a sequence of guided encounters that expand their reference points incrementally.
...
- **Half-bottle pairings:** Offer 375ml bottles of BTG selections where producers make them available. This bridges the gap between a $16 glass and a $75 full bottle for a couple.
- **Producer-breadth strategy:** When a BTG selection succeeds with a guest, having additional wines from the same producer on the full bottle list creates a natural next step in the discovery arc.
- **Flight programs:** Three to four 2–3 oz pours of related selections (e.g., "Three Expressions of Pinot Noir" or "The Whites of Northern Italy") are among the highest-margin items on any list and the most powerful education vehicle. Each flight pour is a potential full-glass sale or bottle conversion.

### The Program as Narrative
...
Concrete metrics to track BTG as a discovery and loyalty vehicle:
...
| Term | Definition |
|---|---|
| **Pour Cost Percentage** | The ratio of a wine's cost per pour to its selling price per pour, expressed as a percentage. The primary financial metric for evaluating BTG pricing. Target range is typically 20–28% depending on tier. |
| **Working Yield** | The realistic number of pours extractable from a bottle after accounting for over-pour, spillage, and residual waste. Typically 4.5 pours per 750ml bottle for a 5 oz standard pour, versus the theoretical maximum of 5.08. |
| **Over-Pour Tax** | The cumulative revenue loss caused by consistently pouring above standard volume. At 0.5 oz of over-pour on 40% of covers, an active BTG program can lose $10,000–$15,000 annually in unrecovered product cost. |
| **Coravin** | A wine preservation system that inserts a thin needle through a natural cork to withdraw wine and replace it with argon gas without removing the cork, allowing premium bottles to be poured by the glass without oxidation. |
| **Enomatic** | A multi-bottle preservation and dispensing unit that stores BTG selections under inert gas (typically argon or nitrogen) while enabling measured, temperature-controlled pours. Standard equipment in high-volume fine dining BTG programs. |
| **Oxidation Timeline** | The expected window during which an opened bottle of wine maintains acceptable service quality. Varies by style: sparkling wines 1–2 days; light whites 3–5 days; fuller whites and medium to full reds 5–7 days; fortified wines 2–6 weeks. |
| **Discovery Arc** | The structured sequence of wine encounters through which a guest's preferences and knowledge expand over time, typically beginning with BTG glass pours and progressing toward bottle purchases, producer loyalty, and broader regional exploration. |
| **BTG-to-Bottle Conversion Rate** | The percentage of guests who begin a table with a by-the-glass order and convert to purchasing a full bottle of the same wine or a related selection during the same visit. A key performance indicator for BTG program quality and server selling effectiveness. |
| **Tier Structure** | The organization of a BTG list into distinct price bands (entry, mid, premium) to enable upsell progression, accommodate different guest budgets, and ensure program profitability across selection types. |
...
**Q1. A 750ml bottle contains 25.4 ounces. A beverage director using a 5 oz pour standard and a working yield of 4.5 pours per bottle is calculating which of the following?**

- A) The theoretical maximum yield, assuming no over-pour or spillage
- B) A realistic yield that accounts for over-pour and residual waste
- C) The yield based on a 6 oz pour standard
- D) The yield for a Coravin-poured bottle only

**Correct: B**

---

**Q2. A BTG bottle costs $18.00. Using a working yield of 4.5 pours and a target pour cost of 25%, what is the minimum selling price per glass?**
...
*(Calculation: Cost per pour = $18.00 ÷ 4.5 = $4.00. Required price = $4.00 ÷ 0.25 = $16.00)*
...
**Q4. A restaurant opens 10 BTG bottles per night. Using a 5 oz pour with working yield of 4.5, and an average bottle cost of $20, what is the daily revenue at risk from oxidation if 20% of bottles are lost to quality degradation?**
...
*(Calculation: 20% of 10 bottles = 2 bottles × $20 = $40)*

---

**Q5. Which of the following wine styles has the shortest acceptable open-bottle window without preservation?**

- A) Full-bodied Cabernet Sauvignon
- B) Barrel-aged white Burgundy
- C) Traditional-method sparkling wine
- D) Skin-contact orange wine

**Correct: C**

---

**Q6. A beverage director is evaluating a BTG selection that costs $40 per bottle, will be served in 6 oz pours, with a working yield of 4 pours. At a target pour cost of 22%, what is the correct selling price?**
...
*(Calculation: Cost per pour = $40 ÷ 4 = $10.00. Required price = $10.00 ÷ 0.22 = $45.45 → round to $45 or $46)*

---

**Q7. Coravin is not appropriate for which of the following wine types?**

- A) A $90 Barolo available by the glass
- B) A premium Napa Cabernet poured infrequently
- C) A traditional-method sparkling wine
- D) A mature Bordeaux with low sales velocity

**Correct: C**

---

**Q8. Research on consumer choice overload most directly supports which BTG program design decision?**

- A) Maximizing selection to ensure every guest category is covered
- B) Limiting BTG offerings to 8–12 selections to prevent decision paralysis and defaults to familiar brands
- C) Offering a single BTG wine in each major category to simplify decision-making entirely
- D) Pricing all BTG selections identically to reduce cognitive load

**Correct: B**

---

**Q9. A BTG selection is selling fewer than two bottles per week. According to the velocity framework in this module, this selection should:**

- A) Be promoted at the entry tier price regardless of bottle cost
- B) Be removed from the BTG program immediately
- C) Require Coravin or Enomatic preservation; without it, this velocity does not support a BTG listing
- D) Be moved to bottle-only listing to increase perceived value

**Correct: C**

---

**Q10. A sommelier wants to use the BTG program to expand guest palates and build loyalty. Which approach is most aligned with the discovery arc concept described in this module?**

- A) Stocking only the most popular varieties to maximize reorder frequency
- B) Rotating selections weekly with no continuity to create novelty
- C) Including one or two unfamiliar selections with server-trained provenance stories alongside anchor selections
- D) Limiting the BTG list to wines available in the $12–$15 range to reduce financial barriers to exploration
...
**Q12. Which preservation system is best suited for a high-volume BTG program with 15+ selections and a $5,000 capital budget?**

- A) VacuVin
- B) Private Preserve nitrogen spray
- C) Coravin for all selections
- D) Enomatic or equivalent multi-bottle preservation dispensing system

**Correct: D**

---

**Q13. A mid-tier BTG bottle costs $22. Using a working yield of 4.5 pours and a 5 oz standard pour, what pour cost percentage does a $17 selling price produce?**
...
*(Calculation: Cost per pour = $22 ÷ 4.5 = $4.89. Pour cost % = $4.89 ÷ $17 = 28.8%)*

---

**Q14. The "over-pour tax" describes:**

- A) An excise tax on wine served above a standard pour size
- B) The premium pricing applied to larger pour sizes on a tiered BTG menu
- C) The cumulative annualized revenue loss caused by consistently exceeding standard pour volume
- D) A guest satisfaction penalty applied to servers who over-pour wine

**Correct: C**

---

**Q15. A program offers a BTG flight of four 2.5 oz pours of different Pinot Noirs priced at $28. Each pour comes from a bottle with a $24 cost. Using a working yield of 4.5 pours and 5 oz standard equivalent, what is the approximate cost of the four flight pours combined?**
...
*(Revised: Cost per pour at 4.5 yield = $24 ÷ 4.5 = $5.33 per 5 oz pour. Each 2.5 oz pour = $2.67. Four pours = $10.67)*

---

**Q16. Which of the following best describes the relationship between BTG program quality and server confidence?**

- A) Server confidence is primarily a function of training depth and is independent of BTG list size
- B) A larger BTG selection increases server confidence by providing more options to recommend
- C) A focused, well-structured BTG list with trained narratives produces higher server confidence and stronger sales than a large, unfocused list
- D) Server confidence has no measurable effect on BTG sales performance

**Correct: C**

---

**Q17. A beverage director notices that a $24 BTG Grüner Veltliner has zero glass-to-bottle conversion over six weeks despite solid glass sales. The most useful next step is:**

- A) Replace the Grüner Veltliner with a more familiar variety
- B) Verify that a full bottle of the same wine (or a complementary producer) is available on the full bottle list, and retrain servers on the conversion conversation
- C) Lower the BTG price to increase volume and hope conversion follows
- D) Move the selection to a seasonal rotation to create scarcity and drive bottle interest

**Correct: B**

---

**Q18. According to this module, the most operationally immediate method for auditing server pour accuracy during live service is:**

- A) Counting remaining pours in open bottles at end of service and comparing to point-of-sale records
- B) Reviewing BTG cost of goods weekly and flagging variance against theoretical pour yield
- C) Weighing filled glasses immediately after pouring, before service, and comparing against target weight for the standard pour size
- D) Observing service from the floor and conducting visual estimates of glass fill levels
