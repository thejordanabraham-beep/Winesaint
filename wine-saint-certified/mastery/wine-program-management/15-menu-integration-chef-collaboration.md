...
**Level:** Wine Program Management Mastery — Menu Integration & Chef Collaboration
**Module:** 15
...
**Prerequisites:** Wine Saint Certified Level 2 or equivalent; Modules 1–14 recommended
...
## Section 1: The Beverage Director–Chef Relationship, Building Partnership, Not Silos
...
## Section 2: Menu Development Collaboration, Getting Involved Before the Menu Launches
...
## Section 3: Pairing Architecture, Designing Wine Pairings for Multi-Course Menus
...
## Section 4: Seasonal Menu Changes, Managing Wine List Transitions with the Kitchen
...
## Section 5: Tasting Menu & Pairing Package Economics
...
## Section 6: Staff Briefings on New Menus, Getting the Floor Ready for New Pairings
...
| Term | Definition |
|------|------------|
| **Pairing architecture** | The deliberate design of a multi-wine sequence to create a coherent, progressive guest experience across a multi-course meal, accounting for weight, acid, contrast, and pacing rather than treating each pairing as an independent decision |
| **Weight progression** | The principle that wines in a multi-course pairing should generally move from lighter to heavier body across the meal, mirroring the typical progression of course weight in a structured menu |
| **Complementary pairing** | A pairing strategy in which the wine shares structural or flavor characteristics with the dish, a rich, oaky Chardonnay with a cream sauce, so each element amplifies the other |
| **Contrasting pairing** | A pairing strategy in which the wine opposes the dish's dominant characteristic (a high-acid, low-body wine cutting through a fatty preparation) to refresh the palate rather than amplify richness |
| **Take rate** | The percentage of eligible guests who purchase an optional offering, such as a tasting menu wine pairing package; a key metric for evaluating floor presentation quality and package pricing effectiveness |
| **Pairing package** | A fixed set of wines, typically one per course, offered at a bundled price alongside a tasting menu or prix fixe format; designed to be presented as a single upsell decision rather than a course-by-course wine selection |
| **Menu development cycle** | The internal workflow through which a new menu is conceived, tested, costed, and trained before launch; typically spans four to eight weeks and includes concept, recipe development, internal tasting, and staff training phases |
| **Pre-service briefing** | A structured, time-limited staff meeting held before service begins, typically 10 to 20 minutes, used to communicate pairing logic, key selling points, and guest language for a new or updated menu |
| **Pairing reference card** | A one-page written document given to floor staff summarizing new pairings by course, with one sentence of pairing rationale and one guest-facing script line per pairing; designed to be used during service as a practical reference, not memorized |
| **Pour yield** | The number of portions a bottle of wine produces at a given pour size; calculated as bottle volume (approximately 25 oz) divided by pour size in ounces; critical for accurate pairing package cost-of-goods modeling |
| **Inventory overlap** | The period during a menu transition when wines selected for a previous menu remain in stock alongside newly introduced wines; requires deliberate sell-through or repositioning strategy to avoid stranded, slow-moving inventory |
| **Pairing hit list** | An internal document that maps each BTG wine to the specific dishes it was selected to complement; used to quickly identify which wines are affected when a dish changes mid-season |
| **Non-alcoholic pairing package** | A structured sequence of non-alcoholic beverages, juices, teas, house-made preparations, offered as an alternative to the wine pairing at a proportionally lower price point; requires independent cost modeling separate from the wine package |
| **Menu concept phase** | The earliest stage of the menu development cycle, in which culinary direction, ingredient sourcing, and course structure are determined; the optimal moment for beverage director involvement before individual recipes are finalized |
| **Facilitator notes** | Scripted guidance materials prepared by a corporate beverage director to enable property-level managers to run pairing briefings consistently across a multi-unit group without requiring the beverage director's direct presence at each property |
...
**Q1. A new seasonal menu launches in six weeks at your restaurant group. According to the transition protocol described in this module, what should you be doing at the six-week mark?**

- A) Finalizing BTG selections and submitting purchasing orders for new wines
- B) Receiving the concept brief from the culinary team and mapping current list coverage against the anticipated new menu
- C) Running all-staff briefings on the new pairings
- D) Attending recipe testing and beginning to finalize pairing recommendations

**Correct: B**

---

**Q2. A beverage director attends an internal menu tasting but does not bring any wines. What opportunity has been missed?**

- A) The chance to cost the new pairings before the menu launches
- B) The chance to receive wine pairing feedback from ownership
- C) The chance to taste wine alongside actual dishes to test pairing intuitions and signal commitment to the culinary team
- D) The chance to introduce new BTG wines to the kitchen team

**Correct: C**

---

**Q3. You are designing a six-course tasting menu pairing and notice that your written progression shows three consecutive wines increasing in weight and richness with no break. What does this signal?**

- A) A well-structured pairing that builds effectively toward the main course
- B) A pacing problem that will likely produce palate fatigue before the meal concludes
- C) A complementary pairing strategy that should be retained as designed
- D) A contrast-heavy sequence that may confuse guests

**Correct: B**

---

**Q4. What is the recommended maximum pour size per course for a tasting menu wine pairing, as described in this module?**
...
**Q5. A wine costs $18 per bottle. At a three-ounce pour, what is the cost of goods for a single pour of that wine?**
...
**Q6. Your tasting menu pairing package has a cost of goods of $16 per guest. Using a 75 percent margin target, what is the appropriate package price?**
...
**Q7. Which of the following best describes the purpose of a "pairing hit list" as introduced in this module?**

- A) A ranking of the most profitable wines in the BTG program
- B) A list of wines that have consistently underperformed on take rate
- C) An internal document mapping each BTG wine to the dishes it was selected to complement, used to identify which wines are affected when a dish changes
- D) A staff reference card for communicating pairings to guests during service

**Correct: C**

---

**Q8. A restaurant transitions to a new menu but fails to update its by-the-glass pairing recommendations before opening night. Which of the following is the most likely guest-facing consequence?**

- A) Guests will order more wine per cover because the new menu drives curiosity
- B) Staff will improvise pairing recommendations, producing inconsistent guest experiences
- C) The beverage director will receive accurate feedback from ownership about the transition
- D) Take rates on the pairing package will increase as guests self-select

**Correct: B**

---

**Q9. According to this module, when should a tasting menu pairing package be presented to guests?**

- A) After the first course arrives, once guests have experienced the food
- B) At the moment guests receive the tasting menu, before they have ordered anything
- C) Only if a guest specifically asks about wine options
- D) At the end of the meal as a way to introduce the concept for a future visit

**Correct: B**

---

**Q10. A beverage director wants to build a genuine collaborative relationship with the executive chef. Which of the following actions best establishes that relationship?**

- A) Presenting a complete list of wine pairings for the current menu without soliciting the chef's input
- B) Asking the chef to explain the flavor logic behind two or three current dishes before offering any pairing suggestions
- C) Arranging for the chef to attend a formal wine education seminar
- D) Proposing that the chef approve all future wine purchases before orders are placed

**Correct: B**

---

**Q11. What is the primary structural difference between a complementary pairing and a contrasting pairing?**

- A) Complementary pairings are used for red wines; contrasting pairings are used for white wines
- B) Complementary pairings amplify shared characteristics between wine and dish; contrasting pairings use opposition to refresh the palate
- C) Complementary pairings work only on tasting menus; contrasting pairings work on à la carte menus
- D) Complementary pairings are lower in cost of goods; contrasting pairings require prestige wine selections

**Correct: B**

---

**Q12. How long should a pre-service pairing briefing run to maximize floor staff retention, according to this module?**

- A) 30 to 45 minutes
- B) 45 to 60 minutes
- C) No more than 15 to 20 minutes
- D) 5 to 8 minutes
...
**Q13. A corporate beverage director oversees ten restaurant properties but cannot personally run pairing briefings at every location. What is the recommended solution?**

- A) Eliminate pre-service pairing briefings at non-flagship properties and distribute written materials only
- B) Hire one full-time traveling sommelier to run briefings across the portfolio
- C) Develop a standardized briefing kit (including a presentation deck, pairing reference card, and facilitator notes) so property-level managers can run briefings consistently
- D) Reduce the frequency of menu changes to limit the number of briefings required

**Correct: C**

---

**Q14. A chef adds a miso glaze to the halibut special mid-season without informing the wine team. This dish has a BTG white wine recommendation built around a clean, delicate preparation. What is the best immediate response?**

- A) Retrain the floor team on a new pairing before the next service using the existing BTG wine regardless
- B) Remove the dish from the wine pairing recommendation list without discussing it with the kitchen
- C) Trigger a brief check-in with the beverage team before the dish goes on the floor, per the mid-season change communication protocol, and assess whether the current BTG recommendation still holds
- D) Leave the existing recommendation in place until the full seasonal transition is completed

**Correct: C**

---

**Q15. A sommelier reviewing a tasting menu pairing sequence notices it moves from a richer oaked white at course four to a bone-dry sparkling wine at course five, then back to a heavy red at course six. What structural pairing principle does this sequence violate?**

- A) The acid management principle, the sequence lacks sufficient acidity overall
- B) The weight progression principle, the sequence breaks an otherwise increasing weight arc with a disorienting drop at course five rather than using it as a deliberate reset before the final course
- C) The contrast principle, the sequence uses too many complementary pairings consecutively
- D) The pour yield principle, the sparkling wine portion is too large relative to the other courses

**Correct: B**

---

**Q16. What is the recommended pricing range for a non-alcoholic pairing package relative to the wine pairing package at the same property?**

- A) 10 to 20 percent of the wine package price
- B) 40 to 60 percent of the wine package price
- C) 70 to 80 percent of the wine package price
- D) Non-alcoholic packages should be priced identically to wine packages

**Correct: B**

---

**Q17. At the beginning of a menu development cycle, a beverage director asks the chef broad questions about whether the new menu will lean toward acid-driven preparations or richer sauces. What is the purpose of asking at this early stage?**

- A) To lock in specific wine pairings before recipes are finalized
- B) To identify which BTG wines to promote in the weeks before the new menu launches
- C) To begin mapping list coverage against anticipated menu direction and flag potential problem areas before individual dishes are set
- D) To assess whether the chef requires additional wine education prior to menu development

**Correct: C**

---

**Q18. A beverage director delivers a pairing briefing but does not include a physical tasting of the wines. According to this module, what is the primary consequence of omitting the tasting component?**

- A) Staff will be unable to describe the wines' price points accurately to guests
- B) Ownership will not be able to evaluate whether the pairings are appropriate
- C) Staff retain pairing logic significantly less effectively than when they taste the wine alongside the dish
- D) The briefing will run too short to cover all pairings adequately

**Correct: C**

---

**Q19. A beverage director ends a pairing briefing with the challenge: "By the end of service tonight, each of you should have recommended the pairing to at least one table that didn't ask about it." What is the stated purpose of this challenge?**

- A) To generate immediate revenue data that can be reported to ownership after service
- B) To set a behavioral expectation alongside the knowledge expectation, and build the habit of active selling through a lightweight accountability touchpoint
- C) To identify which staff members are most qualified to run future pairing briefings
- D) To test whether the briefing content was retained before guests arrive

**Correct: B**

---

**Q20. A tasting menu has six courses, and a pairing package is offered at a take rate of 60 percent across 30 covers in a single Saturday service. The package is priced at $75 with a 75 percent margin. What is the approximate high-margin revenue generated from pairing packages in that service?**
