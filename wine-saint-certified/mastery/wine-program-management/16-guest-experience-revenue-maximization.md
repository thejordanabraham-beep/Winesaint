...
**Level:** Wine Program Management Mastery — Guest Experience & Revenue Maximization
**Module:** 16
...
**Prerequisites:** Wine Saint Certified Level 2 or equivalent; Modules 1–15 recommended
...
The third metric is **wine revenue as a percentage of total beverage revenue**. Across well-managed full-service programs, wine typically represents 45 to 60 percent of total beverage sales. If your wine percentage is below 35 percent, you are likely over-indexed on cocktails or beer and underperforming the revenue potential of your wine list. Tracking this ratio monthly lets you spot seasonal shifts, identify the impact of menu changes, and correlate beverage mix changes with staff turnover or training initiatives.
...
## Section 2: Guest Profiling — Reading the Table Before You Approach
...
## Section 3: The Upsell Framework — Anchoring, Bridging, and Upgrading
...
## Section 4: Managing the Wine Journey — From Aperitif Through Digestif
...
## Section 5: Loyalty and the Wine Guest — Building Regulars Through Wine Experience
...
## Section 6: Measuring Guest Satisfaction with the Wine Program
...
**Attach Rate** — The percentage of dining covers that include any wine purchase. Calculated as wine-purchasing covers divided by total covers for a given period. The primary indicator of floor-level wine engagement.

**Average Bottle Price** — Total bottle wine revenue divided by the number of bottles sold in a given period. A proxy for where guests are spending on the list and whether staff are guiding toward or away from specific price tiers.

**Wine Revenue Percentage** — Wine revenue as a share of total beverage revenue. A well-managed full-service program typically runs 45 to 60 percent. Significant deviation from this range signals program imbalance.

**Anchoring** — The first element of the upsell framework: presenting a specific, mid-tier bottle recommendation with a price, brief description, and contextual reason as the opening move in a wine guidance conversation.

**Bridging** — The second element of the upsell framework: the pivot from the anchor to a higher-priced option, framed as genuine insider knowledge rather than an upsell move. Effective bridging gives the guest clear permission to stay with the anchor.

**Upgrading** — The guest's decision to select a higher-priced option after bridging. In a guest-centered framework, upgrading is the guest's move, not the server's close.

**Aperitif Service** — The practice of offering a glass of wine, sparkling wine, or fortified wine as guests are seated and before the food order is placed. A tool for beginning beverage revenue capture early in the dining arc and setting a wine-forward tone for the experience.

**Digestif** — A post-dinner wine or spirit offered after the main course is complete. Includes fortified wines, sweet wines, and spirits. Frequently under-offered relative to guest receptivity.

**Wine Journey Arc** — The full sequence of wine opportunities in a dining experience, from aperitif through digestif. Managing the full arc rather than only the bottle with the main course is a key lever for per-cover revenue growth.

**Guest Profiling** — The practice of reading observable table signals — occasion type, wine familiarity, spend tier indicators — before the first wine approach to calibrate recommendation strategy.

**Wine Guest Loyalty** — The behavioral pattern of a guest who returns specifically for the wine experience and the feeling of being recognized and guided by the program. Defined by above-average return frequency, higher check averages, and higher beverage revenue per cover.

**Reservation Notes** — A field within a POS or reservation system used to record guest wine preferences, notable bottles, and past interactions to enable personalized wine service on return visits.

**Wine NPS (Net Promoter Score)** — A satisfaction metric derived from the question "How likely are you to recommend our wine program?" Scores of 9–10 are promoters; 0–6 are detractors. Wine NPS = % promoters minus % detractors.

**Server Debrief** — A structured post-service conversation between a manager or beverage director and floor staff to extract qualitative guest satisfaction data from notable wine interactions.

**Revenue Per Cover** — Total food and beverage revenue divided by the number of covers for a given service or period. Wine program management directly influences this number through attach rate, average bottle price, and full arc beverage revenue capture.

---

## Quiz — Module 16

**1.** A restaurant serves 250 covers on a Friday night. Wine is purchased by 80 of those covers. What is the attach rate?
...
**2.** Which of the following best describes what attach rate measures?

- A) The average price of bottles sold during a service
- B) The percentage of covers that include any wine purchase
- C) The ratio of wine revenue to food revenue
- D) The number of bottles sold per server per shift

**Correct: B**

---

**3.** A program generates $9,600 in bottle wine revenue by selling 120 bottles in one week. What is the average bottle price?
...
**4.** In a well-managed full-service restaurant, wine revenue typically represents what percentage of total beverage revenue?
...
**5.** Which of the following is NOT one of the three primary wine revenue metrics discussed in this module?

- A) Attach rate
- B) Average bottle price
- C) Cellar turnover rate
- D) Wine revenue as a percentage of total beverage

**Correct: C**

---

**6.** During guest profiling, a server observes that two guests are dressed formally, have a printed agenda on the table, and one appears to be conducting the conversation. What occasion type does this most likely indicate?
...
**7.** A guest opens the wine list immediately and navigates to the Burgundy section without consulting their companion. This is primarily a signal of:

- A) High spend intent
- B) Wine familiarity and confidence
- C) A celebration occasion
- D) Preference for Old World wine only

**Correct: B**

---

**8.** In the Anchor-Bridge-Upgrade framework, what is the primary purpose of the anchor?

- A) To establish the server's authority as an expert
- B) To present the highest-margin bottle on the list
- C) To offer a specific mid-tier recommendation that establishes a reference price
- D) To identify the guest's exact budget before proceeding

**Correct: C**

---

**9.** Which phrase is cited in this module as a psychologically effective bridging tool because it gives guests explicit permission to stay with the anchor?

- A) "Our most popular selection right now is..."
- B) "If budget isn't a constraint..."
- C) "Most guests at this price point choose..."
- D) "I would personally recommend spending a bit more on..."

**Correct: B**

---

**10.** What is the recommended timing for offering a second bottle or additional wine during service?

- A) After the current bottle is completely empty
- B) Before the current bottle is empty, while guests still have wine in their glasses
- C) Only if the guest makes eye contact with the server
- D) At the same time the dessert menu is presented

**Correct: B**

---

**11.** Which of the following best describes why aperitif service increases beverage revenue?

- A) It replaces the need for bottle sales during the main course
- B) It begins revenue capture before the food order and creates a natural entry into a wine conversation
- C) It increases food order size by stimulating appetite
- D) It gives the kitchen additional time to prepare the first course

**Correct: B**

---

**12.** A restaurant tracks digestif and dessert wine cover attachment as a separate metric and finds it is running at 4%. What does this most likely indicate?

- A) Guests do not enjoy sweet or fortified wines
- B) The digestif selection is priced too high
- C) Floor staff are not consistently making the offer at the end of the meal
- D) The dessert menu is underperforming relative to the wine list

**Correct: C**

---

**13.** Wine loyal guests — those who return specifically for the wine experience — typically represent what percentage of total cover count but what share of wine revenue?

- A) 20–25% of covers; 40–50% of wine revenue
- B) 8–12% of covers; 25–35% of wine revenue
- C) 5–8% of covers; 15–20% of wine revenue
- D) 15–20% of covers; 30–40% of wine revenue

**Correct: B**

---

**14.** Which of the following is the most effective tool for enabling personalized wine recognition for returning guests at scale?

- A) Requiring all servers to memorize the names of top-spending guests
- B) A dedicated sommelier assigned to all repeat guests
- C) Structured reservation notes documenting guest wine preferences after each visit
- D) A printed wine preference card given to guests on their first visit

**Correct: C**

---

**15.** In the context of post-visit surveys, which of the following question types generates the most actionable wine-specific satisfaction data?

- A) "How was your overall dining experience this evening?"
- B) "Would you recommend this restaurant to a friend?"
- C) "How would you rate the guidance you received in selecting wine this evening?"
- D) "How satisfied were you with the value of your meal?"

**Correct: C**

---

**16.** Which of the following is described as a source of guest satisfaction data that surfaces information surveys cannot capture?

- A) Online review platforms
- B) Corporate guest feedback forms
- C) Floor observation and table visits by a manager during service
- D) Monthly beverage cost reconciliation reports

**Correct: C**

---

**17.** Wine NPS is calculated as:

- A) Average wine score minus average food score
- B) Percentage of promoters minus percentage of detractors
- C) Total wine revenue divided by total covers
- D) Number of returning wine guests divided by total guests

**Correct: B**

---

**18.** A Wine NPS score below +20 is described in this module as a signal that which aspect of the program needs attention?

- A) List pricing and margin structure
- B) Cellar management and inventory quality
- C) The guest experience, not the list or pricing
- D) Staff sommelier credentialing and certification levels

**Correct: C**

---

**19.** What distinguishes a program that grows systematically from one that grows only tactically?

- A) A larger wine list with more SKUs and regions
- B) Higher average bottle price targets and more aggressive upsell training
- C) Continuous measurement of guest satisfaction alongside revenue metrics, enabling data-driven program adjustment
- D) A dedicated sommelier on floor for every service

**Correct: C**

---

**20.** A beverage director wants to evaluate whether a recent staff training initiative improved wine revenue performance. Which combination of metrics would provide the most complete picture?

- A) Cellar turnover rate and food cost percentage
- B) Attach rate, average bottle price, and wine revenue as a percentage of total beverage
- C) Total bottle count sold and number of servers trained
- D) POS transaction count and reservation volume

**Correct: B**

---

*End of Module 16 — Wine Saint Certified | Wine Program Management Mastery*
