...
**Level:** Wine Program Management — The Beverage Director's Role
**Module:** 1
...
## Section 1: The Scope of the Role
...
## Section 2: Stakeholder Management
...
## Section 4: Building a Program Culture
...
## Section 5: Program Vision and Standards
...
## Section 6: What Separates Great Programs from Good Ones
...
| Term | Definition |
|------|-----------|
| Beverage Director | The individual responsible for the full scope of a hospitality operation's beverage program, including list curation, staff training, vendor relationships, financial performance, and service standards |
| Beverage Philosophy | A concise written statement of the beliefs and principles that guide all decisions within a beverage program; functions as a practical decision-making tool rather than a marketing document |
| P&L Ownership | Full accountability for the profit and loss performance of the beverage program, including both revenue generation and cost management |
| Beverage Cost Percentage | The ratio of the cost of goods sold for beverages to total beverage revenue, expressed as a percentage; a primary but incomplete measure of financial efficiency |
| Margin Dollars | The gross profit generated per sale, calculated as selling price minus cost; a more complete measure of program profitability than cost percentage alone |
| By-the-Glass Portfolio | The curated selection of wines available in single-glass pours; typically the highest-margin and highest-velocity component of a beverage program |
| Stakeholder Management | The ongoing practice of identifying, understanding, and building credibility with the individuals and groups who have interests in or authority over the beverage program |
| Service Standard | A defined, enforceable expectation for how wine is presented, opened, poured, and communicated during guest service |
| Program Culture | The shared beliefs, behaviors, and norms within a team that determine how wine is treated and sold during everyday service, independent of direct supervision |
| Velocity | The rate at which a specific wine moves through inventory; a key metric for evaluating list efficiency and identifying underperforming SKUs |
| Coherence | The alignment between a program's list, service style, staff knowledge, and guest context such that each element reinforces the others and tells a consistent story |
| Distributor Relationship | The commercial and professional relationship between a beverage program and its wholesale suppliers; when managed well, a source of value beyond the transaction |
| Revenue Per Cover | Total revenue divided by the number of guests served; a key metric that reflects the overall productivity of a service period and is directly influenced by wine sales performance |
| Staff Buy-In | The genuine belief and enthusiasm that floor staff have in the beverage program, which drives voluntary and effective wine recommendations during service |
| List Curation | The deliberate, ongoing process of selecting, editing, and organizing the wines that appear on a beverage menu, guided by a defined philosophy and commercial strategy |

---

## Quiz — The Beverage Director's Role
**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. Which of the following best describes the primary difference between a beverage director role in corporate hospitality versus independent fine dining?**
- A) Corporate beverage directors focus exclusively on financial metrics while fine dining directors focus on quality
- B) Corporate beverage directors typically operate at a remove from the service floor, building systems and standards rather than relying on personal floor presence
- C) Fine dining beverage directors manage more staff and larger budgets
- D) Corporate beverage directors are not responsible for wine list curation

**Correct: B**

---

**Q2. A beverage director at a multi-unit corporate account is frustrated that service standards are inconsistently applied across properties. Which approach is most likely to produce lasting improvement?**
- A) Visit each property in person every week to monitor compliance
- B) Send a written memo to all property managers outlining the standards
- C) Build feedback loops such as manager observation checklists and brief post-service debriefs that surface compliance without requiring constant personal presence
- D) Reduce the number of service standards to the three most important

**Correct: C**

---

**Q3. According to the module, why is cost percentage alone an insufficient measure of beverage program financial performance?**
- A) Cost percentage is calculated differently in corporate hospitality than in independent restaurants
- B) A wine sold at a higher cost percentage but with strong velocity can contribute more gross profit dollars than a lower-cost wine that moves slowly
- C) Distributors inflate cost percentages in corporate accounts
- D) Cost percentage does not account for labor expenses

**Correct: B**

---

**Q4. A beverage director is building their annual training plan. Which format does this module identify as the most powerful ongoing cultural tool?**
- A) A four-hour annual training day covering all wines on the list
- B) Monthly written assessments sent to all front-of-house staff
- C) Brief, regular, informal pre-shift tastings conducted frequently
- D) Online video modules that staff can complete on their own schedule

**Correct: C**

---

**Q5. Which of the following best qualifies as a beverage philosophy, as defined in this module?**
- A) "We are committed to delivering outstanding guest experiences through exceptional wine service"
- B) "We offer wines from around the world at every price point to satisfy all guest preferences"
- C) "We build our list around producers who work their own land, prioritizing underrepresented regions at price points that make daily drinking accessible"
- D) "We source our wines through relationships with premium distributors across the country"

**Correct: C**

---

**Q6. A server at your property tells a guest that the Grüner Veltliner is "kind of like a Sauvignon Blanc" and the guest orders it and loves it. What does this module suggest the beverage director should do?**
- A) Correct the server's description in a one-on-one meeting after service
- B) Celebrate the recommendation publicly and use the server's language as the basis for a training example
- C) Revise the written wine notes for the Grüner Veltliner to match the server's description
- D) Have the server complete additional study on Austrian wine varietals

**Correct: B**

---

**Q7. According to this module, what is the relationship between a well-run beverage program and overall restaurant financial performance?**
- A) A strong beverage program primarily improves food cost percentage by increasing table revenue
- B) Beverage revenue is largely independent of the restaurant's other financial metrics
- C) A well-run beverage program increases average check, improves labor efficiency, and drives return visitation, all of which affect the broader P&L
- D) The beverage program is a secondary revenue line and should not be expected to influence overall business performance

**Correct: C**

---

**Q8. Which of the following stakeholder groups does this module identify as the beverage director's most important constituency for program execution?**
- A) Ownership and corporate leadership
- B) Distributor representatives
- C) General managers
...
**Q9. A distributor representative offers a beverage director early access to a highly allocated Napa Cabernet at favorable pricing. The wine is excellent, but it doesn't align with the program's stated philosophy around underrepresented regions and accessible price points. What is the correct decision-making framework?**
- A) Accept the offer because strong allocations always benefit a beverage program
- B) Evaluate the offer against the program's beverage philosophy; if it doesn't fit, decline regardless of the commercial terms
- C) Accept the offer and add the wine as a special feature outside the main list structure
- D) Consult with the GM before making any decision about high-profile allocations

**Correct: B**

---

**Q10. According to the module, what does it mean for a beverage program to have "coherence"?**
- A) All wines on the list share a common style profile that appeals to a broad audience
- B) The list, service style, staff knowledge, and physical environment all tell the same story and reinforce each other
- C) The program maintains consistent pricing across all categories and price tiers
- D) The beverage director personally approves every wine added to or removed from the list

**Correct: B**

---

**Q11. A new beverage director inherits a program where wine knowledge is concentrated almost entirely in one senior sommelier. What does this module identify as the primary risk of this situation?**
- A) The senior sommelier is likely underpaid and will leave for a competitor
- B) The program is a vulnerability — it depends on one person's presence rather than a distributed, system-supported culture
- C) Staff resent the sommelier's authority and are unlikely to follow wine recommendations
- D) Guests prefer interacting directly with a sommelier rather than with servers

**Correct: B**

---

**Q12. Which of the following best describes the concept of "revenue per cover" and its relevance to the beverage director?**
- A) It measures how much each wine costs per glass poured and determines pricing strategy
- B) It is a metric used only by ownership and is not relevant to beverage program management
- C) It reflects total revenue divided by guests served, and is directly influenced by how effectively wine is sold during service
- D) It is calculated by dividing total beverage revenue by the number of wine SKUs on the list

**Correct: C**

---

**Q13. According to the module, how should a beverage director approach the relationship between training investment and labor efficiency?**
- A) Training is a soft expense that should be minimized in high-turnover environments
- B) Training is a labor efficiency investment — staff with wine knowledge generate more productive service interactions and higher revenue per hour
- C) Training should focus exclusively on legal compliance and safe service rather than wine knowledge
- D) Training ROI is too difficult to measure in a hospitality context to justify significant investment

**Correct: B**

---

**Q14. You are a beverage director preparing for a quarterly review with your GM. Which of the following approaches does this module recommend?**
- A) Focus the conversation on the quality of new additions to the wine list and upcoming vintages
- B) Present challenges the program is facing and request budget to address them
- C) Arrive with data — what's selling, margin performance, training completion — and frame beverage as a source of good news rather than problems
- D) Let the GM lead the agenda and respond to questions as they arise

**Correct: C**

---

**Q15. A beverage director wants to evaluate whether their program has a genuine "point of view" as described in this module. What is the most direct method for making that assessment?**
- A) Review the list to count how many wines come from each country of origin
- B) Calculate total list size and compare it to industry benchmarks for programs of similar size
- C) Ask trusted regular guests what they believe the program stands for after experiencing a full service
- D) Review distributor invoices to determine whether purchasing decisions reflect a consistent style preference

**Correct: C**

---

**Q16. According to the module, what separates a service standard that actually changes behavior from one that is quickly forgotten?**
- A) Written standards are always more effective than verbally communicated ones
- B) Standards must be introduced through demonstration, practiced in training, and reinforced through positive recognition — not delivered as memos or policy updates
- C) Standards should be simplified to a single page so staff can easily memorize them
- D) Enforcement through corrective action is the most reliable way to sustain standard compliance

**Correct: B**

---

**Q17. A beverage director's monthly SKU analysis shows that five wines have not moved in over 60 days. According to this module, what does this represent?**
- A) A healthy sign that the list has depth and variety for guests with specific tastes
- B) A capital and shelf-space cost that warrants immediate evaluation and likely removal or replacement
- C) An opportunity to offer those wines at a discount to drive trial
- D) A distributor relationship issue that should be addressed in the next rep meeting

**Correct: B**

---

**Q18. Which of the following most accurately describes the role of a beverage director as a "translator," as used in this module?**
- A) Providing guests with wine descriptions that translate technical language into approachable terms
- B) Moving fluently between technical, commercial, operational, and educational modes depending on the audience — from ownership to chefs to staff to guests
- C) Ensuring that the wine list includes wines from multiple countries and languages
- D) Translating distributor pricing into cost percentages for the GM's review
