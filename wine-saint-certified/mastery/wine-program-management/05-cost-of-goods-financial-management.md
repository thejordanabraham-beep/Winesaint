# Cost of Goods & Financial Management: Running a Wine Program Like a Business
...
- Calculate pour cost accurately and explain why it is an incomplete measure of program health on its own
- Read a beverage profit and loss statement and identify where performance is strong, where it is weak, and what action to take
- Distinguish between cost of goods purchased and cost of goods sold, and use inventory variance to investigate theft, waste, and over-pouring
- Quantify how beverage attachment rates affect overall restaurant profitability and construct a compelling business case for ownership
- Build a forward-looking beverage budget with daily and weekly forecasts aligned to purchasing cycles
- Select the right financial reports, read them at the right cadence, and present findings to ownership in language that earns budget authority
- Apply real financial formulas and worked calculations to your own program data

---

## Section 1: Understanding Pour Cost

Pour cost is the first financial metric most beverage professionals learn and the one most frequently misunderstood. At its core, the calculation is straightforward:
...
|---|---|---|
| Gross Beverage Sales | 48,200 | Total revenue before any deductions |
| Less: Comps & Voids | (1,440) | Discounted or removed checks |
| Net Beverage Sales | 46,760 | The top line for all % calculations |
| Cost of Goods Sold | 15,430 | What you paid for product that was sold |
| Gross Profit | 31,330 | Net sales minus COGS |
| Gross Margin % | 67.0% | Gross profit ÷ net sales |
| Labor (allocated) | 8,800 | Sommelier, bar staff wages and benefits |
...
> **Pro Tip:** Request that your accounting team provide the P&L with both dollar amounts and percentages for every line item. When you present to ownership, convert every significant variance into a dollar impact. "Our COGS is 2.3 percentage points higher than last month" means less to a GM than "that 2.3-point increase cost us $1,075 in gross margin last month." Specificity earns credibility.
...
**Cost of Sales** is what you actually sold. It is calculated as:
...
**Variance = Theoretical Cost of Sales − Actual Cost of Sales**

If POS data says you should have used $8,200 in product but your physical inventory calculation shows $8,800 was consumed, your variance is **$600 unfavorable**. That $600 went somewhere it is not reflected in revenue.
...
| Day | Revenue Share | Example (of $42,000/week) |
|---|---|---|
| Monday | 8% | $3,360 |
| Tuesday | 9% | $3,780 |
| Wednesday | 11% | $4,620 |
...
The ability to generate accurate financial reports is table stakes. The ability to read them at the right cadence, extract the right signals, and translate them into clear decisions is what distinguishes high-performing beverage directors from those who are perpetually reactive.

**The core report stack for a beverage program:**

| Report | Frequency | What You Are Looking For |
|---|---|---|
| Daily sales by category | Daily | Revenue by daypart, BTG vs. bottle split, variance from forecast |
| Weekly P&L flash | Weekly | Revenue vs. budget, pour cost trend, gross margin dollars |
| Inventory count (BTG spot) | Weekly | BTG variance by SKU, over-pour detection |
| Full inventory count | Monthly | Actual COGS calculation, cellar value, slow-mover identification |
| Full P&L with prior year | Monthly | Year-over-year performance, trend identification |
| Vendor statement reconciliation | Monthly | Invoice accuracy, pricing compliance, credit verification |
| Annual beverage budget vs. actual | Quarterly | Budget variance by category, forecast revision |
...
| Term | Definition |
|------|------------|
| Pour Cost % | The ratio of product cost to revenue: cost of product sold ÷ beverage revenue. Expressed as a percentage; industry benchmark for wine is 28–35%. |
| Gross Margin | Revenue remaining after deducting cost of goods sold. Expressed as either a dollar amount (gross margin dollars) or percentage (gross margin %). The primary measure of program operational efficiency. |
| Cost of Goods Sold (COGS) | The actual cost of product consumed during a period, calculated as: beginning inventory + purchases − ending inventory. Distinct from purchases made during the period. |
| Inventory Variance | The gap between theoretical product usage (derived from POS sales data) and actual product usage (derived from physical inventory). Unfavorable variance indicates theft, waste, over-pouring, or unrecorded comps. |
| Theoretical Usage | The quantity of product that should have been consumed based on POS transaction data and standard pour specifications. Used as the benchmark against which actual usage is measured. |
| Beverage Attachment Rate | The percentage of guests (or covers) who order a beverage item. A key driver of check average and gross margin dollars; calculated as: beverage-ordering guests ÷ total guests. |
| Day-Part | A defined segment of the service day (e.g., lunch, happy hour, dinner) used to analyze revenue distribution, staffing efficiency, and demand patterns. |
| Inventory Velocity | How quickly individual SKUs sell through, typically expressed as turns per month (bottles sold ÷ bottles on hand). Low-velocity items represent tied-up working capital. |
| Working Capital | Liquid resources available for operational use. In a beverage program context, excessive cellar inventory reduces working capital by converting cash into illiquid stock. |
| Rolling Forecast | A financial projection that is continuously updated as actual results become available, extending the forecast window forward by one period as each period closes. More accurate than a static annual budget. |
| Check Average | The average total spend per guest or per cover. Wine sales increase check average both directly (via wine revenue) and indirectly (via wine-food pairing behaviors that increase food spend). |
| Labor Cost Ratio | Total labor expense expressed as a percentage of net revenue. Wine sales improve the ratio by increasing revenue without proportionally increasing labor cost. |
| Payback Period | The time required for an investment to generate sufficient returns to recover its initial cost. Framing capital requests in payback terms (weeks or months, not abstract ROI) is the most persuasive ownership communication format. |
| BTG (By-the-Glass) | Wine sold by the individual pour rather than the full bottle. Typically carries lower pour cost than bottle sales due to higher per-unit markup, but is more vulnerable to execution variance (over-pouring, spillage). |
| Gross Sales vs. Net Sales | Gross sales is total revenue before deductions. Net sales deducts comps, voids, and employee meals. COGS and pour cost should always be calculated against net sales; using gross sales produces a misleadingly favorable pour cost. |
...
**Q1. A restaurant sells a glass of wine for $15. The bottle cost $18 and yields 5 glasses. What is the pour cost on that glass?**
- A) 18%
- B) 24%
- C) 30%
- D) 36%
...
**Q2. Your BTG program generates $9,200 in revenue this week with $2,484 in product cost. Your bottle program generates $11,800 in revenue with $4,248 in product cost. What is your blended wine pour cost?**
- A) 28.0%
- B) 31.9%
- C) 34.8%
- D) 36.0%
...
**Q3. Which of the following statements best explains why a program with a 34% pour cost may be more financially valuable than one with a 27% pour cost?**
- A) Lower pour cost always indicates better program management
- B) A higher pour cost reflects more premium wine selections, which guests prefer
- C) The 34% program may be generating significantly higher gross margin dollars on greater revenue volume
- D) Pour cost above 30% is acceptable only in fine dining contexts

**Correct: C**

---

**Q4. A beverage P&L shows net sales of $52,000, COGS of $18,200, and gross profit of $33,800. What is the gross margin percentage?**
- A) 35.0%
- B) 54.5%
- C) 65.0%
- D) 72.4%
...
**Q5. You begin the month with $16,400 in wine inventory at cost, receive $9,200 in deliveries, and end the month with $14,800 in inventory. What is your cost of sales for the month?**
- A) $9,200
- B) $10,400
- C) $10,800
- D) $11,600
...
**Q6. POS data indicates your BTG program should have consumed $6,100 in product last month. Your physical inventory calculation shows $6,740 was actually consumed. What is your variance, and what does it most likely indicate?**
- A) $640 favorable; the program outperformed sales projections
- B) $640 unfavorable; likely indicating theft, over-pouring, waste, or unrecorded comps
- C) $640 unfavorable; indicating a pricing error on the menu
- D) $640 favorable; indicating strong purchasing efficiency

**Correct: B**

---

**Q7. A sommelier consistently pours 5.5 oz instead of the standard 5 oz for BTG pours. If the program generates $9,000 per week in BTG revenue at a target 5 oz pour, approximately how much revenue is being lost per week to over-pouring?**
- A) $450
- B) $600
- C) $750
- D) $900
...
**Q8. A restaurant has 300 covers on a Friday night. The beverage attachment rate is 32% and the average beverage spend per attaching guest is $28. If attachment improves to 42%, how much additional beverage revenue is generated that evening?**
- A) $420
- B) $560
- C) $840
- D) $1,260
...
**Q9. Total beverage labor for a Saturday night is $3,200. Scenario A produces $19,500 in beverage revenue; Scenario B produces $24,100. What is the labor cost ratio in each scenario, and what accounts for the difference?**
- A) 16.4% and 13.3%; the difference is driven by the labor schedule, not revenue
- B) 16.4% and 13.3%; higher revenue volume in Scenario B improves the ratio without adding labor
- C) 13.3% and 16.4%; labor is proportionally lower in Scenario A due to less service complexity
- D) Both scenarios produce the same labor ratio since labor cost is identical

**Correct: B**

---

**Q10. Which of the following is the correct formula for calculating inventory variance?**
- A) Beginning inventory minus ending inventory
- B) Purchases minus cost of sales
- C) Theoretical cost of sales minus actual cost of sales
- D) COGS minus operating expenses

**Correct: C**

---

**Q11. You are building a payback-period argument for a $5,000 staff wine training investment. Based on your analysis, the training will improve BTG attachment by 5 points, generating $1,800 per month in additional gross margin. What is the payback period, and how would you present this to ownership?**
- A) 2.1 months; frame it as "the investment recovers within a single quarter"
- B) 2.8 months; frame it as "the investment breaks even before the next training cycle"
- C) 5.2 months; frame it as "a long-term talent investment"
- D) 12 months; frame it as "an annual program improvement initiative"

**Correct: B**

---

**Q12. Which financial metric is most directly improved when wine revenue increases while labor costs remain fixed?**
- A) Pour cost percentage
- B) Labor cost ratio
...
**Q13. Your monthly full P&L shows COGS trending upward for three consecutive months despite stable revenue. Before waiting for the next monthly report, what is the most appropriate immediate action?**
- A) Reduce the BTG list to fewer wines to simplify inventory tracking
- B) Pull a physical inventory count and run a theoretical vs. actual reconciliation to identify variance sources
- C) Adjust menu prices upward to offset the rising COGS percentage
- D) Increase purchasing volumes to qualify for distributor volume discounts

**Correct: B**

---

**Q14. A wine priced at cost for $38 has turned 0.2 times per month over the past four months. What does this indicate, and what is the appropriate response?**
- A) The wine is performing at the industry standard velocity; no action required
- B) The wine is a high-value cellar asset; increase allocation purchasing
- C) The wine is a slow-mover consuming working capital; merchandise aggressively, feature as BTG, or liquidate
- D) The wine's velocity is normal for bottle sales and reflects seasonal demand patterns

**Correct: C**

---

**Q15. When presenting beverage financial performance to ownership, which format is most likely to earn budget authority and professional credibility?**
- A) A detailed tasting notes summary accompanied by regional maps for context
- B) A verbal report referencing pour cost percentage compared to industry benchmarks
- C) A one-page scorecard showing revenue vs. budget, gross margin dollars, pour cost trend, one improvement metric, and one investment request with projected return
- D) A full wine list review with pricing rationale and producer biographies

**Correct: C**

---

**Q16. Your restaurant has 400 covers on Saturday with a 28% beverage attachment rate and $31 average beverage spend. You improve attachment to 40% through a new BTG list and service training. Assuming the same cover count and spend-per-attaching-guest, what is the incremental weekly gross margin if wine gross margin is 68%?**
- A) $744
- B) $1,008
- C) $1,488
- D) $2,196
...
**Q17. The difference between "gross sales" and "net sales" on a beverage P&L is most accurately described as:**
- A) The difference between food revenue and beverage revenue
- B) Gross sales less comps, voids, and employee meal deductions
- C) The gross profit margin expressed in dollar terms
- D) The gap between theoretical and actual revenue

**Correct: B**

---

**Q18. A beverage director requests that the accounting team provide the P&L with both dollar amounts and percentages. The primary reason for this request is:**
- A) To comply with standard accounting software output formats
- B) To make it easier to calculate labor cost without a calculator
- C) To enable rapid identification of line-item variances in both scale and proportion, allowing more accurate diagnosis of performance issues
- D) To allow the director to report pour cost to ownership without additional calculation

**Correct: C**

---

**Q19. Which of the following describes a "rolling forecast" and why it is superior to a static annual budget for beverage program management?**
- A) A rolling forecast averages the prior three years of data; it is superior because historical averages are more reliable than projections
- B) A rolling forecast updates forward projections as actual results land, keeping assumptions current and allowing faster response to changing conditions
- C) A rolling forecast is updated annually at the end of the fiscal year to incorporate full-year actuals
- D) A rolling forecast eliminates the need for monthly P&L review by projecting future performance automatically
