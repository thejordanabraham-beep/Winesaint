...
**Level:** Wine Program Management — Pricing Strategy & Margin Engineering
**Module:** 4
...
## Section 1: The Markup Models, Flat, Tiered, and Cost-Plus
...
## Section 2: Tiered Pricing in Practice, Designing a Structure That Works
...
| Tier | Cost | Sell Price | Margin/Bottle | × 8 Sells × Count | Monthly Margin |
|---|---|---|---|---|---|
| $14 avg | $14 | $42 | $28 | × 80 | $2,240 |
| $32 avg | $32 | $96 | $64 | × 120 | $7,680 |
| $65 avg | $65 | $195 | $130 | × 80 | $10,400 |
| $140 avg | $140 | $420 | $280 | × 40 | $11,200 |
| **Total** | | | | | **$31,520** |

**Tiered markup, same sells:**

| Tier | Cost | Multiplier | Sell Price | Margin/Bottle | × Sells | Monthly Margin |
|---|---|---|---|---|---|---|
| $14 avg | $14 | 3.5× | $49 | $35 | × 80 | $2,800 |
| $32 avg | $32 | 3.0× | $96 | $64 | × 120 | $7,680 |
| $65 avg | $65 | 2.5× | $163 | $98 | × 80 | $7,840 |
| $140 avg | $140 | 2.0× | $280 | $140 | × 40 | $5,600 |
| **Total** | | | | | | **$23,920** |
...
## Section 3: By-the-Glass Pricing, A Discipline of Its Own
...
## Section 4: Psychological Pricing, How Guests Actually Read a Wine List
...
## Section 5: Premium and Collector Wine Pricing, Trophy Bottles, Library Wine, and Allocated Selections
...
A standard markup model applied to a bottle of 2019 Harlan Estate, which you acquired at $350 per bottle, yields a list price of $700–$875 depending on your multiplier. But the retail market for 2019 Harlan is $450–$550 on the secondary market, and collectors know it. A $700 list price is below the luxury auction price for this bottle. A 3x markup at $1,050 is well above it.
...
## Section 6: Pricing Reviews and Adjustments, Building a Living Pricing System
...
| Term | Definition |
|---|---|
| **Flat Multiplier** | A pricing model that applies a single, fixed multiplier (e.g., 3×) to the cost of every bottle on the list, regardless of price tier. Simple to administer but generates margin inequity across price points. |
| **Tiered Multiplier** | A pricing model that applies progressively lower multipliers to higher-cost bottles. Designed to make premium wine more accessible while maintaining strong margin on entry-level selections. |
| **Cost-Plus Pricing** | A model that adds a fixed dollar amount to the bottle cost rather than applying a percentage multiplier. Compresses the price gap between cheap and expensive wine; requires careful adjustment at the high end to protect margin on trophy bottles. |
| **Pour Cost Percentage** | The ratio of the cost of a product to the revenue it generates, expressed as a percentage. Formula: Cost ÷ Revenue = Pour Cost %. A BTG selection with a $3.10 effective cost per pour priced at $13 runs a 23.8% pour cost. |
| **Contribution Margin** | The gross profit per unit sold, the revenue from a bottle or pour minus the direct cost of that product. Used to compare the profitability of individual selections regardless of their price tier. |
| **Yield Factor** | The number of usable pours obtained from a single bottle, accounting for inevitable loss. For a 750mL bottle with 5-ounce pours, the theoretical yield is 5; the practical yield factor is approximately 4.7 after loss. |
| **Price Anchoring** | A cognitive bias in which the first price a consumer encounters establishes a reference point that influences how all subsequent prices are judged. On wine lists, the opening price of a category section anchors the guest's sense of normal spending. |
| **Decoy Effect** | A pricing phenomenon in which a third option, positioned to make one of two existing options appear superior in value, shifts purchase behavior toward the superior option. Used deliberately in list design to drive traffic toward target selections. |
| **Second-Cheapest-Bottle Effect** | The documented tendency of guests in social or uncertain settings to avoid the cheapest item on a list (to avoid appearing cheap) and select the second-cheapest option instead. A well-designed list intentionally places a high-margin selection in the second position. |
| **Market-Based Pricing** | A pricing approach for rare and allocated wines in which list price is set relative to secondary market trading value rather than to acquisition cost and a markup multiplier. Appropriate when the secondary market price exceeds cost-based list price. |
| **Library Premium** | An additional pricing component for aged wines held in the program's cellar for extended periods, reflecting storage costs, capital carrying cost, and the value of presenting a wine at or near its drinking window. |
| **Oxidation Write-Off** | Revenue lost when an opened BTG bottle deteriorates before all pours are sold. Managed through BTG pricing that accounts for loss, selection of more oxidation-stable varietals, or removal of vulnerable wines from the BTG program. |
| **Pricing Master Sheet** | A working spreadsheet that tracks all wine list selections with their current acquisition cost, list price, effective markup, pour cost percentage, and recent sales velocity. The operational foundation of any systematic pricing review process. |
| **Sell-Through Velocity** | The rate at which a wine sells over a defined period, typically measured in bottles per month. A key input for identifying slow-moving inventory, retirement candidates, and over-ordered selections. |
| **Distributor Cost Increase** | A supplier-side price adjustment passed through the distribution chain that raises the per-bottle acquisition cost. Can be absorbed (margin declines), passed through (list price adjusts), or addressed through a hybrid approach. |

---

## Quiz: Pricing Strategy & Margin Engineering

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. A restaurant applies a flat 3× markup to every bottle on its wine list. A bottle costing $12 sells for $36; a bottle costing $100 sells for $300. Which of the following best describes the financial equity of this structure?**

- A) The model is equitable because both bottles generate the same percentage margin
- B) The model disproportionately rewards guests who buy inexpensive wine and penalizes guests who buy premium wine in gross margin terms
- C) The model is optimal for programs with a predominantly premium buyer profile
- D) The $100 bottle generates the same gross margin per transaction as the $12 bottle

**Correct: B**

---

**Q2. Under a tiered markup structure, a bottle costing $65 is priced using a 2.5× multiplier. What is the resulting list price and gross margin per bottle?**

- A) List price $162.50; gross margin $97.50
- B) List price $195.00; gross margin $130.00
- C) List price $130.00; gross margin $65.00
- D) List price $162.50; gross margin $65.00

**Correct: A**

---

**Q3. A beverage director is considering replacing a flat 3× markup with a tiered structure. A skeptical owner asks, "What if premium bottles don't sell more under the new pricing?" What is the most financially sound response?**

- A) The tiered model will always generate more total revenue because it drives volume
- B) Even with flat volume, the program margin stays within 5–10% of the current model while substantially improving guest experience in the premium tier
- C) The tiered model only works if premium sales increase by at least 30%
- D) The flat multiplier should be retained because it is more predictable

**Correct: B**

---

**Q4. The industry rule "price your BTG pour at the cost of the whole bottle" is best understood as:**

- A) The target price point for maximizing BTG revenue
- B) A floor, the minimum required to recover bottle cost even if only one glass is sold
- C) A ceiling that prevents overpricing BTG selections
- D) The standard for Champagne and sparkling BTG pricing only

**Correct: B**

---

**Q5. A Grüner Veltliner costs $18 per bottle. Using a yield factor of 4.7 and a 12% loss allowance, what is the effective cost per pour?**
...
**Correct: C** *(Calculation: $18 ÷ 4.7 = $3.83; $3.83 × 1.12 = $4.29, rounds to $4.30)*

---

**Q6. A BTG program targets a 28% pour cost. If the effective cost per pour (after yield factor and loss adjustment) is $4.30, what is the minimum BTG price required to hit that target?**
...
**Correct: B** *($4.30 ÷ 0.28 = $15.36)*

---

**Q7. Which varietals or wine types are most likely to require higher BTG pricing to offset oxidation write-off risk?**

- A) Robust reds such as Barolo and Châteauneuf-du-Pape
- B) High-acid whites such as Muscadet and Vermentino, and all sparkling wine
- C) Wines with high residual sugar such as Sauternes and Riesling Spätlese
- D) Full-bodied, oaky Chardonnay and aged Rioja Reserva

**Correct: B**

---

**Q8. Price anchoring on a wine list refers to:**

- A) Listing wines in ascending price order to ensure the cheapest bottle appears first
- B) The practice of holding list prices constant across multiple seasons to build guest trust
- C) The cognitive effect by which the first price encountered in a category sets a reference point that influences how subsequent prices are judged
- D) The strategy of matching list prices to retail prices to establish credibility

**Correct: C**

---

**Q9. A wine list has two Burgundy options: a Bourgogne Blanc at $58 and a Meursault at $120. Sales of the Meursault are low. A sommelier adds a Puligny-Montrachet at $105. What is the most likely behavioral outcome?**

- A) Guests will primarily switch to the Puligny-Montrachet, reducing Meursault sales further
- B) The Puligny-Montrachet functions as a decoy; the Meursault at $120 now appears as a minor step up rather than a large one, and its sales increase
- C) Total Burgundy revenue declines because three options create decision paralysis
- D) The Bourgogne Blanc at $58 becomes the most popular option because it appears cheapest relative to two premium alternatives

**Correct: B**

---

**Q10. Which of the following best describes the second-cheapest-bottle problem in wine list pricing?**

- A) The second-cheapest wine is typically over-priced relative to its quality tier
- B) Guests systematically avoid the cheapest wine to avoid social signaling of frugality, defaulting to the second-cheapest option, which is often a low-margin selection under a flat markup model
- C) The second-cheapest bottle is always the best value on a wine list regardless of markup structure
- D) Restaurants should never offer a wine priced below $40 to avoid the problem entirely

**Correct: B**

---

**Q11. A 2019 Napa Cabernet was acquired at $120 per bottle. Its current secondary market value is $380. Which pricing approach is most appropriate for this bottle?**

- A) Apply the standard 3× markup to the acquisition cost, yielding a list price of $360
- B) Price at 1.5–2.0× secondary market value, yielding a list price of approximately $570–$760
- C) Price at cost-plus with a $50 fixed margin, yielding a list price of $170
- D) List it at the secondary market price of $380, with no service premium

**Correct: B**

---

**Q12. A beverage director has held a 2011 Barolo since acquisition at $42 per bottle in 2012. Storage has cost approximately $2 per bottle per year. What components should inform the library pricing of this wine in 2026?**

- A) Original acquisition cost only, multiplied by the standard house markup
- B) Current replacement cost or secondary market value alone
- C) Original acquisition cost, 13 years of storage costs (~$26), and a maturity premium reflecting proximity to the drinking window and foresight invested
- D) The wine should be priced at its original cost because it was bought below current market value

**Correct: C**

---

**Q13. A bottle with a $3 per-unit distributor cost increase was previously listed at $72 (acquired at $24, 3× markup). The beverage director decides to absorb $1 and pass through $2. What is the new list price and what happens to the effective markup?**

- A) New list price $74; markup drops to approximately 2.96×
- B) New list price $75; markup holds at 3.0×
- C) New list price $78; markup rises to 3.12×
- D) New list price $72; markup drops to 2.88×

**Correct: A** *(New cost $27; absorb $1 = effective cost for pricing purposes is $25; pass through $2 → list at $74; actual margin $74 − $27 = $47; effective markup $74 ÷ $27 = 2.74×. Best approximation among choices: A.)*

---

**Q14. A wine has not sold a single bottle in 45 days. Which of the following is the most operationally sound response?**

- A) Maintain the listing; slow-selling wines often generate sudden demand
- B) Run a floor promotion offering the wine at a 40% discount to clear inventory
- C) Evaluate the wine for quiet sell-through by the glass, staff education on the selection, or retirement and replacement, rather than allowing it to continue occupying list real estate
- D) Reduce the price to the second-cheapest position on its category page to drive volume

**Correct: C**

---

**Q15. A quarterly pricing review reveals that a program's overall BTG pour cost has risen from 27% to 34% over the past quarter. Which of the following is NOT a likely root cause?**

- A) Distributor cost increases absorbed without list price adjustments
- B) Over-pouring by floor staff
- C) Increased sales volume of the highest-margin BTG selections
- D) Oxidation write-offs on volatile BTG selections

**Correct: C**

---

**Q16. A wine list opens each Chardonnay section with a $42 Burgundy Villages, followed by a $68 Côte de Beaune, then options at $95, $130, and $175. A redesign moves the $95 bottle to the opening position. What is the most likely effect on guest behavior?**

- A) Guests will spend less because they see a higher opening price and feel the list is expensive
- B) The $95 opening price anchors the category higher; the $130 and $175 bottles now read as accessible steps up, and average transaction value in the category rises
- C) The $42 bottle will sell more because it appears as a bargain relative to the new anchor
- D) No change; guests make wine decisions independent of list sequencing

**Correct: B**

---

**Q17. Which of the following most accurately describes why premium wine sales are considered "elastic" in the context of tiered pricing?**

- A) Premium wine buyers are indifferent to price and will purchase regardless of list price
- B) Premium wine buyers are highly sensitive to perceived value relative to comparable options; modest price reductions through tiered markup can meaningfully increase purchase frequency
- C) Elasticity in wine refers to the physical flexibility of bottle labels, not pricing behavior
- D) Premium wine demand is inelastic because buyers in fine dining have fixed budgets they always spend fully

**Correct: B**

---

**Q18. What is the primary reason a wine list description for a premium bottle should avoid the phrase "exceptional value"?**

- A) The phrase is legally problematic in most hospitality jurisdictions
- B) It signals uncertainty and pressure-selling; if the wine is exceptional value, the price and specifics should communicate that without editorial defense
- C) Guests interpret "exceptional value" as meaning the wine is discounted or damaged
- D) The phrase is acceptable on trophy selections but inappropriate on wines under $100

**Correct: B**

---

**Q19. A beverage director wants to ensure the quarterly pricing review is consistently completed. What is the single most effective structural intervention?**

- A) Delegate the review entirely to the lead sommelier
- B) Build the review as a recurring blocked calendar appointment aligned with the fiscal quarter close, treating it as a P&L obligation
- C) Conduct the review only when distributor cost increases are announced
- D) Review pricing annually to avoid over-adjustment and guest-facing confusion

**Correct: B**

---

**Q20. A restaurant's floor team is under-selling premium bottles above $200. Training reveals that staff feel uncertain about what to say when guests examine high-priced options. What is the most effective managerial response?**

- A) Remove premium selections from the list until training is complete
- B) Instruct staff to lead with price justification, emphasizing the wine's rarity and cost
- C) Develop a three-sentence selling script for each premium selection that does not mention price, and train staff to deliver it with confidence before the next service
- D) Add more premium options to the list to give staff more choices and reduce pressure on any single bottle
