...
**Level:** Wine Program Management Mastery — Wine Faults
**Module:** 14
...
**Prerequisites:** Wine Saint Certified Level 2 or equivalent; Modules 1–13 recommended
...
## Section 1: Why Wine Faults Matter for Program Management
...
## Section 2: The Major Faults — TCA Cork Taint, Oxidation, Reduction, Brett, VA, Heat Damage
...
## Section 3: Sensory Detection — Training Your Team to Identify Faults Before Service
...
## Section 4: Guest Communication — How to Handle a Corked or Flawed Bottle Gracefully
...
## Section 5: The Return Policy — Financial Implications, Supplier Credits, and Documentation
...
## Section 6: Prevention — Storage, Temperature Control, and Supplier Accountability
...
**2,4,6-Trichloroanisole (TCA):** The primary chemical compound responsible for cork taint. A chlorinated anisole produced when airborne fungi metabolize chlorinated phenols found in cork, wood, or cleaning products. Detectable by humans at concentrations as low as 1.4 to 6 parts per trillion, depending on the individual. Sensory signature: damp cardboard, wet dog, musty basement, with suppression of fruit aromatics.

**Acetaldehyde:** The primary aldehyde compound associated with oxidation in wine. Formed when ethanol is oxidized by oxygen. Responsible for the sherry-like, bruised-apple, or nutty aromas in an oxidized wine. Also present in acceptable quantities in intentionally oxidative styles such as fino Sherry and tawny Port.

**Acetic Acid (VA — Volatile Acidity):** The acid in vinegar; the primary component of volatile acidity in wine. Produced by Acetobacter bacteria in the presence of oxygen. Detectable aromatically above approximately 0.7 g/L in white wines and 0.9 g/L in red wines. At high levels, produces a sharp, vinegary aroma and harsh, burning finish.

**Brettanomyces bruxellensis (Brett):** A spoilage yeast that metabolizes hydroxycinnamic acids in wine into 4-ethylphenol (4-EP) and 4-ethylguaiacol (4-EG). Sensory signature at high concentrations: barnyard, horse saddle, leather, Band-Aid. Established in barrels and winery equipment; extremely difficult to eliminate. Present at low levels in many Old World wines as a stylistic component.

**Ethyl Acetate:** The ester compound associated with volatile acidity alongside acetic acid. Produced by the same bacterial pathways. Sensory signature: nail polish remover, model glue, solvent. Often the first compound detected in a high-VA wine because its aroma threshold is lower than acetic acid.

**Fault Rate:** A program management metric calculated as faulted bottles divided by total bottles opened, expressed as a percentage. Useful for benchmarking against prior periods, comparing producers, and identifying systematic quality control issues in specific lots or vintages.

**4-Ethylphenol (4-EP):** The primary volatile phenol compound produced by Brettanomyces; responsible for barnyard and horse-sweat aromas. Detection threshold approximately 440 ppb in red wine; above 620 ppb generally considered fault-level.

**Heat Damage:** Degradation of wine quality resulting from exposure to elevated temperatures during production, shipping, or storage. Accelerates oxidative aging, destroys fruit aromatics, and destabilizes the closure seal. Physical signs include pushed corks, capsule staining, and wine seepage. Not correctable once the damage has occurred.

**Hydrogen Sulfide (H₂S):** The simplest sulfur compound associated with reductive faults. Produced during fermentation when yeast is sulfur-stressed or when free sulfur (from vineyard spraying) is present in the must. Sensory signature: rotten egg, drain, sewer. Detectable at very low concentrations; often volatile enough that vigorous aeration can reduce or eliminate it.

**Mercaptans (Thiols):** Complex sulfur compounds (including ethanethiol and methanethiol) that form from hydrogen sulfide during reductive aging. Unlike H₂S, mercaptans are not fully eliminated by aeration. Sensory signature: garlic, onion, rubber, cooked cabbage. A more advanced and less correctable stage of reductive fault.

**Oxidation:** A chemical process in wine whereby exposure to oxygen beyond controlled parameters degrades aromatics and fruit character, produces acetaldehyde, and causes irreversible color change (browning). Caused by compromised closure, improper storage orientation, extreme age, or heat-induced seal failure.

**Reduction:** A winemaking condition caused by insufficient oxygen contact, often in reductively produced wines or under screwcap closures. Produces sulfur compounds including H₂S and mercaptans. Mild reduction may be correctable with aeration; severe reduction involving mercaptans is not fully reversible.

**Sensory Masking:** The phenomenon whereby TCA suppresses the perception of positive aromatic compounds in wine, causing a tainted wine to smell flat or muted before the taint itself is consciously identified. Responsible for subtle TCA cases being perceived as "disappointing" rather than clearly faulted.

**Temperature Data Logger:** An electronic device that continuously records ambient temperature (and often humidity) in a storage environment. Critical infrastructure for any wine cellar or storage area. Enables trend review, alert thresholds, and documentation of storage conditions for supplier accountability purposes.

**TCA Detection Threshold:** The minimum concentration of TCA detectable by a given individual, which varies widely across the population — from roughly 1 to 10 parts per trillion. Supertasters or individuals with high TCA sensitivity may detect taint in wines that appear clean to others. This variation is why a single taster's verdict on a marginal case should be corroborated before a guest-facing decision is made.

---

## Quiz — Module 14

**1.** A guest tells their server that a bottle of Burgundy "smells musty and tastes flat." The server detects a faint damp-cardboard note but is uncertain. What is the correct next step?

A) Tell the guest the wine is fine and suggest a few minutes of air time
B) Replace the bottle immediately without any further assessment
C) Remove the bottle, escalate to the sommelier or manager for a second opinion, and give the guest a timeline
D) Bring a fresh glass and pour a small amount to allow the guest to compare side-by-side

**Correct: C**

---

**2.** TCA is produced when:

A) Acetic acid bacteria oxidize ethanol in the presence of oxygen
B) Fungi metabolize chlorinated phenols into chlorinated anisoles
C) Hydrogen sulfide reacts with ethanol during reductive fermentation
D) Tannins polymerize at elevated storage temperatures

**Correct: B**

---

**3.** Which of the following faults is sometimes considered acceptable or even desirable at low concentrations in certain Old World wine styles?

A) Heat damage
B) High volatile acidity
C) Brettanomyces
D) TCA cork taint
...
**4.** A bottle of Muscadet arrives at the table smelling strongly of struck match and sulfur. The guest is concerned. You identify the fault as mild reduction. What is the most appropriate response?

A) Replace the bottle and log a fault immediately
B) Explain that the wine is oxidized and offer an alternative
C) Suggest vigorous swirling and a few minutes of air, with the option to replace if the aroma does not resolve
D) Confirm the fault and request a supplier credit before the guest finishes the course

**Correct: C**

---

**5.** Your fault log shows that a specific producer's cork-sealed Côtes du Rhône has a fault rate of 4.2% over the past fourteen months. The most appropriate programmatic response is:

A) Immediately drop the wine from the list without contacting the distributor
B) Continue selling the wine without logging further incidents until the rate exceeds 10%
C) Contact the distributor with documented fault data, discuss quality controls, and evaluate whether to adjust the wine's program placement or close terms
D) Switch the wine from bottle service to by-the-glass to mask the fault risk from guests without addressing the underlying issue

**Correct: C**

---

**6.** The sensory masking effect of TCA refers to:

A) TCA's ability to make oxidized wines smell temporarily fresh
B) TCA suppressing the perception of positive aromatic compounds, making a wine seem flat rather than overtly tainted
C) The tendency of TCA to concentrate in the glass rather than the bottle
D) Staff unconsciously ignoring TCA because they have been exposed to it repeatedly

**Correct: B**

---

**7.** Which of the following is the correct documentation standard when submitting a supplier credit request for a faulted bottle?

A) An email stating the wine was faulted and requesting a replacement on the next order
B) A verbal complaint to the distributor rep on their next scheduled visit
C) A photograph of the bottle label and cork, written sensory description, date of opening, purchase price, and fault log reference
D) The original purchase invoice only, without additional sensory documentation

**Correct: C**

---

**8.** Physical signs of heat damage on an incoming delivery include:

A) Dark tannin deposits on the interior of the glass bottle
B) Pushed or leaking corks, capsule staining, and wine seepage around the closure
C) White crystalline tartrate deposits on the bottom of the cork
D) Excessive ullage (fill space) at the top of the bottle

**Correct: B**

---

**9.** The recommended storage orientation for cork-sealed wines intended for more than three months of cellaring is:

A) Vertical, cork up, to allow sediment to settle at the bottom
B) Vertical, cork down, to keep moisture on the cork
C) Horizontal, to keep the cork moist and maintain the seal
D) At a 45-degree angle to allow partial oxidation through the cork

**Correct: C**

---

**10.** 4-Ethylphenol (4-EP) is the primary sensory compound associated with:
...
**11.** A guest reports that an expensive bottle of red wine "tastes like vinegar." The most likely fault is:

A) Reduction caused by a reductive screwcap closure
B) High volatile acidity from acetic acid bacteria
C) TCA from a compromised natural cork
D) Heat damage from improper transit storage

**Correct: B**

---

**12.** When a server suspects a fault before presenting a bottle to the table, the correct protocol is:

A) Present the bottle and let the guest decide whether to accept it
B) Discard the bottle and open a replacement without documentation
C) Do not present the bottle; escalate to the sommelier or manager for a final assessment within two minutes
D) Taste the entire glass themselves before deciding whether to escalate

**Correct: C**

---

**13.** The ideal humidity range for wine storage to prevent cork desiccation without promoting mold growth is:

A) 30–45 percent relative humidity
B) 55–75 percent relative humidity
C) 80–90 percent relative humidity
D) Humidity is irrelevant for cork-sealed wines stored horizontally

**Correct: B**

---

**14.** What is the primary distinction between hydrogen sulfide (H₂S) and mercaptans as reductive fault compounds?

A) H₂S is associated with oxidation; mercaptans are associated with cork taint
B) Mercaptans are less volatile and not fully eliminated by aeration; H₂S is often reduced or eliminated by vigorous swirling
C) H₂S causes the same sensory signature as TCA; mercaptans produce a sherry-like aroma
D) Mercaptans are only found in white wines; H₂S is exclusive to red wines

**Correct: B**

---

**15.** A program consolidates its monthly fault documentation and submits credit requests to distributors in one batch rather than calling about individual bottles. The primary operational advantage of this approach is:

A) It allows the program to accumulate faulted bottles for longer before discarding them
B) It prevents distributors from ever denying a credit claim
C) It creates a more formal, pattern-visible credit request that is harder to dismiss and respects the distributor's time
D) It qualifies the program for volume-based credit discounts from most distributors

**Correct: C**

---

**16.** A wine arrives smelling of nail polish remover and solvent. The most likely fault compound is:
...
**17.** A beverage director wants to track whether a producer's fault rate justifies a purchasing review. Which metric is most useful for this analysis?

A) Total dollar value of credit requests submitted in the current quarter
B) Fault rate by producer on a rolling twelve-month basis, expressed as faulted bottles divided by total bottles opened
C) Number of individual guest complaints about that producer's wine in the current month
D) The producer's Wine Spectator score for the affected vintage

**Correct: B**

---

**18.** When handling a confirmed corked bottle at the table, the phrase "which can happen even with excellent wines" is useful because:

A) It shifts legal responsibility for the fault from the restaurant to the producer
B) It frames the fault as a known and manageable phenomenon, protecting the guest's confidence in their selection
C) It signals to the guest that no replacement will be offered because the fault is expected
D) It gives the server legal protection against a guest disputing the charge

**Correct: B**

---

**19.** A purchase order addendum requiring that "all shipments maintain sub-65°F during transit and include a temperature indicator device" serves primarily to:

A) Guarantee that no heat damage will occur during shipping
B) Establish a contractual basis for refusing or crediting heat-damaged deliveries and signal to the distributor that the program is actively monitoring
C) Reduce the cost of temperature-controlled shipping at the distributor's expense
D) Comply with federal food safety regulations governing beverage alcohol storage

**Correct: B**

---

**20.** Which of the following statements about Brettanomyces contamination is accurate?

A) Brett is exclusively produced in the bottle and cannot originate in the winery
B) Brett can be fully eliminated from affected barrels using standard sulfur treatments
C) Brett is established in winery barrels and equipment and is extremely difficult to eradicate once present
D) Brett only affects wines with residual sugar above 10 g/L

**Correct: C**

---

*End of Module 14 — Wine Faults: Diagnosing, Communicating, and Managing Flawed Bottles*

*Wine Saint Certified — Wine Program Management Mastery*
