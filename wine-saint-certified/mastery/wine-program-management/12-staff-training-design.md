...
**Level:** Wine Program Management Mastery — Staff Training Design
**Module:** 12
...
**Prerequisites:** Wine Saint Certified Level 2 or equivalent; Modules 1–11 recommended
...
## Section 1: Why Most Restaurant Wine Training Fails
...
## Section 2: Building a Training Curriculum, Sequencing Knowledge for Service Staff
...
## Section 3: Pre-Shift Tastings, Structure, Cadence, and What to Cover
...
## Section 4: The Selling Mindset, Training Staff to Recommend, Not Just Describe
...
## Section 5: Certification Pathways, Internal, WSET, Wine Saint, CMS
...
## Section 6: Measuring Training ROI, Tracking Sales per Cover, Upsell Rate, Guest Feedback
...
**BTG Attachment Rate:** The percentage of dining covers that include at least one by-the-glass wine purchase; the most direct operational metric for floor-level wine recommendation activity.

**Certification Reimbursement Policy:** An employer-funded agreement that covers the cost of external wine certifications for staff, typically conditioned on a minimum retention period post-completion to protect the organization's investment.

**Foundation Phase:** The first phase of a structured wine training curriculum, covering minimum product knowledge required for competent, unsupervised wine service; typically completed within the first 30 days of employment.

**Function Phase:** The intermediate phase of wine training that translates product knowledge into service execution and selling behavior, delivered primarily through pre-shift tastings, role-play, and floor coaching across months two through six.

**Fluency Phase:** The advanced, ongoing phase of wine training available to experienced staff, covering deeper regional knowledge, external certification, and development toward senior wine service roles.

**Internal Certification Track:** A documented, employer-designed progression framework with defined standards, assessments, titles, and rewards, serving as the first tier of a restaurant group's wine development system.

**Knowledge Dump Training:** The common failure mode of presenting wine information in a single, non-interactive session without practical selling application, assessment, or follow-up; produces minimal behavioral change on the floor.

**Pre-Shift Tasting:** A structured, 10-minute group wine tasting conducted before service begins; the highest-ROI recurring wine training tool available to a restaurant operation.

**Recommendation Framework (Anchor-Bridge-Specific-Close):** A four-part selling structure for wine recommendations that personalizes to the guest, names and positions the wine, adds a memorable specific detail, and closes with confident, affirmative language.

**Sales per Cover:** Total wine revenue divided by total covers served over a defined period; the foundational aggregate metric for measuring wine program and training performance.

**Table-Ready Language:** A single, jargon-free, guest-facing sentence for each wine on the list that connects flavor profile to a food pairing or occasion and is designed for direct use in a service interaction.

**Training ROI Dashboard:** A single-page monthly summary of core wine training metrics (sales per cover, BTG attachment rate, upsell rate, guest satisfaction) presented in trend-line format to F&B leadership as a standing operational report.

**Upsell Rate:** The frequency with which floor staff successfully recommend a wine at a higher price point than a guest initially indicated; a direct measure of selling framework effectiveness.

**Wine Bible:** A comprehensive, unit-level reference document containing the full BTG and bottle list with tasting notes, food pairings, price points, and selling talking points for every wine; updated at each list change.

**WSET (Wine & Spirit Education Trust):** The globally recognized wine and spirits education organization offering accredited Levels 1–4 qualifications; the most widely used external certification pathway for restaurant beverage staff.

---

## Quiz: Module 12

**1. Which of the following best describes the primary reason most restaurant wine training programs fail to change floor behavior?**

A) Staff are generally uninterested in wine education
B) Training is designed as a one-time knowledge transfer rather than a system with accountability, practice, and application
C) Wine training is too expensive for most restaurant operations to fund adequately
D) External certification requirements are too demanding for service staff

**Correct: B**

---

**2. In the three-phase training model, what is the primary goal of the Foundation phase?**

A) Building advanced regional wine knowledge across all major producing countries
B) Developing a personal selling style unique to each server's personality
C) Ensuring all new staff can perform competent wine service without a manager present before they work their first unsupervised shift
D) Preparing staff for WSET Level 2 certification within their first month

**Correct: C**

---

**3. A pre-shift tasting running more than 15 minutes consistently is most likely to:**

A) Produce deeper wine knowledge by covering more material per session
B) Lose staff engagement and become difficult to schedule consistently, reducing the program's long-term effectiveness
C) Violate labor laws in most states
D) Replace the need for any other form of wine training

**Correct: B**

---

**4. The Anchor-Bridge-Specific-Close recommendation framework is designed primarily to:**

A) Help staff memorize wine list prices
B) Replace the wine list for guests who do not want to read
C) Move staff from describing wine to making confident, personalized recommendations that connect to the guest's specific context
D) Standardize tasting note language across all servers at a multi-unit group

**Correct: C**

---

**5. When a guest says "I don't know much about wine," the most effective trained response is:**

A) Suggest they order what they already know, such as a beer or cocktail
B) Provide a comprehensive explanation of the wine list structure and regional breakdown
C) Reassure the guest and ask a brief qualifying question about food and flavor preference in order to make a confident recommendation on their behalf
D) Offer to bring the manager or sommelier to handle the interaction

**Correct: C**

---

**6. Which metric most directly reflects floor-level wine recommendation behavior by individual servers?**

A) Total bottle sales revenue for the period
B) Wine list size and variety
C) BTG attachment rate
D) Staff tip averages across all beverage categories

**Correct: C**

---

**7. In a 12-week pre-shift tasting rotation, which topic is most appropriate for week 11?**

A) A deep dive lecture on the wine regions of the Rhône Valley
B) Guest scenario role-play exercises
C) A recitation of all wine list prices from memory
D) A review of the restaurant's wine storage protocols

**Correct: B**

---

**8. An internal wine certification program is most likely to improve staff retention when it:**

A) Requires staff to fund their own certification costs
B) Provides visible title recognition, compensation rewards, and a clear pathway to external certification and promotion
C) Is optional and available only to staff who request it
D) Focuses exclusively on wine knowledge exams rather than practical service skills

**Correct: B**

---

**9. Which external certification pathway is most directly aligned with the operational, guest-facing demands of restaurant wine service?**

A) Master of Wine (MW)
B) WSET Level 4 Diploma
C) Wine Saint Certified, designed specifically for hospitality professionals in an operational wine context
D) Society of Wine Educators Certified Specialist of Wine

**Correct: C**

---

**10. A certification reimbursement policy with a 12-month retention clause serves which primary function?**

A) It discourages staff from pursuing certifications unless they are certain they want to stay
B) It protects the employer's financial investment while signaling genuine commitment to staff development and filtering for staff who are serious about their careers
C) It satisfies regulatory requirements for beverage service licensing
D) It limits certification to staff in senior roles only

**Correct: B**

---

**11. A 90-day ROI measurement cycle for a wine training initiative should include which of the following to be credible?**

A) Baseline measurements on core metrics established before the training program launches
B) Measurements taken only at the 90-day endpoint to avoid data noise
C) A comparison to national wine sales averages published by trade associations
D) Guest feedback only, excluding financial metrics as too variable to track reliably

**Correct: A**

---

**12. What is the primary purpose of a "wine bible" document at the unit level?**

A) To replace pre-shift tastings with a self-study option for busy shifts
B) To serve as a comprehensive, always-current reference that enables any staff member to describe and recommend any wine on the list without requiring a sommelier present
C) To document wine list pricing history for accounting purposes
D) To satisfy health department documentation requirements for alcohol service

**Correct: B**

---

**13. "Table-ready language" for a wine is best defined as:**

A) A technical tasting note suitable for use in a wine competition judging panel
B) A multi-sentence regional and varietal overview drawn from the wine's producer fact sheet
C) A single, jargon-free sentence that connects flavor profile to a food or occasion and is designed for direct use in a service interaction
D) The exact language printed on the wine's back label

**Correct: C**

---

**14. At a restaurant doing 200 covers per night, increasing wine sales per cover from $8.50 to $11.00 generates approximately how much in annualized incremental revenue, assuming 300 service days per year?**
...
**15. A beverage director notices that three servers consistently produce BTG attachment rates 12 percentage points below their peer average after 60 days of training participation. The most appropriate next step is:**

A) Remove those servers from wine service responsibilities immediately
B) Schedule individual coaching conversations to diagnose whether the gap reflects a knowledge, confidence, language, or motivation issue, and design targeted interventions accordingly
C) Increase the frequency of pre-shift tastings for the entire floor team to compensate
D) Conclude that those staff are not suitable for the restaurant and initiate separation

**Correct: B**

---

**16. Which of the following sequences is correct for the Foundation phase of a new server's wine training?**

A) Geography first, then grape varieties, then the BTG list, then service mechanics
B) BTG list and flavor profile language first, then pairing logic, then price navigation, then geography as context
C) External certification content first, then internal standards, then practical service
D) Pre-shift tasting attendance only, with no structured curriculum content in the first 30 days

**Correct: B**

---

**17. The Training ROI Dashboard is most effective when it is:**

A) Presented annually at a formal budget review rather than at regular operational meetings
B) Maintained as a confidential document shared only with ownership, not with unit managers
C) Updated monthly and presented at every F&B leadership meeting as a standing agenda item, showing trend-line data across all four core metrics
D) Produced by an outside consulting firm to ensure objectivity

**Correct: C**

---

**18. In the CMS (Court of Master Sommeliers) pathway, which examination is the first meaningful threshold credential for staff pursuing a professional sommelier career?**

A) CMS Introductory Certificate
B) CMS Certified Sommelier
C) CMS Advanced Sommelier
D) Master Sommelier Diploma

**Correct: B**

---

**19. The primary financial argument for running pre-shift tastings three or more times per week rather than once per week is:**

A) Health regulations in some jurisdictions require alcohol consumption training at a minimum frequency
B) The compound learning effect, more frequent exposure produces nonlinearly greater vocabulary and confidence gains that translate into measurably higher BTG attachment rates and sales per cover
C) Once-weekly tastings are insufficient to cover a full wine list within a six-month period
D) More frequent tastings reduce the cost of external certification by substituting for WSET coursework

**Correct: B**

---

**20. When presenting wine training ROI data to ownership, which approach is most likely to be viewed as credible and defensible?**

A) Attribute all wine revenue increases during the training period to the training program
B) Avoid quantitative claims entirely and focus on qualitative staff feedback
C) Acknowledge confounding variables such as seasonal shifts or menu changes and present the data with explicit context about what can and cannot be concluded from it
D) Use national industry benchmarks rather than internal data to avoid unfavorable comparisons
