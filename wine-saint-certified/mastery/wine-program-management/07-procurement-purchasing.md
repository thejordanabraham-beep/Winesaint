# Procurement & Purchasing: Building a Supply Chain That Serves the Program
...
The distributor is your primary commercial relationship. Distributors are licensed at the state level, and in most states, a winery or importer must use a licensed in-state distributor to sell to restaurants. The distributor warehouses inventory, handles delivery, employs the sales representatives you meet weekly, and processes your invoices.

Margins at the distributor tier typically range from 25 to 40 percent above their cost, though this varies by market size, category, and brand negotiating power. On a wine the distributor pays $10 for, your invoice price might be $14 to $16. On a high-velocity, high-profile brand, that margin may compress. On a small-production import that requires hand-selling and education, it may expand.
...
### Using This Knowledge to Negotiate
...
**Delivery reliability.** Late deliveries, short shipments, and temperature-damaged wines are program failures that originate at the logistics tier. Ask about delivery frequency in your market, warehouse storage conditions, and how the company handles damage claims. A distributor with next-day delivery capabilities and a functioning online ordering portal creates materially less operational friction than one requiring three-day lead times and fax orders.
...
Purchasing wine is not a spontaneous activity. In a well-managed program, it is a structured, calendar-driven process that aligns with menu cycles, storage capacity, cash flow windows, and seasonal demand. The absence of that structure produces its own consequences: reactive purchasing, over-reliance on whatever the rep happened to bring that week, and an inventory that reflects distributor priorities rather than your own program vision.
...
### Managing Unsolicited Rep Tastings
...
An allocation offer comes with a quantity and a price. Before committing, evaluate: At what sell-through pace can you move this quantity given your guest base and price point? Does the margin structure work at a sustainable menu price? Does committing to this allocation require cash you need for core list replenishment? Is this wine's profile genuinely right for your guests, or are you acquiring it for prestige reasons that don't translate to the floor?

An allocation that sits in your cellar unsold for 18 months is not a victory. A 12-bottle allocation of a genuinely great Burgundy that sells out in six weeks and generates guest excitement is.
...
| Term | Definition |
|------|------------|
| Three-Tier System | The US regulatory framework requiring wine to pass from producer/importer through a licensed distributor before reaching a retailer or restaurant; implemented at the state level following Prohibition repeal |
...
| Par Level | The target inventory quantity for each SKU in the program, based on consumption velocity and lead time, used to drive routine monthly replenishment orders |
| Buying Calendar | A structured annual schedule for purchasing activity, organized at monthly (replenishment), quarterly (review and adjustment), and annual (strategic) intervals |
...
**Q1. A new distributor offers to add your properties to their portfolio and promises exceptional service. Which factor should carry the most weight in your initial evaluation?**
- A) The total number of labels in their portfolio
- B) The quality and responsiveness of the sales representative assigned to your account
- C) Whether they carry brands your guests already recognize
- D) Their willingness to match competitor invoice pricing on Day 1

**Correct: B**

---

**Q2. In the US three-tier distribution system, what is the importer's primary role?**
- A) Warehousing and delivering wine to restaurant accounts
- B) Setting retail pricing and managing point-of-sale marketing
- C) Sourcing wines from foreign producers, handling TTB compliance, and placing wines with state-level distributors
- D) Providing staff training and brand education at the restaurant level
...
**Q4. A distributor offers exclusive by-the-glass rights to a sought-after Côte de Nuits Villages in your market in exchange for a 24-bottle monthly commitment. The wine invoices at $28. Your by-the-glass pour cost target is 30%. Which glass price would you need to achieve to meet that target on a 5-ounce pour (approximately 5 pours per bottle)?**
- A) $14
- B) $16
- C) $19
- D) $22

**Correct: C** *(Invoice $28 ÷ 5 pours = $5.60 cost per pour. At 30% pour cost: $5.60 ÷ 0.30 = $18.67, rounded to $19.)*

---

**Q5. What is the most effective way to move from a B-tier to an A-tier account status with a distributor?**
- A) Increase the total number of SKUs purchased across the portfolio
- B) Pay invoices consistently on time, submit predictable orders on a regular schedule, and demonstrate active staff engagement with the distributor's brands
- C) Complain formally when service falls short, creating pressure for improved attention
- D) Negotiate the lowest possible invoice pricing to signal purchasing sophistication

**Correct: B**

---

**Q6. A beverage director wants to build toward allocation access for a top Barolo producer. She has never purchased the producer's wines before. What is the most logical first step?**
- A) Contact the producer directly and request inclusion on their allocation list
- B) Request allocation of the flagship Barolo and commit to a volume that demonstrates seriousness
- C) Begin purchasing the producer's more accessible SKUs consistently and feature them on the list while communicating interest in the flagship to the rep
- D) Wait until the next vintage cycle and revisit

**Correct: C**

---

**Q7. Which of the following is NOT a legitimate negotiating lever available to beverage directors in conversations with distributors?**
- A) Volume commitment on a specific SKU in exchange for invoice pricing concessions
- B) Front-of-house list placement in exchange for distributor-funded staff training
- C) Requesting personal gifts for the beverage director as a condition of placement
- D) Market exclusivity on a label in exchange for a defined monthly purchase commitment
...
**Q9. A distributor rep arrives unannounced on a Friday afternoon with six wines to present, none of which fit your current program direction. What is the most professionally appropriate response?**
- A) Taste all six wines and provide feedback to maintain the relationship
- B) Decline the tasting politely and ask the rep to submit proposed wines in advance of a scheduled appointment in the future
- C) Purchase one wine to demonstrate goodwill, even if it doesn't fit the program
- D) Refer the rep to a more junior staff member

**Correct: B**

---

**Q10. A wine purchased En Primeur from Bordeaux is scheduled to arrive 30 months after purchase. Which of the following represents a genuine risk of futures buying?**
- A) The wine may not score as highly as anticipated from barrel samples
- B) Your program's direction may shift before the wine arrives
- C) Your capital is committed without corresponding inventory to sell in the interim
- D) All of the above
...
**Q11. Which of the following scenarios most clearly constitutes a conflict of interest in the buyer-supplier relationship?**
- A) A distributor rep buys you coffee at a sales meeting
- B) A distributor pays for your team's attendance at a winemaker dinner featuring their portfolio
- C) A distributor funds a fully personal vacation for you and your family shortly before a major contract decision, with no disclosure to your employer
- D) A distributor sends a case of wine to your restaurant for a staff tasting

**Correct: C**

---

**Q12. You are managing wine purchasing across eight corporate restaurant properties in four states. What structural reality of the three-tier system most directly affects your procurement strategy?**
- A) You must use a single national distributor to maintain pricing consistency
- B) You can purchase directly from wineries in states where you have properties
- C) Each state requires its own licensed distributor relationships, meaning you may be managing 10 or more active distributor accounts
- D) Importer pricing is fixed federally and cannot be negotiated at the state level

**Correct: C**

---

**Q13. A distributor's depletion report shows that a competitor restaurant is moving 18 bottles per month of a Rhône blend you're also carrying but only moving 6 bottles of. What is the most useful interpretation of this information?**
- A) The competitor's guests have different taste preferences and the data is not applicable to your program
- B) The depletion gap may reflect placement, staff engagement, or pricing differences worth investigating before assuming the wine is simply under-performing
- C) You should immediately discontinue the wine and replace it with a higher-velocity option
- D) The depletion report reflects distributor error and should be disregarded
...
**Q15. A Program Brief shared with distributor reps each quarter is most useful because it:**
- A) Legally binds reps to present only wines that fit the criteria
- B) Signals to reps exactly what you're looking for, improving tasting efficiency and helping identify which reps take the program seriously
- C) Replaces the need for scheduled tasting appointments
- D) Provides documentation of your distributor relationships for compliance audits

**Correct: B**

---

**Q16. Which of the following best describes why prompt payment is strategically valuable in distributor negotiations, beyond simple contractual compliance?**
- A) It qualifies you for federal tax incentives available to prompt-paying hospitality businesses
- B) Distributors are margin businesses with their own cash flow constraints; prompt payment makes you a financially predictable partner and increases your priority status for allocations and support
- C) Prompt payment legally entitles you to distributor discounts under state liquor authority regulations
- D) It demonstrates that your program is financially solvent, which is required to receive allocation wines
...
**Q18. You are in a negotiating conversation with a distributor about pricing on a Napa Valley Cabernet you want to feature by the glass. The rep presents an opening invoice price. What negotiating approach is most likely to produce a favorable outcome?**
- A) Immediately counter with the lowest price you are willing to accept
- B) Let the rep complete their presentation, ask clarifying questions about what the distributor needs from the relationship, and then present your terms once you understand their position
- C) Reject the opening price and request that they return with a revised offer
- D) Agree to the price and negotiate programming support separately in a follow-up meeting
