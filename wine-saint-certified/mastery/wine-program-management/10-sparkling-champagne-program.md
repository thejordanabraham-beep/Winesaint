...
**Level:** Wine Program Management Mastery — Sparkling & Champagne Program
**Module:** 10
...
**Prerequisites:** Wine Saint Certified Level 2 or equivalent; Modules 1–9 recommended
...
## Section 1: Why Sparkling Wine Is Your Most Profitable Category
...
The margin mathematics reinforce this. A $40 bottle of Crémant d'Alsace, sold at $16 per glass over four glasses, generates $64 in revenue — a 60% margin. The same $40 cost applied to a by-the-glass still white, priced at $13 and yielding five glasses, produces $65 in revenue — similar return, but none of the occasion premium, none of the visual impact, and a materially weaker upsell pathway. Sparkling BTG produces comparable or superior revenue while doing more work for the guest experience.
...
## Section 2: Building a Sparkling List — Champagne, Grower Producers, and Alternatives
...
## Section 3: By-the-Glass Sparkling Strategy and Equipment (Coravin Sparkling, Cruvinet)
...
Glassware choice is a genuine operational and guest experience decision. The tulip flute remains the default for sparkling service: its narrow aperture retains carbonation, its chimney concentrates aroma, and its visual profile signals occasion. The coupe has returned to trend — its wider bowl expresses tertiary aromatics and toasty notes better than the flute, making it the preferred choice for vintage and grower Champagne where aromatic complexity is the point. Train your team to offer a choice for premium sparkling and to explain the difference; the explanation itself becomes a service differentiator.
...
## Section 4: Pricing Sparkling Wine — Perceived Value, Anchoring, and Margin
...
## Section 5: Selling Occasions — Celebrating, Aperitif, Food Pairing, Bottle Service
...
## Section 6: Staff Training for Sparkling — Sabrage, Service, and Upsell Scripts
...
| Term | Definition |
|------|-----------|
| Méthode Champenoise (Méthode Traditionnelle) | The production method in which the wine undergoes a secondary fermentation inside the individual bottle, creating carbonation and the characteristic fine, persistent bubbles and autolytic complexity of Champagne and other traditional-method sparkling wines |
| Autolysis | The process by which yeast cells break down after the secondary fermentation, releasing compounds into the wine that produce toasty, biscuity, brioche, and nutty aromas; the primary source of complexity in aged Champagne and traditional-method sparkling wines |
| Récoltant-Manipulant (RM) | A Champagne producer classification designating a grower who cultivates their own vines and produces wine exclusively from their own fruit; commonly referred to as "grower Champagne," these wines offer terroir expression distinct from large négociant blends |
| Non-vintage (NV) | A sparkling wine blended across multiple harvest years to achieve a consistent house style; the entry-level Champagne offering for most major houses, typically aged 15 months minimum on lees before release |
| Blanc de Blancs | A sparkling wine made entirely from white grapes — in Champagne, this means 100% Chardonnay; associated with high acidity, citrus, minerality, and elegance, and strong food pairing versatility |
| Blanc de Noirs | A white or very pale sparkling wine made from black-skinned grapes — in Champagne, Pinot Noir and/or Pinot Meunier — with minimal skin contact; typically shows more body, red fruit, and structure than Blanc de Blancs |
| Dosage | The small addition of a sugar-wine mixture (liqueur d'expédition) added to Champagne after disgorgement to adjust the final sweetness level; the primary determinant of Brut, Extra Brut, Nature/Zéro Dosage, Demi-Sec, or Doux style designations |
| Disgorgement | The process of removing the yeast sediment plug from the bottle neck after secondary fermentation and aging, prior to dosage and final corking; vintage-dated disgorgement on prestige cuvées indicates how long the wine has aged on lees |
| Crémant | French traditional-method sparkling wine produced in an AOC outside Champagne, including Crémant d'Alsace, Crémant de Bourgogne, Crémant de Loire, and others; subject to specific appellation rules for grape varieties, yields, and minimum lees aging |
| Charmat Process (Tank Method) | A sparkling wine production method in which the secondary fermentation occurs in large pressurized tanks rather than individual bottles; produces fresher, fruitier wines with larger, less persistent bubbles — the method used for Prosecco and most commercially priced sparkling wine |
| Oxidation waste | The revenue loss attributable to sparkling wine that degrades in quality after opening before it can be sold; a key cost variable in BTG sparkling economics that is eliminated or minimized through preservation technology such as Coravin Sparkling or Cruvinet systems |
| Pour cost percentage | The ratio of the wholesale cost of a wine to its selling price, expressed as a percentage; the primary margin metric for BTG sparkling, calculated per bottle as (wholesale cost ÷ total pour revenue) × 100; target pour cost for sparkling BTG is typically 22–28% |
| Sabrage | The theatrical technique of opening a Champagne or sparkling wine bottle by striking the neck collar with a saber or the spine of a chef's knife in a single smooth stroke, using CO₂ pressure to cleanly separate the glass collar and cork |
| Prestige cuvée | The top-of-range, typically vintage-dated Champagne offering from a major house, produced from selected grapes and parcels and released after extended aging; examples include Dom Pérignon (Moët & Chandon), Cristal (Roederer), and Belle Époque (Perrier-Jouët) |
| Disgorgement date | The date printed on the label or back label of many grower and prestige Champagnes indicating when the wine was disgorged; a critical indicator of freshness and lees age, and a selling point for guests interested in technical transparency |
...
**Q1. A beverage director argues that adding more Champagne to the list will reduce overall program margin because Champagne is more expensive to purchase. What is the most effective counterargument?**
- A) Champagne has the same cost-to-price ratio as still wine, so it does not affect overall margin
- B) Champagne sustains elevated guest willingness to pay and occasion-driven purchasing, producing comparable or superior revenue per cover relative to still wine while driving higher total table spend
- C) Champagne can be purchased at wholesale below its perceived value, making it inherently more profitable than any still wine category
- D) Champagne is required by health code for operations above a certain dining level

**Correct: B**

---

**Q2. You are building a BTG sparkling program and want to minimize oxidation waste without investing in preservation equipment. Which approach best manages the financial risk?**
- A) Open all sparkling bottles at the start of the week and track quality daily
- B) Purchase only tank-method wines, which are more resistant to oxidation than traditional-method wines
- C) Run a "sparkling of the day" format — open one or two bottles per shift, feature them actively to drive sell-through, and accept that the program changes nightly rather than offering a fixed selection
- D) Pre-pour all sparkling BTG glasses at the start of service to reduce per-pour foam loss

**Correct: C**

---

**Q3. A Coravin Sparkling system is best suited for which operational scenario?**
- A) A high-volume event space serving 500 covers of entry Prosecco per evening
- B) A 60-seat restaurant offering mid-tier grower Champagne by the glass at $22 to $28 per pour with moderate but inconsistent nightly volume
- C) A wine bar that only offers sparkling by the bottle, not by the glass
- D) An operation where the sommelier opens new sparkling bottles for every table order to ensure maximum freshness

**Correct: B**

---

**Q4. What distinguishes a Récoltant-Manipulant (RM) Champagne from a standard négociant house Champagne?**
- A) RM Champagnes are made using the Charmat method and are therefore more affordable than house Champagnes
- B) RM producers blend wine from across the entire Champagne appellation to achieve consistency across vintage variation
- C) RM producers grow their own grapes and produce wine exclusively from their own vineyards, offering terroir-specific expression distinct from large négociant blends
- D) RM designates Champagne that has been aged for a minimum of 10 years before release

**Correct: C**

---

**Q5. A server is asked to describe the difference between Blanc de Blancs and Blanc de Noirs to a guest. Which response is most accurate?**
- A) Blanc de Blancs uses Pinot Noir only; Blanc de Noirs uses Chardonnay only
- B) Blanc de Blancs is made entirely from white grapes (Chardonnay in Champagne) and tends toward citrus and minerality; Blanc de Noirs is made from black-skinned grapes (Pinot Noir and/or Pinot Meunier) with minimal skin contact, showing more body and red fruit character
- C) Blanc de Blancs is the sweeter style; Blanc de Noirs is the driest style in Champagne production
- D) The terms refer to the color of the label — white label for Blanc de Blancs, dark label for Blanc de Noirs

**Correct: B**

---

**Q6. A bottle of Crémant d'Alsace costs $28 wholesale. You pour 5oz glasses with a target of 5 pours per bottle and a target pour cost of 25%. What is the minimum BTG price needed to meet your pour cost target?**
- A) $10.00
- B) $12.00
- C) $14.00
- D) $22.40
...
**Q7. Which sparkling wine style is produced using the Charmat (tank method) process, and what is its primary commercial characteristic compared to traditional-method sparkling wines?**
- A) Champagne; its primary characteristic is lower production cost due to the simplified riddling process
- B) Cava; its primary characteristic is extended lees aging in pressurized tanks that produces greater complexity than bottle-fermented alternatives
- C) Prosecco; its primary characteristic is a fresh, fruit-forward style with less autolytic complexity, produced more efficiently and at lower cost than traditional-method wines
- D) Crémant; its primary characteristic is the use of tank fermentation to preserve primary fruit aromas that would be lost in bottle fermentation

**Correct: C**

---

**Q8. A table of four arrives for a birthday dinner. Applying the occasion-based selling framework, what is the most appropriate first offer before the wine list is presented?**
- A) Ask about dietary restrictions and wine preferences before making any specific recommendation
- B) Present the full wine list and wait for the guests to initiate a sparkling inquiry
- C) Proactively offer a specific sparkling wine by the glass — acknowledging the occasion and framing the offer as a celebratory starting point before still wine is discussed
- D) Offer a Champagne bottle only, as individual glasses are inappropriate for birthday occasions

**Correct: C**

---

**Q9. What is the primary function of a prestige cuvée on a sparkling wine list, even if it sells only one or two bottles per week?**
- A) It satisfies supplier allocation requirements that enable access to entry-level Champagne
- B) It serves as a price anchor, making all other sparkling selections appear more accessible by comparison, while capturing prestige margin on occasion-driven purchases
- C) It provides the sommelier with a reference wine for training staff on what quality Champagne tastes like
- D) It qualifies the restaurant for designation as a fine dining establishment under industry standards

**Correct: B**

---

**Q10. Which food pairing is most likely to surprise and convert a guest who has not previously considered ordering sparkling wine with an entrée?**
- A) Sparkling wine with a rare steak, citing the high acidity as a counterpoint to the fat
- B) Sparkling wine with fried chicken or tempura, explaining that the effervescence and acidity cut through fat and salt in a distinctly satisfying way
- C) Sparkling wine with a Caesar salad, citing the lemon-acidity parallel
- D) Sparkling wine with a chocolate dessert, citing the contrast between sweetness and dryness

**Correct: B**

---

**Q11. When opening a Champagne bottle for table service, what is the correct technique for releasing the cork?**
- A) Twist the cork firmly and pull upward quickly to produce an audible pop, which signals quality to the table
- B) Remove the foil, unwind the cage six half-turns keeping a thumb over the cork, tilt the bottle at 45 degrees, and rotate the bottle (not the cork) slowly until the cork releases with a controlled sigh
- C) Chill the bottle to below 40°F to reduce pressure before opening, then remove the cork by pulling straight up
- D) Use a cork puller tool for sparkling wine to ensure the cork does not break under pressure

**Correct: B**

---

**Q12. What is autolysis, and why is it commercially relevant when selling traditional-method sparkling wine?**
- A) The process of riddling the bottles to consolidate yeast sediment; commercially relevant because it justifies the labor premium in traditional-method wines
- B) The breakdown of yeast cells after secondary fermentation, releasing toasty, biscuity, brioche compounds; commercially relevant because it is the primary source of the complexity that justifies premium pricing over tank-method alternatives
- C) The addition of dosage to adjust sweetness after disgorgement; commercially relevant because it determines the BTG pairing versatility of the wine
- D) The CO₂ integration process that produces fine, persistent bubbles; commercially relevant because it is the primary quality indicator guests assess when evaluating sparkling wine

**Correct: B**

---

**Q13. A server is offering a bottle upgrade to a couple who have each ordered a glass of Crémant. Which upsell script best balances financial logic with guest experience framing?**
- A) "Our Crémant bottle is $65 — significantly cheaper than two more glasses each, so you should probably just get the bottle."
- B) "You're both enjoying the sparkling — would you like to move to a bottle? At $65, it works out to about the same as your next two glasses each, and I'll keep it cold in the ice bucket for you."
- C) "We have a great deal on bottles tonight — I can bring you the same Crémant you're drinking for $65 if you decide you want more."
- D) "Most guests find the bottle is better value. Would you like me to just bring a bottle instead of more glasses?"

**Correct: B**

---

**Q14. A beverage director is considering adding a Cruvinet system to a high-volume hotel bar. Which scenario most justifies the capital investment?**
- A) The bar offers a single BTG sparkling selection and sells fewer than 20 glasses per week
- B) The bar carries a fixed BTG menu of still wines only and is adding sparkling for the first time
- C) The bar carries five BTG sparkling selections with consistent high-volume demand and requires fast-pour service across all selections simultaneously without quality degradation
- D) The bar uses Coravin Sparkling for its premium sparkling offerings and wants a second preservation system as a backup

**Correct: C**

---

**Q15. Which service detail most clearly signals professional sparkling expertise to a knowledgeable guest?**
- A) Presenting the Champagne bottle label for approval before opening
- B) Pouring into a warm glass to reduce excess foam production
- C) Filling the flute to the top to maximize the guest's pour
- D) Offering a choice between flute and coupe based on the wine's style — using a coupe for a vintage or grower Champagne to better express aromatic complexity, and a flute for a fresher NV to preserve carbonation

**Correct: D**

---

**Q16. Sabrage is most appropriately offered in which service context?**
- A) Every table ordering a bottle of Champagne, as the theater increases guest satisfaction universally
- B) Large format (magnum and above) Champagne presentations for special occasion tables, buyouts, and events where theatrical service is part of the guest experience and a trained staff member is assigned
- C) Only at the bar during happy hour, where the noise and excitement are appropriate
- D) Any time a guest specifically requests it, regardless of bottle format or service context

**Correct: B**

---

**Q17. Which combination of sparkling wine selections best represents a financially sound and narratively complete sparkling by-the-glass program for a 100-seat contemporary American restaurant?**
- A) Two Proseccos at different price points and one NV Brut Champagne
- B) One entry Cava or Crémant ($13–$15), one grower Champagne Blanc de Blancs ($22–$26), and one rosé sparkling option ($16–$18)
- C) A single house Champagne by the glass and a Prosecco for table wells
- D) Five different Champagne BTG options at varying price points with no alternative sparkling category represented

**Correct: B**

---

**Q18. A general manager asks why the sparkling attach rate — the percentage of covers ordering sparkling wine — is only 8 percent. Which action is most likely to produce the fastest and largest improvement in that metric?**
- A) Add three more sparkling wines to the wine list
- B) Reduce the BTG sparkling price by 20 percent to lower the barrier for guests
- C) Implement a standard that every table is proactively offered a specific sparkling option before still wine, and track the attach rate weekly
- D) Move the sparkling section to the front of the wine list so guests see it first

**Correct: C**

---

**Q19. Demand for Champagne spikes significantly on Valentine's Day at your restaurant. You are projecting 80% of tables will order a bottle. Which pricing action best captures the demand-driven revenue opportunity while remaining within professional norms?**
- A) Double the list price of all Champagne for the Valentine's Day service
- B) Keep prices identical to the regular list to build guest loyalty and avoid the appearance of price gouging
- C) Apply a modest seasonal price adjustment — 15 to 20 percent above standard list pricing — on prestige and mid-tier Champagne only, communicated in advance through the Valentine's Day menu, reflecting genuine demand and the occasion's elevated guest willingness to pay
- D) Introduce a mandatory Champagne pairing supplement added to every cover without guest option to decline

**Correct: C**

---

**Q20. A knowledgeable guest asks why the disgorgement date matters when choosing between two bottles of the same grower Champagne from the same vintage. What is the most accurate and commercially useful response?**
- A) The disgorgement date indicates which bottle was produced using the more labor-intensive traditional riddling process
- B) The disgorgement date shows when the yeast sediment was removed and dosage added — a more recent disgorgement means the wine has had less time to integrate post-disgorgement, while an earlier disgorgement indicates more development in bottle after the lees were removed; for a fresh, precise style, choose the more recent disgorgement, and for a more evolved, integrated expression, the earlier one
- C) The disgorgement date is primarily a quality control marker indicating the bottle was inspected before release and has no impact on flavor development
- D) Both bottles will taste identical regardless of disgorgement date, as all quality variables are determined before the wine leaves the cellar
