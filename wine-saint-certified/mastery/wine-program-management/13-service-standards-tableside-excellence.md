...
**Level:** Wine Program Management Mastery — Service Standards & Tableside Excellence
**Module:** 13
...
**Prerequisites:** Wine Saint Certified Level 2 or equivalent; Modules 1–12 recommended
...
## Section 1: Why Service Standards Are Revenue Drivers, Not Just Etiquette
...
## Section 2: The Tableside Ritual — Presenting, Opening, Pouring, and Checking
...
**Phase 3: Pouring.** Pour a tasting measure — one to one and a half ounces — for the ordering guest. This is a courtesy pour for approval, not a full first glass. Step back slightly and wait. The guest's job is to confirm the wine is sound: free of major defects, correct temperature, as expected. The guest's job is not to perform a sommelier evaluation. If the wine is sound, a nod or "that's great" is sufficient confirmation. Pour for the table in the correct sequence — traditionally women first, then men, then the host — though in practice, reading the table and following the host's cue is preferable to rigid protocol that ignores social dynamics. Fill glasses to approximately five ounces — roughly one-third of a standard twelve-ounce Bordeaux glass — leaving room for the guest to swirl and for the wine to express itself rather than sitting under its own weight.
...
## Section 3: Decanting Standards — When, Why, and How to Present It to Guests
...
## Section 4: Handling Difficult Service Situations — Corked Bottles, Guest Complaints, Returns
...
## Section 5: Tempo and Timing — Pacing Wine Service with the Kitchen
...
## Section 6: Building Standard Operating Procedures for Wine Service Across a Team
...
| Term | Definition |
|------|-----------|
| **TCA (2,4,6-trichloroanisole)** | The chemical compound responsible for cork taint, produced by microbial interaction with chlorine compounds in natural cork; detectable as a damp cardboard or musty basement aroma that suppresses a wine's fruit and aromatics |
| **Tasting pour** | A measured one-to-one-and-a-half-ounce serving offered to the ordering guest before the table is poured; functions as a quality verification step that allows the guest to confirm the wine is sound and correct before full service proceeds |
| **Aeration decanting** | The vigorous transfer of a young, tannic wine into a decanter via a high-flow pour designed to maximize oxygen contact, softening tannins and opening aromatic compounds compressed by limited bottle age |
| **Sediment decanting** | The slow, controlled decanting of a mature wine over a light source to separate bottle sediment from clear wine; requires a gentle pour and careful observation of the wine's neck to halt the pour before sediment enters the decanter |
| **Tableside ritual** | The complete four-phase sequence of professional wine service — presentation, opening, pouring, and guest check-in — executed in a defined order with scripted language at each stage |
| **Foil cut point** | The precise location on the bottle neck — the second lip rather than the first — at which the foil capsule is cut to ensure the wine pours clean without touching the foil edge |
| **Guest check-in** | The attentive return to a wine table three to five minutes after the first pour, designed to confirm guest satisfaction and open a natural entry point to further wine conversation; distinguished from a generic "is everything okay?" by the use of specific, wine-referential language |
| **Service SOP (Standard Operating Procedure)** | A written operational document specifying the exact steps, scripted language, authority hierarchy, and decision protocols for wine service across all tableside scenarios; functions as both a training document and an observation rubric |
| **Return protocol** | The documented internal procedure governing how returned wine bottles are handled — including who has authority to approve a no-charge replacement, how returns are recorded in the POS, and how the data is used to identify product quality patterns |
| **Tempo management** | The practice of synchronizing wine service pace with guest conversational rhythm and kitchen output, ensuring that refills, new bottle presentations, and glass changes occur at moments that support the guest experience rather than interrupt it |
| **Glass hold signal** | The behavioral indicator — a guest lifting their glass and holding it without drinking — that signals the guest is engaged in conversation and not ready for a refill; a trained observation cue used to govern pour timing |
| **Decanting decision matrix** | A reference document specifying, by bottle, which wines on the current list are routinely offered a decant, which technique is appropriate, and the scripted guest-facing rationale for each recommendation |
| **Authority hierarchy** | The documented designation of which roles — server, sommelier, floor manager, beverage director — have the power to authorize specific service decisions, including no-charge bottle replacements, returns, and significant wine-related comps |
| **SOP observation form** | A structured checklist based on the wine service SOP's critical steps, used by a designated shift observer to evaluate and document tableside execution quality in real time, generating pattern data for the beverage director's weekly review |
| **Reason code** | A POS-level classification tag applied to comped checks or returned bottles, used to track the specific cause of each wine service failure and aggregate pattern data for targeted training interventions |
...
**Q1. A guest orders a $120 bottle of Barolo. The server brings the bottle, sets it on the table without presenting the label, opens it, and pours a full glass without a tasting pour. Which critical purpose of the tableside ritual has been entirely bypassed?**

- A) The opportunity to describe the wine's region and producer to the guest
- B) The final verification step that allows the guest to confirm the correct bottle and vintage before it is opened, and the defect-detection step that occurs during the tasting pour
- C) The decanting decision, which should have been offered before opening
- D) The opportunity to suggest a food pairing with the current course

**Correct: B**

---

**Q2. During a tasting pour, a sommelier detects a faint but unmistakable musty cardboard aroma. The most appropriate immediate response is:**

- A) Serve the wine without comment, since the guest may not notice the defect
- B) Smell the cork ostentatiously to confirm the diagnosis before taking any action
- C) Pull the glass back, confirm the TCA detection, and offer the guest a comparison pour from a fresh bottle, framing the replacement as no-charge and allowing the guest to participate in the confirmation
- D) Apologize immediately, remove the bottle, and return with a replacement without explanation

**Correct: C**

---

**Q3. A guest who ordered a bottle of Napa Cabernet says after the first glass that she doesn't like it — it's "too heavy." The wine is sound. What is the most appropriate response?**

- A) Explain that the wine is technically correct and that her preference is not grounds for a return
- B) Remove the bottle immediately and offer a full replacement at no charge without further discussion
- C) Ask what style she was looking for, reframe the situation as a forward-looking service moment, and use her response to find an alternative that actually works — applying judgment about whether a by-the-glass credit or partial accommodation is appropriate
- D) Offer to decant the bottle to soften the wine's structure

**Correct: C**

---

**Q4. When decanting an aged Burgundy with fifteen years of bottle age, the correct technique is:**

- A) A vigorous, high-flow pour to maximize aeration and open the wine quickly
- B) A slow, controlled pour over a light source to separate bottle sediment from clear wine, halting the pour before sediment enters the decanter
- C) No decanting — aged wines should never be decanted as the process destroys their aromatics
- D) A brief aeration decant of five to ten minutes, then returned to the bottle for service

**Correct: B**

---

**Q5. A server fills a guest's red wine glass to the rim. From a service standards perspective, what is the primary problem?**

- A) Over-pouring reduces the restaurant's margin on the bottle
- B) A full glass does not allow room for the guest to swirl the wine or for the wine to express its aromatics, and signals a lack of technical awareness
- C) It is likely to spill during a long service
- D) The guest did not request a refill

**Correct: B**

---

**Q6. The correct sequence for pouring wine at a table with four guests — two women, one man, and a male host — is:**

- A) Host first, then in clockwise order regardless of gender
- B) Traditionally, women first, then men, then the host — though reading the table and following the host's cue takes priority over rigid protocol that ignores social dynamics
- C) The guest who ordered the wine first, then the others in the order they are seated
- D) Always counterclockwise, beginning with the guest to the server's right

**Correct: B**

---

**Q7. A guest picks up their wine glass and holds it during an animated conversation without drinking. The server approaches to refill. What does this behavioral cue indicate, and what is the appropriate response?**

- A) The guest has finished and is ready for a refill; pour immediately
- B) The guest is signaling through the glass hold that they do not want to be interrupted; the correct response is to read the cue and step back without pouring
- C) The guest is dissatisfied with the wine and should be approached for feedback
- D) The server should ask verbally whether the guest would like more wine before pouring

**Correct: B**

---

**Q8. A new bottle of Côte-Rôtie is offered to a table. The correct guest-facing language when recommending a decant is:**

- A) "I'm going to need to decant this wine."
- B) "Would you like me to decant this? It's quite structured at this stage — fifteen minutes in the decanter will open it considerably and you'll notice the difference by your second glass."
- C) "Decanting is standard for Rhône reds. I'll take care of it."
- D) "Would you like to taste it first before we decide whether to decant?"

**Correct: B**

---

**Q9. When cutting the foil on a bottle of wine tableside, the correct cut point is:**

- A) At the first lip, as close to the top of the bottle as possible
- B) Anywhere on the neck — the cut location does not meaningfully affect the pour
- C) At the second lip, to ensure the wine pours clean without contact with the foil edge
- D) Below the entire foil, so the capsule is fully removed before pouring

**Correct: C**

---

**Q10. A bottle of wine is almost empty. There are approximately three ounces remaining and four guests at the table. What is the most appropriate service action?**

- A) Ask the table to vote on who receives the final pour
- B) Leave the final ounces in the bottle and immediately present a second bottle recommendation
- C) Pour the remaining wine to the guest who has been drinking most slowly — a natural hospitality gesture — then ask the table whether they'd like another bottle or something different to finish the evening
- D) Divide the remaining wine equally among all four glasses, even if the pours are very small

**Correct: C**

---

**Q11. A sommelier is building a wine service SOP and writes: "Present the wine appropriately before opening." From an SOP design perspective, what is the primary problem with this step?**

- A) It is placed in the wrong sequence — presentation should follow opening
- B) It is too specific — SOPs should allow staff to use their own judgment in the moment
- C) It lacks the procedural specificity required for an effective SOP; it does not define what "appropriately" means, resulting in inconsistent execution across the team
- D) It applies only to sommelier-level staff and should not appear in a general service SOP

**Correct: C**

---

**Q12. The correct timing for presenting fresh glasses when a table transitions from a white wine to a red wine between courses is:**

- A) Immediately after the red wine is opened and the tasting pour is approved
- B) Before the new bottle is opened — fresh glasses should be in place before any new wine is poured
- C) When the guest requests them or when the server notices the white wine glasses are empty
- D) After the entrée has been set, so the transition feels simultaneous with the food arrival

**Correct: B**

---

**Q13. A beverage director notices that comp checks related to wine service errors totaled $1,800 in the previous quarter. What is the most direct operational response?**

- A) Reduce the number of wines on the list to lower the complexity of service decisions
- B) Conduct a root cause analysis of each comp event by reason code, then target the specific failure points — incorrect bottle served, corked wine served to guest, service complaints — with training interventions or SOP revisions specific to those gaps
- C) Require all servers to retake the full wine service SOP training regardless of their performance history
- D) Transfer wine service responsibility entirely to the sommelier team to eliminate server-level error

**Correct: B**

---

**Q14. When a guest at a fine dining table complains that a wine is corked, but the sommelier tastes it and believes the wine is sound, the most appropriate response is:**

- A) Tell the guest directly that the wine is not corked and explain TCA so they understand the difference
- B) Replace the bottle immediately without further tasting, since guest perception is the only standard that matters
- C) Offer a fresh glass from a second bottle as a comparison pour, allowing the guest to assess the difference themselves — if the guest agrees the first bottle is sound, the situation resolves without conflict; if the second bottle clarifies the issue, proceed with a no-charge replacement
- D) Escalate to the general manager before taking any action

**Correct: C**

---

**Q15. An observation form is used during a dinner service to audit tableside wine execution. Which approach to feedback produces the most durable behavior change?**

- A) Compiling all observations into a weekly written report delivered at the next staff meeting
- B) Delivering immediate, specific feedback to a server between tables — referencing the exact SOP step that was missed and why it matters — rather than saving observations for a later performance review
- C) Sharing only positive observations during service, reserving corrective feedback for one-on-one conversations outside of the service window
- D) Maintaining the observation records confidentially and using them only for formal performance reviews

**Correct: B**

---

**Q16. A restaurant's wine service SOP includes a laminated one-page visual summary kept at the sommelier station. A newer server consults it before approaching a table with an unfamiliar wine. This is:**

- A) An indication that the server is not sufficiently trained and should not be serving wine yet
- B) An appropriate use of the reference tool — the visual SOP exists precisely for in-service reference and does not replace the full SOP or the training built around it
- C) A service breach — wine service knowledge should be fully memorized before a server approaches any table
- D) Acceptable only in the first week; experienced servers should never need the reference

**Correct: B**

---

**Q17. At which point in a tableside wine service does the guest perform a quality verification, and what specifically are they verifying?**

- A) During the label presentation, confirming the producer name and appellation
- B) During the cork examination, verifying that the cork is intact and free of mold
- C) During the tasting pour, confirming that the wine is free of major defects and correct — not conducting a full sensory evaluation
- D) During the first full glass, after the wine has had time to open

**Correct: C**

---

**Q18. A server's aperitif offer is: "Can I get you something to drink?" A beverage director coaching this server would most likely recommend replacing it with:**

- A) "What wines are you in the mood for tonight?"
- B) "Would you like to start with a glass of something while you look at the menu?" — a specific, actionable prompt that captures the table's spending intention and frames wine as the natural first step in the meal
- C) "I'd recommend starting with our Champagne selection — can I tell you about it?"
- D) No change — the current phrasing is neutral and avoids creating pressure on the guest

**Correct: B**

---

**Q19. A restaurant's wine service SOP does not specify who has the authority to approve a no-charge bottle replacement. During a busy Saturday service, a server approves a replacement for a guest who claimed cork taint — but the sommelier believes the bottle was sound. What operational failure does this scenario illustrate?**

- A) The sommelier should have been consulted before the server approached the guest
- B) The server should have tasted the wine independently before making any service decision
- C) The absence of a documented authority hierarchy in the SOP left the service decision to improvisation, resulting in an inconsistent outcome and internal conflict that the SOP should have pre-resolved
- D) The guest's complaint should have been escalated to the general manager regardless of the server's assessment

**Correct: C**

---

**Q20. A beverage director wants to measure whether wine service standards are improving over time. Which combination of metrics provides the most complete picture?**

- A) Number of staff who have completed the SOP training and scores on the written knowledge quiz
- B) Wine comp dollars by reason code (trending down), average wine spend per cover (trending up), and observation form scores from shift audits (trending toward consistent SOP compliance)
- C) Guest satisfaction survey scores and year-over-year wine revenue growth
- D) The number of decanting offers made per shift and the percentage of bottle orders that include a tasting pour
