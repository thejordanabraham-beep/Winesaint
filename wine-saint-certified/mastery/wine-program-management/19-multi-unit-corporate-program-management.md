...
**Level:** Wine Program Management Mastery — Multi-Unit & Corporate Program Management
**Module:** 19
...
**Prerequisites:** Wine Saint Certified Level 2 or equivalent; Modules 1–18 recommended
...
## Section 1: The Challenge of Scale, Consistency vs. Local Relevance
...
## Section 2: Centralized vs. Decentralized Wine Program Architecture
...
## Section 3: Corporate Purchasing, Negotiating Volume Agreements and National Accounts
...
## Section 4: Cross-Location Training Standards and Accountability
...
## Section 5: Performance Benchmarking Across Units, KPIs, Scorecards, and Accountability
...
## Section 6: The Corporate Beverage Director's Role, Strategy, Travel, and Influence Without Authority
...
**National Account:** A formal commercial agreement between a restaurant group and a distributor or supplier that establishes pricing, volume commitments, and service terms across the entire portfolio, rather than at the individual property level.

**Core List:** The portion of a wine program mandated uniformly across all locations, typically 30 to 50 percent of the full list, consisting of national account selections and wines central to the program's brand identity.

**Hybrid Architecture:** A multi-unit wine program model that combines a centrally mandated core list with defined parameters within which property teams can make local purchasing and list decisions.

**Volume Commitment:** A contractual obligation to purchase a specified quantity of product from a distributor or supplier over a defined period, typically used to secure preferential pricing, allocation access, or marketing support.

**Volume Rebate:** A financial incentive paid by a distributor or supplier to a purchasing group once a defined purchase volume is achieved over a contract period, effectively reducing the net cost of goods.

**Allocation Compliance:** The degree to which a property or portfolio takes delivery of and sells through its committed share of allocated wines within the purchase window, a metric tracked by both the purchasing organization and the supplier.

**Training Standard:** A documented minimum competency requirement for staff by role across all properties in a portfolio, specifying what knowledge and skills must be demonstrated and to what level of proficiency.

**Wine Program Scorecard:** A structured performance measurement tool that tracks KPIs across financial, operational, training, and guest experience dimensions for each property in a portfolio, enabling cross-location comparison and trend analysis.

**Mystery Shop:** A third-party evaluation method in which a trained assessor poses as a guest to score the quality of wine recommendations, service protocol, and beverage team knowledge during an actual service experience.

**Decentralized Sommelier Model:** A program architecture in which property-level sommeliers or beverage leads have meaningful autonomy over list curation, purchasing decisions, and staff education within a framework established by the corporate beverage director.

**Influence Without Authority:** The leadership practice of driving program compliance and performance standards through credibility, relationship, and communication rather than through direct hierarchical control, the defining operating mode of most corporate beverage directors.

**Train the Trainer:** A corporate education model in which property beverage leads are certified in facilitation skills and program content at a central training event, enabling them to deliver consistent education to their own floor teams without requiring ongoing corporate involvement in each session.

**Revenue Per Cover:** Wine revenue divided by total covers served in a given period, the primary per-unit financial KPI for wine program performance, comparable across properties regardless of location size or volume.

**Beverage Cost Percentage:** The cost of goods sold for wine and other beverages expressed as a percentage of beverage revenue, the core margin metric for wine program financial management.

**Program Drift:** The gradual divergence of a property's wine program from corporate standards over time, typically driven by unmanaged local purchasing decisions, staff turnover, and the absence of regular corporate oversight, the most common long-term failure mode of multi-unit wine programs.

---

## Quiz: Module 19

**1.** What is the primary commercial argument for a centralized wine program architecture across a multi-unit portfolio?

A) It allows property sommeliers to focus entirely on guest service rather than purchasing decisions
B) It maximizes purchasing leverage, enables consistent brand delivery, and simplifies financial benchmarking across locations
C) It eliminates the need for a corporate beverage director by making the program self-managing
D) It reduces the cost of distributor relationships by limiting the number of supplier accounts

**Correct: B**

---

**2.** In a hybrid wine program architecture, which element is most appropriately left to property-level discretion?

A) Service protocols for opening and presenting a bottle of wine
B) Glassware standards and table presentation
C) Local wine additions beyond the mandated core list, managed within a defined budget
D) The format and branding of the printed or digital wine menu

**Correct: C**

---

**3.** A corporate beverage director notices that wine revenue per cover is strong across most properties but that one location consistently reports low by-the-glass revenue despite strong bottle sales. What is the most likely explanation?

A) The property's by-the-glass selection is overpriced relative to the local market
B) The property's floor team is recommending bottles confidently but not actively suggesting by-the-glass options to tables that order individual glasses
C) The property has too many by-the-glass options, creating decision paralysis for guests
D) The property's beverage cost for by-the-glass pours is being tracked inaccurately

**Correct: B**

---

**4.** When negotiating a national account agreement with a major distributor, which data point is most important to prepare before entering the conversation?

A) The number of distributor sales representatives currently assigned to your portfolio's properties
B) The total current spend with that distributor aggregated across all properties, broken down by product line and trended over 24 months
C) A list of competitor groups that use the same distributor, to establish a reference benchmark
D) The average delivery lead time per property over the past quarter

**Correct: B**

---

**5.** What is a "volume rebate" in the context of a national account purchasing agreement?

A) A discount applied automatically to all invoices once a monthly purchase threshold is met
B) A financial incentive paid by a distributor or supplier after a defined total purchase volume is achieved over the contract period
C) A penalty clause triggered when a purchasing group fails to meet its volume commitment
D) A credit issued against future purchases when a property returns unsold inventory

**Correct: B**

---

**6.** Which of the following is the most reliable indicator that a multi-unit wine program is experiencing "program drift"?

A) Property-level wine cost percentages fluctuating by more than two points quarter over quarter
B) Individual properties consistently purchasing outside the approved distributor list without flagging deviations to the corporate team
C) Staff turnover rates at high-volume properties exceeding industry averages
D) Distributor delivery reliability declining below 95 percent across the portfolio

**Correct: B**

---

**7.** A corporate beverage director manages 22 properties across 8 states. Which property visit cadence is most operationally defensible?

A) One annual visit to every property, timed to coincide with the list refresh
B) Monthly visits to all properties, rotating so each location receives a visit at least four times per year
C) Quarterly visits to high-volume and underperforming properties, semi-annual visits to stable performers, and an annual all-portfolio beverage lead gathering
D) Visits only upon request from property general managers or when a scorecard alert is triggered

**Correct: C**

---

**8.** What is the most effective use of a corporate beverage director's time during a property visit?

A) Conducting a full cellar audit and cross-referencing inventory against the POS purchase record
B) Meeting with the general manager to review the property's financial performance over the past quarter
C) Working a service alongside the floor team, facilitating a tasting, or running a staff education session
D) Meeting with the local distributor representative to identify opportunities for list additions

**Correct: C**

---

**9.** Which of the following wine program KPIs is considered a leading indicator rather than a lagging indicator of financial performance?

A) Wine revenue as a percentage of total F&B revenue for the trailing quarter
B) Average bottle spend per cover for the current period
C) Staff training completion rate and server recommendation rate, measured in real time
D) Wine cost of goods percentage for the most recently closed accounting period

**Correct: C**

---

**10.** A property's wine program scorecard shows a beverage cost percentage that is consistently at or below the corporate target, but mystery shop scores for wine service quality have declined for three consecutive months. What is the most likely explanation?

A) The property is purchasing too heavily from the approved national account list, limiting local list interest
B) The property is controlling costs through inventory reduction and reduced list investment rather than through genuine operational efficiency
C) The mystery shop methodology is flawed and does not accurately reflect actual guest experience
D) The property's floor team is overselling wine to increase check average at the expense of service quality

**Correct: B**

---

**11.** In a "Train the Trainer" model for multi-unit wine education, what is the primary outcome the corporate team is trying to achieve?

A) Ensuring that every property's staff receives identical wine education content delivered directly by the corporate beverage director
B) Certifying property beverage leads in both content and facilitation skills so they can deliver consistent education to their own floor teams without ongoing corporate involvement
C) Replacing formal staff wine certification programs with informal peer-to-peer learning at the property level
D) Reducing corporate training costs by shifting all education responsibility to property general managers

**Correct: B**

---

**12.** Which of the following structures is most appropriate for volume commitments within a national account agreement?

A) An open-ended commitment described in qualitative terms, with no specific quantity or measurement mechanism
B) A hard annual case commitment with no allowance for property closures or market variability
C) A quarterly volume target expressed in cases, tracked at the portfolio level, with a defined true-up mechanism that accounts for market variability
D) A commitment to purchase only from the approved supplier once a minimum annual spend threshold is reached

**Correct: C**

---

**13.** A corporate beverage director learns that a property sommelier has built an excellent local wine section that is significantly outperforming the national account selections in terms of revenue per cover and guest satisfaction scores. What is the most appropriate corporate response?

A) Require the property to reduce its local additions to no more than 15 percent of the list to protect national account volume commitments
B) Evaluate the local selections for potential elevation to the core program list, and use the property's approach as a case study for other locations
C) Flag the deviation to the general manager as a compliance issue and require the property to realign with the standard list
D) Allow the property to continue but decline to recognize the success formally to avoid setting expectations that other properties will want similar autonomy

**Correct: B**

---

**14.** What is the most common reason that multi-unit organizations fail to leverage their full purchasing power with distributors?

A) Corporate beverage directors typically lack the negotiating experience to structure national account agreements effectively
B) Distributor sales teams are incentivized to prevent national account consolidation because it reduces their commission opportunity
C) Property-level purchasing decisions are not aggregated at the corporate level, so the organization's total volume with any given distributor remains invisible
D) National account agreements require regulatory approval in most states, making them impractical for multi-state portfolios

**Correct: C**

---

**15.** A corporate beverage director wants to introduce a new wine program scorecard but is concerned about creating adversarial relationships with property teams. Which approach best balances accountability with positive engagement?

A) Distribute scorecards only to property general managers, not to beverage leads, so that performance conversations happen through the management chain
B) Publish scorecards across all properties so every location can see peer performance, frame them as shared resources, call out improvement publicly, and address underperformance diagnostically before evaluatively
C) Use the scorecard only internally at the corporate level and share results with properties only when performance falls below a defined threshold
D) Allow properties to opt into the scorecard program voluntarily during an initial rollout phase before making participation mandatory

**Correct: B**

---

**16.** Which of the following best describes "influence without authority" as it applies to the corporate beverage director role?

A) The ability to make purchasing and staffing decisions at the property level without requiring sign-off from property general managers
B) Using the corporate title to establish credibility with distributors even when property staff are not present
C) Driving program standards and property performance through relationship, credibility, and clear communication rather than through direct management of property staff
D) Setting wine list mandates that property teams must follow regardless of local market conditions

**Correct: C**

---

**17.** A property's wine program shows strong financial metrics but has a list accuracy rate of 68 percent, meaning nearly one-third of listed wines are unavailable on any given night. What is the most significant risk this creates?

A) National account volume commitments are at risk because the property is not selling through its allocated wines
B) Guests who order listed wines and are told they are unavailable experience a trust failure that damages the brand relationship and depresses future wine ordering
C) The corporate scorecard will flag the property for a compliance audit that may result in list reduction requirements
D) Distributor representatives will reprioritize delivery to other accounts in the market, further reducing availability

**Correct: B**

---

**18.** When a corporate beverage director opens a property visit by asking "What are you proudest of in your wine program, and what would you most want help with?", what is the primary strategic purpose of this question?

A) To gather data for the corporate scorecard that cannot be captured through POS reporting
B) To signal a supportive rather than evaluative intent, and to calibrate the visit's focus based on the beverage lead's actual operational reality
C) To give the property beverage lead an opportunity to flag compliance issues before they appear in the formal audit
D) To identify training gaps that the corporate team can address through the upcoming Train the Trainer session

**Correct: B**

---

**19.** Which of the following represents the most defensible definition of a "core list" in a multi-unit wine program context?

A) The top-selling wines by revenue across the portfolio, updated monthly based on POS data
B) All wines sourced exclusively from national account suppliers, regardless of performance or program fit
C) The mandated portion of the wine program, typically 30 to 50 percent of the full list, composed of national account selections and key program wines that must appear at every property
D) The by-the-glass selection only, since it represents the most visible and frequently sold portion of the wine program

**Correct: C**

---

**20.** A corporate beverage director is building the annual wine program budget across a 30-unit portfolio. Which of the following best represents a strategically complete budget framework?

A) A single beverage cost percentage target applied uniformly to all properties, with property teams responsible for achieving it through their own purchasing decisions
B) Separate line items for cost of goods, training and education investment, cellar infrastructure, and corporate travel, with per-property targets differentiated by unit volume and market tier
C) A global beverage revenue target for the portfolio, with individual property allocations determined by prior-year performance
D) A fixed per-cover wine spend target for all properties, used as the primary basis for purchasing authorization
