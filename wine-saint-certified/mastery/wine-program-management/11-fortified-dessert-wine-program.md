...
**Level:** Wine Program Management — Fortified & Dessert Wine
**Module:** 11
...
## Section 1: The Case for Fortified and Dessert Wine
...
## Section 2: Building the Fortified Program
...
## Section 3: Dessert Wine Selection
...
## Section 4: The Economics of Fortified and Dessert Wine Service
...
## Section 5: Service Standards and Glassware
...
## Section 6: Selling Fortified and Dessert Wine on the Floor
...
*For the guest who says "I'm too full for dessert":*
"If you want to skip dessert, let me suggest one thing — our 20-Year Tawny Port is a 2-ounce pour, it's not heavy at all, and it finishes the meal beautifully. It's $20 and it's one of our most popular ways to end the evening."

*For the wine-focused guest who ordered a red with dinner:*
"Since you're enjoying the Barolo tonight, I'd love to offer you a glass of Vintage LBV Port to close — it's from the same winemaking tradition, much more concentrated, and it pairs really well with the chocolate desserts."

*For the skeptical guest who "doesn't usually drink sweet wines":*
"The Fino Sherry is actually completely dry — it's one of the driest wines we serve. It has a saline, almost nutty quality that's really distinctive. It's also quite low alcohol. A lot of people who say they don't like sweet wine end up loving it."

*The "digestif instead of dessert" pitch:*
"We have a really nice selection of digestifs that work as alternatives to dessert — Port, Sherry, Madeira. They're small pours, they won't make you feel heavy, and honestly they're one of the best parts of the meal. Would you like me to walk you through what we have?"
...
| Term | Definition |
|------|------------|
| Fortified wine | Wine to which a neutral grape spirit (usually brandy) has been added, either during or after fermentation, raising alcohol to 15–22% ABV and stabilizing the wine |
| Oxidative aging | Aging in contact with oxygen (through porous barrels, deliberate racking, or topping off with older wine), producing complex flavors of dried fruit, nuts, caramel, and the characteristic rancio note found in aged Tawny Port and Oloroso Sherry |
| Biological aging (flor) | Aging under a film of native yeast (flor) that protects wine from oxygen while imparting saline, yeasty, and chamomile characteristics; the defining mechanism of Fino and Manzanilla Sherry production |
| Rancio | A complex flavor descriptor — roasted nuts, dried fruit, leather, caramel — that develops in fortified wines through extended oxidative aging; most prominent in aged Tawny Port and Oloroso Sherry |
| Puttonyos | The Hungarian unit of sweetness measurement for Tokaji Aszú, corresponding to the number of baskets (puttony) of botrytized (aszú) berries added per barrel; the higher the number (3–6), the sweeter and more concentrated the wine |
| Botrytis cinerea | A noble rot fungus that, under the right conditions of alternating humidity and dryness, desiccates grapes and concentrates sugars, acids, and flavor compounds; the mechanism behind Sauternes, German BA/TBA, and Tokaji Aszú |
| Trockenbeerenauslese (TBA) | Germany's highest Prädikat wine category: made from individually selected, botrytis-affected grapes that have dried to raisins; produces wines of extraordinary concentration, sweetness, and longevity; the rarest and most expensive German wine classification |
| Pedro Ximénez (PX) | A white grape variety grown in Jerez and Montilla-Moriles, used to make the darkest, sweetest style of Sherry — sun-dried before pressing to concentrate sugars to extreme levels, producing wines with flavors of molasses, fig, coffee, and chocolate |
| LBV (Late Bottled Vintage) | A Port style made from a single declared year, aged 4–6 years in wood before bottling (longer than Vintage Port); filtered versions are ready to drink immediately; unfiltered versions may require decanting |
| Solera | A fractional blending system used in Sherry and some Madeira production in which wine is moved through a series of progressively older barrels, blending new wine with old wine to maintain consistency of house style and average age |
| Passito | An Italian winemaking technique in which harvested grapes are dried (on mats or hung) before pressing, concentrating sugars and flavor compounds; wines produced this way include Passito di Pantelleria and Amarone |
| Estufagem | A controlled heating process used in Madeira production in which wine is held at 45–55°C for 90 days or more, replicating the heat exposure of long sea voyages; it caramelizes sugars, develops complexity, and renders the wine virtually indestructible |
| Attachment rate | A service metric expressing the percentage of covers that order a specific category (e.g., dessert wine orders divided by total covers served); used to track and incentivize floor sales performance |
| Copita | The traditional Spanish Sherry glass: narrow, tulip-shaped, of 4–6oz capacity; concentrates aromatics and is the correct vessel for Fino, Manzanilla, Amontillado, and Oloroso Sherry service |
| Cost per pour | The wholesale bottle cost divided by the number of standard pours yielded per bottle; the foundational unit of margin analysis for by-the-glass programs |

---

## Quiz — Fortified & Dessert Wine Program

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. A 750ml bottle of 20-Year Tawny Port purchased at $32 wholesale is poured in 2oz servings at $20 per glass. Approximately how many pours does the bottle yield, and what is the gross margin per bottle?**
- A) 8 pours, $128 gross margin
- B) 10 pours, $168 gross margin
- C) 12 pours, $208 gross margin
- D) 15 pours, $268 gross margin

**Correct: C**

---

**Q2. Which of the following characteristics makes oxidative-style fortified wines particularly valuable in a by-the-glass program?**
- A) They are produced in very large quantities, making wholesale pricing accessible
- B) They do not degrade meaningfully after opening, eliminating BTG spoilage risk
- C) They are lower in alcohol than table wine, appealing to health-conscious guests
- D) They can be served directly from the bottle without any special handling

**Correct: B**

---

**Q3. A guest tells your server, "I don't usually drink sweet wine." Which of the following fortified wine styles would be most appropriate to recommend?**
- A) Pedro Ximénez Sherry
...
**Q4. What is the correct service temperature for Fino Sherry?**
- A) 55–60°F
- B) 62–65°F
- C) 43–46°F
- D) 68–72°F
...
**Q5. Which of the following best describes the production mechanism that distinguishes Fino Sherry from Oloroso Sherry?**
- A) Fino is made from Pedro Ximénez grapes; Oloroso is made from Palomino
- B) Fino is aged under a protective layer of flor yeast; Oloroso undergoes fully oxidative aging
- C) Fino is sweeter due to earlier fortification; Oloroso is dry because fermentation completes fully
- D) Fino is aged in American oak; Oloroso is aged in French oak

**Correct: B**

---

**Q6. A beverage director is building a minimum viable Sherry program for a contemporary American restaurant. Which three styles cover the full functional range of aperitif, food pairing, and dessert?**
- A) Manzanilla, Pale Cream, and Cream
- B) Fino, Amontillado, and Pedro Ximénez
- C) Oloroso, Palo Cortado, and East India Sherry
- D) Amontillado, Oloroso, and Dry Oloroso

**Correct: B**

---

**Q7. A restaurant purchases Sauternes in 375ml half-bottles at $28 wholesale and pours 3oz servings. Approximately how many pours per bottle, and at $22 per pour, what is the revenue per bottle?**
- A) 3 pours, $66
- B) 4 pours, $88
- C) 5 pours, $110
- D) 6 pours, $132
...
**Q8. Which of the following dessert wine styles is produced using the estufagem process, rendering it extraordinarily shelf-stable and virtually impossible to damage through improper storage?**
- A) Tokaji Aszú
- B) Sauternes
- C) Madeira
...
**Q9. Which Tokaji Aszú puttonyos level is most commonly found in trade and would be appropriate for a restaurant BTG program?**
- A) 1–2 puttonyos
- B) 3 puttonyos
- C) 5–6 puttonyos
- D) Puttonyos is not used in contemporary Tokaji production

**Correct: C**

---

**Q10. A server recommends PX Sherry to a guest by saying: "This wine exhibits a rancio profile with oxidative tertiary complexity and glycerol-driven viscosity." What is the primary problem with this description?**
- A) It is technically inaccurate — PX is biologically aged, not oxidatively aged
- B) It uses technical language that is not accessible to most guests and fails to create appetite appeal
- C) The descriptor "rancio" is only appropriate for Tawny Port
- D) Servers should not describe wine at all; that is the sommelier's role

**Correct: B**

---

**Q11. Which of the following best describes the appropriate pour size for Pedro Ximénez Sherry and the rationale for it?**
- A) 3oz, because PX is lower in alcohol and can be poured in larger volumes
- B) 2oz, matching the standard fortified wine pour across all styles
- C) 1.5oz, because the wine's extreme viscosity, sweetness, and intensity are best experienced in a smaller pour
- D) 5oz, because PX is often served as a dessert substitute requiring a full serving

**Correct: C**

---

**Q12. A guest finishes their main course and says they are too full for dessert. What is the most effective server response to convert this into a fortified or dessert wine sale?**
- A) Offer to bring a dessert menu anyway and let the guest decide
- B) Suggest a light, 2oz pour of 20-Year Tawny or a dry Sherry as a non-heavy way to finish the meal
- C) Ask if they would prefer a digestif cocktail instead
- D) Respect the guest's decision and clear the table

**Correct: B**

---

**Q13. Why should a restaurant purchase dessert wines in 375ml half-bottles rather than 750ml full bottles for BTG programs?**
- A) Half-bottles are always less expensive per milliliter at wholesale
- B) Half-bottles are the only format legally permitted for dessert wine BTG service
- C) Half-bottles reduce spoilage risk by matching volume to realistic weekly sales pace, even though the per-ml cost may be higher
- D) Guests perceive half-bottles as more premium and will pay a higher price per glass

**Correct: C**

---

**Q14. Which of the following Vintage Port service protocols represents correct professional practice?**
- A) Serve directly from the chilled bottle to preserve freshness
- B) Stand the bottle upright for 24 hours, decant slowly over a light source, and present the cork to the guest
- C) Shake the bottle gently to integrate sediment before pouring
- D) Always decant Vintage Port 48 hours before service and store decanted wine in the refrigerator

**Correct: B**

---

**Q15. A beverage director wants to calculate the annual cost of BTG wine spoilage at her restaurant. She estimates that 3 bottles per month are discarded due to oxidation, at an average wholesale cost of $28 per bottle. What is the annual spoilage cost, and which category of wine would eliminate virtually all of that loss?**
- A) $504/year; switching to only high-alcohol wines above 14% ABV
- B) $1,008/year; switching to exclusively organic and biodynamic wines
- C) $1,008/year; building the BTG program around oxidative-style fortified wines as anchors
- D) $336/year; using private preserve gas systems on all open bottles

**Correct: C**

---

**Q16. Which of the following is the most accurate description of the functional difference between a 20-Year Tawny Port and a Vintage Port in a restaurant program context?**
- A) 20-Year Tawny is made from red grapes; Vintage Port is made from white grapes
- B) 20-Year Tawny is a blended, oxidatively aged wine suited for BTG service; Vintage Port is a single-year declaration aged in bottle, suited for special-occasion bottle sales and formal service
- C) 20-Year Tawny should always be decanted; Vintage Port is served directly from the bottle
- D) 20-Year Tawny is produced in the Douro; Vintage Port is produced in the city of Porto

**Correct: B**

---

**Q17. The classic tableside pairing presentation for Pedro Ximénez Sherry involves which of the following composed dessert elements?**
- A) PX poured over fresh berries and whipped cream
- B) PX served alongside a cheese board with Manchego
- C) PX poured over vanilla ice cream, creating a composed dessert from a single spirit-free addition
- D) PX shaken with cream and served as a dessert cocktail

**Correct: C**

---

**Q18. Which of the following describes the correct glassware for serving Fino Sherry and explains why it is preferable to a standard white wine glass?**
- A) A wide-bowl Burgundy glass; the larger surface area enhances the wine's delicate aromatics
- B) A copita — a small, tulip-shaped glass of 4–6oz capacity — which concentrates aromatics and presents the pour proportionally without making a 2oz serve look sparse
- C) A champagne flute, which preserves the wine's effervescent quality
- D) A rocks glass with ice, which maintains the correct serving temperature throughout service

**Correct: B**

---

**Q19. A new beverage director wants to build a three-wine dessert list that covers different origins, flavor profiles, and price points. Which of the following combinations best achieves that goal?**
- A) Château Guiraud Sauternes, Château d'Yquem Sauternes, and Château Doisy-Daëne Barsac
- B) Graham's 20-Year Tawny, Blandy's Malmsey Madeira, and Cockburn's Ruby Port
- C) Château Guiraud Sauternes, Oremus Tokaji Aszú 5 Puttonyos, and a Mosel Auslese Riesling
- D) Donnafugata Ben Ryé Passito, a second Passito di Pantelleria, and a Sicilian Muscat

**Correct: C**

---

**Q20. Which of the following represents the best long-term strategy for increasing fortified and dessert wine attachment rates on the floor?**
- A) Add fortified wine recommendations to the printed menu only, minimizing server involvement
- B) Run mandatory staff tastings, provide specific sensory language for each wine, pair products to existing menu items, and use sales competitions during the launch period to accelerate behavior change
- C) Lower pour prices to $8–$10 per glass to reduce guest resistance to the category
- D) Feature fortified wines on a separate standalone menu distributed only upon guest request
