...
**Level:** Chile Mastery — The Coastal Revolution
**Module:** 09
...
## Section 2: The Humboldt Current and the Camanchaca — The Climate Mechanics of the Coastal Revolution
...
## Section 3: Old Chile vs. New Chile — The Two Models and Why They Diverged
...
The narrative tool this divergence creates for the floor is one of the most useful in Chilean wine: "old Chile vs. new Chile" is not a generational story or a quality hierarchy in the sense of one being bad and the other being better. It is a story of two different projects. Old Chile — the warm inland valleys — offers reliability, fruit weight, and value in the sense of accessibility. New Chile — the coastal zones — offers complexity, freshness, and the kind of wines that reward attention and pair with a wider range of food. Both have a role on the list. Understanding which to recommend, and to whom, is the professional application.
...
## Section 4: The Geography of the Coastal Revolution — Key Zones and Their Distinctions
...
**Casablanca Valley** is where the coastal revolution began commercially, and it remains the most accessible entry point for guests discovering cool-climate Chile. Sitting roughly 60 kilometers from the Pacific, Casablanca receives its marine influence through gaps in the Coastal Range rather than direct ocean exposure. The result is a valley with genuine warm afternoon periods — enough for Chardonnay and Pinot Noir to ripen fully — but with reliable morning fog and evening cooling that preserves freshness. Casablanca is not the coldest of Chile's coastal zones, but it is the most balanced: cool enough for precision, warm enough for generous mid-palate character. Its primary varieties are Sauvignon Blanc, Chardonnay, and Pinot Noir.
...
## Section 6: Key Producers and Floor Application — The Case-Closers
...
| Term | Definition |
|------|-----------|
| Humboldt Current | Cold, northward-flowing ocean current originating in Antarctic waters and running along the length of Chile's Pacific coast; the primary mechanism behind cool maritime temperatures in coastal wine zones |
| Camanchaca | Dense coastal fog generated when warmer, moisture-laden air condenses over the cold Humboldt-chilled Pacific surface; blankets low-lying coastal vineyards in the morning, moderating temperatures and extending the growing season |
| Aconcagua Costa | The Pacific-facing western arm of the Aconcagua Valley; one of Chile's most exciting emerging cool-climate wine zones; primary region for Errázuriz's cool-climate range |
| Coastal Range (Cordillera de la Costa) | The low mountain ridge running parallel to Chile's Pacific coast; acts as a filter for marine influence, blocking it where solid and channeling it through gaps and valley openings |
| Diurnal variation | The temperature differential between a day's high and low; extreme in coastal Chilean valleys (often exceeding 20°C) and fundamental to preserving natural acidity and extending ripening |
| EQ (Equinox) | Matetic's flagship range produced biodynamically in the San Antonio DO; covers Sauvignon Blanc, Chardonnay, Pinot Noir, and Syrah; the key floor reference for coastal Chilean wine quality |
| Old Chile vs. New Chile | A narrative framework distinguishing the warm-interior valley model (Maipo, Colchagua — reliable fruit weight, Cabernet-driven) from the coastal revolution model (Leyda, Casablanca, Aconcagua Costa — fresh, precise, Pacific-influenced) |
| San Antonio DO | Chilean Denominación de Origen encompassing the coastal valleys south of Casablanca, including the Leyda sub-zone; one of the coolest wine-producing DOs in the country |
| Matetic | Biodynamic estate in the San Antonio DO; producer of the EQ range; the most complete and consistently excellent coastal Chilean producer for floor purposes |
| Casa Marin | Extreme coastal estate in Lo Abarca, San Antonio, founded by Maria Luz Marin; positioned within a few kilometers of the Pacific; produces some of Chile's most mineral and structurally precise Sauvignon Blanc |
| West-facing slope | A vineyard aspect oriented toward the Pacific Ocean; in the Chilean coastal context, a primary quality indicator as these positions receive maximum marine cooling and fog penetration |
| Pyrazine | A family of aromatic compounds responsible for the green, herbaceous, and tropical pungency associated with warm-climate Sauvignon Blanc; present at lower levels in cool-climate coastal Chilean Sauvignon Blanc, contributing to its more restrained and mineral character |
| Coastal mountain viticulture | Vineyards positioned at 400–600m elevation on the slopes of the Coastal Range; combines altitude cooling with Pacific proximity to create the most extreme cool-climate conditions in Chilean viticulture |
| Kingston Family Vineyards | Artisan Casablanca estate founded by a California family with roots in the valley predating the wine industry; benchmark premium producer for the valley at small-production scale |
| Cono Sur 20 Barrels Pinot Noir | Casablanca Valley Pinot Noir; the value benchmark for coastal Chilean cool-climate wine; the entry-point reference for introducing guests to the region's potential |

---

## Quiz — Chile's Coastal Revolution

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. Chile is approximately how long as a country, forming the narrow strip of land that defines its wine geography?**
...
**Q2. What is the Humboldt Current, and where does it originate?**

- A) A warm, southward-flowing current originating in the tropical Pacific
- B) A cold, northward-flowing current originating in Antarctic waters and running along Chile's Pacific coast
- C) A seasonal subsurface current fed by Andean glacial melt, emerging at the coast in summer
- D) A tidal current running east-west through the Pacific valley openings

**Correct: B**

---

**Q3. The camanchaca is best described as:**

- A) A warm, dry afternoon wind that arrives from the Andes and accelerates ripening in coastal vineyards
- B) A heavy autumn rain event that brings moisture to dry coastal valley floors
- C) A dense coastal fog that forms over cold Pacific waters and blankets vineyard zones in the growing season morning hours
- D) A seasonal inversion layer that traps warm air below the cloud line, creating greenhouse conditions

**Correct: C**

---

**Q4. What does the term "old Chile" refer to in the context of this module's narrative framework?**

- A) Vineyards planted before phylloxera using traditional Chilean rootstock
- B) The warm inland valley model of wine production — Central Valley floors, alluvial soils, Cabernet-dominated — that defined Chilean wine from the 1950s through the 1990s
- C) Chile's nineteenth-century wine industry before French varieties were introduced
- D) Wine produced from País and Cinsault in the Southern regions — the traditional indigenous varieties

**Correct: B**

---

**Q5. Which of the following geographic factors is the single most important variable in determining a coastal Chilean vineyard's wine style?**

- A) The elevation of the vineyard above sea level
- B) The vine age and rootstock
- C) The proximity to the Pacific Ocean and the degree to which marine air reaches the site
- D) The orientation relative to the Andes — north-facing versus south-facing

**Correct: C**

---

**Q6. Aconcagua Costa is best described as:**

- A) The southern extension of the Maipo Valley, planted with Cabernet Sauvignon on Andean foothill soils
- B) The Pacific-facing western arm of the Aconcagua Valley, one of Chile's most exciting emerging cool-climate wine zones
- C) An altitude wine zone in the Andes above the Aconcagua Valley floor, known for extreme temperature variation
- D) A sub-zone of the Casablanca Valley adjacent to the port city of Valparaíso

**Correct: B**

---

**Q7. How does coastal Chilean Sauvignon Blanc from Leyda typically compare to Marlborough Sauvignon Blanc in style?**

- A) Leyda is more tropical, more pungent, and more aggressively aromatic
- B) The two regions are stylistically indistinguishable in blind tasting
- C) Leyda is more mineral, more restrained in aromatics, more citrus-driven, and more linear — cooler and more European in character
- D) Leyda Sauvignon Blanc is slightly sweeter and lower in acidity due to its proximity to the equator

**Correct: C**

---

**Q8. What is the stylistic character of cool-climate Syrah from coastal Chilean producers such as Matetic and Casa Marin?**

- A) Rich, extracted, dark-fruited, and full-bodied — analogous to Barossa Valley Shiraz
- B) Light, fresh, and fruity — more rosé than red wine in structure
- C) Peppery, savory, violet-scented, and structurally elegant — analogous to Northern Rhône Syrah
- D) Sweet, tannic, and heavily oaked — a distinctly South American expression of the variety

**Correct: C**

---

**Q9. Which producer is described in this module as the most complete coastal Chilean producer for floor purposes, with a biodynamic estate in the San Antonio DO?**

- A) Viña Leyda
- B) Kingston Family Vineyards
- C) Errázuriz
- D) Matetic
...
**Q10. Which Chilean producer founded by Maria Luz Marin is positioned in this module as the extreme coastal limit — one of the most mineral and structurally precise Sauvignon Blanc producers in the country?**
...
**Q11. Matetic's EQ range is named after what concept, and what does that name signal about the winery's philosophy?**

- A) EQ stands for "Extra Quality," signaling a reserve tier above the entry-level range
- B) EQ stands for "Equinox," emphasizing the balance of solar energy and the precision of farming through the growing cycle
- C) EQ stands for "Export Quality," indicating compliance with international organic certification standards
- D) EQ stands for "Elevation Quality," referencing the altitude of the estate's highest vineyards

**Correct: B**

---

**Q12. The Cono Sur 20 Barrels Pinot Noir from Casablanca is recommended in this module primarily because:**

- A) It is the most expensive Chilean Pinot Noir available and signals premium quality
- B) It is the value benchmark for coastal Chilean cool-climate wine — consistent evidence of the region's potential at an accessible price
- C) It is aged in 20 new French oak barrels for 20 months, producing a richly structured Pinot with strong aging potential
- D) It is produced from the oldest ungrafted Pinot Noir vines in Chile, dating to the nineteenth century

**Correct: B**

---

**Q13. What is the diurnal variation in coastal Chilean wine valleys, and why does it matter for wine quality?**

- A) The variation in annual rainfall; it matters because irrigation decisions depend on how much natural precipitation the vines receive
- B) The difference in sunlight exposure between north-facing and south-facing slopes; it matters because south-facing slopes ripen more slowly in the Southern Hemisphere
- C) The temperature differential between the day's high and low; in coastal Chilean valleys it often exceeds 20°C and is fundamental to preserving natural acidity while allowing full phenolic ripening
- D) The variation in ocean temperature between summer and winter; it matters because warmer winter ocean temperatures reduce the camanchaca intensity in the following growing season

**Correct: C**

---

**Q14. A guest who is a devoted Burgundy drinker expresses skepticism that Chile can produce interesting Pinot Noir. Which of the following responses is most effective based on this module's floor application guidance?**

- A) "You're right that Chile is better known for Cabernet — but the Pinot Noir is a nice everyday option if you want something lighter"
- B) "Leyda and Casablanca produce Pinot Noir that is genuinely Burgundy-adjacent — light, aromatic, silky. The Matetic EQ Pinot Noir from San Antonio is worth trying; it comes from 12 kilometers from the Pacific Ocean"
- C) "Chilean Pinot Noir is really more of an approachable, everyday wine than a serious Burgundy substitute"
- D) "The best Pinot Noir from Chile actually comes from the warm inland valleys — Colchagua has some excellent examples"

**Correct: B**

---

**Q15. What role does the western face of the Coastal Range play in the coastal revolution's geography?**

- A) It blocks all Pacific influence, creating a protected warm microclimate ideal for ripening Cabernet Sauvignon
- B) It provides the altitude necessary for cool-climate viticulture, independent of proximity to the ocean
- C) West-facing slopes on the Coastal Range receive direct Pacific cooling and fog penetration, often producing more precise wine than valley floor or interior-facing positions within the same appellation
- D) The western face channels warm Andean air toward the coast, moderating the extreme cold of the marine influence

**Correct: C**

---

**Q16. The "old Chile vs. new Chile" framing is most useful on the floor when:**

- A) A guest asks which Chilean wine has the highest alcohol content
- B) A guest who has dismissed Chilean wine based on warm, fruit-forward inland reds needs to be introduced to the coastal cool-climate alternative
- C) A guest asks for a recommendation from the least expensive Chilean wine on the list
- D) A guest who enjoys Argentinian Malbec is looking for something similar in style

**Correct: B**

---

**Q17. Which of the following best describes the style of coastal Chilean Chardonnay?**

- A) Heavily oaked, buttery, and tropical — characteristic of warm-climate Chardonnay production
- B) Mineral, tight, and fresh, with natural acidity, stone fruit and citrus character, and a structure closer to Chablis than to a California butter-bomb
- C) Lightly sparkling and low in alcohol — a style developed specifically for the fog-heavy coastal growing conditions
- D) Sweet and late-harvest in most expressions, due to the extended growing season created by the camanchaca

**Correct: B**

---

**Q18. Which producer is credited in this module as the major force driving international awareness of Aconcagua Costa as a distinct cool-climate wine identity?**

- A) Matetic
- B) Casa Marin
- C) Errázuriz
- D) Kingston Family Vineyards

**Correct: C**

---

**Q19. A guest at dinner mentions they love Sancerre but find it increasingly expensive and asks if there are any alternatives worth exploring. Based on this module, which recommendation is most appropriate?**

- A) Casablanca Valley Chardonnay from Kingston Family Vineyards
- B) Leyda Valley Sauvignon Blanc — mineral, citrus-driven, cool-climate precision with a European character that directly parallels Sancerre at a meaningful value
- C) San Antonio Syrah from Matetic — similarly structured and food-versatile
- D) Aconcagua Costa Pinot Noir from Errázuriz — the closest stylistic match to the Loire Valley

**Correct: B**

---

**Q20. Why is the Matetic EQ Pinot Noir described in this module as the "single most effective case-closer" for the coastal Chile conversation?**

- A) It is the most expensive Chilean wine available and therefore signals the highest quality to skeptical guests
- B) It is biodynamic, consistently elegant, well-distributed, priced accessibly against Burgundy analogues, and the combination of the wine itself with the Humboldt Current geography story reliably converts skeptical guests
- C) It is the only Chilean Pinot Noir to receive international biodynamic certification from the French authorities
- D) It is produced in extremely limited quantities, creating the scarcity that makes guests want to try it immediately
