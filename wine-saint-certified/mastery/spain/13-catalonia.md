...
## Section 1: Catalonia — Spain's Wine Laboratory
...
## Section 2: Penedès and the Torres Legacy
...
At the center of Penedès — commercially, historically, and symbolically — is Familia Torres. Founded in 1870 in Vilafranca del Penedès, Torres is the most internationally consequential wine family in Spanish history. It was Miguel Torres Sr. who dragged Spanish viticulture into the modern era by introducing temperature-controlled fermentation in the 1960s, and it was Miguel Torres Jr. who placed Catalonia and Spain on the world's serious wine map with a single wine in a single competition.

In June 1979, the French wine publication Gault Millau organized what it called the "Wine Olympics" in Paris — a blind tasting of wines from twelve countries. In the red wine category, Torres submitted their 1970 Mas La Plana, a single-vineyard Cabernet Sauvignon from Penedès. The competition included the 1970 Château Latour, the 1970 Château Mouton Rothschild, the 1969 Château Pétrus, and other canonical Bordeaux of that vintage. When the results were revealed, the Torres Mas La Plana had placed first. A Spanish Cabernet Sauvignon had defeated the greatest Bordeaux names in France's own organized competition. The result was so unexpected that the story was initially questioned; the bottles were checked and the tasting repeated. The outcome was the same. Torres won.
...
Torres' sustainability work deserves mention because it has become central to the family's identity — and it is increasingly relevant on the floor. Torres has committed to reducing its carbon footprint by 30% by 2030 and achieving climate neutrality by 2050. They own extensive certified-organic and biodynamic vineyards, run the most aggressively documented sustainability program of any major Spanish producer, and have replanted dozens of vineyards at higher altitudes to compensate for rising temperatures. When guests ask about sustainability — an increasingly frequent question across fine dining — Torres provides one of the most detailed and verifiable answers in Spanish wine.

> **Pro Tip:** The 1979 Paris tasting is one of the most powerful narrative tools in Spanish wine service. The guest who knows about the 1976 Judgment of Paris knows what happened when California beat Bordeaux — set this up as the same kind of moment, different country. Say: "In 1979, the French organized their own version of the Judgment of Paris — twelve countries, blind tasting. A Torres Cabernet Sauvignon from Penedès beat Château Latour and Mouton Rothschild. That wine — Mas La Plana — is still being made from the same vineyard today." That story changes how a guest looks at a Torres bottle.

---

## Section 3: Indigenous Varieties and the Catalan Revival
...
Familia Torres has been the most prominent and best-documented actor in this recovery. Their Grans Muralles project, launched in the early 1990s and first released in 1996, is the flagship expression of this work. The wine is produced from old-vine plantings of medieval Catalan varieties on the estate adjacent to the ancient walled monastery of Poblet in Conca de Barberà. The grape varieties in the blend include Garró, Querol, Gonfaus, and Forcada — varieties that were standard components of Catalan wines in the 12th and 13th centuries and had survived only in fragmentary old-vine plantings by the time Torres' viticulturists went looking for them. The project required collaboration with ampelographers, historians, and DNA testing laboratories to authenticate that what they'd found was what historical records described.
...
**Jean León** represents a parallel strand of Penedès history. The Spanish-American entrepreneur Juan Coll (who adopted the name Jean León) planted Cabernet Sauvignon and Chardonnay in Penedès in the early 1960s, contemporaneously with Torres but independently. His restaurant, La Scala, in Hollywood served as the testing ground — he was feeding Marilyn Monroe and Frank Sinatra wine from his own Spanish vineyard while Torres was still building their international strategy. Jean León's estate was acquired by Torres in 1994 and is now operated as a distinct brand within the Torres portfolio, maintaining its focus on Cabernet Sauvignon and Chardonnay as its signature varieties.
...
## Section 4: Terra Alta — Garnacha Blanca's Kingdom
...
## Section 5: Conca de Barberà, Alella, and Costers del Segre
...
## Section 6: Floor Strategy — Selling Catalan Wines
...
| Term | Definition |
|------|------------|
| Catalunya DO | The broad regional catch-all designation covering all of Catalonia, allowing blending across individual DO boundaries; the Catalan equivalent of an IGP, used for wines that do not conform to a specific DO's requirements or for producers who want geographic flexibility |
| DOQ (Denominació d'Origen Qualificada) | The Catalan-language designation equivalent to Spain's DOCa; held by Priorat as one of only two regions in Spain at this tier; signals the highest level of regional regulatory oversight and documented quality |
| Garnacha Blanca | White Grenache; the signature white variety of Terra Alta DO, producing full-bodied, textural whites with stone fruit and almond character from old bush-vine plantings; also used in Priorat and other Catalan DOs |
| Trepat | Indigenous Catalan red grape grown primarily in Conca de Barberà; thin-skinned, high-acid, producing light reds and serious rosés with red cherry, raspberry, and herbal character; best served slightly cool; one of Spain's most obscure and table-versatile discovery grapes |
| Mas La Plana | Familia Torres' flagship single-vineyard Cabernet Sauvignon from Penedès; the wine that placed first at the 1979 Gault Millau "Wine Olympics" in Paris, defeating Château Latour and other top Bordeaux; the reference wine for international varieties in Catalonia |
| Grans Muralles | Torres' project to revive medieval Catalan grape varieties including Garró, Querol, Gonfaus, and Forcada; produced from a vineyard adjacent to the ancient monastery of Poblet in Conca de Barberà; a benchmark for indigenous variety research in Catalan wine |
| Pansa Blanca | Catalan name for Xarel·lo as grown in the Alella DO; produces lighter, more coastal and floral expressions than inland Penedès Xarel·lo; the signature variety of Alella and the focus of producer Parxet |
| Parellada | One of the three traditional Cava base varieties; grown at higher altitudes in Penedès, Conca de Barberà, and other cool-climate Catalan DOs; contributes freshness, lightness, and floral aromatics to Cava blends; the most altitude-dependent and late-ripening of the trio |
| Sumoll | Indigenous Catalan red variety; thin-skinned, high-acid, nearly extinct by the 1990s and now in revival; produces light to medium-bodied reds with red fruit character and pronounced tartness; Catalonia's analogue to light-styled Italian indigenous varieties |
| Terra Alta | The southernmost Catalan DO, occupying a high interior plateau at 400–600 meters near the Aragonese border; hot and dry continental climate with minimal rainfall; built its identity around old-vine Garnacha Blanca; key producers include Bàrbara Forés, Celler Piñol, and Herència Altés |
| Conca de Barberà | Inland Catalan DO at 500–700 meters; source of Parellada for Cava production and home of Trepat; the DO where Torres' Grans Muralles project is based; a cool, high-altitude exception to the warm Catalan Mediterranean pattern |
| Sauló | The granitic sandy soil of the Alella DO; free-draining, low in nutrients, forcing vines to root deeply; contributes to the light, mineral character of Alella's Pansa Blanca wines |
| Familia Torres | Spain's most internationally influential wine family; based in Vilafranca del Penedès; responsible for introducing temperature-controlled fermentation to Spain, the 1979 Paris tasting victory with Mas La Plana, the Grans Muralles indigenous variety revival, and the most documented sustainability program of any major Spanish producer |
| Jean León | Pioneer Penedès estate focused on Cabernet Sauvignon and Chardonnay, planted in the early 1960s; now owned and operated by Torres; named for the Spanish-American entrepreneur Juan Coll who founded it and served the wines at his Hollywood restaurant La Scala |
| Raimat | The large Torres-owned irrigated estate in Costers del Segre near Lleida; produces Chardonnay, Tempranillo, and Cabernet Sauvignon at scale; the anchor producer and most internationally distributed name from the Costers del Segre DO |

---

## Quiz — Catalonia: From Torres to Terra Alta

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. At the 1979 Gault Millau "Wine Olympics" in Paris, which Torres wine placed first in the red wine category, defeating Château Latour and other top Bordeaux?**
- A) Grans Muralles, a blend of medieval Catalan varieties from Conca de Barberà
- B) Sangre de Toro, Torres' flagship Garnacha-Cariñena blend from Penedès
- C) Mas La Plana, a single-vineyard Cabernet Sauvignon from Penedès
- D) Perpetual, Torres' Priorat wine from old-vine Cariñena and Garnacha

**Correct: C**

---

**Q2. Terra Alta DO has built its entire marketing and identity strategy around a single grape variety. What is that variety and why does Terra Alta produce an exceptional version of it?**
- A) Tempranillo; Terra Alta's altitude preserves its acidity in the hot southern climate
- B) Garnacha Blanca; old bush-vine plantings under heat stress produce extraordinarily concentrated, textural whites with stone fruit and almond character
- C) Parellada; Terra Alta's late-ripening conditions preserve freshness in the high-altitude growing season
- D) Malvasia de Sitges; the historical association with the coastal town of Sitges applies throughout the southern Catalan DOs

**Correct: B**

---

**Q3. Trepat is described in this module as a "discovery grape." Which of the following best characterizes its flavor profile and structural identity?**
- A) Full-bodied, high-tannin, dark fruit; a powerful red best paired with grilled beef and lamb
- B) Neutral, low-acid, and high-alcohol; functions primarily as a blending component for Cava production
- C) Light-bodied, high-acid, red cherry and herbal character; excellent slightly cool, best paired with charcuterie and mushroom dishes
- D) Sweet, aromatic, and low in alcohol; best served as an aperitif or dessert wine

**Correct: C**

---

**Q4. What is the Catalan-language equivalent of Spain's DOCa designation, and which region holds it?**
- A) DOQ — Denominació d'Origen Qualificada — held by Penedès
- B) DO — Denominació d'Origen — held by all Catalan wine regions
- C) DOQ — Denominació d'Origen Qualificada — held by Priorat
- D) Catalunya — the regional catch-all DO that supersedes all sub-regional designations

**Correct: C**

---

**Q5. Conca de Barberà DO is best known to the wider wine industry as a source of which grape variety, primarily used for Cava production?**
- A) Xarel·lo
- B) Garnacha Blanca
- C) Macabeu
- D) Parellada
...
**Q6. The Grans Muralles project is Torres' initiative to revive medieval Catalan grape varieties. Which of the following is NOT one of the indigenous varieties involved in this project?**
- A) Garró
- B) Querol
- C) Sumoll
- D) Gonfaus
...
**Q7. A guest at your table always orders white Burgundy or California Chardonnay and says they want "something full-bodied and interesting but different." Which wine best fits this conversation?**
- A) Alella Pansa Blanca from Parxet — coastal, light, floral, and low-alcohol
- B) Terra Alta Garnacha Blanca from Bàrbara Forés — full-bodied, textural, stone fruit and almonds from 80-year-old vines
- C) Conca de Barberà Trepat rosé — light, high-acid, and served slightly cool
- D) Penedès Parellada Joven — fresh, low-alcohol, and designed for immediate consumption

**Correct: B**

---

**Q8. Jean León was a pioneer in Penedès during the 1960s. What distinguishes his project from contemporaneous producers in the region?**
- A) He was the first producer to plant Garnacha Blanca in Penedès and export it under the DO label
- B) He established a focus on Cabernet Sauvignon and Chardonnay at his estate, served the wines at his Hollywood restaurant La Scala, and his estate was later acquired by Torres
- C) He introduced the solera system to Penedès, creating the region's first non-vintage wines
- D) He was the founder of the Cava DO regulatory council and established minimum lees-aging requirements

**Correct: B**

---

**Q9. The Alella DO is notable for which combination of characteristics?**
- A) High altitude (700m+), hot continental climate, and old-vine Garnacha Blanca as its signature variety
- B) A large inland DO near Lleida, dominated by the Raimat estate with irrigated Chardonnay and Tempranillo
- C) One of Spain's smallest DOs, located on granitic Sauló soils 20 kilometers north of Barcelona, with Pansa Blanca (Xarel·lo) as its signature variety
- D) The southernmost Catalan DO, producing full-bodied reds from Garnacha and Monastrell on calcareous clay soils

**Correct: C**

---

**Q10. What is the Catalunya DO, and how does it function differently from Catalonia's eleven specific DOs?**
- A) It is a prestige designation reserved for wines that have passed a blind tasting panel, analogous to Vino de Pago
- B) It is the Catalan equivalent of DOCa, held alongside Priorat as one of two top-tier Catalan designations
- C) It is a regional catch-all designation that allows blending across DO boundaries within Catalonia, functioning similarly to a French IGP
- D) It is the historical name for the Penedès DO, superseded by the current DO structure in 2003

**Correct: C**

---

**Q11. Torres is described as the most aggressively carbon-neutral major wine producer in Spain. On the floor, when does this information become most useful?**
- A) When a guest asks whether Torres wines use organic grape varieties or biodynamic farming exclusively
- B) When a guest asks about sustainability practices — Torres provides one of the most detailed and verifiable answers in Spanish wine, with documented reduction targets and certified-organic vineyard conversion
- C) When a guest asks why Torres wines are more expensive than comparable Penedès producers
- D) When a guest asks specifically about the carbon content of the wine relative to its transport distance

**Correct: B**

---

**Q12. Which of the following food pairings is most appropriate for Mas La Plana (Torres' 100% Cabernet Sauvignon from Penedès)?**
- A) Grilled salmon and light herb-dressed salads, taking advantage of the wine's high acidity and light body
- B) Vanilla ice cream and dark chocolate, where the wine's residual sweetness complements the dessert
- C) Grilled or roasted lamb, rack of lamb, or dry-aged beef, where the wine's firm tannins and dark fruit structure need protein to integrate
- D) Salt cod in cream sauce and shellfish risotto, where the wine's coastal minerality complements oceanic flavors

**Correct: C**

---

**Q13. Garnacha Blanca from Terra Alta is distinguished from other full-bodied white wines by a specific textural quality. How is this texture produced?**
- A) Through mandatory extended oak aging and lees contact, required by the Terra Alta DO regulations
- B) Through the combination of heat stress, extremely low yields from old bush-vine plantings, and the calcareous clay soils of the high plateau, which concentrate sugars and glycerol in the fruit
- C) Through chapitalization — the addition of sugar during fermentation — permitted by the Terra Alta DO to reach minimum alcohol requirements
- D) Through late harvest, with grapes picked several weeks after neighboring DOs to maximize concentration

**Correct: B**

---

**Q14. Sumoll is an indigenous Catalan variety in revival. Which comparison best describes its character to a guest who is unfamiliar with it?**
- A) A Catalan analogue to old-vine Monastrell from Jumilla — deeply colored, tannic, and high in alcohol
- B) A Catalan analogue to Gamay — juicy, light-bodied, high-acid, best served slightly cool with lighter fare
- C) A Catalan white variety similar to Garnacha Blanca, but grown at higher altitudes with greater freshness
- D) An oxidative variety related to Palomino, traditionally used for fortified wine production in Tarragona

**Correct: B**

---

**Q15. Costers del Segre's Raimat estate is distinct from most quality-focused Catalan producers because of which characteristic?**
- A) Raimat farms exclusively in dry-farmed, high-density old vines without irrigation, producing minimal yields of Garnacha Blanca
- B) Raimat uses the traditional solera system for its red wine production, blending multiple vintages to achieve consistency
- C) Raimat operates large-scale irrigated viticulture in a hot continental climate near Lleida, producing commercially oriented Chardonnay, Tempranillo, and Cabernet Sauvignon at scale
- D) Raimat was the first Catalan estate to receive Vino de Pago status and operates independently of the Costers del Segre DO regulatory structure

**Correct: C**

---

**Q16. A guest says: "I've been drinking Bordeaux my whole life. Why should I try something from Catalonia?" What is the most effective response drawing on the content of this module?**
- A) "Catalonia has a warmer climate than Bordeaux, so the wines are riper and more approachable — essentially the same style but in the sun."
- B) "In 1979, the French organized a blind tasting — twelve countries, the best bottles. A Torres Cabernet Sauvignon from Penedès placed first, ahead of Château Latour and Mouton Rothschild. That wine is still being made from the same vineyard today."
- C) "Catalonian wines are made entirely from indigenous varieties that you cannot find anywhere else in the world, unlike Bordeaux which uses international grapes."
- D) "Catalonia's wines are classified at a higher tier than Bordeaux under European wine law, which guarantees better quality at every price point."

**Correct: B**

---

**Q17. The floor strategy section recommends a specific sequence for a Catalan tasting flight. In what order should the wines be served, and why?**
- A) Mas La Plana → Terra Alta Garnacha Blanca → Trepat → Alella Pansa Blanca; moving from heaviest to lightest to allow the palate to recover for aperitif-style wines at the end
- B) Trepat → Grans Muralles → Mas La Plana → Terra Alta Garnacha Blanca; moving from indigenous to international to showcase varietal diversity before finishing with Catalonia's identity white
- C) Alella Pansa Blanca → Terra Alta Garnacha Blanca → Trepat → Mas La Plana; moving from coastal to interior, white to red, approachable to prestige, telling the full story of Catalan diversity
- D) Terra Alta Garnacha Blanca → Alella Pansa Blanca → Mas La Plana → Trepat; moving from the heaviest white to the lightest, then from the most prestigious red to the most obscure

**Correct: C**

---

**Q18. Herència Altés is described as the most internationally acclaimed producer in Terra Alta. What distinguishes their approach from larger Terra Alta producers like Celler Mariol?**
- A) Herència Altés focuses exclusively on red wines from old-vine Garnacha Negra, while Celler Mariol specializes in white Garnacha Blanca
- B) Herència Altés uses organic farming and minimal intervention winemaking, attracting the natural wine community while maintaining Garnacha Blanca's full-bodied character
- C) Herència Altés produces wines exclusively from the Catalunya regional DO, avoiding the Terra Alta designation to allow blending with grapes from other Catalan DOs
- D) Herència Altés is the only Terra Alta producer to use barrel fermentation and extended new-oak aging, distinguishing their wines by power rather than fruit purity

**Correct: B**

---

**Q19. Which of the following statements about the Penedès DO's altitude diversity is accurate?**
- A) Penedès operates at a single uniform altitude of approximately 400 meters, providing a consistent continental climate across the DO
- B) The coastal lower Penedès is warm enough for Garnacha and Monastrell, the middle zone handles the bulk of DO still wine production, and the upper Penedès at 500–800 meters produces cool-climate varieties including Parellada and Chardonnay
- C) The upper Penedès and lower Penedès are considered separate DOs under Catalan wine law, with different permitted grape varieties and aging requirements
- D) Penedès altitude ranges from 1,000 to 1,200 meters, making it the highest-altitude DO in Catalonia and capable of producing wines comparable to those of the Pyrenean foothills

**Correct: B**

---

**Q20. A guest who is bored with predictable wine lists asks for "something truly unusual — something nobody has ever heard of." From the content of this module, which wine and which story best answers that request?**
- A) A Penedès Cabernet Sauvignon from Torres — accessible, internationally recognized, with the 1979 Paris tasting story to provide historical context
- B) A Costers del Segre Chardonnay from Raimat — large-production, food-friendly, and the most internationally distributed Catalan label after Cava
- C) An Alella Pansa Blanca from Parxet — small DO, close to Barcelona, reliable coastal white
- D) A Conca de Barberà Trepat — an indigenous light red grown in one mountain DO, virtually unknown outside Catalonia, with a distinctive flavor profile that no standard variety replicates
