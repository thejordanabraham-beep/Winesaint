...
**Level:** Spain Mastery — Rioja (New Wave)
**Module:** 3
**Audience:** Corporate hospitality professionals — servers, sommeliers, floor managers
**Estimated Duration:** 60–75 minutes
**Prerequisites:** Wine Saint Certified Spain Mastery Modules 1–2 (Spain Overview, Rioja Foundations)
...
- Describe Artadi's evolution from pioneering DOCa Rioja producer to Vino de Mesa / VdT Castilla y León — including the reasoning behind their 2015 departure and what it signals about the tension between innovation and regulation in the region
...
- **Vinos Municipales** — village-level wines, equivalent in spirit to a Burgundy village appellation. The wine must come entirely from vineyards within a single named municipality. Fourteen villages are currently recognized, with Laguardia and Briones among the most commercially significant.
...
> **Pro Tip:** When a guest notices "Vino de la Tierra Castilla y León" on an Artadi label and asks why such an expensive wine doesn't say "Rioja," this is a story worth telling: "Artadi was actually ahead of Rioja's own classification system. They left the DOCa in 2015 because they wanted to label wines by their specific village and vineyard — and the DOCa didn't allow it yet. They argued for single-vineyard classification until it finally became law in 2019. The wine is still made from the same vines in Laguardia. The label changed. The wine didn't."

---

## Section 3: Benjamín Romeo and Contador

If Artadi is the intellectual pioneer of single-vineyard Rioja, **Bodegas Contador** is its most spectacular commercial expression — a wine of such scarcity, critical acclaim, and concentrated ambition that it has become, alongside Vega Sicilia Único, one of Spain's two most collectible bottles.
...
## Section 4: Remírez de Ganuza, Roda, and the Haro Station District
...
**Roda** is a different kind of story. Founded in 1987 and based in **Haro**, Roda occupies a deliberately transitional position in the Rioja landscape: not traditional in the López de Heredia sense (extended American oak, long oxidative aging) and not radical in the Artadi sense (leave the DOCa, reject the system entirely). Roda's philosophy is **transparency through reduction**: reduce extraction, reduce new oak, reduce everything that obscures fruit and terroir, and let the wine express what is actually there. **Roda I** is the flagship red, made primarily from old Garnacha and Tempranillo from calcareous sites across Rioja Alta; **Roda II** is assembled from younger vines and broader sourcing, providing a more accessible entry point to the house style. Both wines use French oak, shorter maceration times, and gravity-flow cellaring — modern tools in service of classical expression.
...
## Section 5: The Village Wine Movement
...
## Section 6: Floor Application — Rioja for Advanced Guests
...
| Term | Definition |
|------|-----------|
| **Viñedos Singulares** | The apex category of Rioja's 2019 classification reform. Single-vineyard wines requiring a minimum vine age of 35 years, hand harvesting, maximum yield of 5,000 kg/hectare, and estate bottling. Rioja's functional equivalent of Grand Cru. |
| **Vinos Municipales** | Village-level wines created by the 2019 reform. Wine must come entirely from vineyards within a single named municipality. Fourteen villages are recognized, including Laguardia and Briones. Equivalent in spirit to a Burgundy village appellation. |
| **Vinos de Zona** | Sub-regional wines from the 2019 reform designating wines from a single sub-zone: Rioja Alta, Rioja Alavesa, or Rioja Oriental. The first tier of the new geographic specificity system. |
| **Rioja Alavesa** | The northernmost of Rioja's three sub-zones, located in the Basque Country (Álava province), defined by limestone plateau soils, higher elevation (550–650m), and Atlantic climatic influence filtered through the Sierra de Cantabria. Generally produces Rioja's most elegant and aromatic Tempranillo. |
| **Viña El Pisón** | Artadi's flagship single-vineyard wine from Laguardia, made from 80+ year old Tempranillo vines, widely considered one of Spain's greatest wines. Now bottled as VdT Castilla y León following Artadi's 2015 departure from the DOCa. |
| **Contador** | Cult wine produced by Benjamín Romeo in tiny quantities from old-vine Tempranillo parcels around Laguardia. Received a 100-point score from Robert Parker's Wine Advocate for the 2004 vintage. Among Spain's most collectible wines. |
| **Predicador** | Benjamín Romeo's accessible label, produced in higher volumes from Rioja Alavesa fruit. An entry point to Romeo's winemaking philosophy at a price accessible for by-the-glass or regular list placement. |
| **Barrio de la Estación** | Haro's Railway Station District — a single neighborhood where CVNE, La Rioja Alta, Muga, López de Heredia, and Bodegas Bilbaínas are clustered. The historical hub of Rioja's export-oriented wine industry, named for the 19th-century railway station that connected the region to Bilbao. |
| **Tempranillo Peludo** | A rare old clone of Tempranillo ("hairy Tempranillo," named for the downy texture of its leaves) grown primarily in San Vicente de la Sonsierra. Produces rounder, more textural wines than standard Tempranillo clones. Señorío de San Vicente is the defining producer of this clone. |
| **Trasnocho** | Remírez de Ganuza's flagship barrel-selection wine, assembled from the best lots of top vintages and aged 16–20 months in French oak. Exemplifies the top-shoulder sorting philosophy. |
| **Vino de Mesa / VdT** | Spain's basic table wine designation (Vino de Mesa) and its regional wine category (Vino de la Tierra). Artadi downgraded to these designations after leaving the DOCa Rioja in 2015 — using them as a statement that classification without genuine geographic specificity was less meaningful than no classification. |
| **Gran Reserva** | The apex of Spain's traditional aging classification for red wine: minimum 60 months total aging, including at least 18 months in oak casks. Represents the pinnacle of the traditional Rioja winemaking model. Not to be confused with the new Viñedos Singulares category — a wine can be both, or either, or neither. |
| **Laguardia** | The medieval hilltop village in Rioja Alavesa considered the most prestigious address for single-vineyard Rioja. Home to Artadi and Contador's source vineyards. Characterized by limestone plateau soils at 620–650 meters elevation, sheltered by the Sierra de Cantabria. |
| **Prado Enea** | Muga's flagship Gran Reserva — one of the definitive expressions of traditional Rioja. Made only in the best vintages, aged 30+ months in a combination of American and French oak, and considered a benchmark for tertiary complexity in aged Rioja. |
| **Sorting Table (Mesa de Selección)** | A conveyor-based selection tool used in premium wineries to sort fruit at harvest. Remírez de Ganuza's double-cut technique on the sorting table — retaining only the top shoulder of each bunch — is one of the most precise and labor-intensive selection methods in Rioja. |

---

## Quiz — Rioja's Revolution: Single-Vineyards, Village Wines, and the Producers Redefining Spain's Greatest Region

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. The 2019 Rioja classification reform created three new geographic categories. Which of the following correctly lists all three in order from broadest to most specific?**

- A) Vinos Municipales, Vinos de Zona, Viñedos Singulares
- B) Vinos de Zona, Vinos Municipales, Viñedos Singulares
- C) Viñedos Singulares, Vinos Municipales, Vinos de Zona
- D) Vinos de Zona, Viñedos Singulares, Vinos Municipales

**Correct: B**

---

**Q2. Artadi left the DOCa Rioja in 2015. Which statement best explains the reason for their departure?**

- A) Artadi wanted to use non-Tempranillo varieties not permitted under DOCa regulations
- B) The DOCa had imposed stricter aging requirements that conflicted with Artadi's minimal-oak style
- C) Artadi disagreed with the pace of classification reform that would have allowed village and single-vineyard labeling
- D) Artadi was found to be sourcing fruit from outside the DOCa boundaries

**Correct: C**

---

**Q3. Following its departure from the DOCa, Artadi's wines are now classified as which designation?**

- A) DO Rioja Alavesa — a new sub-designation created specifically for Basque Country producers
- B) Vino de Pago — Spain's single-estate apex classification
- C) Vino de la Tierra Castilla y León
- D) Denominación de Origen Calificada — the wines retained their DOCa status under a grandfather clause

**Correct: C**

---

**Q4. A guest is looking at a bottle of Viña El Pisón and asks why such a celebrated wine doesn't say "Rioja" on the label. What is the most accurate explanation?**

- A) Artadi left the DOCa Rioja in protest over the pace of classification reform; the wine is still made from the same Laguardia vines
- B) Viña El Pisón is produced from Garnacha, which is not permitted under DOCa Rioja regulations
- C) Artadi was penalized by the DOCa for releasing wines without mandatory aging designations
- D) The wine is made outside the legal boundaries of the Rioja DOCa in an adjacent unclassified zone

**Correct: A**

---

**Q5. Which requirement distinguishes a Viñedo Singular from a Vino Municipal under the 2019 reform?**

- A) A Viñedo Singular must be a blend of at least three grape varieties; Vinos Municipales may be single-varietal
- B) A Viñedo Singular requires minimum 35-year-old vines, hand harvesting, and estate bottling; Vinos Municipales require only single-municipality sourcing
- C) A Viñedo Singular must be aged a minimum of 36 months in oak; a Vino Municipal has no aging requirement
- D) A Viñedo Singular is restricted to Rioja Alavesa; Vinos Municipales may come from any sub-zone

**Correct: B**

---

**Q6. Benjamín Romeo's Contador received a 100-point score from Robert Parker for which vintage?**
...
**Q7. A guest interested in Benjamín Romeo's philosophy but unwilling to spend on Contador asks for a recommendation. Which bottle is the correct answer?**

- A) Artadi Pagos Viejos — a wine from Romeo's former employer with a similar philosophy
- B) Predicador — Romeo's accessible label from Rioja Alavesa fruit
- C) Roda I — a Haro-based wine with a similar minimal-extraction approach
- D) Muga Prado Enea — the most recognizable benchmark wine from the same sub-zone

**Correct: B**

---

**Q8. Fernando Remírez de Ganuza's sorting table innovation involves which specific technique?**

- A) Sorting individual berries rather than whole bunches using optical laser technology
- B) Retaining only the top shoulder of each grape bunch — the ripest, most phenolically developed section — and discarding the lower portions
- C) Pre-sorting bunches in the vineyard 72 hours before harvest to allow damaged fruit to fall naturally
- D) Running each bunch through two successive cold-water flotation tanks to separate underripe from ripe berries

**Correct: B**

---

**Q9. The Barrio de la Estación in Haro refers to which of the following?**

- A) A medieval quarter of Haro that contains 15th-century wine cellars carved into the hillside, now used by multiple bodegas
- B) A railway station district where several major Rioja bodegas clustered in the 19th century, including CVNE, La Rioja Alta, Muga, and López de Heredia
- C) The administrative center of the DOCa Rioja governing body, located adjacent to Haro's main rail terminus
- D) A newly designated Vinos Municipal zone within the greater Haro municipality

**Correct: B**

---

**Q10. Tempranillo Peludo is a rare clone grown primarily around which Rioja village?**

- A) Laguardia
- B) Elciego
- C) Briones
- D) San Vicente de la Sonsierra

**Correct: D**

---

**Q11. Roda I and Roda II are produced by a bodega based in Haro. Which statement best describes Roda's winemaking philosophy?**

- A) Extended American oak aging following the traditional Rioja model, with Roda I aged for at least 30 months and Roda II for 18 months
- B) Minimal new oak, shorter maceration, French oak, and gravity-flow cellaring — transparency through reduction rather than extraction or oxidation
- C) Whole-cluster fermentation with zero sulfur additions, following the natural wine model
- D) Single-vineyard parcels from Laguardia limestone soils, with Roda I sourced exclusively from pre-phylloxera ungrafted vines

**Correct: B**

---

**Q12. A guest asks which Rioja vintage is most widely regarded as the greatest of the 21st century for age-worthy wines with deep structure. What is your answer?**

- A) 2004 — the vintage that produced Contador's 100-point wine
- B) 2016 — cool, Atlantic-influenced, producing wines of unusual elegance
- C) 2012 — warm and ripe, producing the most accessible modern vintage
- D) 2010 — near-perfect growing conditions producing deep, structured, long-lived wines

**Correct: D**

---

**Q13. Marqués de Riscal in Elciego is historically significant for which innovation in Rioja winemaking?**

- A) It was the first Rioja bodega to achieve DOCa status, in 1871
- B) It was the first Rioja bodega to introduce French oak aging, in 1868, following advice from a Médoc consultant
- C) It was the first Rioja bodega to bottle a single-vineyard wine under the new Viñedo Singular classification
- D) It introduced carbonic maceration to Rioja in the 1930s as a method for producing joven-style wines

**Correct: B**

---

**Q14. A guest familiar with Burgundy says they want a Rioja that expresses a specific place rather than a house style. Which bottle type most directly satisfies this request?**

- A) A well-aged Gran Reserva from a traditional producer like Muga or López de Heredia — these wines are defined entirely by oxidative aging, which strips house character and reveals terroir
- B) A Viñedo Singular or Vino Municipal from Laguardia — wines labeled by their specific geographic origin rather than by oak-aging tier
- C) A Crianza from a large commercial producer — these wines are regulated to limit oak contact and are therefore the most terroir-transparent in the Rioja hierarchy
- D) Any Garnacha-dominant blend from Rioja Oriental — the warmer sub-zone produces the most site-specific character in the DOCa

**Correct: B**

---

**Q15. Which pairing is most appropriate for an aged Rioja Gran Reserva with significant tertiary development — leather, tobacco, dried cherry?**

- A) Rare tuna tartare with citrus vinaigrette — the wine's earthiness contrasts with the fish's freshness
- B) Roast suckling pig (cochinillo) or slow-roasted lamb — rich, fatty proteins whose savory character matches the wine's evolved complexity
- C) Oysters on the half shell — the wine's oxidative character mirrors the saline minerality of the shellfish
- D) Fresh goat cheese with herb oil — the dairy fat softens the wine's residual tannin

**Correct: B**

---

**Q16. A guest has tried Artadi's wines before and loved them but is now noticing a different label designation. They ask whether the wine has changed. What is the most accurate and useful response?**

- A) "Yes — Artadi left Rioja and now sources fruit from different vineyards across Castilla y León to avoid the DOCa's restrictions."
- B) "The label changed because Artadi left the DOCa Rioja classification in 2015, but the wine is still made from the same vineyards in Laguardia using the same philosophy. The designation is different; the wine is not."
- C) "The label change reflects a downgrade in quality — wines labeled Vino de la Tierra are subject to fewer quality controls than DOCa wines."
- D) "Artadi was acquired by a larger bodega that operates under Castilla y León regulations, which is why the label changed."

**Correct: B**

---

**Q17. Which of the following statements about Laguardia as a wine village is accurate?**

- A) Laguardia sits at sea level in Rioja Oriental, benefiting from Mediterranean warmth and sandy alluvial soils
- B) Laguardia is in Rioja Alta at approximately 300 meters elevation on ferrous clay soils, producing the region's fullest, darkest Tempranillo
- C) Laguardia is a hilltop village in Rioja Alavesa at 620–650 meters elevation on limestone plateau soils, sheltered by the Sierra de Cantabria
- D) Laguardia is the administrative capital of the DOCa Rioja, and its wines are blended from all three sub-zones by regulatory requirement

**Correct: C**

---

**Q18. A guest asks why Rioja's large traditional bodegas opposed the 2019 classification reform. What is the most accurate explanation?**

- A) Traditional bodegas opposed the reform because it eliminated the Gran Reserva aging category, which was central to their commercial model
- B) Large bodegas opposed the reform because single-vineyard and village-wine classifications would privilege small site-specific producers over houses whose commercial model depends on blending fruit from across the entire DOCa
- C) The large bodegas supported the reform but opposed the minimum vine age requirement, arguing it was set too low at 35 years
- D) Traditional bodegas objected because the reform required all Rioja wines to be bottled in the sub-zone of origin, preventing the export of bulk wine

**Correct: B**

---

**Q19. Which wine is the accessible entry point into Benjamín Romeo's portfolio, suitable for recommending by the glass or for guests new to the producer?**

- A) Contador
- B) Qué Bonito Cacareaba
- C) La Cueva del Contador
- D) Predicador
...
**Q20. A guest who normally drinks village Burgundy — particularly Chambolle-Musigny — asks what in Rioja might offer a similar experience: elegant, aromatic, site-specific Tempranillo. Which response is most accurate and actionable?**

- A) Suggest Rioja Oriental Garnacha — the warmer sub-zone produces wines with the same floral character as Chambolle-Musigny Pinot Noir
- B) Suggest a well-aged Gran Reserva from a traditional house like López de Heredia — the extended oxidative aging produces the aromatic complexity that mirrors aged Chambolle
- C) Suggest a Viñedo Singular or village wine from Laguardia in Rioja Alavesa — the limestone plateau soils and elevated, Atlantic-influenced mesoclimate produce Tempranillo of unusual aromatic finesse and structural elegance, making it the closest analog to the Burgundy village experience
- D) Suggest Predicador by Contador — its broad Rioja Alavesa sourcing offers enough transparency to function like a regional Burgundy without the specificity of a village wine
