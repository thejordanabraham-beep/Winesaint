...
**Level:** Spain Mastery — Grape Varieties
**Module:** 18
**Audience:** Corporate hospitality professionals: servers, sommeliers, floor managers
**Estimated Duration:** 60–75 minutes
**Prerequisites:** Wine Saint Certified Level 2 or equivalent; Spain Mastery Modules 1–17 recommended
...
## Section 1: The Tempranillo Family
...
## Section 2: Garnacha, Graciano, and Mazuelo, The Rioja Blending Varieties
...
## Section 3: Monastrell, Mencía, and the Southern Reds
...
## Section 4: The Great Spanish White Varieties
...
## Section 5: Regional Rarities and the Recovery Movement
...
No single entity has done more for Spain's indigenous variety preservation than Torres, the Catalan wine family with operations spanning from Penedès to Chile. Since the early 2000s, Torres has maintained an active program of identifying, propagating, and vinifying nearly extinct Catalan varieties including Garró, Querol, and Gonfaus. The program's dual purpose is commercial (new varieties for new wines) and conservational (preventing genetic extinction). Wines from the Torres recovery program (labeled under the "Foraster" or "Partal" projects depending on the variety) represent the industry's most visible commitment to the idea that Spain's viticultural heritage belongs to the world, not just to the past.
...
## Section 6: Floor Application, The Variety Matrix
...
1. **Albariño: Rías Baixas** (e.g., Do Ferreiro or Zarate): Teaching point, high-acid Spanish white, saline minerality, the baseline for all Atlantic Spain comparisons.

2. **Verdejo: Rueda** (e.g., Belondrade y Lurton or José Pariente Fermentado en Barrica): Teaching point, herbaceous character, bitter almond finish, how oak transforms the variety's texture without overwhelming its identity.

3. **Mencía: Bierzo** (e.g., Descendientes de J. Palacios "Pétalos" or Raúl Pérez "Ultreia"): Teaching point; spanish red that reads like cool-climate European, granite terroir, what high acidity does to medium-bodied red wine.

4. **Tempranillo: Ribera del Duero Reserva** (e.g., Pesquera Reserva or Aalto): Teaching point; tempranillo in its most structured, continental expression, the reference point for dark-fruited, age-worthy Spanish red.

5. **Old-Vine Garnacha: Calatayud or Campo de Borja** (e.g., Bodegas Breca or Coto de Hayas): Teaching point, what happens when the world's warmest red grape meets high altitude and poor soils, the elegance-within-power paradox.
...
| Term | Definition |
|------|------------|
| Tempranillo | Spain's preeminent red grape; early-ripening (name from "temprano"), medium-to-full body, red to dark fruit, naturally medium acidity; anchors Rioja, Ribera del Duero, Toro, and dozens more |
| Tinto Fino / Tinto del País | Ribera del Duero's regional synonym for Tempranillo; wines labeled with this name are 100% Tempranillo |
| Ull de Llebre | Catalan name for Tempranillo, meaning "hare's eye"; used in Catalonia and appears on some Catalan wine labels |
| Tinta Roriz / Aragonez | Portuguese synonyms for Tempranillo; Tinta Roriz in the Douro, Aragonez in Alentejo |
| Garnacha Tintorera | The only teinturier (red-fleshed) grape widely grown in Spain; technically Alicante Bouschet, a cross of Petit Bouschet and Grenache; used for deep color in blends |
| Graciano | Rioja's high-acid, high-aromatic blending variety; nearly extinct by the 1980s, now being replanted for its longevity contribution to blends; CVNE Contino produces a benchmark 100% varietal |
| Mazuelo | Rioja's name for Carignan (also Cariñena in Catalonia, Carignano in Sardinia); high acid, high tannin, rustic when young, excellent for structure in blends and old-vine complexity in Priorat |
| Bobal | Dark-skinned, high-acid indigenous red of Utiel-Requena (Valencia), grown at 700–900m; historically used for bulk wine and coloring; now producing serious single-variety reds and excellent rosé |
| Teinturier | French term for a red grape variety with red-fleshed (not just red-skinned) berries; Garnacha Tintorera is Spain's primary example; the red flesh produces intensely dark must |
| Treixadura | Key white variety of Galicia's Ribeiro DO; floral and textured, often blended with Godello and Loureira in traditional Galician multi-variety whites |
| Hondarribi Zuri | The primary white grape of Basque Country Txakoli production; produces high-acid, lightly sparkling, saline whites with green apple and citrus character |
| Maturana Tinta | Ancient Rioja variety recently rescued from near-extinction; now authorized in DOCa Rioja; deeply colored, highly aromatic with violet and dark berry character; used notably by Remírez de Ganuza |
| Xarel·lo | The body and aging backbone of traditional Cava; waxy texture, earthy and fennel character, full body; the one Cava grape with genuine personality for serious aging |
| Garnacha Blanca | White mutation of Garnacha; grown in Terra Alta (Catalonia) and Roussillon; produces full-bodied, textured whites with stone fruit and herbal character; performs well with lees contact |
| Loureira | Intensely aromatic Galician and northern Portuguese white variety; lemon blossom, jasmine, and orange peel aromatics; lighter-bodied than Albariño with maximum aromatic expressiveness |

---

## Quiz: Spanish Grape Varieties: A Complete Guide to the Iberian Vine Library

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. A guest at your restaurant points to "Tinto del País" on your Ribera del Duero wine list and asks what grape that is. What is the correct answer?**
- A) A blend of Tempranillo and Garnacha unique to Ribera del Duero
- B) Tempranillo, the regional synonym used in Ribera del Duero
- C) Tinto del País is a distinct indigenous variety unrelated to Tempranillo
- D) Graciano, the high-acid Rioja variety that also grows in Ribera del Duero

**Correct: B**

---

**Q2. Tempranillo's name derives from the Spanish word "temprano," meaning early. What specific agricultural advantage does this early ripening provide in Spain's wine regions?**
- A) It allows Tempranillo to be harvested before the summer heat peaks, preserving natural acidity
- B) It enables Tempranillo to avoid autumn rains that can threaten late-ripening varieties in some Spanish regions
- C) It means Tempranillo can be grown at lower elevations where other red varieties cannot ripen sufficiently
- D) It allows producers to make multiple harvests per season from the same vineyard

**Correct: B**

---

**Q3. Which of the following is the correct pairing of grape name and its synonym relationship?**
- A) Ull de Llebre is Catalan for Garnacha, meaning "hare's eye"
- B) Cencibel is the Rioja name for Graciano
- C) Aragonez is the Alentejo (Portugal) name for Tempranillo
- D) Tinto de Toro is the Ribera del Duero synonym for Monastrell

**Correct: C**

---

**Q4. Garnacha Tintorera (Alicante Bouschet) is described as a teinturier grape. What does this mean, and why does it matter for winemakers?**
- A) It is a grape that must be aged in terracotta (teinturier) rather than oak to preserve its color compounds
- B) It is one of the few varieties with red-fleshed berries, meaning its must is intensely dark-colored and it is used as a blending grape for deep pigmentation
- C) It is a variety that produces wine with an unusually high tannin-to-acidity ratio, used to add structure to lighter blends
- D) It is a late-ripening clone of Garnacha developed by French viticulturalists in the 19th century for southern Spain

**Correct: B**

---

**Q5. A guest who loves Châteauneuf-du-Pape asks for a Spanish wine with similar character. Which recommendation is most accurate?**
- A) Ribera del Duero Gran Reserva, the dark fruit and firm tannin structure parallels the Grenache-dominant style
- B) Old-vine Garnacha from Campo de Borja or Calatayud, or Priorat Garnatxa, the same variety in Mediterranean Spanish terroir
- C) Mencía from Bierzo, the high acidity and granite mineral character mirrors the Rhône's herbal profile
- D) Txakoli from the Basque Country, the saline, herbal qualities echo the garrigue character of southern France

**Correct: B**

---

**Q6. Graciano's structural contribution to a traditional Rioja blend is best described as which of the following?**
- A) It adds body and alcohol potential, filling out the mid-palate that Tempranillo leaves underdeveloped
- B) It supplies neutral base wine that allows Tempranillo's fruit character to show without interference
- C) It contributes high acidity, deep color, firm tannins, and aromatic intensity, the structural assets that allow extended aging
- D) It contributes tannin softening through enzymatic activity during co-fermentation with Tempranillo

**Correct: C**

---

**Q7. CVNE's Contino estate is notable for making a wine that most Rioja producers would not attempt. What is it?**
- A) A 100% Mazuelo varietal wine, demonstrating that Carignan can be serious without blending
- B) A 100% Graciano varietal wine, showcasing the variety's aromatic complexity without Tempranillo blending
- C) A 100% Garnacha Blanca white Rioja, the only such wine produced in DOCa Rioja
- D) A 100% Maturana Tinta, the ancient recovered variety now authorized in DOCa Rioja

**Correct: B**

---

**Q8. A guest who describes themselves as loving Pinot Noir asks for a Spanish recommendation. Which variety and region combination most directly satisfies that preference?**
- A) Monastrell from Jumilla, dark, full-bodied, and earthy like the earthier expressions of Burgundy
- B) Garnacha from Priorat, similar body and tannin structure to Côte de Nuits Pinot Noir
- C) Mencía from Bierzo or Ribeira Sacra, high-acid, medium-bodied, perfumed, and granite-mineral
- D) Bobal from Utiel-Requena, thick skins and dark color echo Pinot Noir's intensity at the top level

**Correct: C**

---

**Q9. Bobal is grown primarily in Utiel-Requena (Valencia). Which of the following characteristics makes it exceptional for rosé production, despite being a dark-skinned red variety?**
- A) Bobal's skins are thin enough to produce very pale rosé while providing negligible tannin, making it approachable immediately
- B) Bobal's thick, dark skins provide rich color to rosé even with brief skin contact, while high natural acidity keeps the wine fresh and food-compatible
- C) Bobal produces white-fleshed berries despite dark skins, meaning rosé color must be added artificially, making it a controlled product
- D) Bobal grown at high altitude in Utiel-Requena produces naturally low alcohol, the primary reason it is preferred for rosé

**Correct: B**

---

**Q10. Godello was nearly extinct by the 1970s. What has distinguished the best modern Godello productions and earned comparisons to white Burgundy?**
- A) High residual sugar levels that develop during late-harvest picking in Valdeorras' warm autumn conditions
- B) Extreme aromatic intensity from lemon blossom and jasmine compounds unique to the Galician terroir
- C) Medium-to-full body, mineral precision from granite and slate soils, stone fruit complexity, and aging potential enhanced by barrel fermentation and lees contact
- D) Very high natural acidity and low alcohol, producing a wine style closer to Chablis than to the Côte de Beaune

**Correct: C**

---

**Q11. Macabeu is the structural base of most Cava production, yet in Rioja it is known by a different name and produces a radically different style of wine. What is its Rioja name, and what producer best exemplifies its aging potential in that region?**
- A) Viura; López de Heredia, whose Viña Tondonia Blanco spends years in American oak before release
- B) Garnacha Blanca; Torres, whose oak-aged Viura program produces wines for 10+ years of bottle age
- C) Parellada; Remírez de Ganuza, who makes single-vineyard Parellada from old-vine Rioja plots
- D) Malvasía; CVNE, whose Monopole Blanco is Spain's benchmark extended-aged Macabeu

**Correct: A**

---

**Q12. Of the three traditional Cava varieties: Macabeu, Xarel·lo, and Parellada, which one is increasingly vinified as a serious still wine, and what is its structural signature?**
- A) Macabeu, for its neutral character that allows terroir to express itself without variety interference
- B) Parellada, for its high altitude delicacy and floral aromatics that translate well to non-sparkling contexts
- C) Xarel·lo, for its full body, waxy texture, earthy character, and aging potential that give serious Cava its backbone
- D) All three are equally important as still varietal wines in Penedès and Conca de Barberà

**Correct: C**

---

**Q13. The Torres recovery program has focused on preserving nearly extinct Catalan varieties. Which of the following correctly identifies varieties associated with that program?**
- A) Maturana Tinta, Maturana Blanca, and Hondarribi Beltza, all rescued from the Sierra Cantábrica
- B) Garró, Querol, and Gonfaus; catalan varieties propagated through the Torres preservation initiative
- C) Treixadura, Loureira, and Caiño Blanco; galician varieties rescued and replanted in Catalonia
- D) Juan García, Bobal, and Trepat, varieties found only in Arribes, Utiel-Requena, and Conca de Barberà

**Correct: B**

---

**Q14. Maturana Tinta has been rescued from near-extinction in Rioja. Which producer is cited in this module as making a single-variety Maturana Tinta bottling?**
- A) CVNE Contino
- B) López de Heredia
- C) Remírez de Ganuza
- D) Artadi
...
**Q15. A guest says they love Sauvignon Blanc and wants a Spanish white. What is the most appropriate first recommendation, and what is the key flavor bridge that connects the two varieties?**
- A) Albariño, the saline, citrus-driven profile parallels the grassy, tropical notes of New Zealand Sauvignon Blanc
- B) Godello, the stone fruit and oak-influenced texture parallels the weight of barrel-fermented Sauvignon Blanc
- C) Verdejo from Rueda, the herbal, citrus, and bitter almond character satisfies the same aromatic palate type as Sauvignon Blanc
- D) Malvasía Aromática Canaria, the intense floral perfume parallels the aromatic expressiveness of Alsatian Sauvignon Blanc

**Correct: C**

---

**Q16. Hondarribi Zuri and Hondarribi Beltza are the key varieties for which Spanish wine style, and in which geographic region are they grown?**
- A) Cava production in Penedès, Catalonia, a high-altitude traditional-method sparkling wine program
- B) Txakoli production in the Basque Country, high-acid, lightly sparkling coastal wines with saline and green apple character
- C) Traditional red Rioja blending in Rioja Alavesa, varieties permitted under DOCa Rioja's Basque expansion
- D) Fortified wine production in San Sebastián, the Basque equivalent of Sherry's biological aging system

**Correct: B**

---

**Q17. Treixadura is described as "the key white in Ribeiro." Which of the following accurately describes Ribeiro's position within Galicia and what distinguishes Treixadura from Albariño?**
- A) Ribeiro is a coastal DO adjacent to Rías Baixas; Treixadura is lighter-bodied and higher-acid than Albariño
- B) Ribeiro is an inland Galician DO centered on the Miño River tributaries; Treixadura is more full-bodied and floral than Albariño, with less citrus acidity
- C) Ribeiro is a Castilian DO on Galicia's eastern border; Treixadura is a red-fleshed white grape with higher sugar levels than Albariño
- D) Ribeiro is the Galician sub-zone of Rías Baixas specializing in Treixadura, which is permitted as an Albariño blending variety

**Correct: B**

---

**Q18. A staff training tasting flight is described in this module. Which wine is recommended as the third pour, and what is the stated teaching point?**
- A) Old-Vine Garnacha from Calatayud, teaching the elegance-within-power paradox of high-altitude Mediterranean reds
- B) Verdejo from Rueda, teaching how oak transforms the variety's texture without overwhelming its herbal identity
- C) Mencía from Bierzo, teaching what high acidity does to medium-bodied red wine and how granite terroir expresses itself in Spanish reds
- D) Albariño from Rías Baixas, establishing the baseline high-acid Spanish white and the saline minerality of Atlantic Galicia

**Correct: C**

---

**Q19. A guest says: "I've been drinking white Burgundy all night, but I want something different for my last glass." You want to stay within the same quality register and structural profile but show them something they haven't had. Which recommendation from this module best fits that brief?**
- A) Albariño from Rías Baixas, similar in acidity and coastal character to Chablis, the lightest white Burgundy expression
- B) Barrel-fermented Godello from Valdeorras, such as Rafael Palacios's As Sortes, granite soils, comparable structure and aging potential, genuine discovery
- C) Rueda Verdejo Fermentado en Barrica, similar use of oak but herbaceous character that contrasts with Burgundy's minerality
- D) Malvasía from the Canary Islands, volcanic mineral character and perfumed fruit that provides maximum contrast to white Burgundy

**Correct: B**

---

**Q20. Which of the following statements about Loureira is accurate according to this module?**
- A) Loureira is the primary grape of Txakoli production in the Basque Country, known for its saline, green apple character
- B) Loureira is a red-fleshed Galician variety used primarily for coloring blends in Ribeiro and Rías Baixas
- C) Loureira is an intensely aromatic Galician and Portuguese white variety with lemon blossom, jasmine, and orange peel character; lighter-bodied than Albariño with maximum aromatic expressiveness
- D) Loureira is a synonym for Treixadura in some Galician sub-regions, where both names refer to the same variety
