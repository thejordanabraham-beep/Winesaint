...
**Level:** Spain Mastery — Monastrell & Southeast
**Module:** 15
...
- Describe Fondillón, Alicante DO's historic sweet-and-rancio wine made from Monastrell, and deploy it as a rare discovery for guests interested in Spain's overlooked fortified wine traditions
...
## Section 1: Monastrell — Spain's Mediterranean Grape
...
The most significant viticultural fact about southeast Spain's Monastrell is geological: the sandy soils of Jumilla, like the sands of Colares in Portugal and parts of Toro, protected many pre-phylloxera vines from the root louse that devastated every other major wine region in Europe in the late 19th century. Phylloxera (*Daktulosphaira vitifoliae*), the aphid-like insect that feeds on vine roots, cannot propagate in pure sand — the loose soil structure prevents the insect from establishing colonies. As a result, ungrafted Monastrell vines planted before the phylloxera epidemic of the 1890s survive in Jumilla today. Some are 100 years old or older. They are not replicas of old vines — they are the actual vines, on their own roots, producing tiny clusters of extraordinary intensity. There are very few places in the world where this is true.
...
## Section 4: Alicante DO and Fondillón
...
But the wine that sets Alicante apart from every other southeast Spanish DO — and from almost every other Spanish appellation — is **Fondillón**. Fondillón is a historic sweet-to-dry, rancio-style wine made from fully overripe Monastrell grapes harvested at a minimum of 16° Brix natural sugar, then aged for a minimum of 10 years (in practice often 15–25 years or more) in large old oak barrels using a solera-like system analogous to Sherry production. The resulting wine is amber-to-mahogany in color, with notes of dried fruit, roasted nuts, caramel, leather, orange peel, and the characteristic *rancio* oxidative quality — a savory, almost nutty complexity that develops from prolonged controlled oxidation. Unlike Sherry, Fondillón is not fortified: the Monastrell grape naturally reaches sufficient sugar at full overripeness to produce a wine of 16% or more alcohol without any addition of spirit.

Fondillón was among the most famous wines in Europe in the 17th and 18th centuries — served at the courts of Louis XIV of France and Philip IV of Spain, praised by Alexandre Dumas in *The Count of Monte Cristo* as one of the world's great wines. It then essentially disappeared from the international market, surviving only in a handful of Alicante bodegas through the 20th century. Today, fewer than a dozen producers make it commercially, and the wines can be extraordinarily old — 20, 30, even 50 years — at prices that vastly undervalue their rarity and complexity relative to comparable aged Sherry or Madeira.
...
## Section 5: Valencia and Utiel-Requena — The Bobal Revelation
...
## Section 6: Floor Application — Southeast Spain
...
| Term | Definition |
|------|------------|
| Monastrell | The Spanish name for the Mourvèdre (France) / Mataro (Australia, California) grape; a thick-skinned, late-ripening, drought-tolerant Mediterranean variety producing wines of deep color, high tannin, high alcohol, and flavors of dark fruit, leather, olive, and Mediterranean herbs; native to the Levante region of eastern Spain |
| Levante | Spain's eastern Mediterranean coastal region and its inland hinterland; the historical homeland of Monastrell; encompasses the provinces of Valencia, Murcia, and Alicante; characterized by semi-arid climate, intense sun, and minimal summer rainfall |
| Jumilla DO | Denominación de Origen in the provinces of Murcia and Albacete; high plateau at 400–800m; semi-arid with minimal rainfall; home to ungrafted pre-phylloxera Monastrell vines in sandy soils; Spain's most internationally recognized Monastrell appellation |
| Pie Franco | "Ungrafted" — vines growing on their own original rootstock rather than grafted onto phylloxera-resistant American rootstock; surviving in Jumilla's sandy soils because the phylloxera louse cannot propagate in pure sand; a term used on labels to designate wines made from pre-phylloxera vine material |
| Juan Gil | Jumilla's most internationally recognized producer; operates a three-tier Monastrell system by label color — Yellow Label (entry), Silver Label (mid-tier), Blue Label (top) — plus the prestige El Nido joint venture with Australian consultant Chris Ringland |
| El Nido | Jumilla's prestige icon wine — a joint venture between the Gil family and Australian consultant Chris Ringland; blends old-vine Monastrell with Cabernet Sauvignon; aged in new French oak; among the most critically acclaimed wines in southeast Spain |
| Casa Castillo | Jumilla's leading organic producer; known for two benchmark wines: Las Gravas (limestone parcels, elegant, structured style) and Pie Franco (pre-phylloxera ungrafted old vines in sand, extraordinary concentration and complexity) |
| Yecla DO | Denominación de Origen in Murcia, directly north of Jumilla; similar semi-arid character with slightly more elevation and rainfall; most important producer is Bodegas Castaño (Hécula, Solanera); produces Monastrell with slightly more freshness and structural precision than Jumilla |
| Bullas DO | Denominación de Origen in western Murcia; highest altitude southeast DO at 600–900m; the most underrated Monastrell appellation; higher rainfall and altitude produce wines with more acidity, lighter color, and greater freshness than Jumilla or Yecla |
| Fondillón | Alicante DO's historic sweet-to-dry, rancio-style wine made from overripe Monastrell harvested at minimum 16° Brix; not fortified; aged a minimum of 10 years (often 15–25+) in large old oak barrels using a solera-like system; historically prized in European royal courts; one of Spain's rarest and most under-recognized traditional wines |
| Bobal | An indigenous thick-skinned red grape of Utiel-Requena DO in inland Valencia; characterized by high natural acidity, deep color, dark cherry and berry flavors, and earthy, herbal character; historically used for bulk production, now being rehabilitated by serious producers; produces some of Spain's finest dry rosés |
| Utiel-Requena DO | Inland Valencia appellation at 700–900m on a continental high plateau; the homeland of Bobal; separated from coastal Valencia by a mountain range, giving it markedly different climate — cooler nights, significant diurnal variation, freshness that contrasts with coastal regions |
| El Terrerazo | Mustiguillo's flagship biodynamically farmed, old-vine Bobal from Utiel-Requena; one of the variety's most ambitious and internationally recognized expressions; demonstrates Bobal's capacity for complexity, structure, and aging potential |
| Tinajas | Large clay amphora vessels of ancient Roman origin; used by Celler del Roure and other producers in Utiel-Requena for aging Bobal; preserves freshness and texture while avoiding the oxidative influence of oak; associated with natural and minimal-intervention winemaking philosophy |
| Diurnal variation | The temperature differential between daytime highs and nighttime lows during the growing season; critical in southeast Spain's high-altitude sites (Jumilla, Bullas, Utiel-Requena) where 15–20°C swings preserve natural acidity and aromatic compounds despite intense daytime heat |

---

## Quiz — Monastrell and Southeast Spain: Jumilla, Yecla, and Old Vine Power

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. Monastrell, Mourvèdre, and Mataro are:**
- A) Three distinct grape varieties grown in Spain, France, and Australia respectively
- B) Three names for the same grape variety — originating in Spain and used under different names in France and Australia/California
- C) Regional subvarieties of Grenache, each adapted to a different climate
- D) Legal synonyms permitted only when the wine is co-produced between two countries

**Correct: B**

---

**Q2. Why do ungrafted, pre-phylloxera Monastrell vines survive in Jumilla when they were destroyed elsewhere?**
- A) Jumilla was geographically isolated from the rest of Europe during the phylloxera epidemic and the louse never arrived
- B) Monastrell's thick skin makes it naturally immune to phylloxera root damage
- C) Jumilla's sandy soils prevent the phylloxera louse from establishing colonies on vine roots, as the insect cannot propagate in pure sand
- D) The extreme summer heat in Jumilla kills phylloxera before it can spread between vines

**Correct: C**

---

**Q3. A guest who loves Bandol from Provence asks if you know anything similar but less expensive. Which response is most accurate and useful?**
- A) "Bandol is made from Mourvèdre — the same grape as Monastrell in Jumilla. The character is very similar: dark fruit, leather, Mediterranean herbs, and warmth. Jumilla is made in more extreme conditions and sells for significantly less."
- B) "There is nothing comparable to Bandol outside of Provence — the terroir is unique and cannot be replicated elsewhere."
- C) "I would recommend a Priorat Garnacha — it uses the same grape as Bandol and grows in identical soils."
- D) "Bandol is made from Grenache; the closest Spanish equivalent would be a young Rioja Tempranillo."

**Correct: A**

---

**Q4. Juan Gil's three-tier Monastrell system is organized as follows, from entry-level to top:**
- A) Blue Label — Silver Label — Yellow Label
- B) Yellow Label — Blue Label — Silver Label
- C) Silver Label — Yellow Label — Blue Label
- D) Yellow Label — Silver Label — Blue Label

**Correct: D**

---

**Q5. El Nido is notable for which of the following?**
- A) It is a 100% old-vine Monastrell made by the Castaño family in Yecla
- B) It is a joint venture between the Gil family and Australian consultant Chris Ringland, blending old-vine Monastrell with Cabernet Sauvignon in Jumilla
- C) It is an ungrafted Monastrell from Alicante DO, produced without any addition of oak
- D) It is the entry-level wine from Casa Castillo, designed for immediate consumption

**Correct: B**

---

**Q6. Casa Castillo's Pie Franco is distinctive for which reason?**
- A) It is the only wine in Jumilla produced from Bobal rather than Monastrell
- B) It is made from pre-phylloxera, ungrafted old vines growing in sand — one of the rarest viticultural survivals in European wine
- C) It is a white wine made from Airén grapes grown on limestone in the highest part of the Jumilla plateau
- D) It is a 100% Cabernet Sauvignon aged in new American oak, produced for the export market

**Correct: B**

---

**Q7. Which statement best describes the relationship between altitude and Monastrell character across southeast Spain's three main DOs?**
- A) Higher altitude produces darker color and more concentrated wines, because the sun is more intense at elevation
- B) All three DOs produce identical Monastrell character because they share the same climate and variety
- C) Higher altitude shifts Monastrell from dense, concentrated, and warm toward more structured, acidic, and fresh — Bullas at 600–900m produces noticeably different wine than low-altitude Jumilla
- D) Lower altitude sites produce lighter, more elegant wines because the vines are closer to underground water sources

**Correct: C**

---

**Q8. Bodegas Castaño's Solanera is produced in which DO, and what variety is it primarily based on?**
- A) Jumilla DO; 100% Cabernet Sauvignon
- B) Bullas DO; a blend of Bobal and Monastrell
- C) Yecla DO; primarily old-vine Monastrell with small amounts of Cabernet Sauvignon and Tintorera
- D) Alicante DO; Monastrell from the coastal subzone

**Correct: C**

---

**Q9. Fondillón is produced in Alicante DO under which conditions?**
- A) Monastrell grapes are fortified with grape spirit immediately after fermentation and aged for a minimum of three years
- B) Monastrell is harvested at minimum 16° Brix natural sugar, fermented without fortification to 16%+ alcohol, and aged a minimum of 10 years in large old oak barrels using a solera-like system
- C) Fondillón is a sparkling wine made from Monastrell using the traditional method, aged on lees for a minimum of 15 years
- D) Monastrell is dried on straw mats for six weeks before fermentation, producing a passito-style wine aged in new French barriques

**Correct: B**

---

**Q10. El Sequé is a joint venture in Alicante DO between a local Monastrell producer and which internationally known Rioja producer?**
- A) Vega Sicilia
- B) Álvaro Palacios
- C) Artadi
- D) CVNE (Compañía Vinícola del Norte de España)

**Correct: C**

---

**Q11. Which of the following most accurately describes Bobal?**
- A) An international variety imported to Utiel-Requena from France in the 19th century; produces light, high-acid wines primarily used for white wine blending
- B) A thick-skinned indigenous Spanish red variety from Utiel-Requena with high natural acidity, dark color, and substantial tannin; historically used for bulk production but now being rehabilitated; produces some of Spain's finest dry rosés
- C) A white-berried mutation of Monastrell grown in the coastal zones of Valencia; produces light, aromatic whites for local consumption
- D) A high-yielding red variety primarily used to add color to Rioja blends, with no significant plantings outside the northern meseta

**Correct: B**

---

**Q12. Mustiguillo's El Terrerazo is significant because:**
- A) It is the only commercially available Fondillón made without a solera system
- B) It is a biodynamically farmed, old-vine Bobal from Utiel-Requena — one of the variety's most ambitious and internationally recognized expressions
- C) It is the first wine in Utiel-Requena to blend Bobal with Monastrell in equal proportions, bridging the two southeastern appellations
- D) It is aged exclusively in new American oak for 30 months, producing Utiel-Requena's most internationally recognized oaked wine

**Correct: B**

---

**Q13. Celler del Roure is notable for using which unusual aging vessel for Bobal?**
- A) New French barriques exclusively — a statement of the winemaker's belief in oak integration for Bobal's tannin structure
- B) Concrete eggs — temperature-regulating fermentation vessels imported from Burgundy
- C) Ancient clay amphora (tinajas) following Roman-era winemaking traditions that preserve freshness and texture while avoiding oak influence
- D) Stainless steel tanks with no aging whatsoever — wines are released immediately after fermentation to maximize primary fruit character

**Correct: C**

---

**Q14. A guest mentions they love big, powerful California Zinfandel and wants to explore something new. Which approach and wine selection is most appropriate?**
- A) Recommend a white Rioja — the guest needs something lighter to refresh their palate after years of heavy reds
- B) Recommend a young Albariño from Rías Baixas — the high acidity will balance the guest's preference for ripe fruit
- C) Recommend a Jumilla Monastrell from old-vine material — the concentration, warmth, and dark fruit profile map directly onto Zinfandel preferences, while the savory character (leather, olive, dried herbs) adds a new dimension the guest hasn't encountered
- D) Recommend a Cava — sparkling wine pairs best with guests who prefer full-bodied reds as a contrast experience

**Correct: C**

---

**Q15. What is the primary difference between Las Gravas and Pie Franco from Casa Castillo in Jumilla?**
- A) Las Gravas is a white wine; Pie Franco is a red wine made from the same estate's Monastrell vines
- B) Las Gravas comes from limestone-rich parcels and expresses more elegance and mineral structure; Pie Franco comes from pre-phylloxera ungrafted vines in sandy soils and delivers extraordinary concentration and historical rarity
- C) Las Gravas uses 100% new French oak for aging; Pie Franco is aged exclusively in concrete tanks without any wood contact
- D) Las Gravas is Jumilla's least expensive wine, a blend of Monastrell and Bobal; Pie Franco is the estate's exported premium wine made from 100% Cabernet Sauvignon

**Correct: B**

---

**Q16. Why is Bullas DO considered the "discovery" appellation among southeast Spain's Monastrell regions?**
- A) It was only established as a DO in 2020 and has not yet been reviewed by international critics
- B) Bullas is the only southeast Spanish DO that produces white wine from Monastrell Blanc, a mutation unique to the province
- C) At 600–900m altitude with higher rainfall than Jumilla or Yecla, Bullas produces genuinely different Monastrell — lighter, higher in acidity, more floral — that is far less known internationally yet dramatically underpriced relative to quality
- D) Bullas is the source of Spain's only certified biodynamic Monastrell, which makes it distinctive but also difficult to source

**Correct: C**

---

**Q17. A guest at your table orders the Juan Gil Yellow Label and enjoys it. They ask if there is a step up. What is the correct recommendation sequence?**
- A) Recommend a completely different producer — it is unprofessional to suggest multiple wines from the same estate
- B) Recommend Juan Gil Silver Label as the next tier from the same producer, then describe Blue Label as the serious occasion wine above it; use the same family, same philosophy, ascending price and concentration as the framework
- C) Recommend El Sequé from Alicante — it is made in the same style but at a lower price point, making it a better value
- D) Suggest decanting the Yellow Label for two hours, which effectively transforms it into a Silver Label-equivalent wine without additional cost

**Correct: B**

---

**Q18. A guest is celebrating a significant occasion and mentions they want to try something from Spain they will almost certainly never encounter again. Which recommendation is most appropriate?**
- A) A standard Crianza Rioja from a major commercial producer — familiar, reliable, and widely respected
- B) An aged Fondillón from Alicante DO — a rare, historically significant wine from fewer than a dozen producers, with 15–25+ years of solera aging and a flavor profile unlike anything else in Spanish wine
- C) A young Juan Gil Yellow Label, because its accessibility and value make it memorable for guests at any price point
- D) A Bobal rosé from Utiel-Requena — the vivid color alone is memorable enough to satisfy the guest's desire for something unique

**Correct: B**

---

**Q19. A guest orders a wood-roasted leg of lamb with rosemary and asks for a wine recommendation. You have a Jumilla old-vine Monastrell and a Bullas Monastrell on your list. Which do you recommend, and why?**
- A) The Bullas — its higher acidity and lighter body are always superior to Jumilla for food pairing, regardless of the dish
- B) The Jumilla old-vine — the lamb's fat and char call for serious tannin structure to cut through the richness; the Jumilla's dark fruit matches the roasted meat, and its garrigue and herbal character mirrors the rosemary; this is the pairing the wine was built for
- C) Neither — lamb at this weight requires an aged white Rioja to complement the herb crust without overwhelming the meat
- D) Either wine is equally appropriate; the guest should choose based purely on price preference, as Monastrell character does not change meaningfully between the two DOs

**Correct: B**

---

**Q20. Which of the following correctly describes the diurnal variation effect in southeast Spain's higher-altitude sites?**
- A) Large diurnal swings (15–20°C between day and night) accelerate sugar accumulation in the berry, producing higher-alcohol wines than low-altitude sites
- B) Large diurnal swings preserve natural acidity and aromatic complexity in the grapes despite intense daytime heat — the cool nights slow ripening and allow the vine to retain freshness that flat, coastal Mediterranean sites lack
- C) Diurnal variation is a negative factor in southeast Spain because the cold nights cause frost damage to Monastrell vines after September
- D) Diurnal variation has no measurable effect on wine character in semi-arid climates because the low humidity neutralizes nighttime cooling

**Correct: B**

---

*Module 15 of the Wine Saint Certified Spain Mastery Program.*
