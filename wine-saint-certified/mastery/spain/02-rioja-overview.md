...
## Section 1: Rioja — History and DOCa Status
...
## Section 2: The Three Sub-Zones in Depth
...
## Section 3: The Classic Style — Traditional Rioja
...
- **Gran Reserva:** Minimum 5 years total aging, with at least 2 years in oak and 3 years in bottle. Produced only in exceptional vintages. The pinnacle of the traditional system.
...
- **Tempranillo:** The backbone. Red fruit, moderate alcohol, good acidity, medium tannins. 70–90% in most reds.
...
## Section 4: The New Wave — Modern Rioja
...
## Section 5: Key Producers and the Floor Reference Guide
...
**CVNE Monopole (white)** — Spain's first modern dry white wine, still made primarily from Viura. The current vintage style is fresh and clean; limited production of an oak-aged version is made for those seeking more complexity.
...
## Section 6: Floor Strategy — Selling Rioja
...
|---|---|
| Crianza (traditional) | Jamón ibérico, roast chicken, lentil stew with chorizo, Manchego |
| Reserva (traditional) | Roast lamb (lechazo), braised beef, aged Idiazábal cheese, mushroom dishes |
| Gran Reserva (traditional) | Slow-roasted lamb shoulder, venison, mature hard cheeses, dishes with deep umami |
| Modern Rioja (French oak) | Grilled lamb chops, roast duck, charcuterie boards, dark chocolate desserts |
| Modern white Rioja (fresh) | Seafood, white asparagus, grilled fish, mild fresh cheeses |
| Traditional white Rioja (oxidative) | Solo as an aperitif; shellfish; aged Manchego; dishes with moderate salinity |
...
| Term | Definition |
|---|---|
| **DOCa (Denominación de Origen Calificada)** | Spain's highest wine quality classification tier, requiring stricter production standards than a standard DO. Rioja received DOCa status in 1991 — the first in Spain. Priorat (as DOQ in Catalan) later joined. |
| **Barrio de la Estación** | The "Station Quarter" in Haro, a small neighborhood surrounding the historic train depot where the greatest traditional Rioja bodegas — CVNE, La Rioja Alta, López de Heredia, Muga — are clustered. |
| **Tempranillo** | Rioja's dominant red grape variety. Produces wines of moderate alcohol, good natural acidity, medium tannins, and red cherry/strawberry fruit. Its name derives from *temprano* (early), referring to its early-ripening nature. |
| **Graciano** | An aromatic, high-acid red blending variety native to Rioja. Used in small proportions; contributes floral aromatics, dark fruit, and natural antioxidant properties that enhance a wine's aging potential. |
| **American Oak** | The barrel wood that defines traditional Rioja's aromatic identity. Wider-grained than French oak, it imparts notes of vanilla, coconut, and dill via compounds including whiskey lactone and vanillin. Arrived in Rioja with French merchants in the 1860s–1880s. |
| **Gran Reserva** | The apex aging tier in Rioja's classification system. Requires a minimum of 5 years total aging (at least 2 in oak, 3 in bottle), produced only in exceptional vintages. The wines arrive at market already substantially aged. |
| **Crianza** | The entry-level classified aging tier in Rioja. Minimum 2 years total aging, with at least 1 year in oak. Approachable and versatile for everyday drinking. |
| **Viñedo Singular** | "Single Vineyard" — the apex designation introduced by the 2019 Rioja Wine Law reform. Requires a registered, delimited vineyard parcel of at least 35 years old, low yields, hand harvesting, and estate bottling. |
| **Viura (Macabeo)** | The dominant white grape variety in Rioja. Produces clean, citrus-driven modern whites when vinified in stainless steel; also used for the traditional barrel-aged white style showing nutty, oxidative character. |
| **Rioja Alavesa** | The sub-zone of Rioja DOCa that lies within the Basque administrative region of Álava. Characterized by limestone-rich soils, higher altitude, and structured, elegant Tempranillo. The current center of the single-vineyard movement. |
| **Rioja Oriental** | The easternmost and warmest sub-zone, formerly called Rioja Baja. Mediterranean climate, lower rainfall, higher proportion of Garnacha plantings. Historically a source of bulk wine; now producing increasingly serious quality Garnacha. |
| **Phylloxera** | The root-louse (*Daktulosphaira vitifoliae*) of American origin that devastated European vineyards beginning in the 1860s. Its destruction of French vineyards drove Bordeaux merchants to Rioja, fundamentally shaping the region's identity and winemaking style. |
| **Whiskey Lactone** | The principal aromatic compound responsible for the coconut notes associated with American oak barrel aging. Present in significantly higher concentrations in American oak than in French oak. |
| **Oxidative Aging** | A winemaking and aging approach in which the wine is intentionally exposed to small amounts of oxygen over an extended period, producing nutty, dried fruit, and earthy complexity at the expense of fresh primary fruit. The defining characteristic of López de Heredia's style and traditional barrel-aged white Rioja. |

---

## Quiz — Rioja Overview: Spain's Most Famous Region and the Style Debate That Defines It

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. Rioja received DOCa status — Spain's highest wine classification — in which year?**
...
**Q2. The influence of Bordeaux négociants on Rioja's winemaking style was primarily triggered by:**

- A) A diplomatic trade agreement between France and Spain in the 1850s
- B) Phylloxera's destruction of French vineyards beginning in the 1860s
- C) The construction of the Bordeaux-to-Madrid railway in the 1870s
- D) A surplus of American oak barrels available after the American Civil War

**Correct: B**

---

**Q3. The Barrio de la Estación in Haro is significant because:**

- A) It is the administrative headquarters of the Rioja DOCa Consejo Regulador
- B) It is where the 2019 Rioja Wine Law reform was formally ratified
- C) It is the neighborhood around the train station where the great traditional Rioja houses are clustered
- D) It is the only part of Haro permitted to produce Gran Reserva wines

**Correct: C**

---

**Q4. Which of the following best characterizes Rioja Alavesa compared to Rioja Alta?**

- A) Warmer, more Mediterranean, higher in Garnacha plantings
- B) Limestone-rich, higher altitude, more structured and mineral Tempranillo
- C) Warmer and wetter, with deeper alluvial soils along the Ebro
- D) Historically the source of bulk blending wine; now emerging for quality Garnacha

**Correct: B**

---

**Q5. American oak imparts which aromatic profile to traditional Rioja, distinguishing it from French oak-aged wines?**

- A) Graphite, lead pencil, and tobacco
- B) Roasted coffee, dark chocolate, and cedar
- C) Vanilla, coconut, and dill
- D) Green pepper, asparagus, and fresh herbs

**Correct: C**

---

**Q6. A Rioja Gran Reserva must meet which minimum aging requirement?**

- A) 1 year oak, 2 years bottle
- B) 2 years oak, 3 years bottle (5 years total minimum)
- C) 3 years oak, 2 years bottle
- D) 4 years oak, 1 year bottle

**Correct: B**

---

**Q7. López de Heredia's Viña Tondonia Gran Reserva is unusual among Rioja wines primarily because:**

- A) It is made exclusively from Garnacha and is produced only in Rioja Oriental
- B) It is aged entirely in new French barriques and released in the vintage year
- C) It is released years or decades after harvest, aged in old American oak, with an oxidative character unlike conventional Rioja
- D) It is the only wine in Rioja classified under the Viñedo Singular designation

**Correct: C**

---

**Q8. The 2019 Rioja Wine Law reform introduced a classification tier called Viñedo Singular. What does this designation require?**

- A) A minimum vine age of 10 years, stainless steel fermentation, and a maximum yield of 8,000 kg/ha
- B) A minimum vine age of 35 years, hand harvesting, maximum yield of 5,000 kg/ha, and estate bottling
- C) Blending from at least three sub-zones and aging for a minimum of 4 years in French oak
- D) Certification by the Basque regional government for wines produced in Rioja Alavesa

**Correct: B**

---

**Q9. Rioja Oriental was formerly known as Rioja Baja. The name was changed primarily because:**

- A) "Baja" was a trademarked term owned by a Mexican wine cooperative
- B) The sub-zone was administratively transferred to the Navarra DO
- C) "Baja" implied inferior quality, which producers sought to overcome
- D) The new name reflects the sub-zone's expansion into eastern Navarra

**Correct: C**

---

**Q10. Which grape variety is most associated with Rioja Oriental and thrives in the sub-zone's hot, dry, Mediterranean conditions?**
...
**Q11. The Winery Roda is significant in the context of Rioja's style debate because:**

- A) It was the first producer to petition for DOCa status in 1985
- B) It is located within the Barrio de la Estación and produces exclusively in the traditional American oak style
- C) It is a modernist producer physically located in Haro's traditional quarter, representing the new style's confident establishment alongside the old
- D) It produces Rioja exclusively from Garnacha sourced from Rioja Oriental

**Correct: C**

---

**Q12. A guest who loves Meursault asks for a white wine recommendation from Spain. Which bottle is the most defensible choice, and how should you frame it?**

- A) A modern stainless-steel Viura Rioja; frame it as "Spain's answer to Chablis"
- B) A López de Heredia Viña Tondonia Blanco Gran Reserva; frame it as "an oxidative aged white that has spent a decade in old American oak — closer to aged white Burgundy than anything else in Spain"
- C) A Remírez de Ganuza Trasnocho; frame it as "the most expensive white in Rioja, which guarantees quality"
- D) A CVNE Monopole from the current vintage; frame it as "Rioja's best-value white wine, great for everyday drinking"

**Correct: B**

---

**Q13. Which of the following describes the correct function of Graciano in a traditional Rioja blend?**

- A) It contributes body, high alcohol, and a spicy, herbal character to offset Tempranillo's acidity
- B) It provides floral aromatics, high natural acidity, and antioxidant properties that support aging
- C) It is the primary structural grape, contributing deep tannins and color stability in the absence of Tempranillo
- D) It adds a coconut and vanilla aromatic profile that complements the American oak character

**Correct: B**

---

**Q14. A guest is choosing between a Rioja Crianza for €28 and a Rioja Gran Reserva for €65. They mention they don't own a wine cellar and tend to drink wine the night they buy it. What is the strongest argument for the Gran Reserva?**

- A) The Gran Reserva will improve significantly over the next 20 years if the guest eventually purchases a cellar
- B) The Gran Reserva's higher price reflects a superior vintage and more concentrated fruit
- C) The Gran Reserva has already been aged for a minimum of five years before release — the aging work has been done for the guest; it is ready to drink at a level of complexity the Crianza cannot offer
- D) The Gran Reserva contains a higher percentage of Graciano, which makes it more immediately approachable

**Correct: C**

---

**Q15. The traditional Rioja house La Rioja Alta, S.A. produces two Gran Reservas: the 904 and the 890. How do they differ?**

- A) The 904 is made from Garnacha; the 890 is made exclusively from Tempranillo
- B) The 904 is richer and more accessible earlier; the 890 is rarer, more concentrated, and requires extended cellaring
- C) The 904 is aged in French oak; the 890 is aged in American oak
- D) The 904 is produced annually; the 890 is produced only in declared years

**Correct: B**

---

**Q16. When describing the difference between traditional and modern Rioja to a guest, which framing is most accurate and most useful?**

- A) "Traditional Rioja uses Tempranillo; modern Rioja uses Garnacha — that's why they taste different."
- B) "Traditional Rioja is aged longer in American oak and shows vanilla, leather, and earthy complexity; modern Rioja uses French oak and is designed for earlier drinking with more forward fruit."
- C) "Traditional Rioja is from Rioja Alta; modern Rioja is from Rioja Alavesa — the sub-zones determine the style."
- D) "Traditional Rioja is unfiltered; modern Rioja is heavily filtered, which is why it tastes cleaner."

**Correct: B**

---

**Q17. Which of the following pairings is best suited to a López de Heredia Viña Tondonia Blanco Gran Reserva?**

- A) Oysters on the half shell with lemon
- B) Fresh fruit salad with a sparkling wine reduction
- C) Shellfish, aged Manchego, or as a solo aperitif — leveraging the wine's oxidative, nutty complexity
- D) Seared tuna with ginger and soy, which balances the wine's fruity primary notes

**Correct: C**

---

**Q18. Artadi is referenced in this module as a producer who made a dramatic statement about Rioja's classification system. What was that statement?**

- A) Artadi petitioned the Consejo Regulador to create a new DOCa for Rioja Alavesa alone
- B) Artadi declassified its wines out of the Rioja DOCa to Vino de la Tierra to protest the regulatory framework's failure to recognize single-vineyard quality
- C) Artadi was the first producer to receive Viñedo Singular certification under the 2019 Wine Law reform
- D) Artadi converted all production to natural, uncertified wines and rejected all DO classification

**Correct: B**

---

**Q19. A table of four is ordering Spanish food — roast lamb, jamón ibérico, and lentil stew with chorizo. They want one red wine to go with everything. The list has a Rioja Crianza, a modern Navarra Garnacha, a Priorat, and a Ribera del Duero Reserva. Which choice best serves the table, and why?**

- A) The Priorat — highest prestige, most concentrated, handles the richest dish
- B) The Rioja Crianza — its combination of bright acidity, moderate tannin, and restrained alcohol makes it the most versatile red across the full range of dishes, including the delicate jamón
- C) The Navarra Garnacha — because Garnacha is native to Spain and pairs best with traditional Spanish food
- D) The Ribera del Duero Reserva — the most structured option, which best handles the fatty jamón

**Correct: B**

---

**Q20. The aromatic compound primarily responsible for coconut notes in American oak-aged Rioja is:**
...
*Module 02 — Rioja Overview | Spain Mastery Program | Wine Saint Certified*
