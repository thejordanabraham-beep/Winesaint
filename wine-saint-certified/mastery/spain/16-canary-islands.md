...
**Level:** Spain Mastery — Canary Islands
**Module:** 16
...
- Name and locate the seven DOs on Tenerife alone, identify which is considered most prestigious, and articulate how the island's altitude range from sea level to 1,700 meters shapes wine diversity
...
## Section 1: The Canary Islands — Spain's Volcanic Frontier
...
## Section 2: Tenerife — The Most Important Wine Island
...
That altitude range is the key to understanding Tenerife. The island's geographic core is the Teide volcano, the third-largest volcano in the world, rising to 3,718 meters and dominating the island's topography entirely. Around its base and on the island's coastal slopes, vineyards exist at virtually every elevation from the shoreline to approximately 1,700 meters — one of the widest altitude ranges of any wine-producing region on earth. A low-elevation vineyard in the south of the island and a high-elevation parcel in the north might as well be in different countries in terms of their climate, ripening conditions, and resulting wine character.

Tenerife contains **seven DOs**, a regulatory complexity that reflects both the island's topographic diversity and the historical development of winemaking in different zones. The seven are:
...
Two additional DOs — **La Palma** and **El Hierro** — are named for their respective islands rather than zones within Tenerife, but are listed here as part of the DO count associated with the archipelago's wine geography.
...
> **Pro Tip:** Wine-savvy guests visiting a restaurant often respond to visual description of the place a wine comes from more than any technical detail. Tenerife gives you one of the most evocative images in wine: "These vines are growing on the slopes of the Teide volcano — the third-largest in the world — at elevations up to 1,700 meters. Some of the vines are 200 years old and still ungrafted. The island has seven wine appellations, more than some entire countries." It is not an exaggeration. It is accurate and it works.

---

## Section 3: The Canary Island Grapes
...
## Section 4: Key Producers — Tenerife and Beyond
...
**Borja Pérez** is one of Tenerife's most focused and critically recognized producers, working primarily within the Tacoronte-Acentejo DO — the island's most prestigious appellation. His wines are precise, tightly wound Listán Negro expressions that reward cellaring. As the most northerly of Tenerife's DOs, Tacoronte-Acentejo provides the coolest and most Atlantic-influenced conditions, and Borja Pérez's wines reflect that: high acidity, restrained fruit, and the kind of mineral-driven structure that demands attention.
...
## Section 5: The Old Vine Story and Why It Matters
...
## Section 6: Floor Application — Selling Canary Islands Wine
...
| Term | Definition |
|------|------------|
| Picón | Volcanic ash and lapilli (small rock fragments) deposited by eruptions; the distinctive Canary Island soil material that retains moisture, insulates roots, and prevents phylloxera from establishing; used as a surface mulch, particularly in Lanzarote |
| Listán Negro | The dominant red grape of the Canary Islands; medium-light body, high acidity, red fruit (cherry, raspberry), saline volcanic minerality; grown primarily on ungrafted old vines; stylistically compared to Pinot Noir in structure |
| Listán Blanco | The dominant white grape; genetically identical to Palomino (the Sherry grape); produces fresh, mineral, saline whites in the Canary Islands' volcanic conditions despite making neutral Sherry base wine on the mainland |
| Malvasía Aromática | Indigenous Canary Island white variety (Malvasía Canaria); historically produced Canary Sack, the fortified sweet wine drunk at European royal courts from the 16th–18th centuries and referenced by Shakespeare; now made in dry and sweet styles |
| Canary Sack | The historic sweet, fortified wine produced from Malvasía in the Canary Islands; one of the most fashionable wines in Europe for over two centuries; Shakespeare's "canary" references this wine |
| Cordón Trenzado | "Braided cordon" — a vine training system unique to the Canary Islands in which main canes are braided and trained low to the ground; provides wind protection and keeps vines close to the heat-retaining volcanic soil |
| Vaso | Bush vine or gobelet training; ungoverned by wire or stake; common among the oldest Canary Island plantings; requires entirely manual cultivation |
| Hoyo / Zanja | The individual crater or trench dug through Lanzarote's lapilli layer in which each vine is planted; allows the vine's roots to access the moisture-retaining subsoil; produces the island's characteristic lunar landscape |
| Zocos | Low, curved dry-stone walls built on the windward side of each hoyo in Lanzarote; protect vines from desiccating trade winds; a distinctive landscape feature visible across the island |
| Tacoronte-Acentejo | The most prestigious DO on Tenerife; north-facing Atlantic slopes, volcanic clay and lapilli soils; considered the source of the island's finest Listán Negro reds |
| Valle de la Orotava | Tenerife DO on the northern slope; home to Tajinaste and Suertes del Marqués; medium elevation (200–600m), Atlantic-facing; benchmark source for elegant old-vine Listán Negro |
| Envínate | Winemaking collective (Roberto Santana, Alfonso Torrente, Laura Ramos, José Martínez) producing wines in Tenerife (Benje, Taganan) and Ribeira Sacra (Lousas); among Spain's most critically celebrated natural wine producers; knowing the name signals wine seriousness in a guest |
| Negramoll | Important secondary Canary Island red grape; genetically identical to Tinta Negra Mole (Madeira's dominant variety); darker and fuller-bodied than Listán Negro; used in blends to add depth and color |
| Baboso Negro | Rare indigenous or historically introduced Canary Island red variety; produces concentrated, distinctive wines; sought after by natural wine collectors; only grown in small quantities on older parcels |
| Calima | Hot, dry, dust-laden wind from the Sahara that periodically affects the Canary Islands; temporarily raises temperatures to extremes; a viticultural challenge managed through elevation, aspect, and vine training |

---

## Quiz — Canary Islands: Volcanic Wines, Ancient Vines, and Spain's Most Thrilling Discovery

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. The Canary Islands are politically part of Spain but geographically positioned closest to which continent or country?**
- A) Southern Europe — the islands are closer to Portugal than to mainland Spain
- B) Northwest Africa — approximately 100km off the Moroccan coast, closer to Morocco than to Spain
- C) The mid-Atlantic — the islands sit equidistant between Africa and the Americas
- D) The Caribbean — the islands' subtropical climate places them in the Caribbean climate zone

**Correct: B**

---

**Q2. What is picón, and why is it significant for Canary Island viticulture?**
- A) A traditional Canary Island fermentation technique using whole-cluster grapes in sealed ceramic vessels
- B) Volcanic ash and lapilli that form the distinctive soil material of the islands; retains moisture, insulates roots, and prevents phylloxera from establishing
- C) A local name for the dominant red grape variety grown across all five wine-producing islands
- D) The seasonal Saharan wind that periodically raises temperatures to extreme levels across the archipelago

**Correct: B**

---

**Q3. Why did most Canary Island vines survive phylloxera ungrafted while nearly all European mainland vines did not?**
- A) The islands were never reached by phylloxera because of strict agricultural quarantine measures maintained by the Spanish colonial government
- B) Canary Island winemakers discovered the grafting solution independently before phylloxera arrived and preemptively grafted all vines
- C) The volcanic and sandy soils of the islands do not provide the conditions phylloxera requires to establish, preventing the louse from attacking vine roots
- D) The Canary Island vine species (*Vitis canariensis*) has a natural genetic resistance to phylloxera that European *Vitis vinifera* lacks

**Correct: C**

---

**Q4. How many DOs are located on the island of Tenerife alone?**
- A) Three — Tacoronte-Acentejo, Valle de la Orotava, and Abona
- B) Five — one for each wine-producing zone of the island
- C) Seven — Tacoronte-Acentejo, Valle de la Orotava, Ycoden-Daute-Isora, Abona, Valle de Güímar, La Palma, and El Hierro
- D) Nine — each of the island's municipalities holds its own DO designation

**Correct: C**

---

**Q5. Which Tenerife DO is considered most prestigious for red wine production, and why?**
- A) Abona — its high southern elevation and extreme heat concentrate the flavors in Listán Negro to an exceptional degree
- B) Tacoronte-Acentejo — north-facing Atlantic slopes, volcanic clay and lapilli, and cooler temperatures produce the island's most complex and age-worthy Listán Negro reds
- C) Valle de Güímar — its eastern exposure creates the ideal balance of sun and wind for premium red wine production
- D) Valle de la Orotava — as the home of Tajinaste and Suertes del Marqués, it is commercially and qualitatively the most important DO

**Correct: B**

---

**Q6. Listán Blanco is genetically identical to which mainland Spanish grape variety?**
- A) Albariño — the dominant white grape of Rías Baixas, Galicia
- B) Verdejo — the signature white variety of Rueda in Castilla y León
- C) Palomino — the dominant variety of Jerez and the base grape for all Sherry production
- D) Macabeo — the primary white variety used in Cava production across Catalunya

**Correct: C**

---

**Q7. What is the floor-useful comparison for Listán Negro that this module endorses, and why is it accurate?**
- A) Garnacha — both are Spanish varieties with red fruit character and high alcohol suited to warm climates
- B) Tempranillo — both are medium-bodied Spanish reds with oak-aging potential and a structured tannic profile
- C) Pinot Noir — both produce medium-light wines defined by transparency, high acidity, aromatic precision, and mineral-driven structure rather than power
- D) Cabernet Franc — both are aromatic reds with herbal notes and firm tannins that reward cellaring for 10–15 years

**Correct: C**

---

**Q8. What is Canary Sack, and who famously referenced the wine it came from?**
- A) A dry, oxidatively aged white wine from Lanzarote, referenced by Hemingway as the finest wine he drank during the Spanish Civil War
- B) The sweet, fortified Malvasía wine produced in the Canary Islands from the 16th century onward; referenced by Shakespeare in multiple plays as "canary"
- C) A sparkling wine produced by traditional method from Listán Blanco; briefly fashionable in Victorian England before Champagne displaced it
- D) A red wine blend from Tacoronte-Acentejo; the name derives from the Canary Islands' historic role as a provisioning port for Atlantic trading vessels

**Correct: B**

---

**Q9. Negramoll, grown in the Canary Islands, is genetically identical to which grape variety produced on another Atlantic island?**
- A) Fer Servadou — the rare variety produced in small quantities in Marcillac, southwest France
- B) Tannat — the dominant variety of Madiran and the national grape of Uruguay
- C) Tinta Negra Mole — the dominant variety of Madeira's wine production
- D) Alfrocheiro — an indigenous Portuguese variety from the Dão and Alentejo regions

**Correct: C**

---

**Q10. What is the cordón trenzado, and what viticultural function does it serve in the Canary Islands?**
- A) A fermentation vessel made from braided volcanic stone; used for indigenous varieties to impart mineral character
- B) A vine training system unique to the Canary Islands in which main canes are braided and trained low to the ground for wind protection and retention of soil heat
- C) A traditional Canary Island blending technique combining Listán Negro and Negramoll in specific braided ratios
- D) A type of dry-stone wall used to terrace steep volcanic slopes in Tacoronte-Acentejo

**Correct: B**

---

**Q11. Lanzarote's viticulture involves planting each vine in an individual crater or trench. What are these called, and what problem does this system solve?**
- A) Bancales — terraced vineyard platforms; they solve the problem of extreme slope angles that prevent conventional vine row orientation
- B) Hoyos or zanjas — individual craters dug through the lapilli to reach subsoil; they allow vines to access moisture-retaining earth in an island that receives almost no rainfall
- C) Picones — small elevated platforms above the lapilli layer; they prevent root exposure to the extreme heat of the volcanic surface
- D) Zocos — circular stone enclosures around each vine; they trap rainwater during the winter season for slow release during dry summer months

**Correct: B**

---

**Q12. What is Envínate, who founded it, and why is knowing this name significant on the floor?**
- A) A large cooperative based in Tacoronte-Acentejo; founded by a group of Canary Island growers in the 1980s; significant because it represents the largest single production of Listán Negro on Tenerife
- B) A winemaking collective founded by Roberto Santana, Alfonso Torrente, Laura Ramos, and José Martínez; significant because a guest who mentions the name unprompted signals they engage with wine at a serious professional level
- C) Bodegas La Geria's prestige export label for Lanzarote Malvasía; significant because it is the reference point for sweet Canary Island wine internationally
- D) A Basque natural wine importer that introduced Canary Island wines to the United States market; knowing the name confirms a guest's interest in natural wine and European imports

**Correct: B**

---

**Q13. Which two wines represent Envínate's primary Tenerife bottlings, and from which DOs do they come?**
- A) La Perdida (Tacoronte-Acentejo) and El Esquilón (Valle de la Orotava)
- B) Benje (Ycoden-Daute-Isora) and Taganan (a small zone on Tenerife's northeastern tip)
- C) Lousas (Valle de Güímar) and Palo Blanco (Abona)
- D) Cumbres de Abona (Abona) and Benje (Tacoronte-Acentejo)

**Correct: B**

---

**Q14. What is the role of the zocos in Lanzarote's viticulture?**
- A) Underground channels that route moisture from the lapilli surface to each vine's root zone during periods of dew formation
- B) Low, curved dry-stone walls built on the windward side of each hoyo to protect individual vines from desiccating trade winds
- C) Raised stone platforms on which each vine is trained to maximize sun exposure on the flat lapilli terrain
- D) Gravity-fed irrigation conduits connecting the island's water reserves to the vineyard zones in the Geria valley

**Correct: B**

---

**Q15. A guest who regularly orders Burgundy says they want "something volcanic and unusual — nothing they've tried before." Which wine and framing best applies this module's approach?**
- A) Offer a Priorat Garnacha and explain that llicorella slate delivers equivalent mineral intensity to volcanic terroir at a more familiar price point
- B) Offer a Tajinaste or Suertes del Marqués Listán Negro from Tenerife, using the framing of 200-year-old ungrafted vines in volcanic ash, the Pinot Noir structural comparison, and the old vine pre-phylloxera story
- C) Offer a Lanzarote Malvasía dry and explain that the hoyo planting system in volcanic lapilli creates a unique terroir expression analogous to Burgundy's limestone influence
- D) Offer an Envínate Lousas from Ribeira Sacra, explaining that granite gorge terroir is more verifiably volcanic than Tenerife's basalt soils

**Correct: B**

---

**Q16. Which food pairing recommendation from this module is most likely to surprise a guest, and what is the rationale for it?**
- A) Malvasía sweet with aged cheese — guests expect sweet wine to pair only with chocolate desserts, not savory cheese
- B) Listán Negro with grilled fish or seafood — guests expect red wine to conflict with fish, but Listán Negro's light body, high acidity, and restrained tannin allow it to work seamlessly
- C) Listán Blanco with raw shellfish — guests expect white wine to be reserved for cooked preparations rather than raw oysters or ceviche
- D) Negramoll with roasted lamb — guests expect Negramoll's dark, full-bodied character to overwhelm lamb's delicacy

**Correct: B**

---

**Q17. Bodegas La Geria is the reference producer of which island, and what is its primary variety?**
- A) Tenerife — Listán Negro
- B) La Palma — Negramoll
- C) El Hierro — Baboso Negro
- D) Lanzarote — Malvasía Aromática

**Correct: D**

---

**Q18. What does this module identify as the most effective opening line for any Canary Islands wine conversation?**
- A) "These wines come from an island chain closer to Africa than to Spain, with a volcanic terroir unlike anything in Europe."
- B) "Have you ever tasted a wine made from 200-year-old ungrafted vines growing in volcanic ash?"
- C) "This grape was the most fashionable wine in Europe for 200 years and Shakespeare wrote about it."
- D) "The Canary Islands have more wine appellations per square kilometer than any other Spanish region."

**Correct: B**

---

**Q19. Why does this module argue that the natural wine world's embrace of the Canary Islands is "direct and logical" rather than trend-driven?**
- A) The Canary Islands wine industry has invested heavily in natural wine marketing since the early 2000s, aligning its brand with the movement deliberately
- B) The core values of natural wine — minimal intervention, indigenous varieties, old ungrafted vines, volcanic terroir — describe what the Canary Islands actually are, not a philosophy the producers adopted
- C) Envínate's founders invented the natural wine movement in Spain before applying its principles to Canary Island viticulture
- D) The Canary Islands DO regulations require certified organic viticulture, making all DO wines legally compliant with natural wine standards

**Correct: B**

---

**Q20. A guest at the bar is browsing the wine list and asks: "What's something here that nobody orders but you think is worth trying?" According to the floor strategy in this module, what is the ideal response?**
- A) Recommend the most underpriced Rioja Reserva on the list and explain the value of extended American oak aging at a competitive price
- B) Recommend a Canary Islands wine — Listán Negro or Listán Blanco — and open with the 200-year-old ungrafted vine line, then read the guest's response to determine how deep to go
- C) Recommend a Sherry and explain that the style is underappreciated nationally, making it the most reliable answer to any "something unusual" request
- D) Recommend a Ribeira Sacra Mencía and explain that Galicia's terraced viticulture is the most underrated story in Spanish wine
