...
**Level:** Spain Mastery — Navarra, Aragón & Garnacha
**Module:** 14
...
## Section 2: Navarra — The Garnacha and Rosado Heartland
...
## Section 3: Campo de Borja — "The Empire of Garnacha"

The town of Borja sits in the Zaragoza province of Aragón, about 80 kilometers south of the Navarra border, at the foot of the Moncayo volcano — the highest peak in the Iberian System at 2,316 meters. The DO surrounding it chose its marketing slogan early and has stuck with it: Campo de Borja calls itself the "Empire of Garnacha." It is not an idle boast. Some of Spain's oldest Garnacha vines survive here, on skeletal soils of slate, clay, and limestone under the shadow of the Moncayo, in conditions of extreme heat, low rainfall, and poor fertility that would defeat almost any other variety. These are the conditions that Garnacha was evolutionarily built for.
...
At the prestige end sits **Alto Moncayo** — a boutique estate on the volcanic slopes of the Moncayo itself, an investment associated with the Broadbent family and producing small quantities of extraordinarily concentrated old-vine Garnacha from some of the most extreme vineyard sites in Aragón. The wines — particularly the eponymous Alto Moncayo — are among the most intense, structured Garnachas produced anywhere in Spain, combining massive concentration with a volcanic mineral signature that distinguishes them from other Aragonese examples. These are wines for guests who understand that great Garnacha, properly made from ancient vines in extraordinary terroir, can age as gracefully as much more celebrated Spanish reds.
...
## Section 4: Cariñena and Calatayud
...
## Section 5: Somontano — Aragón's International Zone
...
## Section 6: Floor Strategy — The Garnacha Conversation
...
| Term | Definition |
|------|------------|
| Garnacha | The Spanish name for Grenache; a red variety originating in Aragón, Spain, now one of the world's most widely planted red grapes; produces wines with red fruit (raspberry, strawberry), white pepper, herbal notes, and high alcohol potential; low natural acidity makes altitude and cool nights critical for quality |
| Cierzo | The cold, dry northwest wind that defines viticulture across Aragón; reduces fungal disease pressure, moderates summer temperatures, and preserves natural acidity in ripening grapes; a key quality factor in Campo de Borja, Cariñena, and Calatayud |
| Campo de Borja DO | Denominación de Origen in Aragón's Zaragoza province, around the town of Borja at the foot of the Moncayo volcano; self-styled "Empire of Garnacha"; noted for extremely old Garnacha bush vines on poor soils and the cooperative-driven value model led by Borsao |
| Calatayud DO | Mountain DO in Aragón's Jalón River valley at 600–900 meters elevation; one of Spain's highest-altitude wine regions; home to some of the country's oldest Garnacha vines on schist and clay-limestone soils; the altitude effect produces acidity and freshness unusual for Aragón |
| Cariñena DO | Denominación de Origen in Aragón's Huerva River valley; the grape Cariñena (Carignan) takes its name from this region, though Garnacha now dominates plantings; key producer is Grandes Vinos y Viñedos, with the Anayón premium label |
| Somontano DO | Denominación de Origen in Huesca province at the foothills of the Pyrenees; Aragón's most internationally oriented wine region; unique in Spain for its founding commitment to Chardonnay, Gewürztraminer, Merlot, and Cabernet Sauvignon; key producers include Viñas del Vero, Enate, and Sommos |
| Navarra DO | Denominación de Origen in northern Spain between Rioja and the Basque Country; five sub-zones (Baja Montaña, Valdizarbe, Tierra Estella, Ribera Alta, Ribera Baja) with markedly different climates; historically famous for Garnacha rosado; now developing a quality identity around old-vine Garnacha |
| Rosado | Spanish term for rosé wine; Navarra rosado is required by DO regulation to be made by short skin maceration (not direct pressing), producing wines with more body, color, and structure than most Provence-style rosés |
| Tres Picos | Borsao cooperative's flagship Garnacha, a 100% old-vine field blend from Campo de Borja; widely considered one of Spain's best value-for-quality wines in the €12–18 retail range; an essential reference for field blends and cooperative quality |
| Alto Moncayo | Prestige estate in Campo de Borja on the volcanic slopes of the Moncayo mountain, associated with the Broadbent family; produces small quantities of extremely concentrated, mineral, old-vine Garnacha that represents the DO's quality ceiling |
| Borsao | The dominant cooperative of Campo de Borja; processes fruit from hundreds of small growers; produces a quality-tiered range from everyday Garnacha to the flagship Tres Picos field blend; the commercial engine of the "Empire of Garnacha" identity |
| Chivite (Colección 125) | Bodegas Julián Chivite; Navarra's most important family producer since 1860; Colección 125 Reserva is the flagship red (Tempranillo-based blend with Cabernet Sauvignon and Merlot); the estate also holds the Señorío de Arínzano Vino de Pago designation |
| Vino de Pago | Spain's apex wine classification (above DOCa/DO), restricted to individual estates demonstrating distinctive terroir and consistent quality; approximately 20 estates in Spain hold this status; Señorío de Arínzano in Navarra's Tierra Estella sub-zone is among them |
| Gobelet / Bush Vine | Traditional training method in which the vine stands free without trellis support, forming a low, self-supporting bush; common in hot, dry regions of Spain and Aragón; naturally limits yields, concentrates fruit, and is associated with old-vine plantings of Garnacha |
| Diurnal Temperature Range | The difference between daytime high and overnight low temperatures during the growing season; critical quality factor in Calatayud, Baja Montaña, and Campo de Borja, where swings of 15–20°C preserve natural acidity in Garnacha despite warm summer days |

---

## Quiz — Navarra, Aragón, and Spain's Garnacha Heartland

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. DNA evidence has confirmed that Garnacha (Grenache) originated in which region of Spain?**
...
**Q2. Which of the following best explains why Garnacha was historically undervalued as a variety?**
- A) It could not ripen fully in Spain's hot continental climates and consistently produced green, herbaceous wines
- B) It produced high-alcohol wines with a tendency to oxidize, making it more useful as a blending component than a celebrated varietal wine
- C) It was genetically identical to Tempranillo and therefore offered no distinctive character of its own
- D) Spanish DO regulations historically prohibited varietal Garnacha bottlings

**Correct: B**

---

**Q3. Navarra DO is divided into five sub-zones. Which sub-zone is the northernmost, sits closest to the Pyrenees at 400–700 meters elevation, and produces Navarra's most elegant, lighter-bodied Garnacha?**
- A) Ribera Baja
- B) Tierra Estella
- C) Ribera Alta
- D) Baja Montaña
...
**Q4. By DO regulation, Navarra rosado must be produced using which method — and why does this matter for floor service?**
- A) Direct pressing only, producing pale, delicate wines similar to Provence rosé
- B) Short skin maceration (not direct pressing), producing wines with more body, color, and structural presence than most rosés — making them more food-friendly and effective with guests who dismiss light rosé
- C) Carbonic maceration, which gives the wines their distinctive fresh-fruit character and low tannins
- D) Extended maceration of 24–48 hours, giving Navarra rosado its deep pink color and near-red wine structure

**Correct: B**

---

**Q5. Campo de Borja is located in which Spanish province, and at the foot of which prominent geographic feature?**
- A) Huesca province, at the foot of the Pyrenees
- B) Zaragoza province, at the foot of the Moncayo volcano
- C) Navarra province, at the foot of the Sierra de Cantabria
- D) Teruel province, at the foot of the Iberian System's highest ridge

**Correct: B**

---

**Q6. Borsao's flagship wine, Tres Picos, is best described as:**
- A) A Tempranillo Reserva from selected old-vine parcels, aged 18 months in new French oak
- B) A blend of Garnacha, Cariñena, and Cabernet Sauvignon from Campo de Borja's warmest sectors
- C) A 100% old-vine Garnacha field blend from Campo de Borja, widely considered one of Spain's best value-for-quality red wines
- D) A single-vineyard Garnacha from the volcanic slopes of Alto Moncayo, produced in tiny quantities for the collector market

**Correct: C**

---

**Q7. Alto Moncayo differs from Borsao (Tres Picos) primarily in terms of:**
- A) Variety — Alto Moncayo uses Cariñena, Borsao uses Garnacha
- B) Scale and terroir — Alto Moncayo is a small prestige estate on volcanic slopes producing extremely concentrated old-vine Garnacha in limited quantities; Borsao is a large cooperative producing excellent-value wines from broad Campo de Borja sourcing
- C) Oak treatment — Borsao uses new French oak, Alto Moncayo uses neutral vessels only
- D) Appellation — Borsao is in Calatayud DO, Alto Moncayo is in Campo de Borja DO

**Correct: B**

---

**Q8. Cariñena DO carries a significant geographical irony. What is it?**
- A) The DO uses no Cariñena grapes at all — it is planted entirely with Tempranillo and Cabernet Sauvignon
- B) The grape variety Cariñena (Carignan) takes its name from this region, but Garnacha now dominates the DO's plantings while the namesake variety plays a supporting role
- C) Cariñena DO produces primarily white wine despite sharing its name with a red grape variety
- D) The town of Cariñena is actually located in Navarra, not in the DO that bears its name

**Correct: B**

---

**Q9. What is the Cierzo, and why is it important to Aragonese viticulture?**
- A) A type of clay-limestone soil found in Campo de Borja that retains moisture and moderates extreme summer heat
- B) A warm, humid Mediterranean wind from the southeast that helps grapes ripen fully in Aragón's mountain regions
- C) A cold, dry northwest wind that reduces fungal disease pressure, moderates summer temperatures, and preserves natural acidity in ripening Garnacha
- D) A traditional Aragonese winemaking technique involving extended skin contact to build structure in Garnacha

**Correct: C**

---

**Q10. Calatayud DO is distinctive within Aragón for which primary quality factor?**
- A) Its proximity to the coast, which brings marine influence and moderate temperatures year-round
- B) Its extremely high altitude (600–900 meters) in the Jalón River valley, which produces significant diurnal temperature variation, preserves natural acidity in old-vine Garnacha, and extends the ripening season
- C) Its granite soils, which are the poorest and most free-draining in Spain and uniquely suited to late-ripening red varieties
- D) Its cooler-than-average temperatures caused by Atlantic airflow channeled from the Bay of Biscay

**Correct: B**

---

**Q11. Somontano DO is described as Aragón's "international zone." Which of the following best explains why?**
- A) It exports more wine than any other Spanish DO, primarily to Asian markets
- B) It was founded by French and Italian immigrants who brought their native varieties and winemaking traditions to Huesca province
- C) Unlike most Spanish DOs where international varieties arrived as a trend, Somontano was designed from the outset to focus on Chardonnay, Merlot, Cabernet Sauvignon, and Gewürztraminer — before it was fashionable elsewhere in Spain
- D) Its wines must be co-produced with at least one non-Spanish winery under EU regulations

**Correct: C**

---

**Q12. Which statement most accurately describes the floor strategy for Somontano with a hesitant guest?**
- A) Use Somontano as a direct competitor to Rioja for guests who find Tempranillo too heavy
- B) Position Somontano for guests who are interested in Spanish wine but uncertain about indigenous varieties — the familiar grapes (Chardonnay, Merlot) in a Pyrenean-foothill context offer approachability with genuine Spanish character
- C) Avoid recommending Somontano to any guest with wine knowledge, as the region's quality is below the level serious wine drinkers expect
- D) Focus exclusively on Somontano's indigenous Parraleta and Alcañón to emphasize Spanish distinctiveness

**Correct: B**

---

**Q13. A guest who loves Châteauneuf-du-Pape asks what Campo de Borja is similar to. Which response is most accurate and effective?**
- A) "Campo de Borja is actually quite different — it is made from Tempranillo and Monastrell, with no connection to Châteauneuf's variety mix."
- B) "Same core grape — Garnacha is Grenache. Châteauneuf grows it on galets roulés over clay; Campo de Borja grows it on volcanic schist and limestone under the Moncayo. The red fruit and white pepper character is the through line. What changes is the mineral signature of the mountain."
- C) "Campo de Borja is more like Burgundy — elegant, restrained, and built for long aging on limestone soils."
- D) "The comparison does not hold because Campo de Borja uses 100% Garnacha while Châteauneuf blends up to 18 varieties."

**Correct: B**

---

**Q14. A guest at a business dinner says they "don't really drink rosé" and you want to recommend a Navarra rosado. Which is the most effective approach?**
- A) Agree and steer them toward a light Garnacha red from Navarra instead
- B) Explain that Navarra rosado is made by skin maceration — not direct pressing — giving it more body and structural depth than most rosé; frame it as closer to a very fresh light red than a pale wine; suggest pairing it with the charcuterie board
- C) Pour a small taste without explanation and let the wine speak for itself
- D) Apologize for raising it and move directly to the red wine section of the list

**Correct: B**

---

**Q15. Chivite's most prestigious estate wine, Señorío de Arínzano, holds what classification that places it at the apex of Spain's appellation hierarchy?**
- A) DOCa (Denominación de Origen Calificada), shared with Rioja and Priorat
- B) Gran Reserva, the highest aging-based designation in Spanish wine law
- C) Vino de Pago, Spain's highest classification restricted to individual estates with distinctive terroir and consistent quality
- D) Vino de la Tierra, giving the estate freedom from DO restrictions on variety and winemaking

**Correct: C**

---

**Q16. In terms of food pairing, which combination is most classically associated with Navarra or Aragonese Garnacha?**
- A) Grilled tuna with soy-ginger glaze and a side of white rice
- B) Chilled gazpacho with crème fraîche and toasted pumpkin seeds
- C) Roast lamb with rosemary — the tannins cut the fat, the red fruit frames the meat, and the herbal notes in the wine echo the aromatics of the herb crust
- D) Steamed mussels in white wine and cream, with crusty bread

**Correct: C**

---

**Q17. A wine-knowledgeable guest asks you which Aragonese wine region offers the best combination of old-vine intensity and altitude-driven freshness, at a price point that most guests have not yet discovered. What is the most accurate and compelling answer?**
- A) Cariñena DO — its namesake grape produces the most intense, mineral wines in Aragón at accessible prices
- B) Somontano DO — its Pyrenean foothill location gives international varieties a freshness and mineral character unlike anywhere else in Spain
- C) Campo de Borja DO — the Moncayo volcanic soils produce Spain's most extracted Garnacha at extraordinary value
- D) Calatayud DO — some of Spain's oldest Garnacha vines grow at 600–900 meters on schist and clay-limestone, producing wines with genuine freshness and concentration that most guests have not yet encountered

**Correct: D**

---

**Q18. Which of the following producers is associated with Enate, and what makes this winery distinctively memorable for a guest conversation?**
- A) Enate is associated with Borsao cooperative and is memorable for having the highest vine age of any Campo de Borja estate
- B) Enate is a Somontano DO producer notable for commissioning original Spanish artwork for each wine label each year, with the winery functioning partly as an art gallery — making the label itself a conversation piece on any table
- C) Enate is a Navarra DO producer associated with the Chivite family and memorable for holding Spain's oldest continuous winemaking license, dating to 1548
- D) Enate is a Calatayud producer associated with Isidro Palacios, memorable for producing Spain's highest-altitude Garnacha at just under 1,000 meters

**Correct: B**

---

**Q19. When pitching an entry-level Campo de Borja Garnacha (Joven or young Crianza tier) to a price-conscious guest, what is the most accurate aging guidance?**
- A) These wines are built for long aging — cellaring for 10–15 years will reveal their best complexity
- B) These wines are best within 3–5 years of vintage, when their primary red fruit character is freshest and cleanest; they are not designed for extended cellaring
- C) Serve them at least 5 years after vintage, as Garnacha requires time to integrate its naturally high tannins
- D) These wines are best served the year of release; any bottle age causes the fruit to fade and the wine to become overly structured

**Correct: B**

---

**Q20. A guest at a wine-savvy table asks you to explain in one sentence why old-vine Garnacha from Calatayud or Campo de Borja tastes fundamentally different from young-vine Garnacha produced in fertile lowland soils. Which answer is most accurate?**
- A) Old vines have developed thicker bark and deeper root color, which transfers more tannin and anthocyanin pigment directly into the grape juice during fermentation
- B) Old vines in poor, rocky mountain soils produce tiny yields — sometimes under one kilogram of fruit per vine — resulting in a ferociously high skin-to-juice ratio, concentrated mineral uptake from deep roots, and a textural and aromatic complexity that high-yield young vines in fertile soils physically cannot replicate
- C) Old vines benefit from decades of accumulated sugar reserves in the root system, which they release into the fruit each year, producing higher natural alcohol and therefore more concentrated flavor
- D) The age of the vine increases its natural acidity, which is why old-vine Garnacha tastes fresher and more structured than young-vine examples from the same region

**Correct: B**

---

*Module 14 of the Wine Saint Certified Spain Mastery Program. Proceed to Module 15.*
