...
**Level:** Australia Mastery — Old Vine Grenache Deep Dive
**Module:** 13
...
- Identify the key producers driving Australian old vine Grenache — Clarendon Hills, d'Arenberg, Yangarra Estate, John Duval Wines, Spinifex, Teusner, and Bekkers — and articulate each producer's style, philosophy, and the guest story behind them
- Explain the GSM blending tradition — how Grenache, Shiraz, and Mourvèdre each contribute to the blend — and position Australian GSM relative to southern Rhône blends for guests who know Châteauneuf-du-Pape
...
## Section 1: The Global Grenache Renaissance — Why This Variety Is the Most Exciting in Fine Wine Right Now
...
The sommeliers and collectors who have been paying closest attention over the past decade have landed on a conclusion: Australia, specifically South Australia, is home to old-vine Grenache that is genuinely world-class. The vine ages involved — 80, 100, 120, even 150-plus years — are not matched in most French or Spanish appellations. The soils — ancient sandy loams over ironstone in Blewitt Springs, the complex red-brown earths of the Barossa — impart genuine mineral character. The winemakers now working with these resources bring both technical rigor and philosophical respect for what old vines are doing.
...
## Section 2: Australia's Grenache Heritage — A Near-Miss Survival Story
...
What survived this decimation is some of the most significant viticultural heritage on earth. The vines that remained — through farmer stubbornness, geographic inaccessibility, neglect that paradoxically became preservation, or deliberate decision by forward-thinking growers — were already extraordinarily old. By the time the premium wine market in the 1990s and 2000s began to take serious interest in old-vine Grenache, the surviving blocks were 70, 80, 100 years old. Some, in the most ancient corners of the Barossa and McLaren Vale, are demonstrably older — planted before 1900 or even before the phylloxera crisis that arrived in parts of South Australia in the late nineteenth century.
...
The **Barossa Old Vine Charter**, established by the Barossa Wine Association, formalized this heritage with a classification system: Barossa Old Vine (35 years and older), Barossa Survivor Vine (70 years and older), Barossa Centurion Vine (100 years and older), and Barossa Ancestor Vine (125 years and older). The Charter provides a framework for communicating vine age on labels and in marketing — a vocabulary that resonates with guests who understand what vine age means for wine quality.
...
## Section 3: Why Old Vines Are Different — The Science and Sensory Reality
...
## Section 4: The Regional Expressions — Barossa, McLaren Vale, Clare Valley, and Blewitt Springs
...
Barossa Valley old vine Grenache is the richest, fullest, and most decadent expression of the variety in Australia. The Barossa floor — particularly the Ebenezer, Vine Vale, and Tanunda areas that contain many of the oldest Grenache plantings — delivers a climate that is genuinely warm, with substantial heat accumulation through the growing season and limited cooling influence compared to the coastal regions. The result in old vine Grenache is a wine of formidable fruit weight: dark cherry, ripe raspberry, plum, and spice, with a confiture-like richness that reads as opulent rather than elegant. Alcohol is high by global standards — 14.5 to 16% is not uncommon — but when old-vine concentration provides the structure to carry it, the wine remains balanced rather than hot. The tannic presence is modest (Grenache is naturally lower in tannin than Shiraz or Cabernet), and the finish is long, warm, and fruit-persistent.

The Barossa Grenache that fits this description — from Centurion or Ancestor vines on the valley floor — is among Australia's most collectible. John Duval, who spent decades as chief winemaker at Penfolds before establishing his own label, has devoted significant energy to old-vine Grenache and GSM in the Barossa, and his Plexus blend is widely considered a benchmark for how these varieties work together in the region. Spinifex, founded by Pete Schell and Magali Gely, pursues a more artisan, low-intervention approach to the same old vine material and produces Grenache of real purity and cellar-worthiness.
...
## Section 5: The Key Producers — Who Is Making Australia's Great Grenache
...
## Section 6: GSM Blending, Grenache Blanc and Gris, and Floor Positioning
...
| Term | Definition |
|------|-----------|
| Old vine Grenache | Grenache produced from vines typically 35 years or older (in Australian classification terms) but most meaningfully from vines 70, 100, or 150-plus years old; characterized by low yields, deep root systems, thick-skinned berries, and exceptional phenolic and flavor concentration unavailable from young vine plantings |
| Barossa Old Vine Charter | A classification system established by the Barossa Wine Association defining four vine age categories: Old Vine (35+ years), Survivor Vine (70+ years), Centurion Vine (100+ years), and Ancestor Vine (125+ years); provides formal vocabulary for communicating vine age on labels and in marketing |
| Pre-phylloxera vines | Vines planted before phylloxera — the root louse that devastated European vineyards from the 1860s onward — arrived in the local area; in Australia's case, before the late 1800s in affected regions; these vines grow ungrafted on their own roots, a condition considered the ideal for expressing terroir and associated with exceptional wine quality |
| Bush vine | Traditional, unsupported vine training system in which vines are pruned to low, free-standing gobelet or bush shapes without trellising; common in old Australian Grenache and Shiraz plantings; associated with low yields, deep root systems, and concentrated fruit |
| Yield self-limitation | The natural process by which aging vines progressively reduce their fruit production due to declining vascular efficiency; rather than requiring artificial green harvesting, old vines regulate their own yields, concentrating energy into smaller crops of dense, phenolically complex fruit |
| GSM blend | Grenache/Shiraz/Mourvèdre — the Australian designation for the southern Rhône-inspired blending tradition; Grenache contributes red fruit, body, and accessible tannin; Shiraz adds dark fruit, color, spice, and structure; Mourvèdre provides savory, earthy complexity, high acidity, and tannic aging potential |
| Mourvèdre | A thick-skinned red variety (called Mataro in older Australian usage, Monastrell in Spain) that contributes savory, meaty, and earthy complexity to GSM blends, along with a firm tannic structure and high natural acidity; requires significant heat to ripen fully and thrives in the Barossa Valley and McLaren Vale |
| Blewitt Springs | A sub-zone within the elevated eastern section of McLaren Vale characterized by ancient sandy soils over ironstone; consistently produces some of Australia's most elegant and mineral old vine Grenache, with fine-grained tannins and aromatic precision; home to Yangarra Estate and key Clarendon Hills sourcing sites |
| Garrigue | A term derived from the scrubland vegetation of the southern French Mediterranean coast; used to describe an herbal, wild herb, and dried lavender aromatic quality in Grenache-dominant wines from the southern Rhône and analogous Mediterranean climates; can appear in Australian old vine Grenache and GSM blends as dried herb, rosemary, and dark olive notes |
| Grenache Blanc / Grenache Gris | White and grey-pink color mutations of Grenache Noir; small but growing category in South Australia produced from old vine plantings; Grenache Blanc produces textually rich, aromatic whites; Grenache Gris produces pale-hued whites or rosé; both carry the old-vine concentration dimension of their red counterpart when sourced from ancient blocks |
| Diurnal temperature variation | The difference between daytime high and overnight low temperatures during the growing season; high diurnal range (as found in Clare Valley and elevated Barossa sites) preserves natural acidity and aromatic freshness in grapes; lower diurnal range in warmer valley floors contributes to the richer, more opulent Grenache profile of the Barossa floor |
| Ironstone | An iron-rich sedimentary rock formation present in the subsoil of key McLaren Vale and Blewitt Springs vineyard sites; contributes a mineral, earthy, and sometimes ferrous quality to wines grown above it; associated with the distinctive iron and earth character of McLaren Vale Grenache compared to Barossa Grenache |
| Plexus | John Duval's benchmark Barossa Valley GSM blend; widely considered a reference point for how Grenache, Shiraz, and Mourvèdre work together in the Barossa; a practical floor reference for guests asking about premium Australian GSM |
| Biodynamic viticulture | A farming philosophy that treats the vineyard as a self-sustaining ecosystem, following a lunar calendar for farming decisions and using herbal and mineral preparations rather than synthetic inputs; practiced by Yangarra Estate and Bekkers in McLaren Vale; associated with precision and site transparency in the resulting wines |

---

## Quiz — Old Vine Grenache: Australia's Most Exciting Wine Story

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. Which of the following best explains why Grenache is described as the most exciting variety in the fine wine world right now?**

- A) Grenache has recently been proven to be the oldest domesticated wine grape variety, generating renewed academic and collector interest
- B) Critical attention, collector enthusiasm, and genuine quality from old vine plantings in regions like Priorat, Châteauneuf-du-Pape, and Australia have converged to establish Grenache as a world-class variety
- C) A series of record auction prices for young-vine Grenache from California has elevated the variety's global profile
- D) The French government classified Grenache as a Grand Cru variety in 2022, driving international demand

**Correct: B**

---

**Q2. Why were extensive Grenache plantings established across South Australia from the 1850s through the 1920s?**

- A) Grenache was considered the finest red variety for dry table wine and was planted to meet British export demand
- B) Grenache was a reliable blending component for fortified wine production — the dominant Australian wine style of the era — and produced generous quantities of sugar-rich fruit in the hot, dry South Australian climate
- C) The South Australian government subsidized Grenache planting as part of a phylloxera recovery program
- D) Grenache was planted exclusively for medicinal purposes before being repurposed for wine production in the twentieth century

**Correct: B**

---

**Q3. What was the primary commercial threat that caused widespread removal of old vine Grenache plantings in South Australia during the 1980s and 1990s?**

- A) A severe phylloxera outbreak that destroyed most Grenache vines across the Barossa and McLaren Vale
- B) Government regulations mandating the replanting of all pre-war vineyards with certified disease-free material
- C) A market shift away from fortified wine toward dry table wine, with demand concentrated on international varieties like Chardonnay and Cabernet Sauvignon, making old vine Grenache economically unviable
- D) Extended drought conditions that killed most unirrigated bush vine Grenache plantings

**Correct: C**

---

**Q4. What does it mean for a vine to be "pre-phylloxera," and why is it considered significant for wine quality?**

- A) The vine was planted using clonal selection techniques developed before phylloxera was identified, resulting in higher-yielding, more disease-resistant material
- B) The vine was planted before phylloxera arrived in the local region and grows ungrafted on its own roots — a condition considered ideal for expressing terroir and associated with exceptional complexity and vine age
- C) The vine has been treated with pre-phylloxera pesticides that prevent the root louse from establishing, allowing it to remain ungrafted without risk
- D) Pre-phylloxera is a marketing term with no technical significance — all vines produce equivalent wine regardless of whether they are grafted

**Correct: B**

---

**Q5. The Barossa Old Vine Charter establishes four vine age categories. Which of the following lists them in correct ascending order of vine age?**

- A) Old Vine, Heritage Vine, Centurion Vine, Ancestor Vine
- B) Old Vine, Survivor Vine, Centurion Vine, Ancestor Vine
- C) Pioneer Vine, Old Vine, Centurion Vine, Heritage Vine
- D) Survivor Vine, Old Vine, Heritage Vine, Ancestor Vine

**Correct: B**

---

**Q6. Which of the following most accurately explains why old vines produce lower yields than young vines?**

- A) Old vines are deliberately irrigated less heavily, forcing them to reduce fruit production as a survival strategy
- B) Old vines are typically planted at higher elevations where cooler temperatures reduce pollination success and fruit set
- C) As vines age, their vascular system becomes less efficient, naturally reducing productive capacity and concentrating the vine's energy into the smaller crop it does produce
- D) Old vine growers consistently remove 80 to 90 percent of the crop through intensive green harvesting, which is prohibited on younger vines under South Australian law

**Correct: C**

---

**Q7. A guest asks why old vine Grenache is more complex than young vine Grenache from the same region. Which explanation is most accurate?**

- A) Old vines are farmed organically, and organic farming always produces more complex wine than conventional viticulture
- B) Old vines produce thick-skinned, concentrated berries with high skin-to-juice ratios, draw mineral complexity from deep subsoil layers inaccessible to young vine root systems, and self-limit their yields — all without winemaker intervention
- C) Old vines have been exposed to more vintages of weather variation, which trains the vine to produce better fruit in difficult conditions
- D) Winemakers apply extended maceration techniques exclusively to old vine fruit, which extracts additional phenolic complexity not present in young vine wines

**Correct: B**

---

**Q8. How does Barossa Valley old vine Grenache typically differ from McLaren Vale old vine Grenache in style?**

- A) Barossa Grenache is always lighter and more aromatic; McLaren Vale Grenache is heavier and darker due to its proximity to the Gulf St Vincent
- B) Barossa Grenache is richer, fuller, and more decadent — darker cherry, plum, and warm spice — while McLaren Vale Grenache is more aromatic, finer-textured, and carries a distinctive iron and earth mineral character from its ironstone soils
- C) The two regions produce essentially identical Grenache because they share the same soils and equivalent heat accumulation
- D) McLaren Vale Grenache is always blended with Shiraz, while Barossa Grenache is consistently bottled as a single variety

**Correct: B**

---

**Q9. What distinguishes Blewitt Springs as a Grenache sub-zone within McLaren Vale?**

- A) Its position on the valley floor, where clay-rich soils retain moisture and produce full-bodied, tannic Grenache ideal for long aging
- B) Its higher elevation and ancient sandy soils over ironstone, which drain rapidly, stress the vine, and consistently produce McLaren Vale's most elegant and mineral old vine Grenache
- C) Its proximity to Gulf St Vincent, which delivers a sea breeze strong enough to make Blewitt Springs the coolest sub-zone in Australia
- D) Its exclusive use of grafted vine material, which in combination with sandy soils produces uniquely fine-grained tannin

**Correct: B**

---

**Q10. Clarendon Hills, founded by Roman Bratasiuk, is most accurately described as:**

- A) A large-production McLaren Vale estate focused on accessible, commercially priced Grenache blends for international export markets
- B) The most dedicated old-vine specialist in Australia, producing single-vineyard Grenache (and Mourvèdre) from multiple McLaren Vale sites with a rigorous, European-influenced approach that yields some of Australia's most collectible wines
- C) A Barossa estate specializing exclusively in fortified Grenache and vintage Port-style wines from Centurion vines
- D) A McLaren Vale cooperative that pools old vine fruit from dozens of small growers to produce a single unified Grenache blend each vintage

**Correct: B**

---

**Q11. John Duval's wine background and its relevance to his old vine Barossa Grenache program is best described as:**

- A) He trained in the southern Rhône under Marcel Guigal and brought a French approach to Grenache farming and blending to the Barossa
- B) He spent decades as chief winemaker at Penfolds — responsible for Grange during its modern era — before establishing his own label devoted to preserving old vine Barossa varieties including Grenache and Shiraz in his benchmark Plexus GSM blend
- C) He founded the Barossa Old Vine Charter and has spent his career advocating for legislative protection of old vine sites rather than producing wine
- D) He established his label specifically to produce single-variety Grenache Blanc from Barossa Ancestor vines, a variety previously overlooked in the region

**Correct: B**

---

**Q12. In a GSM blend, which variety primarily contributes savory, meaty, earthy complexity and the tannic aging potential that distinguishes a serious GSM from a simple Grenache-Shiraz blend?**
...
**Q13. A guest who knows and loves Châteauneuf-du-Pape expresses skepticism about Australian Grenache. Which response most effectively addresses their skepticism?**

- A) Agree that southern Rhône Grenache is superior and suggest a Barossa Shiraz as the appropriate Australian alternative
- B) Explain that Australian GSM uses the same three varieties, the same blending philosophy, and a comparable Mediterranean climate — but that Australian old vine material includes Centurion and Ancestor vines over 100 years old, a vine age that even the finest Châteauneuf-du-Pape estates rarely match
- C) Point out that Australian Grenache is aged in French oak barrels from Burgundy coopers, making it stylistically identical to Châteauneuf-du-Pape
- D) Suggest that the guest cannot fairly evaluate Australian Grenache without first completing a tasting course in Avignon

**Correct: B**

---

**Q14. Yangarra Estate's Old Vine Grenache is primarily notable for which of the following?**

- A) It is produced from the youngest Grenache vines in Blewitt Springs, demonstrating that vine age is irrelevant when farming is biodynamic
- B) It is sourced from 70-plus-year-old Grenache vines in Blewitt Springs farmed biodynamically, delivering aromatic, mineral, and elegant Grenache that challenges assumptions about warm-climate Grenache
- C) It is the only McLaren Vale Grenache aged in American oak hogsheads rather than French barrique, producing a distinctive vanilla and coconut character
- D) It is a joint venture between Yangarra and Clarendon Hills using shared vineyard resources in the Kangarilla sub-zone

**Correct: B**

---

**Q15. Clare Valley old vine Grenache differs from Barossa and McLaren Vale equivalents primarily because:**

- A) Clare Valley has warmer temperatures and heavier clay soils, producing the richest and most concentrated Grenache of the three regions
- B) Clare Valley's higher elevation delivers cooler temperatures, more natural acidity, and a lighter, fresher Grenache style — the most food-friendly expression of Australian old vine Grenache
- C) Clare Valley Grenache is exclusively blended with Riesling, the region's flagship variety, producing a unique aromatic white-red blend
- D) Clare Valley Grenache is produced only in fortified style because the region's climate is too cool for dry red wine production

**Correct: B**

---

**Q16. What does "Grenache Blanc" refer to, and why is it relevant to the Australian old vine story?**

- A) A white wine made by pressing Grenache Noir grapes with minimal skin contact, producing a pale pink rosé style exclusive to McLaren Vale
- B) A white color mutation of Grenache that produces textually rich, aromatic white wines; old vine Australian plantings of Grenache Blanc are producing some of the country's most compelling whites, carrying the old-vine concentration dimension of their red counterpart
- C) The French term for unripe Grenache — blanc referring to the green color of the berries before veraison — used in quality assessment rather than as a variety name
- D) A certified organic Grenache produced exclusively in the Clare Valley using biodynamic blanc (white) preparation sprays

**Correct: B**

---

**Q17. A guest at a table has ordered roast duck as their main course and is unfamiliar with Australian wine. Which recommendation and framing is most appropriate?**

- A) Suggest a Barossa Shiraz, explaining that the region is Australia's most famous and all its wines pair well with poultry
- B) Suggest a Clare Valley Riesling, noting that duck pairs best with white wine due to its lighter protein content
- C) Suggest an old vine McLaren Vale Grenache, noting that Grenache's red fruit, moderate tannin, and savory old-vine depth are a natural match for the richness of duck — and use the vine age story to make the recommendation memorable
- D) Suggest a Coonawarra Cabernet Sauvignon, which has a structure that overpowers the duck and cleanses the palate

**Correct: C**

---

**Q18. Bekkers, the small McLaren Vale label founded by Toby and Emmanuelle Bekkers, is best positioned for a guest who:**

- A) Wants an approachable, high-volume McLaren Vale Grenache at an entry-level price point for by-the-glass service
- B) Is looking for the estate most associated with Chester Osborn's eccentric personality and the Cube cellar door experience
- C) Wants small-production, biodynamically farmed McLaren Vale Grenache and Syrah of extraordinary refinement comparable in its sense of place to serious Burgundy — and is prepared to invest accordingly
- D) Is interested specifically in Barossa Grenache rather than McLaren Vale, and Bekkers is the appropriate Barossa reference

**Correct: C**

---

**Q19. Teusner Wines is most useful to a wine program primarily because:**

- A) It is the only producer offering a Barossa Centurion vine bottling at a prestige price point comparable to Clarendon Hills
- B) Its old vine Barossa Grenache blends deliver genuine old-vine character at accessible prices, making it ideal for by-the-glass positioning and as a discovery wine for guests who haven't encountered Australian Grenache before
- C) Teusner produces the only certified pre-phylloxera single-variety Grenache in the Barossa, making it the region's rarest and most collectible label
- D) It is an exclusively export-focused label unavailable for domestic sale and relevant only for guests planning to visit Australia

**Correct: B**

---

**Q20. Which framing is most effective when introducing old vine Grenache to a guest with no prior knowledge of the category?**

- A) Begin with a technical explanation of phylloxera history and its impact on European viticulture before transitioning to the Australian context
- B) Lead immediately with the wine's alcohol percentage and tannin level to set appropriate expectations before the guest tastes
- C) Lead with the physical fact of the vine's age — a plant older than anyone alive producing a tiny handful of extraordinary fruit — and connect that directly to the concentration and depth in the glass, using the low-yield analogy to make the mechanism intuitive
- D) Compare Australian old vine Grenache unfavorably to Châteauneuf-du-Pape to establish credibility, then explain why the guest should order it anyway
