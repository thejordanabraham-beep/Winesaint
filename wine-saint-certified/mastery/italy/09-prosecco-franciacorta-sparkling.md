...
**Level:** Italy Mastery — Northeast Italy Sparkling
**Module:** 9
...
## Section 1: Italy's Sparkling Wine Landscape
...
## Section 2: Prosecco — The World's Best-Selling Sparkling Wine
...
**Prosecco DOC** covers an enormous zone — approximately 22,000 hectares spread across nine provinces in Veneto and Friuli-Venezia Giulia. This is the bulk tier. The regulations allow high yields, flat vineyard sites, and a broad production style. Most of the Prosecco in the world's Aperol Spritz comes from here. It is correct and legal, but it is the floor, not the ceiling.
...
## Section 3: Prosecco on the Floor — Opportunities and Pitfalls
...
## Section 4: Franciacorta — Italy's Answer to Champagne
...
Franciacorta achieved DOCG status in 1995 — the only Italian sparkling wine to hold DOCG status based on its production method as well as its geography. This is the regulatory equivalent of having both the geographical and methodological case recognized at the highest Italian quality tier.
...
**Berlucchi** — The pioneer. In 1961, Guido Berlucchi, a local winemaker, met Franco Ziliani, a young enologist who had studied the Champagne method in France. Together, they produced the first modern Franciacorta sparkling wine using Traditional method techniques. Every bottle of Franciacorta produced today traces its lineage to that collaboration. Berlucchi's wines remain reliable, food-versatile, and historically important.
...
## Section 5: Trento DOC and Other Italian Traditional Method Wines
...
## Section 6: Lambrusco and Building a Complete Italian Sparkling Program
...
| Term | Definition |
|------|-----------|
| Charmat/Martinotti method | Secondary fermentation conducted in a large pressurized stainless steel tank (autoclave) rather than in individual bottles; produces fresh, primary-fruit-forward sparkling wines at lower cost and in less time; the method behind Prosecco and Asti Spumante |
| Traditional/Classic method (Metodo Classico) | Secondary fermentation conducted inside the individual bottle, with extended lees aging before disgorgement; produces complex sparkling wines with autolytic character (brioche, toast, cream); the same method as Champagne's *méthode champenoise*; used for Franciacorta, Trento DOC, and Alta Langa |
| Glera | The primary grape variety of Prosecco; renamed from "Prosecco" in 2009 when the EU granted the Prosecco name as a protected geographical indication; vigorous and productive with neutral aromatics of white peach, green apple, and pear; best expressed on steep hillside sites in Conegliano-Valdobbiadene |
| Prosecco DOC vs. DOCG | Prosecco DOC covers approximately 22,000 hectares across nine provinces in Veneto and Friuli-Venezia Giulia; Prosecco DOCG is reserved for the superior hillside zones of Conegliano Valdobbiadene Prosecco Superiore DOCG and Asolo Prosecco Superiore DOCG, with stricter yield limits and quality standards |
| Conegliano Valdobbiadene | The primary Prosecco DOCG zone; a UNESCO World Heritage Site of steep hills northeast of Treviso; encompasses the Rive (single-commune) designation and the Cartizze Grand Cru; produces Prosecco of dramatically higher quality and character than DOC production from flat valley vineyards |
| Cartizze | A specific 107-hectare hilltop within the Valdobbiadene commune; the "Grand Cru" of Prosecco; steep slopes, unique microclimate, fixed production; typically made in Extra Dry style with greater concentration and floral intensity; retails at $50–80 and represents the pinnacle of the Prosecco category |
| Col Fondo | Ancestral method Prosecco; refermented in bottle, not disgorged, and sold with lees still present; cloudy in appearance, slightly savory, with a gentle natural mousse and yeasty complexity; the artisan precursor to the Charmat method and experiencing a contemporary revival |
| Franciacorta DOCG | Italy's premier Traditional method sparkling wine appellation; located in Lombardy on glacial moraine hills south of Lake Iseo; achieved DOCG status in 1995; requires minimum 18 months lees aging for non-vintage (30 months for vintage, 60 months for Riserva); produced from Chardonnay, Pinot Nero, and Pinot Bianco; directly comparable to Champagne in method and quality |
| Autolysis | The process by which yeast cells self-digest after fermentation is complete; during extended lees aging in Traditional method sparkling wine, autolysis releases compounds that produce characteristic flavors of brioche, toasted bread, cream, almonds, and pastry; the primary mechanism by which Franciacorta and Champagne develop their complex secondary character |
| Bellavista | Benchmark Franciacorta producer founded by Vittorio Moretti; longtime partner of Teatro alla Scala in Milan; their Pas Operé vintage is the house icon; among the most prestigious addresses in Italian sparkling wine |
| Ca' del Bosco | The most internationally recognized Franciacorta producer; Maurizio Zanella studied in Burgundy and Champagne before founding the estate; their Annamaria Clementi Riserva spends a minimum of 67 months on lees and retails at $150–200, competing directly with prestige cuvée Champagne |
| Trento DOC | Traditional method sparkling wine appellation in Trentino; primarily Chardonnay with Pinot Nero, Pinot Bianco, and Meunier permitted; Alpine mountain climate produces higher natural acidity and more mineral, austere character than Franciacorta; dominated by Ferrari Trento |
| Lambrusco | Family of indigenous red grape varieties and the sparkling red wines they produce in Emilia-Romagna; six DOPs cover different sub-varieties from pale, delicate Lambrusco di Sorbara to dark, tannic Lambrusco Grasparossa di Castelvetro; largely made by Charmat method; a historic companion to the rich food culture of Emilia-Romagna |
| Lambrusco di Sorbara | The most prized Lambrusco sub-variety; produces pale ruby to pink-red sparkling wine of delicate structure, vivid raspberry and cherry aromatics, crisp acidity, and refreshing bitterness; the finest expression of dry serious Lambrusco; exceptional with Emilian salumi, Mortadella, and Parmigiano-Reggiano |
| Autoclave | The large pressurized stainless steel tank used in the Charmat method for secondary fermentation; allows the process to occur at scale under controlled pressure and temperature; the defining piece of equipment that distinguishes Charmat production from Traditional method bottle fermentation |

---

## Quiz — Italian Sparkling Wines: Prosecco, Franciacorta, and the Northeast

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. A guest asks you to explain the difference between Prosecco and Champagne. Which answer is most accurate and professionally useful?**

- A) "Prosecco is a higher-quality wine — it's fresh and Italian, whereas Champagne is French and overpriced."
- B) "Prosecco is fermented in a tank, which preserves its fresh fruit character and makes it ideal for aperitivo. Champagne is fermented in the bottle and aged on the lees, developing toasty, complex secondary flavors. They're designed for different moments — not the same category."
- C) "There's no meaningful difference — both are sparkling wines and both go well with dinner."
- D) "Champagne is always better than Prosecco because it uses the Traditional method."

**Correct: B**

---

**Q2. What is Cartizze, and why does it matter for a floor professional?**

- A) Cartizze is a producer in Friuli-Venezia Giulia known for making Italy's most exported Prosecco
- B) Cartizze is a specific 107-hectare hilltop within Valdobbiadene — the Grand Cru of the Prosecco appellation; it produces more concentrated, floral, slightly sweeter Prosecco than standard DOCG, typically retailing at $50–80, and represents the premium Prosecco upsell opportunity
- C) Cartizze is the brand name for Berlucchi's entry-level Franciacorta non-vintage
- D) Cartizze is a DOC sub-zone in Friuli that produces a single-vineyard Glera of exceptional quality

**Correct: B**

---

**Q3. The Glera grape was renamed from "Prosecco" in 2009. Why?**

- A) The EU determined the old name was misleading because the wine is not actually sweet
- B) Italian producers wanted to distinguish their grape from French Glera plantings in Alsace
- C) The EU granted Prosecco as a protected geographical indication, requiring the grape name and the wine/place name to be legally distinct so the geographic designation could be protected
- D) The renaming was a voluntary decision by the Conegliano Valdobbiadene Consorzio to differentiate DOCG Prosecco from DOC Prosecco

**Correct: C**

---

**Q4. A guest says they want "the best Prosecco on the list." Your program carries Prosecco DOC, Conegliano Valdobbiadene DOCG, and Valdobbiadene Superiore di Cartizze. Which do you recommend and how do you describe it?**

- A) Prosecco DOC — it's the most widely recognized and the guest will know what they're getting
- B) Conegliano Valdobbiadene DOCG — it's the most common premium choice
- C) Cartizze — a specific 107-hectare hillside in Valdobbiadene that is essentially the Grand Cru of Prosecco; more concentrated, more floral, a touch of sweetness, and genuinely different from anything else in the category
- D) All three are equivalent in quality — let the guest choose by price

**Correct: C**

---

**Q5. What are the minimum lees aging requirements for non-vintage Franciacorta, and how do they compare to non-vintage Champagne?**

- A) Franciacorta: 12 months minimum; Champagne: 15 months minimum — Champagne is stricter
- B) Franciacorta: 18 months minimum; Champagne: 15 months minimum — Franciacorta is stricter at the non-vintage level
- C) Both Franciacorta and Champagne require exactly 18 months minimum for non-vintage
- D) Franciacorta: 30 months minimum; Champagne: 15 months minimum — Franciacorta is significantly stricter

**Correct: B**

---

**Q6. What is Col Fondo Prosecco, and how does it differ from conventional Charmat-method Prosecco?**

- A) Col Fondo is a specific Rive designation within the Valdobbiadene DOCG; it refers to vineyard location rather than production method
- B) Col Fondo is Prosecco made by the ancestral method — refermented in bottle, not disgorged, sold with lees still present; it is cloudy, slightly savory, yeasty, and more complex than Charmat Prosecco; the artisan precursor to the modern tank method
- C) Col Fondo refers to the traditional wooden vats (botti) used in Prosecco fermentation; wines so labeled are fermented in oak rather than stainless steel
- D) Col Fondo is a producer in Conegliano specializing in single-vineyard Prosecco of exceptional concentration

**Correct: B**

---

**Q7. Which of the following best identifies the three benchmark Franciacorta producers?**

- A) Ferrari Trento, Bellavista, and Contadi Castaldi
- B) Berlucchi, Ca' del Bosco, and Cleto Chiarli
- C) Bellavista, Ca' del Bosco, and Berlucchi — the pioneers and benchmarks of the Franciacorta category
- D) Ca' del Bosco, Paltrinieri, and Monte Rossa

**Correct: C**

---

**Q8. A guest who collects Champagne asks if there is any Italian sparkling wine that is genuinely comparable. What is the best response?**

- A) "Nothing in Italy competes with Champagne — the method and terroir are simply different."
- B) "Prosecco Superiore di Cartizze is Italy's Grand Cru equivalent and competes directly with prestige cuvée Champagne."
- C) "Franciacorta is made by the exact same method as Champagne, aged on the lees for even longer at the non-vintage level, from the same grape varieties. Ca' del Bosco Annamaria Clementi spends 67+ months on lees and retails at a fraction of what comparable prestige Champagne costs. The method and quality are fully comparable."
- D) "Trento DOC is the most direct Champagne alternative — Ferrari Trento uses French grapes and French techniques exclusively."

**Correct: C**

---

**Q9. How does the character of Trento DOC differ from Franciacorta, and why?**

- A) Trento DOC is made from Glera rather than Chardonnay, giving it a fruitier, less complex character
- B) Trento DOC is produced in an Alpine mountain climate at higher elevations, resulting in higher natural acidity, a more mineral and austere character, and less of Franciacorta's relative richness and fruit generosity
- C) Franciacorta is more mineral than Trento DOC because it is produced closer to the Alps
- D) There is no meaningful difference in character between Trento DOC and Franciacorta — both are Traditional method wines from northern Italy

**Correct: B**

---

**Q10. What does the label term "Metodo Classico" or "Metodo Tradizionale" indicate on an Italian sparkling wine?**

- A) The wine was produced in the Classico zone of a specific appellation
- B) The wine was made using traditional large-format Slavonian oak barrels for secondary fermentation
- C) The wine underwent secondary fermentation inside the individual bottle and extended lees aging before disgorgement — the same method as Champagne; a quality signal indicating higher production cost and greater complexity potential
- D) The wine is a non-vintage blend, assembled using traditional Italian blending methods

**Correct: C**

---

**Q11. A guest at your restaurant orders an Aperol Spritz. Your program carries both Prosecco DOC and Conegliano Valdobbiadene DOCG Prosecco. What is the intelligent floor response?**

- A) Make the Aperol Spritz with DOC Prosecco and say nothing — it's just a cocktail
- B) Redirect the guest away from the Spritz and recommend a glass of Franciacorta instead
- C) Offer to make the Spritz with the DOCG Prosecco for a slightly higher price, framing it as "we make ours with a better Prosecco — the flavor is noticeably cleaner and fresher"
- D) Ask the guest if they have considered switching to Champagne for a more sophisticated cocktail experience

**Correct: C**

---

**Q12. Why does serious Lambrusco have such a strong traditional pairing with Emilian charcuterie — Prosciutto di Parma, Mortadella, Parmigiano-Reggiano?**

- A) Lambrusco's sweetness provides contrast to the salt in cured meats
- B) Lambrusco's bubbles, acidity, and mild tannin cut through fat in rich salumi while its cherry-berry fruit refreshes the palate — an evolved regional pairing between a sparkling red and one of Italy's richest food cultures
- C) Lambrusco is the only Italian wine produced in the same region as Parmigiano-Reggiano, making the pairing a matter of proximity rather than complementarity
- D) The high alcohol in Lambrusco acts as a digestive aid that balances the heaviness of aged charcuterie

**Correct: B**

---

**Q13. Which Lambrusco sub-variety is considered the most prized, and how would you describe it to a guest?**

- A) Lambrusco Grasparossa di Castelvetro — the darkest, most tannic, most structured
- B) Lambrusco Salamino di Santa Croce — the most versatile and widely planted
- C) Lambrusco di Sorbara — the most delicate; pale ruby to pink in color, vivid raspberry and fresh cherry aromatics, crisp acidity, dry style, refreshing bitterness; extraordinary with Emilian salumi
- D) Lambrusco Reggiano — the most age-worthy and complex of the sub-varieties

**Correct: C**

---

**Q14. A guest who regularly drinks non-vintage Champagne at $120–150 a bottle is open to trying something new. How do you make the Franciacorta pitch?**

- A) "Franciacorta is a cheaper option if you want to save money tonight."
- B) "Franciacorta is made by the exact same method as Champagne — bottle fermented, aged on the lees for at least 18 months — from Chardonnay and Pinot Nero in Lombardy. It's genuinely comparable in quality and it's $50–80 at this quality level. The difference is Italy doesn't have Champagne's marketing budget."
- C) "Franciacorta is similar to Champagne but slightly sweeter and less acidic — it's the Italian alternative for guests who find Champagne too tart."
- D) "I'd recommend Prosecco Cartizze instead — it's Italy's premium sparkling wine and a better value than Franciacorta."

**Correct: B**

---

**Q15. What is autolysis, and why does it matter for understanding the difference between Franciacorta and Prosecco?**

- A) Autolysis is the process by which Glera grapes develop their characteristic white peach and green apple aromatics during slow, cold tank fermentation
- B) Autolysis is the self-digestion of yeast cells after fermentation, releasing flavor compounds — brioche, toast, cream, almond — during extended lees contact in Traditional method wines; it is why Franciacorta develops complex secondary character that Charmat-method Prosecco, with its brief lees contact, does not
- C) Autolysis refers to the secondary malolactic fermentation that occurs naturally in Franciacorta, converting malic acid to lactic acid and creating a rounder texture
- D) Autolysis is the chemical process by which dosage sugar integrates into sparkling wine, producing the final flavor balance after disgorgement

**Correct: B**

---

**Q16. A table is celebrating an anniversary and wants to drink Italian sparkling wines through their entire meal. How do you structure the program from aperitivo through dessert?**

- A) Start and finish with Prosecco — it is the most versatile Italian sparkling wine and works throughout the meal
- B) Serve only Franciacorta throughout — it is the highest quality Italian sparkling wine and covers all course pairings
- C) Begin with Prosecco DOCG for aperitivo; move to Franciacorta or Trento DOC for the meal (food-versatile, Complex, Traditional method); consider Lambrusco di Sorbara with any charcuterie or cheese course; close with Moscato d'Asti for dessert
- D) Begin with Champagne for prestige, transition to Franciacorta for the main courses, and close with Prosecco for the dessert course

**Correct: C**

---

**Q17. Which statement about Prosecco freshness and aging is correct?**

- A) Prosecco DOCG from Cartizze can age 5–7 years and improve significantly in complexity with cellaring
- B) Prosecco is not an aging wine; the Charmat method is designed to preserve primary fruit aromatics that fade over time — buy fresh, sell fresh, and open bottles should be consumed within 24–48 hours
- C) Prosecco ages similarly to Champagne — the lees contact during tank fermentation provides sufficient structure for 3–5 years of development
- D) Only Col Fondo Prosecco requires fresh consumption; conventional Charmat Prosecco can be stored for 2–3 years without quality loss

**Correct: B**

---

**Q18. Berlucchi is historically significant in the Franciacorta story because:**

- A) Berlucchi created the first DOCG classification for Franciacorta in 1995 and lobbied for its recognition as Italy's premier sparkling wine
- B) In 1961, Guido Berlucchi and enologist Franco Ziliani produced the first modern Franciacorta sparkling wine using Traditional method techniques learned in Champagne — the origin of the entire modern Franciacorta category
- C) Berlucchi introduced the concept of extended lees aging (Riserva tier) to Franciacorta, establishing the 60-month minimum that applies today
- D) Berlucchi was the first Franciacorta producer to be recognized internationally, winning the Champagne and Sparkling Wine World Championships in 1978

**Correct: B**

---

**Q19. A guest says "I want something Italian and sparkling but I'm tired of Prosecco." They have a budget of around $70 for a bottle. What do you recommend?**

- A) Cartizze — the Grand Cru of Prosecco, a completely different experience from standard Prosecco
- B) Franciacorta non-vintage Brut from Bellavista or Contadi Castaldi — Traditional method, comparable to Champagne in method and complexity, available at this price point, and a genuinely different experience than any Prosecco
- C) Lambrusco di Sorbara — the most serious Italian sparkling wine at this price point
- D) Alta Langa DOCG — Italy's finest sparkling wine, produced at lower volumes and higher quality than Franciacorta

**Correct: B**

---

**Q20. What does the "Extra Dry" designation on a bottle of Prosecco actually indicate, and why does this matter on the floor?**

- A) Extra Dry indicates the driest style of Prosecco, made with no dosage and zero residual sugar
- B) Extra Dry is slightly sweeter than Brut — it contains more residual sugar — and it is the traditional Prosecco style that many Italian and global consumers have been drinking for decades without realizing it; when a guest says "I want something drier," verify whether they are currently drinking Extra Dry before defaulting to Brut
- C) Extra Dry is an intermediate sweetness level between Dry (sweet) and Brut (dry), with residual sugar equivalent to that of non-vintage Champagne
- D) Extra Dry is a production designation indicating that the secondary fermentation was conducted at lower temperatures to preserve extra freshness

**Correct: B**

---

*End of Module 9 — Italian Sparkling Wines: Prosecco, Franciacorta, and the Northeast*

*Next: Module 10 — Friuli-Venezia Giulia: Italy's White Wine Frontier*
