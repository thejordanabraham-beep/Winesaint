...
**Level:** Italy Mastery — Central Italy
**Module:** 11
...
## Section 1: Central Italy Beyond Tuscany
...
## Section 2: Marche — Verdicchio and the Adriatic Whites
...
*Umani Ronchi* is the region's largest quality producer — extensive distribution, good pricing, and their Vecchie Vigne Riserva ("old vines reserve") is a serious bottling. Their entry-level Verdicchio is a strong BTG option.
...
## Section 3: Umbria — Sagrantino's Kingdom
...
## Section 4: Est! Est!! Est!!! and Lazio
...
## Section 5: Grechetto and Umbrian Whites — The Value Argument

Grechetto is Umbria's most interesting white grape, and it remains one of Italy's most undervalued white varieties by international standards. Its name suggests Greek origin — many Italian varieties with "Greco" or "Grechetto" in their names trace ancestry to ancient Greek colonization of the Italian peninsula — and DNA analysis has confirmed that Grechetto di Orvieto is genetically identical to Pignoletto, a variety cultivated in Emilia-Romagna. The Umbrian expression, however, differs markedly from its Emilian cousin, shaped by the volcanic tuff and limestone soils of the Orvieto zone and by the local microclimate.
...
The DOC regulations permit up to 60% Trebbiano Toscano (called Procanico locally) in the blend, with Grechetto and other authorized varieties making up the remainder. This is where the quality divide occurs: producers who lean on Trebbiano produce neutral, high-acid wine of no particular distinction. Producers who emphasize Grechetto — and who farm the Classico zone on volcanic tuff and limestone — produce wines of real character and food pairing utility.

The essential producers: *Palazzone* (Giovanni Dubini's estate; their Campo del Guardiano is Grechetto-dominant, stainless steel-raised, showing herbal-floral aromatics and genuine mineral character — the reference for serious dry Orvieto); *Barberani* (in the Lago di Corbara sub-zone near the Tiber; also produces excellent Orvieto Classico); *Decugnano dei Barbi* (one of the region's historic estates, strong on the sweet styles as well as the dry). Antinori's *Castello della Sala* estate in Umbria is worth knowing: their *Cervaro della Sala* blends 80% Chardonnay with 20% Grechetto in French oak — it is more of an internationalized Umbrian white than a traditional Orvieto, but it is age-worthy, well-distributed, and demonstrates the ceiling for Umbrian white wine when investment matches ambition.
...
## Section 6: Floor Application — Building a Central Italian Program
...
| Wine | Role | Notes |
|------|------|-------|
| Verdicchio dei Castelli di Jesi DOC | BTG white anchor | Food-versatile, reliable, talking points |
| Verdicchio di Matelica DOC (Bisci or Collestefano) | Premium bottle white | Insider selection, higher structure |
| Frascati Superiore DOCG (Villa Simone) | Roman option, approachable | Table storytelling, house pour conversation |
| Orvieto Classico (Palazzone Campo del Guardiano) | Serious white option | Grechetto-dominant, mineral character |
| Rosso Conero DOC | Value BTG red | Alternative to Chianti, Adriatic character |
| Montefalco Rosso DOC (Antonelli) | Value prestige red | Sagrantino introduction, 3–5 year window |
| Sagrantino di Montefalco DOCG (Caprai 25 Anni) | Prestige cellar red | The big conversation, built for aging |
| Est! Est!! Est!!! di Montefiascone DOC | Conversation piece | Sell the story, price accessibly |
...
| Term | Definition |
|------|------------|
| Verdicchio | Indigenous white grape of Marche; name from "verde" (green) referencing its green-hued youth; produces high-acid, mineral wines with characteristic bitter-almond finish; grown principally in Castelli di Jesi DOC and Matelica DOC |
| Amphora bottle | The distinctive fish-shaped bottle used for Verdicchio dei Castelli di Jesi; introduced in the 1950s–60s as a marketing strategy to make the wine instantly recognizable in export markets; now associated with both the variety's recognition and its early reputation for cheap wine |
| Rosso Conero | DOC from the Adriatic hills near Monte Conero and Ancona in Marche; produced from Montepulciano grape (the grape, not the Tuscan town); rich, dark, earthy, tannic — a value alternative to Chianti from central Italy's eastern coast |
| Sagrantino di Montefalco | DOCG from the hills around Montefalco in Umbria; produced from 100% Sagrantino grape; Italy's most tannic variety, with documented tannin levels exceeding Nebbiolo and Tannat; minimum 37 months aging (12 in wood); requires 10–15 years minimum to approach approachability |
| Arnaldo Caprai | The Umbrian estate (and founding family) that single-handedly revived and internationalized Sagrantino di Montefalco; Marco Caprai's research partnership with the University of Milan in the late 1980s–90s established optimal clones, yields, and winemaking protocols; the "25 Anni" bottling (1993) established the international benchmark |
| Grechetto | Umbria's most characterful white grape; genetically identical to Pignoletto (Emilia-Romagna); produces medium-bodied whites with pear, apple, herbal and floral notes, and characteristic slight bitter finish; the quality backbone of Orvieto Classico when emphasized over Trebbiano Toscano |
| Orvieto | Ancient white wine DOC straddling the Umbria-Lazio border; one of Italy's oldest documented wine zones; blends Grechetto and/or Trebbiano Toscano (minimum 60% combined); quality ranges from neutral bulk production (Trebbiano-dominant) to structured, mineral-driven wine (Grechetto-dominant, Classico zone) |
| Frascati | White wine DOC/DOCG from the Castelli Romani volcanic hills southeast of Rome; the traditional table wine of Rome; Malvasia Bianca di Candia and Trebbiano Toscano; mostly neutral and commercial, but serious producers (Villa Simone, Castel de Paolis) produce genuinely interesting Frascati Superiore DOCG |
| Castelli Romani | The volcanic hills southeast of Rome; the source of Lazio's traditional table wines including Frascati, Marino, and Grottaferrata; volcanic soils derived from ancient crater activity contribute drainage and mineral character to the wines |
| Est! Est!! Est!!! | White wine DOC from Montefiascone, north of Rome near Lake Bolsena; famous for a medieval legend in which a bishop's servant marked an inn with triple "Est!" and the bishop drank himself to death there; Trebbiano/Malvasia/Rossetto blend; the legend vastly exceeds the wine's quality |
| Cesanese | Indigenous red grape of Lazio; the base for Cesanese del Piglio DOCG in the Prenestini hills east of Rome; produces tannic, rustic, dark-fruited wines of genuine character; significantly underappreciated and underpriced in international markets |
| Montefalco Rosso | DOC from the same hills as Sagrantino di Montefalco; 60–70% Sangiovese blended with 10–15% Sagrantino and other varieties; accessible in 3–5 years; positioned as the approachable entry point to Montefalco and the Sagrantino zone |
| Bucci (Villa Bucci Riserva) | The benchmark producer for Verdicchio dei Castelli di Jesi Riserva; old vines, suppressed yields, consultant Stéphane Derenoncourt; Villa Bucci Riserva ages 20+ years in great vintages and demonstrates Verdicchio's potential as a serious, cellar-worthy Italian white |
| Lacrima di Morro d'Alba | DOC from Marche; produced from the intensely aromatic indigenous Lacrima grape; extraordinarily floral (roses, violets) with low tannin; a curiosity wine and conversation piece for guests interested in unusual Italian indigenous varieties |

---

## Quiz — Marche, Umbria & Lazio

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. What characteristic finish is considered the hallmark of Verdicchio, distinguishing it as a feature of the variety rather than a flaw?**
- A) A sweet, honeyed aftertaste
- B) A bitter-almond finish
- C) A smoky, reductive note
- D) A sharp, green-pepper bitterness

**Correct: B**

---

**Q2. What does the name "Verdicchio" refer to?**
- A) The wine's resemblance to verd (green wine) from Portugal
- B) The verdigris color of the famous amphora bottle
- C) The grape's greenish hue in youth, from "verde" (Italian for green)
- D) The green grassy character of wines from the Matelica zone

**Correct: C**

---

**Q3. A guest asks which Verdicchio zone is considered the "connoisseur's choice" — smaller, higher altitude, and more structured. Which DOC is correct?**
- A) Verdicchio dei Castelli di Jesi
- B) Verdicchio di Offida
- C) Verdicchio di Matelica
- D) Verdicchio delle Marche IGT

**Correct: C**

---

**Q4. Which producer is considered the benchmark for long-aging Verdicchio dei Castelli di Jesi Riserva, producing a wine capable of 20+ years of bottle development?**
- A) Garofoli
- B) Umani Ronchi
- C) Bisci
- D) Bucci (Villa Bucci Riserva)

**Correct: D**

---

**Q5. According to laboratory analyses, how does Sagrantino's tannin level compare to Nebbiolo (Barolo/Barbaresco)?**
- A) Sagrantino has lower tannin than Nebbiolo
- B) Sagrantino and Nebbiolo have approximately equal tannin levels
- C) Sagrantino has higher tannin levels than Nebbiolo
- D) Sagrantino's tannin is only measurable in the passito style, not the dry style

**Correct: C**

---

**Q6. What are the minimum aging requirements for Sagrantino di Montefalco DOCG (dry style)?**
- A) 18 months total, 6 months in wood
- B) 25 months total, 12 months in wood
- C) 37 months total, 12 months in wood
- D) 48 months total, 24 months in wood

**Correct: C**

---

**Q7. Which producer revived and internationalized Sagrantino di Montefalco, conducting research with the University of Milan to optimize clone selection and production techniques?**
- A) Paolo Bea
- B) Antonelli San Marco
- C) Lungarotti
- D) Arnaldo Caprai
...
**Q8. A guest who loves Barolo asks about Sagrantino di Montefalco. They want to try it tonight. What is the best floor recommendation?**
- A) Open a bottle of Sagrantino and suggest it will pair well with any red meat dish
- B) Explain that young Sagrantino is not ready to drink; recommend Montefalco Rosso as the accessible expression from the same zone
- C) Suggest a glass of Rosso Conero as a less tannic alternative
- D) Recommend they order the Sagrantino and decant it for one hour before tasting

**Correct: B**

---

**Q9. What is the composition of Montefalco Rosso DOC?**
- A) 100% Sagrantino
- B) 100% Sangiovese
- C) 60–70% Sangiovese, 10–15% Sagrantino, remainder other red varieties
- D) 50% Sagrantino, 50% Montepulciano

**Correct: C**

---

**Q10. The Est! Est!! Est!!! legend involves a bishop traveling to Rome in 1111. What happened at Montefiascone?**
- A) The bishop found the wine so poor he refused to stop and continued to Rome
- B) The bishop's servant marked the inn with "Est!" and the bishop passed through without stopping
- C) The bishop's servant found the wine so exceptional he wrote "Est! Est!! Est!!!" and the bishop subsequently drank himself to death there
- D) The bishop purchased the vineyards of Montefiascone and established the first wine trade route to Rome

**Correct: C**

---

**Q11. What is the primary quality distinction within Orvieto DOC production?**
- A) Whether the wine is aged in French oak or Slavonian oak
- B) Whether the wine uses Grechetto as the dominant variety (higher quality) versus Trebbiano Toscano (lower quality, neutral)
- C) Whether the wine is harvested by hand or machine
- D) Whether the wine is produced in Umbria or on the Lazio side of the DOC border

**Correct: B**

---

**Q12. Which Lazio appellation is considered the region's most interesting red wine, produced from the indigenous Cesanese grape in the Prenestini hills east of Rome?**
- A) Frascati Superiore DOCG
- B) Est! Est!! Est!!! di Montefiascone DOC
- C) Falerno del Massico DOC
- D) Cesanese del Piglio DOCG

**Correct: D**

---

**Q13. A table orders a whole grilled fish and asks for an Italian white wine recommendation. Which wine from this module is the most defensible pairing based on regional tradition and flavor profile?**
- A) Frascati Superiore DOCG, because Roman whites traditionally accompany fish
- B) Verdicchio dei Castelli di Jesi DOC, because its high acidity and bitter-almond finish cut through seafood the way the Adriatic coast tradition dictates
- C) Orvieto Classico, because Grechetto's herbal notes are an excellent seafood complement
- D) Trebbiano Toscano-dominant Orvieto, because its neutrality will not overpower the fish

**Correct: B**

---

**Q14. What is the geological characteristic that distinguishes the best vineyard sites in the Orvieto Classico zone and contributes freshness and mineral character to wines made there?**
- A) Granite bedrock with well-drained sandy topsoil
- B) Volcanic tuff (consolidated volcanic ash) alongside limestone, providing exceptional drainage and soil temperature moderation
- C) Alluvial gravel deposits similar to the Médoc in Bordeaux
- D) Heavy clay with iron-rich red soils similar to Pomerol

**Correct: B**

---

**Q15. Which producer makes Campo del Guardiano — the reference bottling for serious, Grechetto-dominant dry Orvieto?**
- A) Barberani
- B) Lungarotti
- C) Palazzone
- D) Decugnano dei Barbi

**Correct: C**

---

**Q16. Marche's Rosso Conero DOC is produced from which grape variety?**
- A) Sangiovese
- B) Nebbiolo
- C) Montepulciano (the grape variety)
- D) Lacrima
...
**Q17. What is the Lacrima di Morro d'Alba DOC primarily known for among guests who encounter it?**
- A) Its high tannin and aging potential, similar to Sagrantino
- B) Its intensely floral aromatics — roses and violets — and low tannin, making it an unusual and striking wine for adventurous guests
- C) Its similarity in character to Barolo, useful as a lower-cost alternative
- D) Its neutral profile, making it a reliable house pour for guests who dislike prominent flavors

**Correct: B**

---

**Q18. The Torgiano Rosso Riserva DOCG is associated with which family estate, which pioneered quality winemaking in Umbria in the 1960s and whose Rubesco Riserva Vigna Monticchio is the benchmark bottling?**
- A) Caprai
- B) Bea
- C) Antinori
- D) Lungarotti
...
**Q19. A guest asks you to describe central Italy's wine regions as compared to Tuscany and Piedmont. Which framing is most accurate and most effective on the floor?**
- A) "These are second-tier wines — not as good as Tuscany, but fine for the price"
- B) "These are insider selections: unique indigenous varieties, less internationally famous, and therefore priced as genuine value compared to wines of equivalent quality from Chianti or Barolo"
- C) "Central Italy is a backup option when we run out of Tuscany or Piedmont by the glass"
- D) "These wines are less structured and require no aging, which makes them good for guests who don't know much about wine"

**Correct: B**

---

**Q20. Which of the following correctly lists the three regions covered in this module and their primary geographical characteristic?**
- A) Marche (landlocked, west of Apennines), Umbria (Adriatic coast), Lazio (Alps foothills, north of Rome)
- B) Marche (Adriatic coast, east of Apennines), Umbria (landlocked, the only landlocked region in central Italy), Lazio (Rome, the Tiber, Castelli Romani hills south of the city)
- C) Marche (Tyrrhenian coast), Umbria (Po River valley), Lazio (Adriatic coast, east of Apennines)
- D) Marche (Alpine foothills), Umbria (coastal, Mediterranean), Lazio (landlocked, south of Rome)

**Correct: B**

---

*End of Module 11 — Marche, Umbria & Lazio*

*Wine Saint Certified — Italy Mastery*
*Next: Module 12 — Southern Italy: Campania, Basilicata & Beyond*
