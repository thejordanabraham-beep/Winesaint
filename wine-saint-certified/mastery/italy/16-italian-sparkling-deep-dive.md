...
**Level:** Italy Mastery — Sparkling Wine
**Module:** 16
...
## Section 1: Production Methods, The Technical Foundation
...
## Section 2: Franciacorta, The Complete Picture
...
## Section 3: Prosecco, Building a Serious Program
...
| Designation | Residual Sugar (g/L) |
|---|---|
| Brut Nature | 0–3 |
| Extra Brut | 0–6 |
| Brut | 0–12 |
...
## Section 4: Trento DOC + Alta Langa + Ferrari
...
The primary grape is Chardonnay; Pinot Nero, Pinot Bianco, and Meunier are also permitted. Trento DOC Rosé must include a minimum 30% Pinot Nero. Aging minimums: 15 months for Non-Vintage, 24 months for Vintage, 36 months for Riserva.
...
The Langhe's association with Italy's most celebrated red wines gives Alta Langa DOCG a cultural and culinary context that is genuinely compelling: this is the sparkling wine of the same hillsides that produce Barolo. The wines must be Traditional method, must come from Chardonnay and Pinot Nero at minimum 85% total, and must spend a minimum of 30 months on the lees (36 months for vintage wines). Yields are strictly limited.
...
## Section 5: Lambrusco and Emilia-Romagna Sparkling
...
## Section 6: Building an Italian Sparkling Program + Floor Mastery
...
**Opening and Pouring:**
Traditional method wines under cork should be opened with controlled pressure management, thumb on cork, slow rotation of the bottle rather than the cork, a quiet sigh rather than a pop. The dramatic pop wastes CO2, disturbs the mousse, and is not appropriate for a fine dining environment. Prosecco under crown cap (increasingly common for quality producers) is simply opened.
...
"Completely different methods. Champagne is made with secondary fermentation in the bottle and spends years on the lees (that's where the toasty, bready complexity comes from. Prosecco is made in sealed tanks and bottled young) the goal is to preserve fresh fruit and floral aromas. One is about depth and complexity from age; the other is about brightness and immediacy. Both are excellent, it depends on what you're in the mood for."

**"I thought all Italian sparkling wine was Prosecco."**
...
**"I want something festive but not too expensive."**
"Our Prosecco Superiore is the right answer, it's from the DOCG zone, the hillside vineyards in Valdobbiadene, so it has more complexity than the standard DOC. Very fresh, beautiful white peach and pear, excellent for celebrating without the commitment of a premium bottle."
...
| Term | Definition |
|------|-----------|
| Metodo Classico / Metodo Tradizionale | The Traditional method of sparkling wine production: secondary fermentation in the individual bottle, followed by extended aging on the lees, riddling, disgorgement, and dosage. Used in Franciacorta, Trento DOC, and Alta Langa DOCG. Produces autolytic complexity (brioche, toast, biscuit) from lees contact. |
| Metodo Martinotti / Metodo Charmat / Metodo Italiano | Secondary fermentation conducted in large sealed pressurized stainless steel tanks (autoclaves) rather than in individual bottles. Shorter lees contact; preserves primary fruit and floral aromas. Used for Prosecco and most Lambrusco. Named for Federico Martinotti (Italian, 1895) despite common use of the name "Charmat" (French patent, 1910). |
| Metodo Ancestrale / Col Fondo | The oldest sparkling wine production method: wine is bottled before primary fermentation is complete; secondary fermentation finishes in bottle; wine is typically not disgorged (lees remain). Produces cloudy, lower-pressure, lower-alcohol wine with earthy, savory character. "Col Fondo" is the Venetian dialect term for undisgorged Prosecco made this way. |
| Satèn | A sparkling wine category exclusive to Franciacorta DOCG. A Blanc de Blancs (Chardonnay, with or without Pinot Bianco) produced at lower pressure than standard Franciacorta (approximately 4.5–5 atm vs. 6 atm standard), resulting in a creamier, silkier mousse. Minimum 24 months on lees. The name derives from the Italian for "satin," evoking its texture. No other appellation in the world has this category. |
| Spumante | Fully sparkling wine; minimum 3 atmospheres of pressure in the bottle. The term covers all fully sparkling Italian wines, from Franciacorta to Prosecco to Asti Spumante. |
| Frizzante | Lightly sparkling wine; 1 to 2.5 atmospheres of pressure. Lower effervescence than spumante; common in some Lambrusco styles and traditional Col Fondo wines. |
| Autoclave | The large, sealed, pressurized stainless steel tank used in the Charmat/Martinotti method to conduct secondary fermentation. Allows production at scale while maintaining controlled pressure throughout the process. |
| Rive | A designation within the Valdobbiadene DOCG (and Conegliano DOCG) of Prosecco Superiore indicating a single-commune or single-vineyard wine. Must be vintage dated. Lower maximum yields than standard DOCG. Represents the highest terroir expression in the Prosecco category. |
| Cartizze (Valdobbiadene Superiore di Cartizze) | A 107-hectare sub-zone within the Valdobbiadene DOCG, effectively Prosecco's Grand Cru vineyard. Distinctive glacial-alluvial soils, south-facing slopes. Produces fuller, richer, more complex Prosecco than standard DOCG. Typically produced in an Extra Dry or Dry style. Should be listed and priced separately from standard Prosecco on a wine program. |
| Franciacorta DOCG | A DOCG appellation in Lombardy's Brescia province producing exclusively Traditional method sparkling wine from Chardonnay, Pinot Nero, Pinot Bianco, and Erbamat. Received spumante DOCG status in 1995. Aging categories: Non-Vintage (18 months minimum), Millesimato/Vintage (30 months), Satèn (24 months), Rosé (24 months), Riserva (60 months). |
| Trento DOC | A DOC appellation in Trentino producing Traditional method sparkling wine primarily from Chardonnay. Alpine vineyards at high altitude contribute exceptional natural acidity. Home of Ferrari Trento, Italy's most internationally recognized Traditional method sparkling producer. |
| Alta Langa DOCG | A DOCG appellation in Piedmont's Langhe hills producing Traditional method sparkling wine from Chardonnay and Pinot Nero at elevations of 250–900 meters. DOCG status granted 2011. Minimum 30 months on lees. One of Italy's most serious and under-recognized Traditional method appellations. |
| Lambrusco di Sorbara | The most refined of the six Lambrusco DOPs. Pale ruby to near-rosé in color; high acidity; aromas of violet, wild rose, and red fruit; low tannin. The canonical pairing wine for prosciutto di Parma, salumi, and light antipasti from Emilia-Romagna. Benchmark: Cleto Chiarli Vecchia Modena Premium; Paltrinieri. |
| Annamaria Clementi | Ca' del Bosco's flagship Riserva Franciacorta, named for founder Maurizio Zanella's mother. Typically aged 67–80 months on the lees, well above the 60-month Riserva minimum. One of Italy's most celebrated Traditional method sparkling wines and a benchmark for the entire Franciacorta appellation. |

---

## Quiz: Italian Sparkling Wine: Deep Dive

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. What distinguishes the Satèn category from all other Franciacorta styles?**

- A) It is made from Pinot Nero only
- B) It uses the Charmat method rather than the Traditional method
- C) It is produced at lower pressure (approx. 4.5–5 atm) from white grapes only, creating a creamier mousse
- D) It must be aged a minimum of 60 months on the lees

**Correct: C**

---

**Q2. Federico Martinotti is significant in Italian sparkling wine history because:**

- A) He established the Franciacorta DOCG in 1995
- B) He created the first Prosecco sparkling wine in 1961 alongside Guido Berlucchi
- C) He developed the tank fermentation method for sparkling wine in the 1890s, predating Eugène Charmat's French patent
- D) He founded Ferrari Trento in 1902 and introduced Chardonnay to Trentino

**Correct: C**

---

**Q3. A guest at your table orders "Extra Dry Prosecco" because they prefer very dry wines. What should you do?**

- A) Proceed with the order; extra Dry is the driest Prosecco style
- B) Clarify the sweetness preference: Extra Dry contains 12–17 g/L residual sugar, which is sweeter than Brut; offer Brut or Extra Brut if they prefer genuine dryness
- C) Recommend Cartizze, which is always produced in a Brut style
- D) Suggest Franciacorta instead, which does not use the Extra Dry designation

**Correct: B**

---

**Q4. What are the minimum lees aging requirements for Franciacorta Riserva?**
...
**Q5. Ferrari Giulio Ferrari Riserva del Fondatore is significant because:**

- A) It is the entry-level Franciacorta from Ca' del Bosco, designed for by-the-glass programs
- B) It is a blanc de blancs from Trento DOC aged a minimum of 10 years on the lees, named for Ferrari's founder
- C) It is the only Alta Langa wine permitted to use the Riserva designation
- D) It is the flagship Rosé from Ferrari Trento, made from 100% Pinot Nero

**Correct: B**

---

**Q6. Which Lambrusco appellation produces the palest, most refined, most food-versatile style: ideal for pairing with prosciutto di Parma and light charcuterie?**

- A) Lambrusco Grasparossa di Castelvetro DOC
- B) Lambrusco Reggiano DOC
- C) Lambrusco Salamino di Santa Croce DOC
- D) Lambrusco di Sorbara DOC

**Correct: D**

---

**Q7. Which of the following correctly describes the Charmat method's primary advantage over the Traditional method for wines like Prosecco?**

- A) It produces greater autolytic complexity, more brioche and toast character
- B) It allows longer lees contact, developing more structure in the wine
- C) It preserves primary fruit and floral aromatics by limiting lees contact and fermentation time
- D) It requires secondary fermentation in bottle, giving each wine individual character

**Correct: C**

---

**Q8. A guest says, "I thought all Italian sparkling wine was Prosecco." Which response best reflects the breadth of Italian sparkling?**

- A) "You're right; prosecco is the dominant style, and the other categories are quite minor"
- B) "Actually, Italian sparkling wine is one of the world's most diverse categories, it includes Franciacorta (Traditional method from Lombardy), Trento DOC (Alpine Traditional method), Alta Langa (Piedmont Traditional method), and Lambrusco (sparkling red from Emilia-Romagna)"
- C) "The main alternative to Prosecco is Asti Spumante, which is made from Moscato Bianco"
- D) "Franciacorta is really the only alternative worth knowing, the others are minor appellations"

**Correct: B**

---

**Q9. What is the Valdobbiadene Superiore di Cartizze?**

- A) A single 107-hectare vineyard within the Valdobbiadene DOCG, Prosecco's Grand Cru, producing fuller, richer, more complex wine typically in a slightly sweeter style
- B) The name of the leading producer of Lambrusco di Sorbara
- C) A Rive designation for single-vineyard Franciacorta from the commune of Cartizze
- D) The term for a Col Fondo Prosecco produced without disgorgement in the Conegliano zone

**Correct: A**

---

**Q10. Berlucchi's historical significance in Franciacorta is:**

- A) They produce the Satèn category's most celebrated expression, the benchmark for the style
- B) Guido Berlucchi and Franco Ziliani created the first modern Franciacorta sparkling wine in 1961
- C) They were the first Franciacorta house to receive DOCG certification in 1995
- D) They introduced the Riserva category and the Annamaria Clementi cuvée to Franciacorta

**Correct: B**

---

**Q11. A guest requests a Champagne alternative for a special occasion. Your list includes Franciacorta, Trento DOC, and Alta Langa. Which is the most appropriate response?**

- A) Apologize for not carrying Champagne and suggest Prosecco as the most affordable option
- B) Recommend the Franciacorta Riserva or Ca' del Bosco Annamaria Clementi, explaining it is Traditional method, the same as Champagne, with extended lees aging and comparable complexity; present at a price advantage
- C) Offer the Lambrusco di Sorbara as a sparkling alternative with similar structure to Champagne
- D) Recommend Brachetto d'Acqui as it most closely resembles Champagne's rosé styles

**Correct: B**

---

**Q12. How does Lambrusco Grasparossa di Castelvetro differ from Lambrusco di Sorbara?**

- A) Grasparossa is paler, more delicate, and higher in acidity, the most refined Lambrusco style
- B) Grasparossa is exclusively made by the ancestral method, while Sorbara uses the Charmat method
- C) Grasparossa is darker, more tannic, and more structured, better suited to heartier foods like tagliatelle al ragù
- D) Grasparossa is a white sparkling wine; Sorbara is a red sparkling wine

**Correct: C**

---

**Q13. At what serving temperature should Lambrusco be served, and in which glassware?**

- A) 6–8°C in a flute, identical to Prosecco service
- B) 14–16°C in a wide-mouthed glass that allows aromatics to develop
- C) Room temperature (18–20°C) in a standard red wine glass
- D) 10–12°C in a tulip sparkling glass

**Correct: B**

---

**Q14. The Col Fondo style of Prosecco differs from standard Charmat-method Prosecco because:**

- A) It uses the Traditional method with disgorgement and dosage
- B) It is filtered and bottled at high pressure for maximum effervescence
- C) It is bottled before first fermentation completes, finishing in bottle, and is typically not disgorged, resulting in a cloudy, lower-pressure wine with earthy, savory character
- D) It must be produced exclusively from Pinot Bianco rather than Glera

**Correct: C**

---

**Q15. Which of the following Franciacorta producers is historically significant for founding the house in 1961: and named their prestige cuvée after that founding year?**
...
**Q16. Alta Langa DOCG's minimum lees aging requirement for Non-Vintage wines is:**
...
**Q17. A guest finishing their cheese course has ordered prosciutto di Parma and asks for a wine recommendation. Which Italian sparkling wine is most appropriate and why?**

- A) Franciacorta Satèn, its low pressure and creamy texture complement the delicate fat of the prosciutto
- B) Lambrusco di Sorbara, its high acidity, light tannin, and effervescence cut through fat and complement the salinity of the prosciutto; it is the traditional pairing from the same food culture
- C) Cartizze, its slight sweetness provides contrast to the saltiness of the prosciutto
- D) Trento DOC Riserva, its autolytic complexity and Alpine mineral character pair well with cured meats

**Correct: B**

---

**Q18. Brachetto d'Acqui DOCG is best described as:**

- A) A dry, high-acid Piedmontese Traditional method sparkling made from Brachetto
- B) A sweet, low-alcohol sparkling red wine from southern Piedmont with strawberry, rose, and raspberry character, the canonical pairing for chocolate desserts
- C) The ancestral-method Lambrusco produced in the Acqui Terme zone
- D) A Charmat-method Blanc de Blancs from Piedmont positioned as an alternative to Moscato d'Asti

**Correct: B**

---

**Q19. What is the most important practical correction a floor professional must make when a guest who prefers dry wine orders Prosecco Extra Dry?**

- A) No correction needed; extra Dry is suitable for guests who prefer dry wines
- B) Redirect the guest to Brut or Extra Brut, explaining that "Extra Dry" counterintuitively contains 12–17 g/L of residual sugar, more than Brut, and is noticeably sweeter on the palate
- C) Offer a Frizzante style instead, which is always drier than Extra Dry Spumante
- D) Suggest Cartizze, which is always produced Brut or Extra Brut

**Correct: B**

---

**Q20. A guest wants a sparkling wine recommendation for the beginning of their meal through the dessert course. Which Italian sparkling program sequence is most appropriate?**

- A) Prosecco DOC Brut (aperitivo) → Franciacorta Brut NV or Trento DOC (mid-meal, Traditional method pairing) → Lambrusco di Sorbara (with charcuterie or cheese course) → Brachetto d'Acqui (dessert)
- B) Cartizze (aperitivo) → Lambrusco Grasparossa (mid-meal) → Prosecco DOCG Superiore (cheese) → Franciacorta Satèn (dessert)
- C) Franciacorta Riserva (aperitivo) → Asti Spumante (mid-meal) → Trento DOC Rosé (cheese) → Cartizze (dessert)
- D) Brachetto d'Acqui (aperitivo) → Prosecco DOC (mid-meal) → Franciacorta NV (cheese) → Alta Langa (dessert)
