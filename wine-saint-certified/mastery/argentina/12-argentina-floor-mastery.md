...
**Level:** Argentina Mastery — Floor Application
**Module:** 12
**Audience:** Corporate hospitality professionals — servers, sommeliers, floor managers
**Estimated Duration:** 60–75 minutes
**Prerequisites:** All Argentina Mastery modules 01–11
...
**The Sustainability-Focused Guest** is a growing and increasingly influential profile who pays attention to farming practices, carbon footprint, water use, and producer philosophy. Argentine wine has a legitimate and underutilized story for this guest: high-altitude desert viticulture with minimal disease pressure requires dramatically fewer chemical interventions than European or California viticulture. The arid Andean climate, combined with the near-total absence of rain during the growing season, means that many Argentine producers farm in conditions that are effectively organic by default. Producers like Zuccardi have pursued formal organic and biodynamic certification with rigorous documentation. The Andes snowmelt irrigation — ancient acequias channeling glacial water through an engineered gravity system — is itself a model of sustainable water management. This is not greenwashing; it is geology made practice.
...
## Section 2: The Argentine Wine Program — Building for Revenue and Discovery
...
**Premium Argentine wine anchors** for a serious program include: at the red apex, Cheval des Andes (the LVMH Cheval Blanc and Terrazas de los Andes joint venture), Catena Adrianna Vineyard series, Achaval-Ferrer Finca Altamira, and Zuccardi Finca Piedra Infinita. At the white apex, Catena Adrianna White Bones Chardonnay, which has received scores in the high 90s from every major critical publication and is produced at one of the highest-altitude Chardonnay sites in the world. One or two of these on a list signals to the guest who knows Argentine wine that your program was curated by someone who does too.
...
## Section 3: Handling Common Guest Scenarios — Prepared Conversations for Every Situation
...
## Section 4: Argentine Wine and the Modern Menu — Beyond the Obvious Pairing
...
## Section 5: The Argentine Wine Story in 60 Seconds — Customized by Guest Type
...
> **Pro Tip:** Practice the 60-second narrative until it feels like conversation rather than presentation. The most common mistake floor professionals make with wine storytelling is delivering it at the speed of a monologue rather than the rhythm of a dialogue. Build in a natural pause after the hook — "Argentina is the world's highest-altitude wine country" — and let the guest respond. Their response tells you which version of the remaining 45 seconds to deliver.

---

## Section 6: Staff Training Structure for Argentine Wine — Building Durable Floor Knowledge
...
| Term | Definition |
|------|------------|
| **Alta expresión** | A designation used by Argentine producers to indicate their highest-tier, single-vineyard or reserve wines; analogous to "gran reserva" in intent but without formal regulatory definition in Argentina |
| **Acequias** | Ancient gravity-fed irrigation channels originating in pre-Columbian engineering and expanded under Spanish colonial administration, used to distribute Andean snowmelt to vineyards across Mendoza and other Argentine wine regions |
| **Cheval des Andes** | A premium Argentine wine produced as a joint venture between Château Cheval Blanc (Saint-Émilion) and Terrazas de los Andes; the most prominent example of a direct Bordeaux–Argentina winemaking partnership |
| **Diurnal temperature variation** | The swing between daytime high and nighttime low temperatures during the ripening season; in Valle de Uco's highest zones this differential approaches 20–25°C, preserving acidity while allowing full phenolic ripeness |
| **Gualtallary** | A high-altitude sub-district within Tupungato, Valle de Uco, characterized by calcareous clay, limestone, and volcanic rock over 1,400 meters elevation; the source of some of Argentina's most critically acclaimed single-vineyard Malbecs |
| **Luján de Cuyo** | Argentina's first DOC (Denominación de Origen Controlada), located south of Mendoza city; a warmer, lower-altitude zone producing fuller-bodied, plush Malbec; home to historic producers including Achaval-Ferrer and Catena Zapata's main winery |
| **Malbec** | The dominant red grape of Argentina, originating as Côt/Auxerrois in France; transformed by Argentine altitude, aridity, and UV radiation from a tannic, rustic blending grape into a plush, expressive, and internationally acclaimed variety |
| **Mendoza** | Argentina's primary wine province, responsible for approximately 70% of national production; home to Luján de Cuyo, Maipú, and Valle de Uco; sits at the eastern foothills of the Andes between roughly 600 and 1,500 meters above sea level |
| **Terroir de altitude** | A working concept in Argentine viticulture referring to the combined effect of elevation on wine character — increased UV radiation, lower temperatures, greater diurnal variation, and reduced atmospheric pressure — that differentiates high-altitude from valley-floor expressions of the same variety |
| **Torrontés** | Argentina's signature white grape variety, producing highly aromatic, dry wines with intense floral and stone fruit characteristics and crisp acidity; the principal expressions come from Cafayate in Salta and Mendoza; unique to Argentina among major wine-producing nations |
| **Valle de Uco** | A high-altitude valley in southern Mendoza encompassing the sub-regions of Tupungato, Tunuyán, and San Carlos; the center of Argentina's premium single-vineyard Malbec production; sites here range from approximately 900 to over 1,500 meters above sea level |
| **Vertical tasting** | A tasting format in which multiple vintages of the same wine — or, in staff training contexts, multiple quality tiers from the same producer — are presented simultaneously to demonstrate the effects of age, vintage variation, or winemaking decisions on wine character |
| **Bonarda** | Argentina's second most planted red grape variety (also known as Douce Noire in France and Charbono in California); produces medium-bodied, fresh, low-tannin wines with dark fruit and earthy character; highly effective as a food wine for mixed menus and underutilized in BTG programs |
| **Catena Adrianna Vineyard** | A benchmark single-vineyard site owned by Catena Zapata in Gualtallary, Valle de Uco, at approximately 1,500 meters elevation; produces Malbec and Chardonnay expressions that have received scores of 97–99 from major critical publications and are widely cited as among the world's great vineyard sites |
| **Coulure** | The failure of fertilization during vine flowering, resulting in poor fruit set and significantly reduced yields; a significant challenge for Malbec in its native Bordeaux and Cahors environments, and one of the conditions absent in Argentina's arid, stable Andean climate |

---

## Quiz — Argentina on the Floor: Service, Sales & Guest Experience

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. A guest says, "Just bring me a Malbec." What is the most effective immediate response?**

- A) Bring the house Malbec without further conversation
- B) Ask whether they prefer something richer and plush from the lower valleys or more mineral and fresh from the high-altitude zones
- C) Recommend your most expensive Malbec to maximize revenue
- D) Explain the history of Malbec in France before making a recommendation

**Correct: B**

---

**Q2. The $60–120 Argentine wine segment is described as a high-margin opportunity primarily because:**

- A) Argentine wine is produced at lower cost than other regions due to lower labor standards
- B) Single-vineyard Valle de Uco Malbec consistently delivers comparable or greater complexity than Napa equivalents at two to three times the price
- C) Argentine producers have agreements with distributors that reduce wholesale pricing
- D) Guests in this price range are less informed and easier to upsell

**Correct: B**

---

**Q3. Which wine is recommended as the BTG white discovery wine in an Argentine wine program, and why?**

- A) High-altitude Chardonnay, because guests recognize it as a premium variety
- B) Sauvignon Blanc, because it pairs with the widest range of menu items
- C) Torrontés, because it is unique, affordable, aromatic, and consistently generates guest curiosity about Argentine wine
- D) Viognier, because its floral profile mirrors Argentine wine's general character

**Correct: C**

---

**Q4. A guest asks: "Is this Argentine Cabernet blend like a Bordeaux?" What is the most accurate and effective response strategy?**

- A) Confirm that Argentine Cabernet is essentially the same as Bordeaux to close the sale quickly
- B) Deny any relationship to avoid false comparisons
- C) Acknowledge the structural relationship, note the distinctions in fruit profile and terroir, and introduce Cheval des Andes as a direct institutional connection between the two
- D) Redirect the guest to Malbec, which is more distinctly Argentine

**Correct: C**

---

**Q5. For a guest ordering from a mixed menu including seafood starters and meat mains, which Argentine wine strategy is both appropriate and revenue-positive?**

- A) Recommend only Malbec, as it pairs with everything
- B) Suggest Torrontés by the glass for starters and a Malbec when mains arrive, or offer Bonarda as a versatile single-bottle solution
- C) Suggest a premium Chardonnay for the entire meal
- D) Recommend sparkling wine for starters and Cabernet for mains

**Correct: B**

---

**Q6. Which producer pairing is identified as the most compelling entry point for a fine wine traditionalist who has never considered Argentine wine?**

- A) Zuccardi and Clos de los Siete
- B) Luigi Bosca and Achaval-Ferrer
- C) Catena Adrianna Vineyard and Cheval des Andes (with its Cheval Blanc connection)
- D) Norton and Trapiche

**Correct: C**

---

**Q7. What is the Torrontés aromatic-palate paradox, and why is it useful in staff training?**

- A) Torrontés looks pale but has deep red color when oxygenated
- B) The wine's nose is intensely floral and seemingly sweet, but the palate is dry and crisp — a surprise that, when experienced personally, gives staff language and enthusiasm they deliver authentically on the floor
- C) Torrontés smells like red fruit but tastes like white wine
- D) The wine is polarizing among staff, which generates useful debate

**Correct: B**

---

**Q8. For a Burgundy-focused guest, which Argentine wine conversation is most appropriate?**

- A) Lead with Malbec's richness and compare it to Pommard
- B) Focus on the geological precision of Valle de Uco, specifically Gualtallary's limestone and clay soils, the Catena Adrianna Vineyard's parcel mapping, and the White Bones Chardonnay's critical acclaim
- C) Recommend an Argentine Pinot Noir from Patagonia
- D) Discuss the parallels between Luján de Cuyo and the Côte de Beaune

**Correct: B**

---

**Q9. What is the recommended format for a monthly Argentine wine spotlight in staff training?**

- A) A 30-minute lecture covering the full Argentine wine map
- B) A 15-minute structured session covering origin and producer (5 minutes), sensory engagement (5 minutes), and floor application (5 minutes)
- C) A 45-minute deep dive comparing Argentine wine to French equivalents
- D) An informal tasting with no structured format, to allow organic discovery

**Correct: B**

---

**Q10. Why is the vertical Malbec staff tasting — using, for example, the Catena range — identified as the most effective tool for teaching the altitude quality hierarchy?**

- A) It is the most cost-effective tasting format available
- B) Catena is the only producer with wines available across all price points
- C) Staff who experience the quality differential between entry and single-vineyard expressions in the glass — rather than on paper — sell that differential intuitively on the floor
- D) The Catena family story is easier for staff to memorize than other producers

**Correct: C**

---

**Q11. Which cheese pairing is explicitly identified as particularly compelling with high-altitude single-vineyard Malbec, and why?**

- A) Brie, because its creaminess softens Malbec's tannin
- B) Blue cheese, because the salt cuts through Malbec's fruit
- C) Aged gouda, because its caramel and butterscotch notes create a resonant connection with the wine's dark fruit and oak integration
- D) Fresh mozzarella, because its neutrality allows Malbec's fruit to dominate

**Correct: C**

---

**Q12. What specific feature of Argentine viticulture is most relevant to the sustainability-focused guest?**

- A) Argentina has more certified biodynamic vineyards than any other South American country
- B) The arid Andean climate and high UV exposure mean minimal fungal disease pressure, dramatically reducing the need for chemical interventions, and many producers farm effectively organic by default
- C) Argentine producers are required by law to report annual pesticide use
- D) Water scarcity in Mendoza has forced producers to abandon irrigation entirely

**Correct: B**

---

**Q13. For a Napa-focused guest, what is the core value proposition of premium Argentine Malbec?**

- A) Argentine Malbec is lighter and more food-friendly than Napa Cabernet
- B) Argentine Malbec is produced by French-trained winemakers with Napa experience
- C) High-altitude Argentine single-vineyard Malbec delivers comparable concentration, complexity, and cellaring potential to Napa mountain Cabernet at a significantly lower price point
- D) Argentine Malbec is older-vines and therefore structurally superior to Napa Cabernet

**Correct: C**

---

**Q14. What is the recommended food pairing strategy for Torrontés with charcuterie, and what makes it effective?**

- A) Torrontés's sweetness balances the salt of cured meats
- B) Torrontés's floral aromatics create a contrasting backdrop to savory cured meats, refreshing the palate between bites — the aromatic contrast, not similarity, is what makes it work
- C) Torrontés and charcuterie share similar weight and texture
- D) Torrontés's tannin structure cuts through the fat in cured meats

**Correct: B**

---

**Q15. What does the phrase "joint venture" accomplish specifically when introduced in a conversation with a fine wine traditionalist about Cheval des Andes?**

- A) It signals that the wine is priced for investment rather than consumption
- B) It implies a lower-quality collaboration product compared to the estate wines of either partner
- C) It answers the implicit question behind the traditionalist's skepticism — "who vouches for this?" — by naming Château Cheval Blanc as a direct guarantor of quality
- D) It allows the guest to recognize the wine from prior critical coverage

**Correct: C**

---

**Q16. Which pairing represents the strongest case for Malbec with a vegetarian dish?**

- A) Malbec with a simple garden salad — the wine's acidity refreshes the palate
- B) Malbec with mushroom bourguignon or mushroom risotto — the dish's umami depth provides the savory anchor that replaces protein
- C) Malbec with lightly dressed steamed vegetables — the wine's fruit carries the dish
- D) Malbec with a tomato-based pasta — the wine's dark fruit complements the tomato acid

**Correct: B**

---

**Q17. What instruction is given to staff before the Torrontés staff tasting, and what is its pedagogical purpose?**

- A) Staff are told to read the tasting notes first so they know what to look for
- B) Staff are asked to smell the wine, write three words predicting the taste, then taste and compare — the paradox between expectation and experience becomes personally memorable and generates authentic floor enthusiasm
- C) Staff are paired with guests to taste simultaneously, creating a shared discovery moment
- D) Staff are told to taste blind without smelling first, to isolate flavor from aroma

**Correct: B**

---

**Q18. The full 60-second Argentine wine narrative for a guest who knows nothing about Argentina covers which four core elements?**

- A) Malbec history, Mendoza geography, producer rankings, and critical scores
- B) Altitude viticulture, Andean snowmelt irrigation, the Malbec transformation from France, and family estate character plus value positioning
- C) Wine law, appellation structure, comparative pricing, and food pairing suggestions
- D) Argentine independence history, the gaucho tradition, French immigrant winemakers, and export statistics

**Correct: B**

---

**Q19. What makes the Valle de Uco the most relevant Argentine conversation for a guest who is deeply loyal to Burgundy?**

- A) The Valle de Uco produces the most Pinot Noir in Argentina
- B) The Valle de Uco has a direct historical relationship with Burgundian producers going back to the 19th century
- C) Producers in Valle de Uco are mapping individual parcels by geology with the same precision as the Côte de Nuits, and the calcareous clay and limestone soils of Gualtallary are structurally analogous to Burgundy's soils at dramatically different altitude
- D) Valle de Uco Malbec is typically lighter-bodied and more elegant than other Argentine Malbec, making it stylistically similar to Pinot Noir

**Correct: C**

---

**Q20. What is the final outcome that the module identifies as the goal of all Argentine wine staff training — the floor standard a fully trained team should achieve?**

- A) Staff should be able to recite the names and scores of the top ten Argentine producers from memory
- B) Staff should be able to sell the Argentine wine section without a wine list in front of them
- C) Staff should integrate all modules into a service posture that positions Argentine wine not as a casual crowd-pleaser but as one of the most compelling and undervalued fine wine stories in the world — delivered with authentic enthusiasm grounded in personal sensory experience
- D) Staff should pass the Argentina Mastery certification exam before serving Argentine wine
