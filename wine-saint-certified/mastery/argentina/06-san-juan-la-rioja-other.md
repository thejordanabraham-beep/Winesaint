...
**Level:** Argentina Mastery — San Juan, La Rioja & Other Regions
**Module:** 06
...
## Section 1: San Juan, Argentina's Desert Giant
...
## Section 2: Pedernal Valley, San Juan's Crown Jewel
...
Pedernal sits in the southwestern corner of San Juan province, bounded by the Pie de Palo mountain range to the north and the Sierra Valle Fértil to the east, at elevations ranging from 1,200 to 1,400 meters above sea level. It is geographically isolated, accessible only by unpaved roads crossing rocky desert terrain, and was largely ignored by commercial wine producers until the late 1990s and early 2000s, when a combination of rising land prices in Mendoza and serious interest in high-altitude terroir drove prospectors north. What they found was a valley with conditions that were, in several respects, more extreme and more interesting than anything in Mendoza.
...
## Section 3: La Rioja, Argentina's Oldest Wine Province

La Rioja occupies an unusual position in Argentine wine history: it was first, and then it fell behind. The province lies north of San Juan, nestled between the Andes foothills and the arid Sierras Pampeanas, and it carries a distinction that no other Argentine wine region can claim. In 1591, Jesuit missionaries planted grapevines in La Rioja as part of the broader colonial expansion of viticulture across Spanish South America, making La Rioja the oldest wine-producing region in the country by more than a century. Those original Jesuit plantings established a tradition of winemaking that outlasted the colonial era and persisted through Argentine independence, though the province never developed the commercial infrastructure or international visibility that Mendoza achieved in the twentieth century.

Today, La Rioja is a small producer in national volume terms, with a wine culture shaped by local consumption, high temperatures, and limited access to the international capital that transformed Mendoza and, more recently, selected valleys in San Juan. The provincial capital, also called La Rioja, sits at approximately 860 meters above sea level in a broad, hot valley where viticulture is possible but challenging. The province's climate is characterized by extreme heat during summer, very low rainfall comparable to San Juan, and moderate winters that provide sufficient dormancy for deciduous viticulture.
...
## Section 4: Argentina's Other Producing Regions
...
## Section 5: Argentina's Wine Classification System
...
The second tier, **Indicación Geográfica (IG)**, designates wines that originate from a defined geographical region and carry that region's name on the label. To use an IG designation, a wine must meet specific requirements: the grapes must come from within the defined zone, the variety must be listed on the label, and the wine must meet minimum quality standards as assessed by the INV. All of the major Argentine wine regions, Mendoza, San Juan, La Rioja, Salta, Neuquén, Río Negro, operate as IGs, and sub-regions within them may carry their own IG designations. Valle de Uco, for example, achieved IG status in 2019. Luján de Cuyo has functioned as a recognized geographical indication since 1993, when it became the first Argentine IG to receive formal designation under the predecessor framework.
...
## Section 6: Floor Strategy, Positioning Secondary Regions for Guests
...
| Term | Definition |
|------|------------|
| Pedernal Valley | High-altitude sub-region of San Juan (1,200–1,400m) with limestone-rich soils, recognized for premium Syrah and Malbec distinct from Tulum's bulk production character |
| Tulum Valley | San Juan's primary production zone: hot, flat, and fertile; the commercial engine of the province, responsible for bulk wine and large-scale blending components |
| Jáchal | Remote northern zone within San Juan, home to old-vine Criolla varieties and field-blend vineyards; of interest to natural wine producers, minimal export presence |
| Pedro Giménez | White grape variety widely planted in San Juan and Mendoza; used in bulk white wine production and pisco/aguardiente distillation; not related to Pedro Ximénez of Spain |
| Torrontés | Argentina's signature white grape, a natural cross of Muscat of Alexandria and Criolla Chica; aromatic and floral; historically centered in La Rioja, now most prized from Salta's Cafayate |
| Famatina | Sub-region within La Rioja province, located on the slopes of the Sierra de Famatina at moderate altitude; shows quality potential for Torrontés and Malbec beyond the province's typical valley-floor production |
| Denominación de Origen Controlada (DOC) | Argentina's highest wine classification tier; requires defined boundaries, approved varieties, and production standards; currently granted only to Luján de Cuyo and San Rafael |
| Indicación Geográfica (IG) | Mid-tier Argentine designation guaranteeing that a wine originates from a named geographical zone; covers all major Argentine wine regions and many sub-regions |
| Instituto Nacional de Vitivinicultura (INV) | Argentina's national wine regulatory body; oversees denominación framework, production standards, and export certification |
| Criolla | Family of ancient grape varieties brought to Argentina by Spanish missionaries; includes Criolla Grande, Criolla Chica, and Cereza; historically dominant before Malbec's rise; still present in old-vine Jáchal and La Rioja vineyards |
| Chapadmalal | Coastal community south of Mar del Plata in Buenos Aires Province; site of Atlantic-influenced cool-climate viticulture experiments, primarily Pinot Noir and Chardonnay |
| Diurnal temperature variation | The difference between daytime high and nighttime low temperatures during the growing season; large swings (20–25°C in Pedernal) preserve acidity and slow ripening for more structured, complex wines |
| Zonda | Hot, dry wind that descends from the Andes into San Juan and Mendoza, capable of accelerating ripening and reducing disease pressure; distinct from the Patagonian winds that affect southern zones |
| Vino de Mesa | Argentina's base wine classification; no regional specificity, may blend from multiple provinces; common in domestic bulk production |

---

## Quiz: San Juan, La Rioja & Argentina's Secondary Regions

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. San Juan is best described as Argentina's _____ wine-producing province by volume.**
- A) Third-largest
- B) Largest
- C) Second-largest
- D) Fourth-largest
...
**Q2. The Tulum Valley within San Juan is primarily associated with:**
- A) Premium single-vineyard Syrah on limestone soils
- B) Large-scale bulk production for blending and domestic consumption
- C) Cool-climate Pinot Noir grown under Atlantic maritime influence
- D) Ancient Criolla vines farmed for natural wine production

**Correct: B**

---

**Q3. What makes Pedernal Valley's soils distinctively different from most of Mendoza's quality zones?**
- A) They are predominantly volcanic basalt from ancient eruptions
- B) They are heavy clay with high water retention
- C) They are limestone-rich and calcareous, forcing deep root growth and adding mineral tension
- D) They are pure sand with no mineral complexity

**Correct: C**

---

**Q4. The elevation range of Argentina's Pedernal Valley vineyards is approximately:**
- A) 400–600 meters
- B) 800–1,000 meters
- C) 1,200–1,400 meters
- D) 1,600–1,800 meters

**Correct: C**

---

**Q5. Pedernal Valley has gained international recognition primarily for which variety?**
- A) Malbec
- B) Torrontés
- C) Viognier
- D) Syrah
...
**Q6. The tasting profile of Pedernal Syrah is most often compared to:**
- A) Warm-climate McLaren Vale Shiraz
- B) Northern Rhône Syrah, savory, peppery, and structured
- C) Southern Rhône GSM blends, soft, round, and spiced
- D) Barossa Valley Shiraz, rich and full-bodied with ripe jammy fruit

**Correct: B**

---

**Q7. La Rioja Province holds which distinction in Argentine wine history?**
- A) It was the first province to achieve DOC status
- B) It is Argentina's highest-altitude wine region
- C) Jesuits planted grapevines there in 1591, making it Argentina's oldest wine region
- D) It produces the highest volume of Malbec of any Argentine province

**Correct: C**

---

**Q8. Which white variety is most historically and culturally associated with La Rioja Province?**
- A) Chardonnay
- B) Viognier
- C) Torrontés
- D) Pedro Giménez
...
**Q9. The Famatina sub-region within La Rioja is notable because:**
- A) It produces the largest volume of bulk wine in the province
- B) It sits at higher altitude than the valley floor, showing improved quality potential for Torrontés and Malbec
- C) It is Argentina's only coastal wine-producing zone
- D) It was designated Argentina's third DOC in 2022

**Correct: B**

---

**Q10. Chapadmalal and Sierra de los Padres are wine-producing zones located in:**
- A) Salta Province, at very high altitude near the Bolivian border
- B) Neuquén Province in Patagonia
- C) Buenos Aires Province, with Atlantic maritime climate influence
- D) San Juan Province, in the Pedernal Valley

**Correct: C**

---

**Q11. What is Argentina's highest wine classification tier, equivalent to France's AOC?**
- A) Indicación Geográfica (IG)
- B) Denominación de Origen Controlada (DOC)
- C) Vino de Mesa
- D) Gran Reserva
...
**Q12. As of this module, how many DOC designations exist in Argentina?**
- A) One (Luján de Cuyo only)
- B) Five, covering each major province
- C) Two. Luján de Cuyo and San Rafael
- D) Twelve, covering all GI zones and key sub-regions

**Correct: C**

---

**Q13. A guest points to "Indicación Geográfica Mendoza" on a label and asks what it means. The most accurate explanation is:**
- A) The wine was produced entirely from estate-grown grapes on a certified biodynamic farm
- B) The wine originates from within the defined Mendoza region and meets basic geographical origin requirements
- C) The wine has passed Argentina's highest tier of quality review and meets strict varietal standards
- D) The wine was blended from multiple Argentine provinces for national distribution

**Correct: B**

---

**Q14. A guest who loves Crozes-Hermitage asks for a recommendation outside France. Which response best demonstrates the floor skills taught in this module?**
- A) Recommend a Mendoza Malbec, explaining it is Argentina's signature variety
- B) Suggest a Bonarda from San Juan's Tulum Valley as a full-bodied crowd-pleaser
- C) Introduce a Pedernal Valley Syrah, framing it as high-altitude, limestone-grown, and Northern Rhône-adjacent in character
- D) Offer a Torrontés from Salta as a refreshing alternative to red Rhône wines

**Correct: C**

---

**Q15. What role does San Juan's warm-grown Malbec typically serve in large Argentine wine brands?**
- A) It forms the single-varietal backbone of premium export labels
- B) It contributes body and generous fruit as a blending component alongside higher-altitude Mendoza fruit
- C) It is reserved exclusively for domestic consumption under national law
- D) It is distilled into pisco and not used for table wine production

**Correct: B**

---

**Q16. The Jáchal zone within San Juan is best known for:**
- A) Its Pedernal limestone soils and premium Syrah output
- B) Remote location, old-vine Criolla varieties, and limited commercial export presence
- C) Cool Atlantic maritime climate and experimental Pinot Noir
- D) Its status as San Juan's largest volume production district

**Correct: B**

---

**Q17. Pedro Giménez, a widely planted variety in San Juan, is used primarily for:**
- A) Single-varietal premium white wine export to European markets
- B) Sparkling wine production in Patagonia
- C) Bulk white wine production and distillation into aguardiente/pisco
- D) Blending with Malbec to produce rosé

**Correct: C**

---

**Q18. Which of the following statements about Argentine DOC wines is accurate?**
- A) All Argentine wine regions may use the DOC designation if they choose to apply
- B) DOC wines must be blends of at least three approved varieties
- C) Holding a DOC designation guarantees a wine is among Argentina's most prestigious; most iconic Argentine wines operate within the IG framework
- D) The DOC tier was created in 2019 alongside Valle de Uco's official IG recognition

**Correct: C**

---

**Q19. For which type of guest is the La Rioja 1591 Jesuit planting story most useful as a floor tool?**
- A) Guests who want to order quickly and are focused on food pairing efficiency
- B) Guests already engaged in conversation who respond to historical depth and are building a richer mental model of Argentine wine
- C) Guests who are new to Argentine wine and need a simple introduction to the country's key variety
- D) Guests who have specifically asked for recommendations in the under-$40 price range

**Correct: B**

---

**Q20. A guest says they have tried Mendoza Malbec many times and want something different from Argentina. Based on this module, what is the most strategic recommendation?**
- A) Recommend another Mendoza Malbec from a different sub-region, explaining that Mendoza's diversity is underappreciated
- B) Suggest a Patagonian Malbec and change the subject
- C) Open with the Pedernal Valley Syrah story, covering limestone soils, high altitude, and Northern Rhône character, as Argentina's most exciting underdog discovery for wine-engaged guests
- D) Explain that Argentina does not produce any other wines of note outside Malbec
