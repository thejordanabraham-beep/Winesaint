...
**Level:** Germany Mastery — German Sweet Wines
**Module:** 19
...
## Section 1: The Prädikat Hierarchy at Its Summit
...
## Section 2: Botrytis Cinerea — The Noble Rot Mechanism
...
## Section 3: Beerenauslese — The Accessible Rarity
...
## Section 4: Trockenbeerenauslese — The Pinnacle
...
## Section 5: Eiswein — The Ice Wine Alternative
...
## Section 6: Floor Application — Selling the Pinnacle
...
| Term | Definition |
|------|------------|
| **Oechsle (°Oe)** | The German must weight measurement system, named for physicist Ferdinand Oechsle. One degree Oechsle equals 1 gram per liter of dissolved sugar above pure water. BA minimum is 110–128°Oe; TBA minimum is 150°Oe. |
| **Botrytis cinerea** | A fungus whose benevolent form — noble rot — penetrates grape skins under specific climatic conditions (morning fog, afternoon sun), dehydrates berries, and concentrates sugars, acids, and distinctive aromatic compounds including honey, dried apricot, saffron, and ginger. |
| **Noble rot (Edelfäule)** | The beneficial form of Botrytis cinerea infection. Distinguished from grey rot (which destroys grapes) by the alternating fog-and-sunshine conditions that enable dehydration rather than proliferation into the fruit's flesh. |
| **Grey rot (Grauschiefer)** | The malevolent form of Botrytis cinerea, which occurs in continuously cool, wet conditions without drying sunshine. Grey rot destroys fruit, introduces bitter laccase enzymes, and produces off-flavors that can ruin a harvest. |
| **Beerenauslese (BA)** | "Berry selection." A Prädikat level requiring 110–128°Oe (by region and variety), produced from individually hand-selected overripe and Botrytis-affected berries. Yields are typically 100–300 bottles per batch. Intensely sweet with 100–150 g/L residual sugar, balanced by high acidity and capable of decades of aging. |
| **Trockenbeerenauslese (TBA)** | "Dried berry selection." The highest German Prädikat, requiring a minimum 150°Oe. Made from individually selected shriveled, raisin-like grapes subject to extreme Botrytis concentration. Yields are measured in dozens to low hundreds of bottles. Residual sugar may exceed 200 g/L; alcohol typically 6–8%. Among the most expensive wines in the world. |
| **Eiswein** | Wine produced from grapes harvested and pressed while frozen, at temperatures of -7°C or below. The concentrated, sugar-saturated juice separates from the ice crystals during pressing. Eiswein requires healthy (non-botrytized) fruit, making it climatically opposite to TBA. Style is purer, more fruit-direct, and without the caramelized Botrytis character of BA or TBA. |
| **Prädikat** | Literally "predicate" — the quality designation awarded to a German wine based on must weight at harvest. The full hierarchy: QbA → Kabinett → Spätlese → Auslese → Beerenauslese → Trockenbeerenauslese / Eiswein. |
| **Glycerol** | A byproduct of Botrytis cinerea metabolism in the grape berry. Contributes to the viscous, almost oily texture characteristic of BA and TBA wines. Also responsible for the visible "tears" or "legs" on the glass when poured. |
| **Laccase** | An enzyme produced by Botrytis cinerea that oxidizes phenolic compounds. In red wine production, laccase is destructive — it causes rapid oxidation and browning. In white wine production and at controlled infection levels, it contributes to the complex, oxidative register of BA and TBA. |
| **Goldkapsel (GK)** | "Gold capsule." An unofficial designation used by many Mosel estates — particularly Egon Müller, JJ Prüm, and Zilliken — to indicate the highest-quality selection within a given Prädikat level. A "Lange Goldkapsel" (long gold capsule) indicates an even more intensely selected bottling. These are not legally defined categories but carry significant weight in the collector market. |
| **Fuder** | A large (1,000-liter) traditional German oak barrel used for fermentation and aging of Riesling. The neutral, seasoned wood imparts no oak flavor but allows gentle oxidation. Standard at traditional Mosel and Saar estates including Egon Müller, JJ Prüm, and Zilliken. |
| **Schatzkammer** | Literally "treasure vault." The private cellar of reserve wines maintained by estates such as Egon Müller, containing older TBA and BA vintages rarely made available to the public. A symbol of confidence in the wines' longevity. |
| **TDN (1,1,6-trimethyl-1,2-dihydronaphthalene)** | The chemical compound responsible for the "petrol" or "kerosene" note that develops in aged Riesling, particularly from cool climates. A normal and desirable characteristic of mature BA, TBA, and Eiswein from German producers. |

---

## Quiz — German Sweet Wines: BA, TBA, Eiswein, and the Prädikat Summit

**Instructions:** Select the best answer. All answers can be found in this module.

---

**Q1. Which of the following correctly lists the Prädikat hierarchy in ascending order of must weight?**
- A) Kabinett → Auslese → Spätlese → BA → TBA
- B) QbA → Kabinett → Spätlese → Auslese → BA → TBA
- C) Kabinett → Spätlese → BA → Auslese → TBA → Eiswein
- D) QbA → Spätlese → Kabinett → Auslese → Eiswein → TBA

**Correct: B**

---

**Q2. What distinguishes BA, TBA, and Eiswein from Kabinett, Spätlese, and Auslese as a category?**
- A) They are made from different grape varieties than lower Prädikat levels
- B) They can only be produced in the Mosel and Saar
- C) They require specific natural phenomena — Botrytis or frost — that cannot be engineered by winemakers
- D) They must be fermented in new French oak barrels

**Correct: C**

---

**Q3. What climatic conditions are required for Botrytis cinerea to develop as noble rot rather than destructive grey rot?**
- A) Continuous cool, wet weather with low temperatures throughout the day
- B) Morning fog followed by dry, warm afternoon sunshine — repeated over weeks
- C) A single heavy rainstorm followed by three weeks of dry heat
- D) Early morning frost followed by afternoon temperatures above 25°C

**Correct: B**

---

**Q4. What is the minimum Oechsle level required for Trockenbeerenauslese in the Mosel?**
- A) 83°Oe
- B) 110°Oe
- C) 128°Oe
- D) 150°Oe
...
**Q5. Why does Botrytis cinerea increase glycerol content in BA and TBA wines?**
- A) Glycerol is added by the winemaker to compensate for low yields
- B) The fungus produces glycerol as a metabolic byproduct during its dehydration of the berry
- C) Glycerol is concentrated from the grape's natural sugar reserves when Oechsle exceeds 100°
- D) Glycerol is produced by extended lees contact in the Fuder

**Correct: B**

---

**Q6. Egon Müller Scharzhofberger TBA from a great vintage (such as 1976) has sold at auction for approximately how much per bottle?**
- A) €500–€1,000
- B) €2,000–€5,000
- C) €10,000–€15,000 or more
- D) €50,000–€100,000
...
**Q7. Which estate and vineyard represents the Middle Mosel benchmark for TBA?**
- A) Dönnhoff / Oberhäuser Brücke
- B) Robert Weil / Kiedricher Gräfenberg
- C) JJ Prüm / Wehlener Sonnenuhr
- D) Willi Schaefer / Graacher Himmelreich

**Correct: C**

---

**Q8. What is the key flavor difference between TBA and Eiswein of similar Oechsle levels?**
- A) TBA is always drier than Eiswein because its fermentation proceeds further
- B) Eiswein shows a purer, more direct expression of the grape variety; TBA carries caramelized, Botrytis-driven complexity — honey, saffron, marmalade
- C) TBA always has higher acidity than Eiswein because Botrytis concentrates acid more efficiently than freezing
- D) Eiswein is only produced from Müller-Thurgau; TBA requires Riesling

**Correct: B**

---

**Q9. What temperature must grapes reach for legal Eiswein harvest in Germany?**
- A) 0°C or below
- B) -3°C or below
- C) -7°C or below
- D) -12°C or below
...
**Q10. Why is Botrytis cinerea feared in red wine production but welcomed in German white wine production?**
- A) Red wine grapes are picked earlier and cannot tolerate fungal infection at lower Oechsle levels
- B) Botrytis produces laccase, which oxidizes phenolics — destructive during red wine maceration, but manageable in pressed white juice with thick-skinned varieties like Riesling
- C) Botrytis only infects white wine grapes; red wine varieties are biologically resistant
- D) German law prohibits the use of Botrytis-affected grapes in red wine production

**Correct: B**

---

**Q11. Which German region and producer is considered the primary benchmark for Eiswein production?**
- A) Rheingau — Robert Weil
- B) Mosel — JJ Prüm
- C) Nahe — Dönnhoff
- D) Saar — Egon Müller
...
**Q12. What is the primary distinction between Canadian Icewine and German Eiswein in terms of production context?**
- A) Canadian Icewine is produced from red grapes only; German Eiswein is made exclusively from Riesling
- B) Canadian Icewine requires a lower harvest temperature (-6°C vs. -7°C) than German Eiswein
- C) Canadian Icewine is produced on a much larger commercial scale, with more reliable frost conditions, while German Eiswein is an increasingly rare annual gamble against warming winters
- D) German Eiswein uses Botrytis before freezing; Canadian Icewine does not

**Correct: C**

---

**Q13. A guest at your table has tried dessert wines before and found them "too heavy and sweet." Which wine from this module would you recommend as an introduction to German sweet wines, and why?**
- A) Egon Müller TBA, because its legendary status will impress even skeptical guests
- B) Robert Weil Kiedricher Gräfenberg BA, because BA's balance of intense sweetness and high acidity creates a wine that finishes clean rather than cloying
- C) A Nahe Eiswein, because the absence of Botrytis means the wine will feel lighter and more fruit-focused, with high acidity that prevents the "heavy" quality the guest described
- D) JJ Prüm Wehlener Sonnenuhr Spätlese, because it is not technically sweet enough to trigger the guest's objection

**Correct: C** *(B is also defensible — this is a scenario question and either answer with strong justification would be acceptable in discussion; C is preferred because it directly addresses the guest's "heavy" objection.)*

---

**Q14. Why does TBA commonly show hints of oxidation, and how should a floor professional characterize this to a guest?**
- A) TBA is oxidized because it is bottled without sulfur additions — a legal requirement in Germany
- B) TBA is fermented in used barrels that introduce oxygen; this is a flaw that should be acknowledged honestly
- C) At TBA's extreme sugar concentration, fermentation barely proceeds and the wine develops a slight oxidative register — this is correct and expected, contributing to the caramelized, amber complexity characteristic of the category
- D) TBA is made from sun-dried grapes similar to Italian passito, and the oxidation comes from the drying process rather than Botrytis

**Correct: C**

---

**Q15. Which Rheinhessen estate and vineyard is a benchmark for BA and TBA in that region?**
- A) Willi Schaefer / Graacher Domprobst
- B) Gunderloch / Nackenheimer Rothenberg
- C) Forstmeister Geltz-Zilliken / Saarburger Rausch
- D) Van Volxem / Wiltinger Gottesfuß

**Correct: B**

---

**Q16. What is the "Goldkapsel" designation, and why does it matter on the floor?**
- A) A legally defined German appellation indicating a single-vineyard wine from an official Grand Cru site
- B) An unofficial designation used by estates like Egon Müller and JJ Prüm to identify the highest-quality selection within a Prädikat level — a collector signal with significant price premium implications
- C) A Mosel Wine Association certification awarded to estates that age their wines a minimum of three years before release
- D) A regional designation for wines produced in the Bernkastel-Wehlen corridor of the Middle Mosel

**Correct: B**

---

**Q17. A guest sees a BA half-bottle priced at €180 and asks why it costs so much. What is the most effective floor response?**
- A) "German wines have always commanded premium prices because of their reputation — this is consistent with the market."
- B) "This wine is from a very small estate that produces very few bottles each year."
- C) "The harvest for this wine required pickers to select individual berries by hand over several weeks — in a single day, a picker may fill enough for roughly one bottle. For what's in that half-bottle, €180 is genuinely reasonable."
- D) "It is a rare vintage, and the winery priced it accordingly."

**Correct: C**

---

**Q18. What is the approximate aging potential of a great TBA from a top producer in an exceptional vintage?**
- A) 5–10 years
- B) 15–25 years
- C) 30–50 years
- D) 50–100 years or more

**Correct: D**

---

**Q19. Which of the following food pairings is most appropriate for a BA or TBA at dessert service?**
- A) A bitter dark chocolate fondant
- B) Roquefort or Stilton blue cheese
- C) A dry charcuterie board with aged Comté
- D) A Baked Alaska with meringue and vanilla ice cream

**Correct: B**

---

**Q20. What is the primary reason Eiswein production is becoming rarer in Germany, and which regions remain most viable for it?**
- A) German wine law was changed in 2018 to require a lower harvest temperature, making Eiswein production more difficult
- B) Consumer demand for Eiswein has declined, so fewer estates attempt production
- C) Climate change is reducing the frequency of hard winter frosts below -7°C; the Mosel (particularly the Saar), Nahe, and Mittelrhein remain the most viable regions due to their cooler valley topography and higher elevation sites
- D) A new EU regulation requires Eiswein grapes to be harvested by machine, making it impractical for small estates
