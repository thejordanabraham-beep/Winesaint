...
**Level:** Germany Mastery — Classification
**Module:** 3
...
## Section 2: The Prädikat System, From QbA to TBA
...
**Trockenbeerenauslese (TBA)**, Minimum ~150°Oe. The pinnacle. Individually selected, severely shriveled, raisined, botrytized berries, not plump grapes but near-raisins, concentrated to an extraordinary degree by both botrytis and desiccation. "Trockenbeeren" means "dried berries." The must weight at this level is so high, sometimes exceeding 200°Oe in exceptional years, that fermentation can barely proceed, leaving residual sugar of 300–450 g/L at 5–7% ABV. TBA is the rarest and most labor-intensive wine style in the world; a single harvest of a small vineyard might produce only a few hundred half-bottles. Egon Müller's Scharzhofberger TBA from the Mosel regularly reaches €20,000–€30,000 per bottle at auction. TBA from exceptional vintages can age for 50–100 years or more, evolving through honey, saffron, apricot, and petrol to flavors that have no equivalent in any other wine.

**Eiswein**: Must weight equivalent to BA (minimum ~110°Oe) but produced by a completely different mechanism. Eiswein grapes are left on the vine until a hard freeze occurs, at -8°C or below, then harvested and pressed immediately while still frozen. When frozen grape berries are pressed, the water (which freezes at a higher temperature) remains as ice crystals while only the highly concentrated, unfrozen juice runs free. The result: a wine with the Oechsle level of a BA but a character entirely distinct from TBA. Eiswein has the piercing acidity of Kabinett combined with extraordinary sugar concentration, it does not have the oxidative, honeyed character of botrytis wines because botrytis is not involved (or is minimized). The flavor profile is often described as pure fruit extract, lime, cherry, quince, with an almost electric acidity-sweetness tension. Eiswein and TBA are frequently confused by guests; the distinction is mechanistic (freezing vs. botrytis desiccation) and stylistic (racy and pure vs. rich and honeyed).
...
## Section 3: The Sweetness Trap, Trocken, Halbtrocken, and the Prädikat Confusion
...
**Trocken** (dry): Maximum 9 g/L residual sugar, or up to 18 g/L if the total acidity (in g/L) is within 2 g/L of the residual sugar content. The second clause exists because high-acid wines can carry more residual sugar without tasting sweet; the sugar and acid balance each other. For practical floor purposes: Trocken means dry. The label will say "Trocken" explicitly if the winemaker chose this designation.

**Halbtrocken** (half-dry / off-dry): 10–18 g/L residual sugar. The German term translates literally as "half-dry", the wines are perceptibly off-dry but not sweet. They pair well with food and are often the most versatile style for guests who find bone-dry wines too austere but don't want sweetness.
...
## Section 4: The VDP Classification, Germany's Answer to Burgundy
...
## Section 5: Regional Oechsle Minimums and Reading a Complete German Label
...
## Section 6: The 2021 Wine Law Reform and Floor Navigation

**The 2021 Reform; What Changed:**

The 2021 German Wine Law reform was the first major structural change to the system since 1971. Its goals were clear: repair the failures of the original law by creating a more terroir-based, geographically specific framework within the official system. The key additions:
...
| Term | Definition |
|---|---|
| Oechsle (°Oe) | A hydrometer measurement of must weight (grape juice sugar content before fermentation), expressed in degrees. The foundational measurement of the German Prädikat system. Approximately 1°Oe ≈ 0.6–0.7% potential alcohol. |
| QbA (Qualitätswein bestimmter Anbaugebiete) | Base level of Germany's official quality system; wines from a specific growing region; chaptalization (sugar addition) permitted; accounts for most German wine by volume. |
| Prädikat | The German term for the special quality attributes that place wines above QbA level; the six Prädikat levels (Kabinett through TBA) require no chaptalization and indicate ascending must weight at harvest. |
| Kabinett | The lightest Prädikat level; minimum 67°Oe for Mosel Riesling; typically 7.5–9% ABV; delicate, precise, high-acid; no chaptalization permitted. |
| Spätlese | "Late harvest"; second Prädikat level; minimum ~76°Oe for Mosel Riesling; riper and more concentrated than Kabinett; can be dry or sweet depending on fermentation, the label must be read carefully. |
| Auslese | "Selected harvest"; third Prädikat level; minimum ~83°Oe; grapes selected bunch by bunch; botrytis often present; typically 80–200 g/L RS; dry Auslese exists but is the exception. |
| Beerenauslese (BA) | "Berry selection"; fourth Prädikat level; minimum ~110°Oe; individual botrytized berries selected; rare; 150–250 g/L RS; 6–9% ABV; one of the world's great dessert wine styles. |
| Trockenbeerenauslese (TBA) | "Dried berry selection"; pinnacle Prädikat level; minimum ~150°Oe; individually selected shriveled, botrytized berries; rarest and most labor-intensive wine style in the world; 300–450 g/L RS; 5–7% ABV; can age 50–100+ years. |
| Eiswein | Grapes harvested frozen at -8°C or below; only concentrated unfrozen juice pressed out; must weight equivalent to BA; character is distinct from TBA, high acidity with pure fruit concentration rather than honeyed botrytis richness. |
| Trocken | "Dry"; maximum 9 g/L residual sugar (or up to 18 g/L if total acidity is within 2 g/L of RS); the explicit label designation indicating dry fermentation; critical for interpreting Prädikat wines. |
| Halbtrocken | "Half-dry"; 10–18 g/L residual sugar; off-dry; perceptibly but not overtly sweet; food-friendly and versatile. |
| Feinherb | Unofficial, unregulated label term indicating off-dry to lightly sweet character; approximately 10–20 g/L RS; interpretation requires knowledge of the specific producer's usage. |
| VDP (Verband Deutscher Prädikatsweingüter) | Association of German Prädikats Wine Estates; approximately 200 member estates; identified by the eagle logo; operates a four-tier vineyard classification system (Gutswein / Ortswein / Erste Lage / Grosse Lage) independent of official wine law. |
| Grosse Lage | The VDP's highest vineyard classification tier; equivalent to Burgundy Grand Cru; the finest classified sites in each region; can produce dry (GG) and sweet wines. |
| Erste Lage | The VDP's second-highest vineyard classification tier; equivalent to Burgundy Premier Cru; classified superior vineyard sites; dry or sweet styles permitted. |
| Grosses Gewächs (GG) | "Great growth"; the dry wine (Trocken) produced from a Grosse Lage vineyard by a VDP member estate; Germany's most prestigious dry white wine category; typically $50–$200+ at retail. |
| Goldkapsel | Informal, unregulated designation used by select top Mosel producers (notably JJ Prüm, Egon Müller) to indicate their finest barrel selection within a given Prädikat; Long Goldkapsel (LGK) indicates an even more selective cut. |
| AP Number (Amtliche Prüfungsnummer) | Government-assigned testing and approval number required on all QbA and Prädikat wines; encodes bottling location, producer code, lot number, and year; proof the wine passed an official tasting panel. |
| Gutswein | The VDP's entry-level tier; estate wine expressing regional character; the producer's house style rather than a specific classified vineyard site. |
| Ortswein | The VDP's village-level tier; wine from a specific named village; comparable to a Burgundy village wine; intermediate quality tier between Gutswein and Erste Lage. Also a new official category under the 2021 Wine Law reform. |

---

## Quiz: The German Classification System

*Instructions: Select the best answer for each question. Correct answers are marked with ✓.*

---

**1. Germany's official Prädikat system is based primarily on which measurement?**

A) Vineyard altitude
B) ✓ Must weight at harvest, measured in degrees Oechsle
C) Residual sugar in the finished wine
D) Vineyard size in hectares

---

**2. What does QbA stand for, and what distinguishes it from the Prädikat levels?**

A) Qualitätswein bestimmter Anbaugebiete; QbA wines must be made from a single grape variety
B) Qualitätswein bei Auslese; QbA allows oak aging while Prädikat wines do not
C) ✓ Qualitätswein bestimmter Anbaugebiete; QbA permits chaptalization (sugar addition), while chaptalization is forbidden at all Prädikat levels
D) Qualitätswein bestimmter Anbaugebiete; QbA wines must come from certified organic vineyards

---

**3. Place the following Prädikat levels in correct ascending order of must weight (Oechsle), from lowest to highest:**

A) Kabinett / Auslese / Spätlese / BA / TBA / Eiswein
B) ✓ Kabinett / Spätlese / Auslese / BA or Eiswein (equivalent minimum) / TBA
C) Spätlese / Kabinett / Auslese / TBA / BA / Eiswein
D) Kabinett / Spätlese / BA / Auslese / Eiswein / TBA

---

**4. A guest at your table orders a Mosel Riesling Spätlese. They have not specified a preference for dry or sweet. Based on the label alone, what do you know with certainty?**

A) The wine is off-dry with approximately 15 g/L residual sugar
B) The wine has botrytis influence and will taste honeyed
C) ✓ The grapes were harvested at a minimum of approximately 76°Oe; whether the wine is dry or sweet depends on additional label information (presence or absence of "Trocken") or producer knowledge
D) The wine is dry because Spätlese is traditionally a food wine style

---

**5. A guest reads the label and says: "It says Spätlese. I don't want something sweet." Your response should:**

A) Agree and redirect them to a Kabinett, which is always dry
B) Explain that Spätlese is always slightly sweet and offer an Alsatian alternative
C) ✓ Clarify that Spätlese indicates harvest ripeness, not finished sweetness; check whether the label says "Trocken," and if so, assure the guest the wine is dry; explain that Spätlese Trocken is a rich, concentrated dry wine
D) Tell the guest that all Mosel Rieslings are sweet by definition

---

**6. What is the legal maximum residual sugar for a wine labeled "Trocken"?**

A) 4 g/L
B) 6 g/L
C) ✓ 9 g/L (or up to 18 g/L if total acidity is within 2 g/L of the residual sugar level)
D) 12 g/L with no exceptions

---

**7. Which of the following is true about the term "Feinherb"?**

A) Feinherb is a legally defined sweetness category equivalent to Halbtrocken
B) Feinherb indicates wines with a minimum of 25 g/L residual sugar
C) ✓ Feinherb is an unofficial, unregulated term used by producers to indicate off-dry to lightly sweet character; its precise meaning varies by producer and is not legally defined
D) Feinherb applies only to Auslese-level wines and above

---

**8. What does the VDP eagle on a wine's capsule signify?**

A) The wine has received a government award for exceptional quality in the current vintage
B) The wine is certified organic by the German agricultural authority
C) ✓ The producer is a member of the Verband Deutscher Prädikatsweingüter, Germany's private association of top estates, which operates its own four-tier vineyard classification system
D) The wine achieved a minimum of 90 points from a major international critic

---

**9. What is a Grosses Gewächs (GG), and what three conditions must be met to use this designation?**

A) A sweet wine from any VDP member estate; conditions: must be Auslese or above, from a VDP estate, and bottled in a specific bottle shape
B) ✓ A dry wine from a Grosse Lage vineyard by a VDP member estate; the three conditions are: (1) the wine must be Trocken (dry), (2) the grapes must come from a classified Grosse Lage, and (3) the producer must be a VDP member meeting VDP standards
C) A single-vineyard wine at any sweetness level from any classified German vineyard
D) Germany's term for a wine equivalent to a French Premier Cru; any VDP wine at the Erste Lage level or above qualifies

---

**10. What distinguishes Eiswein from Trockenbeerenauslese?**

A) Eiswein has higher residual sugar than TBA and ages longer
B) TBA requires freezing temperatures while Eiswein uses botrytis for concentration
C) They are identical in production method; only the vintage year and region differ
D) ✓ Eiswein concentrates sugar by pressing frozen grapes at -8°C or below (water freezes, concentrated juice flows free), producing wines with high acidity and pure fruit character; TBA concentrates sugar through botrytis (noble rot) and desiccation of individual berries, producing honeyed, oxidative complexity. The two wines share similar Oechsle minimums but have fundamentally different characters.

---

**11. Why do Oechsle minimums for the same Prädikat level differ between the Mosel and the Pfalz?**

A) The Pfalz has historically produced lower quality wines, so lower standards are required
B) The Mosel uses a different Oechsle measurement scale than other regions
C) ✓ Warmer regions like the Pfalz naturally achieve higher must weights, so the bar is set higher to ensure the Prädikat designation remains meaningful; a Pfalz Riesling Spätlese minimum of 85°Oe reflects the same relative achievement as a Mosel Riesling Spätlese at 76°Oe
D) The Oechsle minimums are identical across all German regions; regional variations are a common misconception

---

**12. A collector asks you about the Goldkapsel on a JJ Prüm Wehlener Sonnenuhr Riesling Spätlese. What does it indicate?**

A) The wine was bottled in gold-foil-sealed bottles for the export market only
B) ✓ The Goldkapsel is an informal producer designation (not legally defined) indicating that this lot represents the finest barrel selection within the Spätlese category, richer, more concentrated, and more age-worthy than the standard Spätlese bottling; a Long Goldkapsel (LGK) would indicate an even more selective cut
C) The wine achieved a minimum of 95 points from the German Wine Institute evaluation panel
D) The gold capsule indicates the wine was made from a single barrel and no additional bottles will be released

---

**13. Place the VDP hierarchy in correct order from entry level to apex:**

A) Erste Lage / Ortswein / Gutswein / Grosse Lage
B) Ortswein / Gutswein / Grosse Lage / Erste Lage
C) ✓ Gutswein (entry) / Ortswein / Erste Lage / Grosse Lage (apex)
D) Grosse Lage / Gutswein / Erste Lage / Ortswein

---

**14. A Grosse Lage vineyard in the Mosel produces two wines in the same vintage from the same site: one labeled "Grosses Gewächs" and one labeled "Grosse Lage Auslese." How are these wines different?**

A) The GG is a blend of multiple vineyard sites while the Auslese is single-vineyard
B) The Auslese is the dry wine and the GG is the sweet wine
C) They are the same wine; producers use the terms interchangeably
D) ✓ The Grosses Gewächs is the dry (Trocken) wine from that site, while the Grosse Lage Auslese is a naturally sweet wine from the same site with residual sugar at Auslese Oechsle levels; same vineyard, different styles, different purposes

---

**15. What is the AP Number (Amtliche Prüfungsnummer) and why does it appear on German wine labels?**

A) An optional producer code used by VDP members to indicate barrel selection
B) A vintage quality rating issued by the German Wine Institute, where higher numbers indicate better vintages
C) ✓ A government-assigned testing and approval number required on all QbA and Prädikat wines, confirming the wine was submitted to an official tasting panel and approved as representative of its stated category; it encodes bottling location, producer code, lot number, and year of bottling
D) A certification number indicating the wine was produced from certified organic or biodynamic vineyards

---

**16. A guest at a corporate dinner says they remember loving a German Riesling that was "sweet but not heavy." They want something similar. What Prädikat level and sweetness profile are they most likely describing, and how do you navigate the list?**

A) They are describing a TBA; look for the most expensive wine on the list and present it
B) They are describing a dry Grosses Gewächs; the term "sweet" is being used loosely to mean "rich and fruity"
C) ✓ They are most likely describing a Kabinett or Spätlese with moderate residual sugar (perhaps 30–70 g/L RS), the signature German style of high acidity balancing sweetness to produce a wine that is sweet but electric rather than heavy; look for wines without a Trocken designation at these Prädikat levels, from the Mosel where lower alcohol and higher acidity produce the lightest, most precise style
D) They are describing an Eiswein; the "not heavy" element confirms a freezing-harvest wine

---

**17. What was the primary structural failure of the 1971 German Wine Law that led to the creation of the VDP's parallel classification?**

A) The 1971 law required all German wines to be labeled in English for export markets, which producers resented
B) The 1971 law banned chaptalization at all quality levels, making wine production in cool years economically unviable
C) ✓ The 1971 law prioritized grape ripeness (must weight) over vineyard quality and terroir; it permitted generous yields, expanded vineyard boundaries, and gave no legal recognition to superior vineyard sites, meaning a wine from Germany's best Grand Cru vineyard had no official advantage over a wine from an industrial site, incentivizing quantity over quality
D) The 1971 law required VDP producers to release wines at government-set prices, eliminating the premium market

---

**18. A knowledgeable guest asks you to compare the VDP Ortswein tier to a Burgundy equivalent. What is the correct comparison, and what does it tell the guest about what to expect in the glass?**

A) VDP Ortswein is equivalent to a Burgundy Grand Cru, the highest site classification, single vineyard, maximum geographic specificity
B) ✓ VDP Ortswein is comparable to a Burgundy village wine, a wine from a specific named village (e.g., Piesport or Wehlen) without a specific vineyard designation, showing village character rather than single-site precision; it sits above estate-level wine (Gutswein) but below classified vineyards (Erste Lage and Grosse Lage)
C) VDP Ortswein is equivalent to a Burgundy Premier Cru; it represents a classified superior site within a village appellation
D) VDP Ortswein has no Burgundy equivalent because the German village system is not geographically defined in the same way as French appellations

---

**19. You are conducting staff training and a server asks: "If Spätlese doesn't tell me if the wine is sweet, and Trocken sometimes doesn't appear on the label, how do I quickly tell if a German wine has residual sugar?" What is the most practical floor answer?**

A) Always assume residual sugar unless the label explicitly says Trocken; never guess
B) Check the color of the label: traditional estate labels indicate sweetness; modern minimalist labels indicate dry styles
C) The AP number encodes residual sugar information; a number ending in an odd digit indicates dry, even digit indicates sweet
D) ✓ Check the ABV: below 11% ABV often signals residual sweetness (fermentation was not taken to completion, leaving sugar and resulting in lower alcohol); above 12.5% ABV typically signals a dry wine fermented to completion; this is informal but reliable in practice; always confirm with explicit Trocken designation when available

---

**20. A table of collectors is ordering a special-occasion German wine and one guest asks about Egon Müller's TBA. They want to understand why it commands such extraordinary auction prices. What is the complete accurate answer?**

A) Egon Müller TBA is expensive primarily because of marketing and brand prestige; the wine itself is technically comparable to other TBA producers
B) Egon Müller uses a patented freezing technique that combines TBA and Eiswein production methods, creating a hybrid style no other producer can replicate
C) The price reflects the gold capsule designation, which Egon Müller applies exclusively to TBA wines, creating artificial scarcity through limited labeling
D) ✓ Egon Müller's Scharzhofberger TBA commands extraordinary prices for several compounding reasons: (1) TBA requires individually selected, shriveled, botrytized berries, extraordinarily labor-intensive, with entire vineyards yielding only a few hundred half-bottles; (2) TBA is only produced in exceptional years when conditions for noble rot and desiccation develop correctly, not every year qualifies; (3) the Scharzhofberger vineyard is one of Germany's most acclaimed Grosse Lagen sites; (4) Egon Müller is one of Germany's most historically revered estates with a track record for aging; (5) the wines can age 50–100+ years, developing extraordinary complexity; the auction price reflects all of these factors combined, rarity, site, producer reputation, and age potential

---

*End of Quiz, 20 Questions*

---

*Wine Saint Certified. Germany Mastery | Module 3 of 8*
*© Wine Saint. For licensed hospitality training use only.*
